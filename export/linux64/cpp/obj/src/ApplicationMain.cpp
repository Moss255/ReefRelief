...
Void ApplicationMain_obj::main( ){
{
		...
		HX_STACK_LINE(29)
		::openfl::_legacy::Lib_obj::setPackage(HX_HCSTRING("MossGames","\x3f","\xd8","\x8e","\x0a"),HX_HCSTRING("ReefRelief","\x65","\x67","\xfc","\x2b"),HX_HCSTRING("com.example.myapp","\x84","\x30","\x57","\xc1"),HX_HCSTRING("0.0.1","\x35","\x3d","\xc8","\xc1"));
		HX_STACK_LINE(133)
		...
		HX_STACK_LINE(52)
		::openfl::_legacy::Lib_obj::create( Dynamic(new _Function_1_1()),(int)640,(int)480,(int)60,(int)0,tmp22,HX_HCSTRING("ReefRelief","\x65","\x67","\xfc","\x2b"),null(),null());
	}
return null();
}
