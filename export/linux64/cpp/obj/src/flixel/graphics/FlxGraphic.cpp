...
{
		HX_STACK_FRAME("flixel.graphics.FlxGraphic","dump",0xe78dc2db,"flixel.graphics.FlxGraphic.dump","flixel/graphics/FlxGraphic.hx",407,0xb3633517)
		HX_STACK_THIS(this)
		HX_STACK_LINE(409)
		...
		if ((tmp)){
			...
			if ((tmp9)){
				HX_STACK_LINE(409)
				::String tmp10 = this->assetsKey;		HX_STACK_VAR(tmp10,"tmp10");
				HX_STACK_LINE(409)
		...
		if ((tmp1)){
			HX_STACK_LINE(411)
			::openfl::_legacy::display::BitmapData tmp2 = this->bitmap;		HX_STACK_VAR(tmp2,"tmp2");
			HX_STACK_LINE(411)
			tmp2->dumpBits();
			HX_STACK_LINE(412)
			this->isDumped = true;
...
{
		HX_STACK_FRAME("flixel.graphics.FlxGraphic","onContext",0x4fa62b89,"flixel.graphics.FlxGraphic.onContext","flixel/graphics/FlxGraphic.hx",435,0xb3633517)
		HX_STACK_THIS(this)
		HX_STACK_LINE(437)
...
Void FlxGraphic_obj::destroy( ){
{
		...
		HX_STACK_LINE(475)
		{
			...
			while((true)){
				...
				HX_STACK_LINE(475)
				::flixel::graphics::frames::FlxFrameCollectionType collectionType = tmp5;		HX_STACK_VAR(collectionType,"collectionType");
				HX_STACK_LINE(475)
				++(_g);
				HX_STACK_LINE(477)
				::haxe::ds::EnumValueMap tmp6 = this->frameCollections;		HX_STACK_VAR(tmp6,"tmp6");
				HX_STACK_LINE(477)
				::flixel::graphics::frames::FlxFrameCollectionType tmp7 = collectionType;		HX_STACK_VAR(tmp7,"tmp7");
				HX_STACK_LINE(477)
...
{
		HX_STACK_FRAME("flixel.graphics.FlxGraphic","addFrameCollection",0x06dd03b1,"flixel.graphics.FlxGraphic.addFrameCollection","flixel/graphics/FlxGraphic.hx",491,0xb3633517)
		HX_STACK_THIS(this)
...
cpp::ArrayBase FlxGraphic_obj::getFramesCollections( ::flixel::graphics::frames::FlxFrameCollectionType type){
	HX_STACK_FRAME("flixel.graphics.FlxGraphic","getFramesCollections",0xa4089c80,"flixel.graphics.FlxGraphic.getFramesCollections","flixel/graphics/FlxGraphic.hx",506,0xb3633517)
	HX_STACK_THIS(this)
...
::flixel::graphics::frames::FlxFrame FlxGraphic_obj::getEmptyFrame( ::flixel::math::FlxPoint size){
	HX_STACK_FRAME("flixel.graphics.FlxGraphic","getEmptyFrame",0xc5b0f80f,"flixel.graphics.FlxGraphic.getEmptyFrame","flixel/graphics/FlxGraphic.hx",524,0xb3633517)
	HX_STACK_THIS(this)
...
::openfl::_legacy::display::Tilesheet FlxGraphic_obj::get_tilesheet( ){
	HX_STACK_FRAME("flixel.graphics.FlxGraphic","get_tilesheet",0x1819f201,"flixel.graphics.FlxGraphic.get_tilesheet","flixel/graphics/FlxGraphic.hx",536,0xb3633517)
	HX_STACK_THIS(this)
	HX_STACK_LINE(537)
...
::openfl::_legacy::display::BitmapData FlxGraphic_obj::getBitmapFromSystem( ){
	HX_STACK_FRAME("flixel.graphics.FlxGraphic","getBitmapFromSystem",0xb3be27b7,"flixel.graphics.FlxGraphic.getBitmapFromSystem","flixel/graphics/FlxGraphic.hx",558,0xb3633517)
	HX_STACK_THIS(this)
	HX_STACK_LINE(559)
			...
			HX_STACK_LINE(566)
			{
				...
				if ((tmp7)){
					...
					HX_STACK_LINE(566)
					{
						...
						HX_STACK_LINE(566)
						::String tmp9 = (HX_HCSTRING("Could not find a BitmapData asset with ID '","\x5f","\x79","\xa9","\x21") + id);		HX_STACK_VAR(tmp9,"tmp9");
						HX_STACK_LINE(566)
						::String tmp10 = (tmp9 + HX_HCSTRING("'.","\x27","\x22","\x00","\x00"));		HX_STACK_VAR(tmp10,"tmp10");
						HX_STACK_LINE(566)
						::flixel::_system::debug::log::LogStyle tmp11 = ::flixel::_system::debug::log::LogStyle_obj::ERROR;		HX_STACK_VAR(tmp11,"tmp11");
						HX_STACK_LINE(566)
						tmp8->__Field(HX_HCSTRING("advanced","\xa2","\x69","\x7b","\x3b"), hx::paccDynamic )(tmp10,tmp11,true);
					}
					HX_STACK_LINE(566)
					tmp4 = null();
				}
...
bool FlxGraphic_obj::get_canBeDumped( ){
	HX_STACK_FRAME("flixel.graphics.FlxGraphic","get_canBeDumped",0x9b8a5e36,"flixel.graphics.FlxGraphic.get_canBeDumped","flixel/graphics/FlxGraphic.hx",578,0xb3633517)
	HX_STACK_THIS(this)
	HX_STACK_LINE(579)
	::hx::Class tmp = this->assetsClass;		HX_STACK_VAR(tmp,"tmp");
	HX_STACK_LINE(579)
...
int FlxGraphic_obj::get_useCount( ){
	HX_STACK_FRAME("flixel.graphics.FlxGraphic","get_useCount",0x2bcc1fb8,"flixel.graphics.FlxGraphic.get_useCount","flixel/graphics/FlxGraphic.hx",583,0xb3633517)
	HX_STACK_THIS(this)
	HX_STACK_LINE(584)
...
int FlxGraphic_obj::set_useCount( int Value){
	HX_STACK_FRAME("flixel.graphics.FlxGraphic","set_useCount",0x40c5432c,"flixel.graphics.FlxGraphic.set_useCount","flixel/graphics/FlxGraphic.hx",588,0xb3633517)
	HX_STACK_THIS(this)
...
bool FlxGraphic_obj::get_destroyOnNoUse( ){
	HX_STACK_FRAME("flixel.graphics.FlxGraphic","get_destroyOnNoUse",0x7e860bbd,"flixel.graphics.FlxGraphic.get_destroyOnNoUse","flixel/graphics/FlxGraphic.hx",598,0xb3633517)
	HX_STACK_THIS(this)
	HX_STACK_LINE(599)
...
bool FlxGraphic_obj::set_destroyOnNoUse( bool Value){
	HX_STACK_FRAME("flixel.graphics.FlxGraphic","set_destroyOnNoUse",0x5b353e31,"flixel.graphics.FlxGraphic.set_destroyOnNoUse","flixel/graphics/FlxGraphic.hx",603,0xb3633517)
	HX_STACK_THIS(this)
	HX_STACK_ARG(Value,"Value")
	HX_STACK_LINE(604)
...
::flixel::graphics::frames::FlxImageFrame FlxGraphic_obj::get_imageFrame( ){
	HX_STACK_FRAME("flixel.graphics.FlxGraphic","get_imageFrame",0xc1224382,"flixel.graphics.FlxGraphic.get_imageFrame","flixel/graphics/FlxGraphic.hx",613,0xb3633517)
	HX_STACK_THIS(this)
	HX_STACK_LINE(614)
...
::flixel::graphics::frames::FlxAtlasFrames FlxGraphic_obj::get_atlasFrames( ){
	HX_STACK_FRAME("flixel.graphics.FlxGraphic","get_atlasFrames",0x774c10a1,"flixel.graphics.FlxGraphic.get_atlasFrames","flixel/graphics/FlxGraphic.hx",623,0xb3633517)
	HX_STACK_THIS(this)
	HX_STACK_LINE(624)
...
::openfl::_legacy::display::BitmapData FlxGraphic_obj::set_bitmap( ::openfl::_legacy::display::BitmapData value){
	HX_STACK_FRAME("flixel.graphics.FlxGraphic","set_bitmap",0x39ee9b13,"flixel.graphics.FlxGraphic.set_bitmap","flixel/graphics/FlxGraphic.hx",628,0xb3633517)
	HX_STACK_THIS(this)
	HX_STACK_ARG(value,"value")
	HX_STACK_LINE(629)
	...
	if ((tmp)){
		...
		if ((tmp5)){
			HX_STACK_LINE(635)
			::openfl::_legacy::display::Tilesheet tmp7 = this->_tilesheet;		HX_STACK_VAR(tmp7,"tmp7");
			HX_STACK_LINE(635)
			::openfl::_legacy::display::Tilesheet tmp8 = tmp7;		HX_STACK_VAR(tmp8,"tmp8");
			HX_STACK_LINE(635)
			tmp6 = (tmp8 != null());
		}
		else{
		...
		if ((tmp6)){
			HX_STACK_LINE(636)
			::openfl::_legacy::display::BitmapData tmp7 = this->bitmap;		HX_STACK_VAR(tmp7,"tmp7");
			HX_STACK_LINE(636)
			::openfl::_legacy::display::Tilesheet tmp8 = ::openfl::_legacy::display::Tilesheet_obj::__new(tmp7);		HX_STACK_VAR(tmp8,"tmp8");
			HX_STACK_LINE(636)
			this->_tilesheet = tmp8;
		}
	}
	HX_STACK_LINE(640)
	...
	HX_STACK_ARG(Cache,"Cache")
{
		...
		if ((tmp1)){
			...
			if ((tmp3)){
				...
				HX_STACK_LINE(43)
				{
					...
					HX_STACK_LINE(43)
					::String tmp6 = (HX_HCSTRING("Could not find a BitmapData asset with ID '","\x5f","\x79","\xa9","\x21") + Source);		HX_STACK_VAR(tmp6,"tmp6");
					HX_STACK_LINE(43)
					::String tmp7 = (tmp6 + HX_HCSTRING("'.","\x27","\x22","\x00","\x00"));		HX_STACK_VAR(tmp7,"tmp7");
					HX_STACK_LINE(43)
					::flixel::_system::debug::log::LogStyle tmp8 = ::flixel::_system::debug::log::LogStyle_obj::ERROR;		HX_STACK_VAR(tmp8,"tmp8");
					HX_STACK_LINE(43)
		...
		HX_STACK_LINE(52)
		::flixel::graphics::FlxGraphic tmp9 = tmp7->__Field(HX_HCSTRING("_cache","\x83","\xe1","\xfb","\x3c"), hx::paccDynamic )->__Field(HX_HCSTRING("get","\x96","\x80","\x4e","\x00"), hx::paccDynamic )(tmp8);		HX_STACK_VAR(tmp9,"tmp9");
		HX_STACK_LINE(52)
		...
		if ((tmp12)){
			...
			HX_STACK_LINE(58)
			{
				...
				HX_STACK_LINE(58)
				::String tmp15 = (HX_HCSTRING("Could not find a BitmapData asset with ID '","\x5f","\x79","\xa9","\x21") + Source);		HX_STACK_VAR(tmp15,"tmp15");
				HX_STACK_LINE(58)
				::String tmp16 = (tmp15 + HX_HCSTRING("'.","\x27","\x22","\x00","\x00"));		HX_STACK_VAR(tmp16,"tmp16");
				HX_STACK_LINE(58)
				::flixel::_system::debug::log::LogStyle tmp17 = ::flixel::_system::debug::log::LogStyle_obj::ERROR;		HX_STACK_VAR(tmp17,"tmp17");
				HX_STACK_LINE(58)
				tmp14->__Field(HX_HCSTRING("advanced","\xa2","\x69","\x7b","\x3b"), hx::paccDynamic )(tmp16,tmp17,true);
			}
			HX_STACK_LINE(58)
			tmp13 = null();
		}
	...
	HX_STACK_ARG(Cache,"Cache")
{
		...
		if ((tmp5)){
			...
			::String tmp7 = key;		HX_STACK_VAR(tmp7,"tmp7");
			HX_STACK_LINE(124)
			::flixel::graphics::FlxGraphic tmp8 = tmp6->__Field(HX_HCSTRING("_cache","\x83","\xe1","\xfb","\x3c"), hx::paccDynamic )->__Field(HX_HCSTRING("get","\x96","\x80","\x4e","\x00"), hx::paccDynamic )(tmp7);		HX_STACK_VAR(tmp8,"tmp8");
			HX_STACK_LINE(124)
			graphic = tmp8;
			HX_STACK_LINE(125)
	...
	HX_STACK_ARG(Cache,"Cache")
{
		...
		bool tmp17 = Unique;		HX_STACK_VAR(tmp17,"tmp17");
		HX_STACK_LINE(168)
		bool tmp18 = Cache;		HX_STACK_VAR(tmp18,"tmp18");
		HX_STACK_LINE(168)
		::flixel::graphics::FlxGraphic tmp19 = ::flixel::graphics::FlxGraphic_obj::createGraphic(tmp15,tmp16,tmp17,tmp18);		HX_STACK_VAR(tmp19,"tmp19");
		HX_STACK_LINE(168)
		graphic = tmp19;
		HX_STACK_LINE(169)
		::flixel::graphics::FlxGraphic tmp20 = graphic;		HX_STACK_VAR(tmp20,"tmp20");
		HX_STACK_LINE(169)
		::flixel::graphics::frames::FlxImageFrame tmp21 = ::flixel::graphics::frames::FlxImageFrame_obj::fromGraphic(tmp20,null());		HX_STACK_VAR(tmp21,"tmp21");
		HX_STACK_LINE(169)
		::flixel::graphics::frames::FlxImageFrame image = tmp21;		HX_STACK_VAR(image,"image");
		HX_STACK_LINE(170)
		::flixel::graphics::frames::FlxFrame tmp22 = image->frames->__get((int)0).StaticCast< ::flixel::graphics::frames::FlxFrame >();		HX_STACK_VAR(tmp22,"tmp22");
		HX_STACK_LINE(170)
		tmp22->name = Source->name;
		HX_STACK_LINE(171)
		::flixel::graphics::FlxGraphic tmp23 = graphic;		HX_STACK_VAR(tmp23,"tmp23");
		HX_STACK_LINE(171)
		return tmp23;
	}
}
...
bool Unique = __o_Unique.Default(false);
	HX_STACK_FRAME("flixel.graphics.FlxGraphic","fromFrames",0x44a73197,"flixel.graphics.FlxGraphic.fromFrames","flixel/graphics/FlxGraphic.hx",185,0xb3633517)
	HX_STACK_ARG(Source,"Source")
	HX_STACK_ARG(Unique,"Unique")
	HX_STACK_ARG(Key,"Key")
{
	...
	HX_STACK_ARG(Key,"Key")
{
		...
		HX_STACK_LINE(210)
		{
			...
			::flixel::graphics::FlxGraphic tmp14 = graphic;		HX_STACK_VAR(tmp14,"tmp14");
			HX_STACK_LINE(210)
			tmp12->__Field(HX_HCSTRING("_cache","\x83","\xe1","\xfb","\x3c"), hx::paccDynamic )->__Field(HX_HCSTRING("set","\xa2","\x9b","\x57","\x00"), hx::paccDynamic )(tmp13,tmp14);
			HX_STACK_LINE(210)
			tmp11 = graphic;
		}
		HX_STACK_LINE(210)
...
bool Unique = __o_Unique.Default(false);
	HX_STACK_FRAME("flixel.graphics.FlxGraphic","getBitmap",0xcbe6761e,"flixel.graphics.FlxGraphic.getBitmap","flixel/graphics/FlxGraphic.hx",247,0xb3633517)
	HX_STACK_ARG(Bitmap,"Bitmap")
	HX_STACK_ARG(Unique,"Unique")
{
		HX_STACK_LINE(248)
	...
	HX_STACK_ARG(Cache,"Cache")
{
		...
		if ((tmp2)){
			...
			HX_STACK_LINE(269)
			{
				...
				HX_STACK_LINE(269)
				tmp4->__Field(HX_HCSTRING("_cache","\x83","\xe1","\xfb","\x3c"), hx::paccDynamic )->__Field(HX_HCSTRING("set","\xa2","\x9b","\x57","\x00"), hx::paccDynamic )(tmp5,tmp6);
				HX_STACK_LINE(269)
				graphic;
			}
		}
