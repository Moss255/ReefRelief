...
{
		HX_STACK_FRAME("flixel.input.keyboard.FlxKeyboard","onKeyUp",0xa36f8255,"flixel.input.keyboard.FlxKeyboard.onKeyUp","flixel/input/keyboard/FlxKeyboard.hx",93,0x41882875)
		HX_STACK_THIS(this)
		...
		if ((tmp3)){
			...
			HX_STACK_LINE(98)
			::openfl::_legacy::events::KeyboardEvent tmp7 = event;		HX_STACK_VAR(tmp7,"tmp7");
			HX_STACK_LINE(98)
			::openfl::_legacy::events::KeyboardEvent tmp8 = tmp7;		HX_STACK_VAR(tmp8,"tmp8");
			HX_STACK_LINE(98)
		...
		if ((tmp4)){
			...
			HX_STACK_LINE(100)
			tmp5->__Field(HX_HCSTRING("set_visible","\x95","\xdf","\x8b","\x33"), hx::paccDynamic )(tmp8);
		}
	}
return null();
}
...
{
		HX_STACK_FRAME("flixel.input.keyboard.FlxKeyboard","onKeyDown",0xf4d786dc,"flixel.input.keyboard.FlxKeyboard.onKeyDown","flixel/input/keyboard/FlxKeyboard.hx",106,0x41882875)
		HX_STACK_THIS(this)
		HX_STACK_ARG(event,"event")
		HX_STACK_LINE(107)
		::openfl::_legacy::events::KeyboardEvent tmp = event;		HX_STACK_VAR(tmp,"tmp");
...
Void FlxKeyboard_obj::playback( Array< ::Dynamic > Record){
{
		...
		while((true)){
			...
			HX_STACK_LINE(172)
			::flixel::_system::replay::CodeValuePair o = tmp3;		HX_STACK_VAR(o,"o");
			HX_STACK_LINE(173)
			...
			HX_STACK_LINE(173)
			::flixel::input::FlxInput o2 = tmp6;		HX_STACK_VAR(o2,"o2");
			HX_STACK_LINE(174)
