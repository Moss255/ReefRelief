...
bool FlxKeyManager_obj::checkStatus( Dynamic KeyCode,int Status){
	...
	if ((tmp3)){
		...
		HX_STACK_LINE(147)
		Dynamic tmp4 = KeyCode;		HX_STACK_VAR(tmp4,"tmp4");
		HX_STACK_LINE(147)
		::String tmp5 = ::Std_obj::string(tmp4);		HX_STACK_VAR(tmp5,"tmp5");
		HX_STACK_LINE(147)
		::String tmp6 = (HX_HCSTRING("Invalid key code: ","\x1d","\x50","\x8f","\xe3") + tmp5);		HX_STACK_VAR(tmp6,"tmp6");
		HX_STACK_LINE(147)
...
bool FlxKeyManager_obj::inKeyArray( cpp::ArrayBase KeyArray,::openfl::_legacy::events::KeyboardEvent Event){
	...
	if ((tmp)){
		...
		HX_STACK_LINE(300)
		::openfl::_legacy::events::KeyboardEvent tmp1 = Event;		HX_STACK_VAR(tmp1,"tmp1");
		HX_STACK_LINE(300)
		int tmp2 = this->resolveKeyCode(tmp1);		HX_STACK_VAR(tmp2,"tmp2");
		HX_STACK_LINE(300)
		...
		HX_STACK_LINE(301)
		{
			...
			while((true)){
				HX_STACK_LINE(301)
				bool tmp3 = (_g < KeyArray->__Field(HX_HCSTRING("length","\xe6","\x94","\x07","\x9f"), hx::paccDynamic ));		HX_STACK_VAR(tmp3,"tmp3");
				HX_STACK_LINE(301)
				bool tmp4 = !(tmp3);		HX_STACK_VAR(tmp4,"tmp4");
				HX_STACK_LINE(301)
				if ((tmp4)){
				...
				HX_STACK_LINE(301)
				Dynamic tmp5 = KeyArray->__GetItem(_g);		HX_STACK_VAR(tmp5,"tmp5");
				HX_STACK_LINE(301)
				Dynamic key = tmp5;		HX_STACK_VAR(key,"key");
				HX_STACK_LINE(301)
				++(_g);
				HX_STACK_LINE(303)
				bool tmp6 = (key == code);		HX_STACK_VAR(tmp6,"tmp6");
				HX_STACK_LINE(303)
				bool tmp7 = !(tmp6);		HX_STACK_VAR(tmp7,"tmp7");
				HX_STACK_LINE(303)
