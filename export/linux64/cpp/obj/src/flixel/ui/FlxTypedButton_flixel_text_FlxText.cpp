...
{
		HX_STACK_FRAME("flixel.ui.FlxTypedButton_flixel_text_FlxText","drawDebug",0xbcdf6ce4,"flixel.ui.FlxTypedButton_flixel_text_FlxText.drawDebug","flixel/ui/FlxButton.hx",328,0xc64cf442)
		HX_STACK_THIS(this)
		HX_STACK_LINE(329)
...
HX_DEFINE_DYNAMIC_FUNC0(FlxTypedButton_flixel_text_FlxText_obj,drawDebug,(void))
...
Void FlxTypedButton_flixel_text_FlxText_obj::onUpHandler( ){
{
		...
		HX_STACK_LINE(516)
		{
			...
			if ((tmp3)){
				HX_STACK_LINE(516)
				_this->sound->__Field(HX_HCSTRING("play","\xf4","\x2d","\x5a","\x4a"), hx::paccDynamic )(true,null(),null());
			}
		}
	}
return null();
