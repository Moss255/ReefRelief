...
bool Closable = __o_Closable.Default(false);
{
	...
	if ((tmp26)){
		...
		HX_STACK_LINE(126)
		::openfl::_legacy::display::Bitmap icon = tmp28;		HX_STACK_VAR(icon,"icon");
		HX_STACK_LINE(127)
		icon->set_x((int)5);
		HX_STACK_LINE(128)
		icon->set_y((int)2);
		HX_STACK_LINE(129)
		icon->set_alpha(((Float)0.8));
		HX_STACK_LINE(130)
		::openfl::_legacy::text::TextField tmp29 = this->_title;		HX_STACK_VAR(tmp29,"tmp29");
		HX_STACK_LINE(130)
		Float tmp30 = icon->get_x();		HX_STACK_VAR(tmp30,"tmp30");
		HX_STACK_LINE(130)
		Float tmp31 = icon->get_width();		HX_STACK_VAR(tmp31,"tmp31");
		HX_STACK_LINE(130)
		...
		tmp29->set_x(tmp33);
		HX_STACK_LINE(131)
		::openfl::_legacy::display::Bitmap tmp34 = icon;		HX_STACK_VAR(tmp34,"tmp34");
		HX_STACK_LINE(131)
		this->addChild(tmp34);
	}
	HX_STACK_LINE(134)
	...
	if ((tmp28)){
		HX_STACK_LINE(142)
		::flixel::_system::debug::GraphicCloseButton tmp29 = ::flixel::_system::debug::GraphicCloseButton_obj::__new((int)0,(int)0,null(),null());		HX_STACK_VAR(tmp29,"tmp29");
		HX_STACK_LINE(142)
...
Void Window_obj::setVisible( bool Value){
{
		...
		HX_STACK_LINE(256)
		bool tmp1 = this->_closable;		HX_STACK_VAR(tmp1,"tmp1");
		HX_STACK_LINE(256)
		...
		if ((tmp2)){
			...
			HX_STACK_LINE(258)
			int tmp4 = this->_id;		HX_STACK_VAR(tmp4,"tmp4");
			HX_STACK_LINE(258)
			bool tmp5 = this->get_visible();		HX_STACK_VAR(tmp5,"tmp5");
			HX_STACK_LINE(258)
			hx::IndexRef((tmp3->data->__Field(HX_HCSTRING("windowSettings","\xf3","\x3c","\x19","\x85"), hx::paccDynamic )).mPtr,tmp4) = tmp5;
			HX_STACK_LINE(259)
			::flixel::util::FlxSave tmp6 = ::flixel::FlxG_obj::save;		HX_STACK_VAR(tmp6,"tmp6");
			HX_STACK_LINE(259)
			tmp6->flush(null(),null());
		}
		HX_STACK_LINE(262)
		::flixel::_system::ui::FlxSystemButton tmp3 = this->toggleButton;		HX_STACK_VAR(tmp3,"tmp3");
		HX_STACK_LINE(262)
		...
		if ((tmp4)){
			...
			HX_STACK_LINE(263)
			bool tmp6 = this->get_visible();		HX_STACK_VAR(tmp6,"tmp6");
			HX_STACK_LINE(263)
			bool tmp7 = !(tmp6);		HX_STACK_VAR(tmp7,"tmp7");
			HX_STACK_LINE(263)
			tmp5->__Field(HX_HCSTRING("set_toggled","\x73","\x49","\x6b","\x5c"), hx::paccDynamic )(tmp7);
		}
		HX_STACK_LINE(265)
		bool tmp5 = this->get_visible();		HX_STACK_VAR(tmp5,"tmp5");
		HX_STACK_LINE(265)
		if ((tmp5)){
			...
			HX_STACK_LINE(266)
			tmp6->addChild(hx::ObjectPtr<OBJ_>(this));
		}
	}
return null();
}
...
{
		HX_STACK_FRAME("flixel.system.debug.Window","toggleVisible",0x493d16e8,"flixel.system.debug.Window.toggleVisible","flixel/system/debug/Window.hx",270,0xb8dfd4e5)
		HX_STACK_THIS(this)
		HX_STACK_LINE(271)
...
{
		HX_STACK_FRAME("flixel.system.debug.Window","putOnTop",0xbb5abdfd,"flixel.system.debug.Window.putOnTop","flixel/system/debug/Window.hx",275,0xb8dfd4e5)
		HX_STACK_THIS(this)
		HX_STACK_LINE(276)
...
{
		HX_STACK_FRAME("flixel.system.debug.Window","loadSaveData",0x8d0923e3,"flixel.system.debug.Window.loadSaveData","flixel/system/debug/Window.hx",280,0xb8dfd4e5)
		HX_STACK_THIS(this)
		HX_STACK_LINE(281)
...
{
		HX_STACK_FRAME("flixel.system.debug.Window","onMouseDown",0xd777d132,"flixel.system.debug.Window.onMouseDown","flixel/system/debug/Window.hx",372,0xb8dfd4e5)
		HX_STACK_THIS(this)
		HX_STACK_ARG(E,"E")
		HX_STACK_LINE(373)
...
{
		HX_STACK_FRAME("flixel.system.debug.Window","bound",0xf2ff51e8,"flixel.system.debug.Window.bound","flixel/system/debug/Window.hx",404,0xb8dfd4e5)
		HX_STACK_THIS(this)
		HX_STACK_LINE(405)
		::openfl::_legacy::geom::Rectangle tmp = this->_bounds;		HX_STACK_VAR(tmp,"tmp");
		HX_STACK_LINE(405)
...
Dynamic Window_obj::__Field(const ::String &inName,hx::PropertyAccess inCallProp)
{
	...
	case 9:
		...
		if (HX_FIELD_EQ(inName,"_closable") ) { return _closable; }
