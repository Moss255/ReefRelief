...
Void BitmapLog_obj::resizeTexts( ){
{
		...
		HX_STACK_LINE(204)
		::flixel::_system::ui::FlxSystemButton tmp29 = this->_buttonText;		HX_STACK_VAR(tmp29,"tmp29");
		HX_STACK_LINE(204)
		::openfl::_legacy::text::TextField tmp30 = this->_counterText;		HX_STACK_VAR(tmp30,"tmp30");
		HX_STACK_LINE(204)
		Float tmp31 = tmp30->get_textWidth();		HX_STACK_VAR(tmp31,"tmp31");
		HX_STACK_LINE(204)
		Float tmp32 = (Float(tmp31) / Float((int)2));		HX_STACK_VAR(tmp32,"tmp32");
		HX_STACK_LINE(204)
		Float tmp33 = ((int)33 - tmp32);		HX_STACK_VAR(tmp33,"tmp33");
		HX_STACK_LINE(204)
		tmp29->__Field(HX_HCSTRING("set_x","\x5b","\x9b","\x2f","\x7a"), hx::paccDynamic )(tmp33);
	}
return null();
}
	...
	HX_STACK_ARG(name,"name")
{
		...
		struct _Function_1_1{
			inline static Dynamic Block( ::String &tmp2,::openfl::_legacy::display::BitmapData &tmp1){
				HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","flixel/system/debug/log/BitmapLog.hx",241,0x69d60e7d)
				{
