...
{
HX_STACK_FRAME("flixel.system.debug.watch.Tracker","new",0xf6eed663,"flixel.system.debug.watch.Tracker.new","flixel/system/debug/watch/Tracker.hx",147,0x14368dcf)
HX_STACK_THIS(this)
...
HX_STACK_ARG(WindowTitle,"WindowTitle")
{
	...
	if ((tmp3)){
		...
		HX_STACK_LINE(156)
		tmp4 = ::flixel::util::FlxStringUtil_obj::getClassName(tmp5,true);
	}
	else{
		HX_STACK_LINE(156)
		tmp4 = WindowTitle;
	...
	HX_STACK_LINE(159)
	Float tmp7 = (tmp6 + (int)30);		HX_STACK_VAR(tmp7,"tmp7");
	HX_STACK_LINE(159)
...
{
		HX_STACK_FRAME("flixel.system.debug.watch.Tracker","destroy",0x264ff07d,"flixel.system.debug.watch.Tracker.destroy","flixel/system/debug/watch/Tracker.hx",170,0x14368dcf)
		HX_STACK_THIS(this)
		HX_STACK_LINE(171)
		{
			HX_STACK_LINE(171)
...
::flixel::_system::debug::watch::TrackerProfile Tracker_obj::findProfileByClass( ::hx::Class ObjectClass){
	HX_STACK_FRAME("flixel.system.debug.watch.Tracker","findProfileByClass",0x1c23782e,"flixel.system.debug.watch.Tracker.findProfileByClass","flixel/system/debug/watch/Tracker.hx",179,0x14368dcf)
	HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("flixel.system.debug.watch.Tracker","initWatchEntries",0xac4e4a0e,"flixel.system.debug.watch.Tracker.initWatchEntries","flixel/system/debug/watch/Tracker.hx",188,0x14368dcf)
		HX_STACK_THIS(this)
		HX_STACK_ARG(Profile,"Profile")
		HX_STACK_LINE(189)
...
{
		HX_STACK_FRAME("flixel.system.debug.watch.Tracker","addExtensions",0x13338d58,"flixel.system.debug.watch.Tracker.addExtensions","flixel/system/debug/watch/Tracker.hx",197,0x14368dcf)
		HX_STACK_THIS(this)
		HX_STACK_ARG(Profile,"Profile")
		HX_STACK_LINE(198)
...
{
		HX_STACK_FRAME("flixel.system.debug.watch.Tracker","addVariables",0x5f6aa5f3,"flixel.system.debug.watch.Tracker.addVariables","flixel/system/debug/watch/Tracker.hx",216,0x14368dcf)
		HX_STACK_THIS(this)
		...
		HX_STACK_LINE(220)
		{
			...
			while((true)){
				...
				++(_g);
				HX_STACK_LINE(221)
				::String tmp4 = variable;		HX_STACK_VAR(tmp4,"tmp4");
				HX_STACK_LINE(221)
				Dynamic tmp5 = this->_object;		HX_STACK_VAR(tmp5,"tmp5");
				HX_STACK_LINE(221)
				::String tmp6 = variable;		HX_STACK_VAR(tmp6,"tmp6");
				HX_STACK_LINE(221)
				::flixel::_system::debug::watch::WatchEntryData tmp7 = ::flixel::_system::debug::watch::WatchEntryData_obj::FIELD(tmp5,tmp6);		HX_STACK_VAR(tmp7,"tmp7");
				HX_STACK_LINE(221)
				this->add(tmp4,tmp7);
			}
		}
...
{
		HX_STACK_FRAME("flixel.system.debug.watch.Tracker","addProfile",0x17dc8565,"flixel.system.debug.watch.Tracker.addProfile","flixel/system/debug/watch/Tracker.hx",55,0x14368dcf)
		HX_STACK_ARG(Profile,"Profile")
		HX_STACK_LINE(56)
		bool tmp = (Profile != null());		HX_STACK_VAR(tmp,"tmp");
		HX_STACK_LINE(56)
...
::flixel::_system::debug::watch::TrackerProfile Tracker_obj::findProfile( Dynamic Object){
	HX_STACK_FRAME("flixel.system.debug.watch.Tracker","findProfile",0x9e194af3,"flixel.system.debug.watch.Tracker.findProfile","flixel/system/debug/watch/Tracker.hx",64,0x14368dcf)
...
{
		HX_STACK_FRAME("flixel.system.debug.watch.Tracker","onStateSwitch",0xc2667bc9,"flixel.system.debug.watch.Tracker.onStateSwitch","flixel/system/debug/watch/Tracker.hx",77,0x14368dcf)
		HX_STACK_LINE(77)
...
{
		HX_STACK_FRAME("flixel.system.debug.watch.Tracker","initProfiles",0x6f40e3f7,"flixel.system.debug.watch.Tracker.initProfiles","flixel/system/debug/watch/Tracker.hx",81,0x14368dcf)
		HX_STACK_LINE(82)
