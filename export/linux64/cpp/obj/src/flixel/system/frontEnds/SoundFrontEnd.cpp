	...
	HX_STACK_ARG(OnComplete,"OnComplete")
{
		...
		if ((tmp1)){
			HX_STACK_LINE(116)
			{
				...
				HX_STACK_LINE(116)
				tmp2->__Field(HX_HCSTRING("advanced","\xa2","\x69","\x7b","\x3b"), hx::paccDynamic )(HX_HCSTRING("FlxG.loadSound() requires either\nan embedded sound or a URL to work.","\x4f","\x8f","\xa4","\xef"),tmp3,true);
			}
			HX_STACK_LINE(117)
			return null();
		}
...
::openfl::_legacy::media::Sound SoundFrontEnd_obj::cache( ::String EmbeddedSound){
	...
	HX_STACK_LINE(155)
	{
		...
		HX_STACK_LINE(155)
		::String tmp6 = (HX_HCSTRING("Could not find a Sound asset with an ID of '","\x6f","\x0e","\x1e","\x66") + EmbeddedSound);		HX_STACK_VAR(tmp6,"tmp6");
		HX_STACK_LINE(155)
		...
		while((true)){
			...
			if ((tmp7)){
				...
				HX_STACK_LINE(168)
				{
					...
					HX_STACK_LINE(168)
					::String tmp9 = (HX_HCSTRING("Could not find a Sound asset with an ID of '","\x6f","\x0e","\x1e","\x66") + id);		HX_STACK_VAR(tmp9,"tmp9");
					HX_STACK_LINE(168)
		...
		if ((tmp1)){
			...
			if ((tmp6)){
				...
				HX_STACK_LINE(187)
				{
					...
					::flixel::_system::frontEnds::LogFrontEnd tmp8 = ::flixel::FlxG_obj::log;		HX_STACK_VAR(tmp8,"tmp8");
					HX_STACK_LINE(187)
					::String tmp9 = (HX_HCSTRING("Could not find a Sound asset with an ID of '","\x6f","\x0e","\x1e","\x66") + EmbeddedSound);		HX_STACK_VAR(tmp9,"tmp9");
					HX_STACK_LINE(187)
					::String tmp10 = (tmp9 + HX_HCSTRING("'.","\x27","\x22","\x00","\x00"));		HX_STACK_VAR(tmp10,"tmp10");
					HX_STACK_LINE(187)
					::flixel::_system::debug::log::LogStyle tmp11 = ::flixel::_system::debug::log::LogStyle_obj::ERROR;		HX_STACK_VAR(tmp11,"tmp11");
