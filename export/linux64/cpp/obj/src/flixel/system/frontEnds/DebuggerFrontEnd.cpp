...
HX_STACK_THIS(this)
{
	...
	HX_STACK_LINE(27)
	this->toggleKeys = Array_obj< int >::__new().Add((int)113).Add((int)192).Add((int)220);
	HX_STACK_LINE(20)
...
{
		HX_STACK_FRAME("flixel.system.frontEnds.DebuggerFrontEnd","setLayout",0x96c2386b,"flixel.system.frontEnds.DebuggerFrontEnd.setLayout","flixel/system/frontEnds/DebuggerFrontEnd.hx",54,0x2ebb4b30)
		HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("flixel.system.frontEnds.DebuggerFrontEnd","resetLayout",0xc33ca418,"flixel.system.frontEnds.DebuggerFrontEnd.resetLayout","flixel/system/frontEnds/DebuggerFrontEnd.hx",62,0x2ebb4b30)
		HX_STACK_THIS(this)
		HX_STACK_LINE(64)
		::flixel::FlxGame tmp = ::flixel::FlxG_obj::game;		HX_STACK_VAR(tmp,"tmp");
		HX_STACK_LINE(64)
...
bool UpdateLayout = __o_UpdateLayout.Default(true);
	HX_STACK_FRAME("flixel.system.frontEnds.DebuggerFrontEnd","addButton",0x7066ab72,"flixel.system.frontEnds.DebuggerFrontEnd.addButton","flixel/system/frontEnds/DebuggerFrontEnd.hx",79,0x2ebb4b30)
	HX_STACK_THIS(this)
...
::flixel::_system::debug::Window DebuggerFrontEnd_obj::track( Dynamic ObjectOrClass,::String WindowTitle){
	HX_STACK_FRAME("flixel.system.frontEnds.DebuggerFrontEnd","track",0x1a1fb78a,"flixel.system.frontEnds.DebuggerFrontEnd.track","flixel/system/frontEnds/DebuggerFrontEnd.hx",95,0x2ebb4b30)
	HX_STACK_THIS(this)
	...
	if ((tmp3)){
		...
		{
			HX_STACK_LINE(104)
			Dynamic tmp4 = ObjectOrClass;		HX_STACK_VAR(tmp4,"tmp4");
			HX_STACK_LINE(104)
			::String tmp5 = ::flixel::util::FlxStringUtil_obj::getClassName(tmp4,true);		HX_STACK_VAR(tmp5,"tmp5");
			HX_STACK_LINE(103)
			::String tmp6 = (HX_HCSTRING("Could not find a tracking profile for object of class '","\x1a","\xec","\x71","\x30") + tmp5);		HX_STACK_VAR(tmp6,"tmp6");
			HX_STACK_LINE(103)
			...
			HX_STACK_LINE(103)
			::flixel::_system::debug::log::LogStyle tmp10 = ::flixel::_system::debug::log::LogStyle_obj::ERROR;		HX_STACK_VAR(tmp10,"tmp10");
			HX_STACK_LINE(103)
...
{
		HX_STACK_FRAME("flixel.system.frontEnds.DebuggerFrontEnd","addTrackerProfile",0xb36941d1,"flixel.system.frontEnds.DebuggerFrontEnd.addTrackerProfile","flixel/system/frontEnds/DebuggerFrontEnd.hx",121,0x2ebb4b30)
		HX_STACK_THIS(this)
...
bool UpdateLayout = __o_UpdateLayout.Default(true);
	HX_STACK_FRAME("flixel.system.frontEnds.DebuggerFrontEnd","removeButton",0xa0228237,"flixel.system.frontEnds.DebuggerFrontEnd.removeButton","flixel/system/frontEnds/DebuggerFrontEnd.hx",132,0x2ebb4b30)
	HX_STACK_THIS(this)
...
bool DebuggerFrontEnd_obj::set_drawDebug( bool Value){
	HX_STACK_FRAME("flixel.system.frontEnds.DebuggerFrontEnd","set_drawDebug",0x8073fd91,"flixel.system.frontEnds.DebuggerFrontEnd.set_drawDebug","flixel/system/frontEnds/DebuggerFrontEnd.hx",142,0x2ebb4b30)
	HX_STACK_THIS(this)
...
bool DebuggerFrontEnd_obj::set_visible( bool Value){
	HX_STACK_FRAME("flixel.system.frontEnds.DebuggerFrontEnd","set_visible",0xfdfb51d4,"flixel.system.frontEnds.DebuggerFrontEnd.set_visible","flixel/system/frontEnds/DebuggerFrontEnd.hx",154,0x2ebb4b30)
	HX_STACK_THIS(this)
	HX_STACK_ARG(Value,"Value")
	HX_STACK_LINE(155)
