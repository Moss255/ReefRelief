...
Void LogFrontEnd_obj::notice( Dynamic Data){
{
		...
		Dynamic tmp = Data;		HX_STACK_VAR(tmp,"tmp");
		HX_STACK_LINE(42)
		::flixel::_system::debug::log::LogStyle tmp1 = ::flixel::_system::debug::log::LogStyle_obj::NOTICE;		HX_STACK_VAR(tmp1,"tmp1");
		HX_STACK_LINE(42)
		this->advanced(tmp,tmp1,null());
	}
return null();
	...
	HX_STACK_ARG(FireOnce,"FireOnce")
{
		...
		if ((tmp3)){
			HX_STACK_LINE(64)
			::flixel::_system::debug::log::LogStyle tmp4 = ::flixel::_system::debug::log::LogStyle_obj::NORMAL;		HX_STACK_VAR(tmp4,"tmp4");
			HX_STACK_LINE(64)
			Style = tmp4;
		}
		HX_STACK_LINE(67)
		...
		HX_STACK_LINE(72)
		::flixel::_system::debug::log::Log tmp8 = tmp7->debugger->__Field(HX_HCSTRING("log","\x84","\x54","\x52","\x00"), hx::paccDynamic );		HX_STACK_VAR(tmp8,"tmp8");
		HX_STACK_LINE(72)
		Dynamic tmp9 = Data;		HX_STACK_VAR(tmp9,"tmp9");
		HX_STACK_LINE(72)
		::flixel::_system::debug::log::LogStyle tmp10 = Style;		HX_STACK_VAR(tmp10,"tmp10");
		HX_STACK_LINE(72)
		...
		if ((tmp12)){
			...
			if ((tmp13)){
				HX_STACK_LINE(77)
				::openfl::_legacy::media::Sound tmp14;		HX_STACK_VAR(tmp14,"tmp14");
				HX_STACK_LINE(77)
				{
					HX_STACK_LINE(77)
					...
					HX_STACK_LINE(77)
					::String tmp15 = (Style->__Field(HX_HCSTRING("errorSound","\xe7","\x7b","\xd0","\xf5"), hx::paccDynamic ) + extension);		HX_STACK_VAR(tmp15,"tmp15");
					HX_STACK_LINE(77)
					tmp14 = ::openfl::_legacy::Assets_obj::getSound(tmp15,null());
				}
				HX_STACK_LINE(77)
				::openfl::_legacy::media::Sound sound = tmp14;		HX_STACK_VAR(sound,"sound");
				HX_STACK_LINE(78)
				bool tmp15 = (sound != null());		HX_STACK_VAR(tmp15,"tmp15");
				HX_STACK_LINE(78)
				if ((tmp15)){
					HX_STACK_LINE(80)
					::flixel::_system::frontEnds::SoundFrontEnd tmp16 = ::flixel::FlxG_obj::sound;		HX_STACK_VAR(tmp16,"tmp16");
					HX_STACK_LINE(80)
					::openfl::_legacy::media::Sound tmp17 = sound;		HX_STACK_VAR(tmp17,"tmp17");
					HX_STACK_LINE(80)
					::flixel::_system::FlxSound tmp18 = tmp16->__Field(HX_HCSTRING("load","\x26","\x9a","\xb7","\x47"), hx::paccDynamic )(tmp17,null(),null(),null(),null(),null(),null(),null());		HX_STACK_VAR(tmp18,"tmp18");
					HX_STACK_LINE(80)
					tmp18->__Field(HX_HCSTRING("play","\xf4","\x2d","\x5a","\x4a"), hx::paccDynamic )(null(),null(),null());
				}
			}
			HX_STACK_LINE(85)
			...
			if ((tmp14)){
				HX_STACK_LINE(87)
				::flixel::_system::frontEnds::DebuggerFrontEnd tmp15 = ::flixel::FlxG_obj::debugger;		HX_STACK_VAR(tmp15,"tmp15");
				HX_STACK_LINE(87)
				tmp15->__Field(HX_HCSTRING("set_visible","\x95","\xdf","\x8b","\x33"), hx::paccDynamic )(true);
			}
			HX_STACK_LINE(90)
			bool tmp15 = (Style->__Field(HX_HCSTRING("callbackFunction","\xfd","\xcd","\x91","\x7e"), hx::paccDynamic ) != null());		HX_STACK_VAR(tmp15,"tmp15");
			HX_STACK_LINE(90)
			if ((tmp15)){
				HX_STACK_LINE(92)
...
Void LogFrontEnd_obj::clear( ){
{
		...
		::flixel::FlxGame tmp = ::flixel::FlxG_obj::game;		HX_STACK_VAR(tmp,"tmp");
		HX_STACK_LINE(104)
		::flixel::_system::debug::log::Log tmp1 = tmp->debugger->__Field(HX_HCSTRING("log","\x84","\x54","\x52","\x00"), hx::paccDynamic );		HX_STACK_VAR(tmp1,"tmp1");
		HX_STACK_LINE(104)
