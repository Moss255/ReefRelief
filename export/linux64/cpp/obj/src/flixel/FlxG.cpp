...
int FlxG_obj::set_updateFramerate( int Framerate){
	...
	if ((tmp2)){
		...
		HX_STACK_LINE(659)
		::flixel::_system::debug::log::LogStyle tmp4 = ::flixel::_system::debug::log::LogStyle_obj::WARNING;		HX_STACK_VAR(tmp4,"tmp4");
		HX_STACK_LINE(659)
...
int FlxG_obj::set_drawFramerate( int Framerate){
	...
	if ((tmp2)){
		...
		::flixel::_system::debug::log::LogStyle tmp4 = ::flixel::_system::debug::log::LogStyle_obj::WARNING;		HX_STACK_VAR(tmp4,"tmp4");
		HX_STACK_LINE(679)
		tmp3->__Field(HX_HCSTRING("advanced","\xa2","\x69","\x7b","\x3b"), hx::paccDynamic )(HX_HCSTRING("FlxG.drawFramerate: The update framerate shouldn't be smaller than the draw framerate, since it can stop your game from updating.","\x99","\x27","\x6a","\xbf"),tmp4,true);
	}
	HX_STACK_LINE(682)
