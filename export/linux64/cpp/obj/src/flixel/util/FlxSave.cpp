...
{
HX_STACK_FRAME("flixel.util.FlxSave","new",0x2c4b0107,"flixel.util.FlxSave.new","flixel/util/FlxSave.hx",13,0xc43cd0a9)
HX_STACK_THIS(this)
{
	HX_STACK_LINE(35)
...
{
		HX_STACK_FRAME("flixel.util.FlxSave","destroy",0x7bc03d21,"flixel.util.FlxSave.destroy","flixel/util/FlxSave.hx",43,0xc43cd0a9)
		HX_STACK_THIS(this)
		HX_STACK_LINE(44)
...
bool FlxSave_obj::bind( ::String Name){
	HX_STACK_FRAME("flixel.util.FlxSave","bind",0x8d6a5736,"flixel.util.FlxSave.bind","flixel/util/FlxSave.hx",59,0xc43cd0a9)
	HX_STACK_THIS(this)
		...
		if (__e.IsClass< ::openfl::errors::Error >() ){
			...
			::openfl::errors::Error e = __e;{
				HX_STACK_LINE(68)
				{
					...
					HX_STACK_LINE(68)
					::flixel::_system::debug::log::LogStyle tmp1 = ::flixel::_system::debug::log::LogStyle_obj::ERROR;		HX_STACK_VAR(tmp1,"tmp1");
					HX_STACK_LINE(68)
...
int MinFileSize = __o_MinFileSize.Default(0);
	HX_STACK_FRAME("flixel.util.FlxSave","close",0xc505001f,"flixel.util.FlxSave.close","flixel/util/FlxSave.hx",86,0xc43cd0a9)
	HX_STACK_THIS(this)
...
int MinFileSize = __o_MinFileSize.Default(0);
	HX_STACK_FRAME("flixel.util.FlxSave","flush",0x7f3d4b2b,"flixel.util.FlxSave.flush","flixel/util/FlxSave.hx",99,0xc43cd0a9)
	HX_STACK_THIS(this)
	HX_STACK_ARG(MinFileSize,"MinFileSize")
	HX_STACK_ARG(OnComplete,"OnComplete")
{
		...
		HX_STACK_LINE(115)
		bool tmp2 = (result == ((Dynamic)((int)0)));		HX_STACK_VAR(tmp2,"tmp2");
		HX_STACK_LINE(115)
		::flixel::util::FlxSaveStatus tmp3;		HX_STACK_VAR(tmp3,"tmp3");
		HX_STACK_LINE(115)
		if ((tmp2)){
			HX_STACK_LINE(115)
			tmp3 = ::flixel::util::FlxSaveStatus_obj::SUCCESS;
		}
		else{
			HX_STACK_LINE(115)
			tmp3 = ::flixel::util::FlxSaveStatus_obj::PENDING;
		}
		HX_STACK_LINE(115)
		bool tmp4 = this->onDone(tmp3);		HX_STACK_VAR(tmp4,"tmp4");
		HX_STACK_LINE(115)
		return tmp4;
	}
}
...
bool FlxSave_obj::erase( ){
	HX_STACK_FRAME("flixel.util.FlxSave","erase",0xefbed14d,"flixel.util.FlxSave.erase","flixel/util/FlxSave.hx",126,0xc43cd0a9)
	HX_STACK_THIS(this)
	HX_STACK_LINE(127)
	bool tmp = this->checkBinding();		HX_STACK_VAR(tmp,"tmp");
	HX_STACK_LINE(127)
	...
	struct _Function_1_1{
		inline static Dynamic Block( ){
			HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","flixel/util/FlxSave.hx",132,0xc43cd0a9)
			{
...
bool FlxSave_obj::onDone( ::flixel::util::FlxSaveStatus Result){
	HX_STACK_FRAME("flixel.util.FlxSave","onDone",0x76016afa,"flixel.util.FlxSave.onDone","flixel/util/FlxSave.hx",144,0xc43cd0a9)
	HX_STACK_THIS(this)
	...
	switch( (int)(Result->__Index())){
		case (int)1: {
			...
			::flixel::_system::frontEnds::LogFrontEnd tmp = ::flixel::FlxG_obj::log;		HX_STACK_VAR(tmp,"tmp");
			HX_STACK_LINE(148)
			::flixel::_system::debug::log::LogStyle tmp1 = ::flixel::_system::debug::log::LogStyle_obj::WARNING;		HX_STACK_VAR(tmp1,"tmp1");
			HX_STACK_LINE(148)
			tmp->__Field(HX_HCSTRING("advanced","\xa2","\x69","\x7b","\x3b"), hx::paccDynamic )(HX_HCSTRING("FlxSave is requesting extra storage space.","\x65","\xed","\x43","\x59"),tmp1,true);
		}
		;break;
		case (int)2: {
			HX_STACK_LINE(150)
			...
			::flixel::_system::debug::log::LogStyle tmp1 = ::flixel::_system::debug::log::LogStyle_obj::ERROR;		HX_STACK_VAR(tmp1,"tmp1");
			HX_STACK_LINE(150)
			tmp->__Field(HX_HCSTRING("advanced","\xa2","\x69","\x7b","\x3b"), hx::paccDynamic )(HX_HCSTRING("There was a problem flushing\nthe shared object data from FlxSave.","\x0d","\x4e","\xe5","\xad"),tmp1,true);
		}
		;break;
		default: {
		}
...
bool FlxSave_obj::checkBinding( ){
	HX_STACK_FRAME("flixel.util.FlxSave","checkBinding",0xf0eb45d6,"flixel.util.FlxSave.checkBinding","flixel/util/FlxSave.hx",169,0xc43cd0a9)
	HX_STACK_THIS(this)
	HX_STACK_LINE(170)
	::openfl::_legacy::net::SharedObject tmp = this->_sharedObject;		HX_STACK_VAR(tmp,"tmp");
	HX_STACK_LINE(170)
	...
	if ((tmp1)){
		HX_STACK_LINE(172)
		{
			...
			HX_STACK_LINE(172)
			::flixel::_system::debug::log::LogStyle tmp3 = ::flixel::_system::debug::log::LogStyle_obj::WARNING;		HX_STACK_VAR(tmp3,"tmp3");
			HX_STACK_LINE(172)
