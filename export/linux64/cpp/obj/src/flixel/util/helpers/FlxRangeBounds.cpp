...
bool FlxRangeBounds_obj::equals( ::flixel::util::helpers::FlxRangeBounds OtherRangeBounds){
	...
	HX_STACK_LINE(66)
	{
		...
		HX_STACK_LINE(66)
		::flixel::util::helpers::FlxBounds otherBounds = OtherRangeBounds->start;		HX_STACK_VAR(otherBounds,"otherBounds");
		HX_STACK_LINE(66)
		bool tmp3 = (_this->min == otherBounds->min);		HX_STACK_VAR(tmp3,"tmp3");
		HX_STACK_LINE(66)
	...
	if ((tmp)){
		...
		HX_STACK_LINE(66)
		::flixel::util::helpers::FlxBounds otherBounds = OtherRangeBounds->end;		HX_STACK_VAR(otherBounds,"otherBounds");
		HX_STACK_LINE(66)
		bool tmp4 = (_this->min == otherBounds->min);		HX_STACK_VAR(tmp4,"tmp4");
		HX_STACK_LINE(66)
		bool tmp5 = tmp4;		HX_STACK_VAR(tmp5,"tmp5");
		HX_STACK_LINE(66)
		...
		if ((tmp6)){
			HX_STACK_LINE(66)
			tmp1 = (_this->max == otherBounds->max);
		}
		else{
			HX_STACK_LINE(66)
			tmp1 = false;
