...
class HXCPP_CLASS_ATTRIBUTES  FlxPath_obj : public hx::Object{
	...
	public:
		...
		virtual ::flixel::util::FlxPath setProperties( hx::Null< Float >  Speed,hx::Null< int >  Mode,hx::Null< bool >  AutoRotate);
		Dynamic setProperties_dyn();

		virtual ::flixel::util::FlxPath start( Array< ::Dynamic > Nodes,hx::Null< Float >  Speed,hx::Null< int >  Mode,hx::Null< bool >  AutoRotate,hx::Null< bool >  NodesAsReference);
		Dynamic start_dyn();

		virtual ::flixel::util::FlxPath restart( );
		Dynamic restart_dyn();

		virtual ::flixel::util::FlxPath setNode( int NodeIndex);
		Dynamic setNode_dyn();
		...
		virtual ::flixel::util::FlxPath cancel( );
		Dynamic cancel_dyn();
		...
		virtual Array< ::Dynamic > get_nodes( );
		Dynamic get_nodes_dyn();

		virtual Array< ::Dynamic > set_nodes( Array< ::Dynamic > Nodes);
