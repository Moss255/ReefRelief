...
class HXCPP_CLASS_ATTRIBUTES  FlxArrayUtil_obj : public hx::Object{
	...
	public:
		...
		static cpp::ArrayBase setLength_flixel_group_FlxTypedGroup_T( cpp::ArrayBase array,int newLength);
		...
		static Array< ::Dynamic > fastSplice_flixel_system_debug_watch_WatchEntry( Array< ::Dynamic > array,::flixel::_system::debug::watch::WatchEntry element);
		...
		static cpp::ArrayBase clearArray( cpp::ArrayBase array,hx::Null< bool >  recursive);
