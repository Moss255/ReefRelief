...
class HXCPP_CLASS_ATTRIBUTES  FlxTilemap_obj : public ::flixel::tile::FlxBaseTilemap_obj{
	...
	public:
		...
		virtual Void updateDebugTileBoundingBoxSolid( );
		Dynamic updateDebugTileBoundingBoxSolid_dyn();

		virtual Void updateDebugTileBoundingBoxNotSolid( );
		Dynamic updateDebugTileBoundingBoxNotSolid_dyn();

		virtual Void updateDebugTileBoundingBoxPartial( );
		Dynamic updateDebugTileBoundingBoxPartial_dyn();

		virtual ::openfl::_legacy::display::BitmapData updateDebugTile( ::openfl::_legacy::display::BitmapData tileBitmap,int color);
		...
		virtual ::openfl::_legacy::display::BitmapData makeDebugTile( int color);
		Dynamic makeDebugTile_dyn();

		virtual Void drawDebugTile( ::openfl::_legacy::display::BitmapData debugTile,int color);
		Dynamic drawDebugTile_dyn();

		virtual Void onDrawDebugChanged( );
