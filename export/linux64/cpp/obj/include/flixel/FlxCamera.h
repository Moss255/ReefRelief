...
class HXCPP_CLASS_ATTRIBUTES  FlxCamera_obj : public ::flixel::FlxBasic_obj{
	...
	public:
		...
		virtual ::flixel::graphics::tile::FlxDrawTilesItem startQuadBatch( ::flixel::graphics::FlxGraphic graphic,bool colored,hx::Null< bool >  hasColorOffsets,::openfl::_legacy::display::BlendMode blend,hx::Null< bool >  smooth,Dynamic shader);
		...
		virtual Void drawPixels( ::flixel::graphics::frames::FlxFrame frame,::openfl::_legacy::display::BitmapData pixels,::flixel::math::FlxMatrix matrix,::openfl::_legacy::geom::ColorTransform transform,::openfl::_legacy::display::BlendMode blend,Dynamic smoothing,Dynamic shader);
		Dynamic drawPixels_dyn();

		virtual Void copyPixels( ::flixel::graphics::frames::FlxFrame frame,::openfl::_legacy::display::BitmapData pixels,::openfl::_legacy::geom::Rectangle sourceRect,::openfl::_legacy::geom::Point destPoint,::openfl::_legacy::geom::ColorTransform transform,::openfl::_legacy::display::BlendMode blend,Dynamic smoothing,Dynamic shader);
