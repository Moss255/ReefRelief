...
class ApplicationMain {
	...
	public static function main () {
		...
		flash.Lib.setPackage ("MossGames", "ReefRelief", "com.example.myapp", "0.0.1");
		...
		telemetryConfig.app_name = "ReefRelief";
		#end
...
class ApplicationMain {
	...
	public static function main () {
		...
		wx.App.boot (function () {
			...
			frame = wx.Frame.create (null, null, "ReefRelief", null, { width: 640, height: 480 });
