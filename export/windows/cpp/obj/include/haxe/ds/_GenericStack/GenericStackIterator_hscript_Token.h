...
class HXCPP_CLASS_ATTRIBUTES GenericStackIterator_hscript_Token_obj : public ::cpp::FastIterator_obj< ::hx::EnumBase >
{
	public:
		typedef ::cpp::FastIterator_obj< ::hx::EnumBase > super;
