...
class HXCPP_CLASS_ATTRIBUTES GenericCell_hscript_Token_obj : public hx::Object
{
	...
	public:
		void __construct(::hx::EnumBase elt, ::haxe::ds::GenericCell_hscript_Token next);
		...
		static hx::ObjectPtr< GenericCell_hscript_Token_obj > __new(::hx::EnumBase elt, ::haxe::ds::GenericCell_hscript_Token next);
