...
class HXCPP_CLASS_ATTRIBUTES WatchEntry_obj : public  ::openfl::_legacy::display::Sprite_obj
{
	...
	public:
		void __construct(::String displayName,::hx::EnumBase data, ::Dynamic removeEntry);
		...
		static hx::ObjectPtr< WatchEntry_obj > __new(::String displayName,::hx::EnumBase data, ::Dynamic removeEntry);
