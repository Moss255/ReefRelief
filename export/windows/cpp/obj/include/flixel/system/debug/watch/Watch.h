...
class HXCPP_CLASS_ATTRIBUTES Watch_obj : public  ::flixel::_hx_system::debug::Window_obj
{
	...
	public:
		...
		void add(::String displayName,::hx::EnumBase data);
		::Dynamic add_dyn();

		Bool isInvalid(::String displayName,::hx::EnumBase data);
		::Dynamic isInvalid_dyn();

		 ::flixel::_hx_system::debug::watch::WatchEntry getExistingEntry(::String displayName,::hx::EnumBase data);
		::Dynamic getExistingEntry_dyn();

		void addEntry(::String displayName,::hx::EnumBase data);
		::Dynamic addEntry_dyn();

		void remove(::String displayName,::hx::EnumBase data);
		::Dynamic remove_dyn();
