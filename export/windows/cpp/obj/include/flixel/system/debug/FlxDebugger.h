...
class HXCPP_CLASS_ATTRIBUTES FlxDebugger_obj : public  ::openfl::_legacy::display::Sprite_obj
{
	...
	public:
		...
		::Dynamic resetButtonLayout_dyn();
		 ...
		 ::flixel::_hx_system::ui::FlxSystemButton addButton(::hx::EnumBase Position, ::openfl::_legacy::display::BitmapData Icon, ::Dynamic UpHandler,hx::Null< Bool >  ToggleMode,hx::Null< Bool >  UpdateLayout);
