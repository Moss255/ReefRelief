...
void Compress_obj::__construct(Int level){
            	HX_STACK_FRAME("haxe.zip.Compress","new",0x4ddc50a9,"haxe.zip.Compress.new","C:\\HaxeToolkit\\haxe\\std/cpp/_std/haxe/zip/Compress.hx",30,0xd451ba8b)
            	HX_STACK_THIS(this)
...
void Compress_obj::setFlushMode(::hx::EnumBase f){
            	HX_STACK_FRAME("haxe.zip.Compress","setFlushMode",0x35ab82dc,"haxe.zip.Compress.setFlushMode","C:\\HaxeToolkit\\haxe\\std/cpp/_std/haxe/zip/Compress.hx",38,0xd451ba8b)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(f,"f")
