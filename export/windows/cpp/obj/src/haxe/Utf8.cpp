...
Int Utf8_obj::compare(::String a,::String b){
            	HX_STACK_FRAME("haxe.Utf8","compare",0x9f848dd0,"haxe.Utf8.compare","C:\\HaxeToolkit\\haxe\\std/cpp/_std/haxe/Utf8.hx",78,0xf320feca)
            	HX_STACK_ARG(a,"a")
            	HX_STACK_ARG(b,"b")
HXLINE(  78)		return _hx_string_compare(a,b);
            	}
...
::String Utf8_obj::sub(::String s,Int pos,Int len){
            	HX_STACK_FRAME("haxe.Utf8","sub",0x67d06d2b,"haxe.Utf8.sub","C:\\HaxeToolkit\\haxe\\std/cpp/_std/haxe/Utf8.hx",82,0xf320feca)
            	HX_STACK_ARG(s,"s")
