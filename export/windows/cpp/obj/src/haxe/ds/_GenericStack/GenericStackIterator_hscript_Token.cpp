...
void GenericStackIterator_hscript_Token_obj::__construct( ::haxe::ds::GenericCell_hscript_Token head){
            	HX_STACK_FRAME("haxe.ds._GenericStack.GenericStackIterator_hscript_Token","new",0xbf5d5a94,"haxe.ds._GenericStack.GenericStackIterator_hscript_Token.new","C:\\HaxeToolkit\\haxe\\std/haxe/ds/GenericStack.hx",45,0x6d04e29d)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(head,"head")
HXLINE(  45)		this->current = head;
            	}
...
Bool GenericStackIterator_hscript_Token_obj::hasNext(){
            	HX_STACK_FRAME("haxe.ds._GenericStack.GenericStackIterator_hscript_Token","hasNext",0xccb359a1,"haxe.ds._GenericStack.GenericStackIterator_hscript_Token.hasNext","C:\\HaxeToolkit\\haxe\\std/haxe/ds/GenericStack.hx",42,0x6d04e29d)
            	HX_STACK_THIS(this)
HXLINE(  42)		return hx::IsNotNull( this->current );
            	}


::hx::EnumBase GenericStackIterator_hscript_Token_obj::next(){
            	HX_STACK_FRAME("haxe.ds._GenericStack.GenericStackIterator_hscript_Token","next",0xb251e83f,"haxe.ds._GenericStack.GenericStackIterator_hscript_Token.next","C:\\HaxeToolkit\\haxe\\std/haxe/ds/GenericStack.hx",43,0x6d04e29d)
            	HX_STACK_THIS(this)
HXLINE(  43)		HX_VARI( ::hx::EnumBase,result) = this->current->elt;
...
void GenericStackIterator_hscript_Token_obj::__Mark(HX_MARK_PARAMS)
{
	...
	::cpp::FastIterator_obj< ::hx::EnumBase >::__Mark(HX_MARK_ARG);
	HX_MARK_END_CLASS();
}
...
void GenericStackIterator_hscript_Token_obj::__Visit(HX_VISIT_PARAMS)
{
	...
	::cpp::FastIterator_obj< ::hx::EnumBase >::__Visit(HX_VISIT_ARG);
}
