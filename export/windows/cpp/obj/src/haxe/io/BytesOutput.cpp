...
void BytesOutput_obj::__construct(){
            	HX_STACK_FRAME("haxe.io.BytesOutput","new",0x130b775e,"haxe.io.BytesOutput.new","C:\\HaxeToolkit\\haxe\\std/haxe/io/BytesOutput.hx",40,0xe8d8730b)
            	HX_STACK_THIS(this)
...
void BytesOutput_obj::writeByte(Int c){
            	HX_STACK_FRAME("haxe.io.BytesOutput","writeByte",0xed1b0d05,"haxe.io.BytesOutput.writeByte","C:\\HaxeToolkit\\haxe\\std/haxe/io/BytesOutput.hx",55,0xe8d8730b)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(c,"c")
...
Int BytesOutput_obj::writeBytes( ::haxe::io::Bytes buf,Int pos,Int len){
            	HX_STACK_FRAME("haxe.io.BytesOutput","writeBytes",0x8a9057ce,"haxe.io.BytesOutput.writeBytes","C:\\HaxeToolkit\\haxe\\std/haxe/io/BytesOutput.hx",59,0xe8d8730b)
            	HX_STACK_THIS(this)
...
HXLINE(  66)		return len;
 ...
 ::haxe::io::Bytes BytesOutput_obj::getBytes(){
            	HX_STACK_FRAME("haxe.io.BytesOutput","getBytes",0x9fe35837,"haxe.io.BytesOutput.getBytes","C:\\HaxeToolkit\\haxe\\std/haxe/io/BytesOutput.hx",137,0xe8d8730b)
            	HX_STACK_THIS(this)
