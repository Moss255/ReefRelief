...
Int Thread_obj::__compare( ::Dynamic t){
            	HX_STACK_FRAME("cpp.vm.Thread","__compare",0x3204cb4d,"cpp.vm.Thread.__compare","C:\\HaxeToolkit\\haxe\\std/cpp/vm/Thread.hx",66,0xd8d7e381)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(t,"t")
...
STATIC_HX_DEFINE_DYNAMIC_FUNC0(Thread_obj,current,return )
 ...
 ::cpp::vm::Thread Thread_obj::create( ::Dynamic callb){
            	HX_STACK_FRAME("cpp.vm.Thread","create",0xb01a9834,"cpp.vm.Thread.create","C:\\HaxeToolkit\\haxe\\std/cpp/vm/Thread.hx",53,0xd8d7e381)
