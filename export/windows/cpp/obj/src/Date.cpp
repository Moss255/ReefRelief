...
void Date_obj::__construct(Int year,Int month,Int day,Int hour,Int min,Int sec){
            	HX_STACK_FRAME("Date","new",0x9aa26240,"Date.new","C:\\HaxeToolkit\\haxe\\std/cpp/_std/Date.hx",27,0x1bc6780a)
            	HX_STACK_THIS(this)
...
HX_DEFINE_DYNAMIC_FUNC0(Date_obj,getTime,return )
 ...
 ::Date Date_obj::now(){
            	HX_STACK_FRAME("Date","now",0x9aa26af6,"Date.now","C:\\HaxeToolkit\\haxe\\std/cpp/_std/Date.hx",51,0x1bc6780a)
...
STATIC_HX_DEFINE_DYNAMIC_FUNC0(Date_obj,now,return )
 ...
 ::Date Date_obj::new1( ::Dynamic t){
            	HX_STACK_FRAME("Date","new1",0xb37395f1,"Date.new1","C:\\HaxeToolkit\\haxe\\std/cpp/_std/Date.hx",54,0x1bc6780a)
            	HX_STACK_ARG(t,"t")
