...
void Stage_obj::__construct( ::Dynamic handle,Int width,Int height){
            		...
            		void _hx_run(::String message){
            			HX_STACK_FRAME("openfl._legacy.display.Stage","new",0x8f657500,"openfl._legacy.display.Stage.new","openfl/_legacy/display/Stage.hx",158,0x8b30a073)
...
HXLINE( 854)				Bool _hx_tmp10;
HXDLIN( 854)				Bool _hx_tmp11;
HXDLIN( 854)				if ((((int)flags & (int)::openfl::_legacy::display::Stage_obj::efAltDown) > (int)0)) {
HXLINE( 854)					_hx_tmp11 = (type == ::openfl::_legacy::events::KeyboardEvent_obj::KEY_DOWN);
            				}
            				else {
HXLINE( 854)					_hx_tmp11 = false;
            				}
HXDLIN( 854)				if (_hx_tmp11) {
HXLINE( 854)					_hx_tmp10 = hx::IsEq(  ::Dynamic(event->__Field(HX_("code",2d,b1,c4,41),hx::paccDynamic)),(int)13 );
            				}
            				else {
HXLINE( 854)					_hx_tmp10 = false;
            				}
HXDLIN( 854)				if (_hx_tmp10) {
HXLINE( 859)					::hx::EnumBase _hx_tmp12 = this->get_displayState();
HXDLIN( 859)					if (hx::IsEq( _hx_tmp12,::openfl::_legacy::display::StageDisplayState_obj::NORMAL_dyn() )) {
