...
Dynamic GridFitType_Impl__obj::__Create(hx::DynamicArray inArgs)
{
 ...
 ::Dynamic GridFitType_Impl__obj::fromString(::String value){
            	HX_STACK_FRAME("openfl.text._GridFitType.GridFitType_Impl_","fromString",0xec7a2309,"openfl.text._GridFitType.GridFitType_Impl_.fromString","openfl/text/GridFitType.hx",12,0x99326c1c)
...
::String GridFitType_Impl__obj::toString(Int value){
            	HX_STACK_FRAME("openfl.text._GridFitType.GridFitType_Impl_","toString",0x85ab7e5a,"openfl.text._GridFitType.GridFitType_Impl_.toString","openfl/text/GridFitType.hx",25,0x99326c1c)
            	HX_STACK_ARG(value,"value")
...
{
{
            	HX_STACK_FRAME("openfl.text._GridFitType.GridFitType_Impl_","boot",0xa66842e0,"openfl.text._GridFitType.GridFitType_Impl_.boot","openfl/text/GridFitType.hx",6,0x99326c1c)
HXLINE(   6)		NONE = (int)0;
            	}
{
            	HX_STACK_FRAME("openfl.text._GridFitType.GridFitType_Impl_","boot",0xa66842e0,"openfl.text._GridFitType.GridFitType_Impl_.boot","openfl/text/GridFitType.hx",7,0x99326c1c)
HXLINE(   7)		PIXEL = (int)1;
            	}
{
            	HX_STACK_FRAME("openfl.text._GridFitType.GridFitType_Impl_","boot",0xa66842e0,"openfl.text._GridFitType.GridFitType_Impl_.boot","openfl/text/GridFitType.hx",8,0x99326c1c)
