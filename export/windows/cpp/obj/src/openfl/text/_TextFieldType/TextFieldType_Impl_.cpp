...
Dynamic TextFieldType_Impl__obj::__Create(hx::DynamicArray inArgs)
{
 ...
 ::Dynamic TextFieldType_Impl__obj::fromString(::String value){
            	HX_STACK_FRAME("openfl.text._TextFieldType.TextFieldType_Impl_","fromString",0x3beed305,"openfl.text._TextFieldType.TextFieldType_Impl_.fromString","openfl/text/TextFieldType.hx",11,0xaebfe8fa)
...
::String TextFieldType_Impl__obj::toString(Int value){
            	HX_STACK_FRAME("openfl.text._TextFieldType.TextFieldType_Impl_","toString",0x7192f756,"openfl.text._TextFieldType.TextFieldType_Impl_.toString","openfl/text/TextFieldType.hx",23,0xaebfe8fa)
            	HX_STACK_ARG(value,"value")
...
{
{
            	HX_STACK_FRAME("openfl.text._TextFieldType.TextFieldType_Impl_","boot",0xd2688ddc,"openfl.text._TextFieldType.TextFieldType_Impl_.boot","openfl/text/TextFieldType.hx",6,0xaebfe8fa)
HXLINE(   6)		DYNAMIC = (int)0;
            	}
{
            	HX_STACK_FRAME("openfl.text._TextFieldType.TextFieldType_Impl_","boot",0xd2688ddc,"openfl.text._TextFieldType.TextFieldType_Impl_.boot","openfl/text/TextFieldType.hx",7,0xaebfe8fa)
