...
Dynamic AntiAliasType_Impl__obj::__Create(hx::DynamicArray inArgs)
{
 ...
 ::Dynamic AntiAliasType_Impl__obj::fromString(::String value){
            	HX_STACK_FRAME("openfl.text._AntiAliasType.AntiAliasType_Impl_","fromString",0x0b2fac83,"openfl.text._AntiAliasType.AntiAliasType_Impl_.fromString","openfl/text/AntiAliasType.hx",11,0x9da7f159)
...
::String AntiAliasType_Impl__obj::toString(Int value){
            	HX_STACK_FRAME("openfl.text._AntiAliasType.AntiAliasType_Impl_","toString",0xa8e1d554,"openfl.text._AntiAliasType.AntiAliasType_Impl_.toString","openfl/text/AntiAliasType.hx",23,0x9da7f159)
            	HX_STACK_ARG(value,"value")
...
{
{
            	HX_STACK_FRAME("openfl.text._AntiAliasType.AntiAliasType_Impl_","boot",0x423514da,"openfl.text._AntiAliasType.AntiAliasType_Impl_.boot","openfl/text/AntiAliasType.hx",6,0x9da7f159)
HXLINE(   6)		ADVANCED = (int)0;
            	}
{
            	HX_STACK_FRAME("openfl.text._AntiAliasType.AntiAliasType_Impl_","boot",0x423514da,"openfl.text._AntiAliasType.AntiAliasType_Impl_.boot","openfl/text/AntiAliasType.hx",7,0x9da7f159)
