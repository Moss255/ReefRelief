...
Dynamic Orientation3D_Impl__obj::__Create(hx::DynamicArray inArgs)
{
 ...
 ::Dynamic Orientation3D_Impl__obj::fromString(::String value){
            	HX_STACK_FRAME("openfl.geom._Orientation3D.Orientation3D_Impl_","fromString",0xa47116a0,"openfl.geom._Orientation3D.Orientation3D_Impl_.fromString","openfl/geom/Orientation3D.hx",12,0xf4ac08f1)
...
::String Orientation3D_Impl__obj::toString(Int value){
            	HX_STACK_FRAME("openfl.geom._Orientation3D.Orientation3D_Impl_","toString",0xf11d8e31,"openfl.geom._Orientation3D.Orientation3D_Impl_.toString","openfl/geom/Orientation3D.hx",25,0xf4ac08f1)
            	HX_STACK_ARG(value,"value")
...
{
{
            	HX_STACK_FRAME("openfl.geom._Orientation3D.Orientation3D_Impl_","boot",0xe951db37,"openfl.geom._Orientation3D.Orientation3D_Impl_.boot","openfl/geom/Orientation3D.hx",6,0xf4ac08f1)
HXLINE(   6)		AXIS_ANGLE = (int)0;
            	}
{
            	HX_STACK_FRAME("openfl.geom._Orientation3D.Orientation3D_Impl_","boot",0xe951db37,"openfl.geom._Orientation3D.Orientation3D_Impl_.boot","openfl/geom/Orientation3D.hx",7,0xf4ac08f1)
HXLINE(   7)		EULER_ANGLES = (int)1;
            	}
{
            	HX_STACK_FRAME("openfl.geom._Orientation3D.Orientation3D_Impl_","boot",0xe951db37,"openfl.geom._Orientation3D.Orientation3D_Impl_.boot","openfl/geom/Orientation3D.hx",8,0xf4ac08f1)
