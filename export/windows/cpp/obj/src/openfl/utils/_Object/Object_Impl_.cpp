...
Dynamic Object_Impl__obj::__Create(hx::DynamicArray inArgs)
{
 ...
 ::Dynamic Object_Impl__obj::_new(){
            	HX_STACK_FRAME("openfl.utils._Object.Object_Impl_","_new",0x3180f425,"openfl.utils._Object.Object_Impl_._new","openfl/utils/Object.hx",7,0xcbd6e8e2)
HXLINE(   7)		HX_VARI_NAME(  ::Dynamic,this1,"this") =  ::Dynamic(hx::Anon_obj::Create(0));
...
Bool Object_Impl__obj::hasOwnProperty( ::Dynamic this1,::String name){
            	HX_STACK_FRAME("openfl.utils._Object.Object_Impl_","hasOwnProperty",0xff2b1b45,"openfl.utils._Object.Object_Impl_.hasOwnProperty","openfl/utils/Object.hx",16,0xcbd6e8e2)
            	HX_STACK_ARG(this1,"this1")
            	HX_STACK_ARG(name,"name")
HXLINE(  16)		Bool _hx_tmp = hx::IsNotNull( this1 );
...
HXLINE(  23)		HX_VARI( hx::Class,c) = ::Type_obj::getClass(this1);
HXLINE(  25)		while(true){
HXLINE(  25)			Bool _hx_tmp = !(hx::IsNotNull( c ));
...
STATIC_HX_DEFINE_DYNAMIC_FUNC2(Object_Impl__obj,isPrototypeOf,return )
 ...
 ::Dynamic Object_Impl__obj::iterator( ::Dynamic this1){
            	...
            	HX_STACK_ARG(this1,"this1")
HXLINE(  39)		HX_VARI( ::Array< ::String >,fields) = ::Reflect_obj::fields(this1);
HXLINE(  40)		Bool _hx_tmp = hx::IsNull( fields );
...
Bool Object_Impl__obj::propertyIsEnumerable( ::Dynamic this1,::String name){
            	HX_STACK_FRAME("openfl.utils._Object.Object_Impl_","propertyIsEnumerable",0xddba318b,"openfl.utils._Object.Object_Impl_.propertyIsEnumerable","openfl/utils/Object.hx",48,0xcbd6e8e2)
            	HX_STACK_ARG(this1,"this1")
            	HX_STACK_ARG(name,"name")
HXLINE(  48)		Bool _hx_tmp;
HXDLIN(  48)		Bool _hx_tmp1 = hx::IsNotNull( this1 );
...
HXLINE(  48)			 ::Dynamic _hx_tmp2 = ::Reflect_obj::field(this1,name);
HXDLIN(  48)			return ::Std_obj::is(_hx_tmp2,hx::ClassOf< ::haxe::lang::Iterable >());
            		}
            		else {
...
::String Object_Impl__obj::toLocaleString( ::Dynamic this1){
            	HX_STACK_FRAME("openfl.utils._Object.Object_Impl_","toLocaleString",0x947c7aea,"openfl.utils._Object.Object_Impl_.toLocaleString","openfl/utils/Object.hx",55,0xcbd6e8e2)
            	HX_STACK_ARG(this1,"this1")
...
::String Object_Impl__obj::toString( ::Dynamic this1){
            	HX_STACK_FRAME("openfl.utils._Object.Object_Impl_","toString",0x3ea16170,"openfl.utils._Object.Object_Impl_.toString","openfl/utils/Object.hx",62,0xcbd6e8e2)
            	HX_STACK_ARG(this1,"this1")
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(Object_Impl__obj,toString,return )
 ...
 ::Dynamic Object_Impl__obj::valueOf( ::Dynamic this1){
            	HX_STACK_FRAME("openfl.utils._Object.Object_Impl_","valueOf",0xaf96f6a4,"openfl.utils._Object.Object_Impl_.valueOf","openfl/utils/Object.hx",69,0xcbd6e8e2)
            	HX_STACK_ARG(this1,"this1")
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(Object_Impl__obj,valueOf,return )
 ...
 ::Dynamic Object_Impl__obj::__get( ::Dynamic this1,::String key){
            	HX_STACK_FRAME("openfl.utils._Object.Object_Impl_","__get",0x156bee32,"openfl.utils._Object.Object_Impl_.__get","openfl/utils/Object.hx",76,0xcbd6e8e2)
            	HX_STACK_ARG(this1,"this1")
