...
Dynamic Endian_Impl__obj::__Create(hx::DynamicArray inArgs)
{
 ...
 ::Dynamic Endian_Impl__obj::fromString(::String value){
            	HX_STACK_FRAME("openfl.utils._Endian.Endian_Impl_","fromString",0x910e541f,"openfl.utils._Endian.Endian_Impl_.fromString","openfl/utils/Endian.hx",11,0xb1ee6086)
...
::String Endian_Impl__obj::toString(Int value){
            	HX_STACK_FRAME("openfl.utils._Endian.Endian_Impl_","toString",0x9a281df0,"openfl.utils._Endian.Endian_Impl_.toString","openfl/utils/Endian.hx",23,0xb1ee6086)
            	HX_STACK_ARG(value,"value")
HXLINE(  23)		switch((int)(value)){
            			case (int)0: {
HXLINE(  23)				return HX_("bigEndian",7b,d5,5a,20);
            			}
            			break;
            			case (int)1: {
HXLINE(  23)				return HX_("littleEndian",31,2e,7b,07);
            			}
            			break;
            			default:{
...
{
{
            	HX_STACK_FRAME("openfl.utils._Endian.Endian_Impl_","boot",0x6ccbdf76,"openfl.utils._Endian.Endian_Impl_.boot","openfl/utils/Endian.hx",6,0xb1ee6086)
HXLINE(   6)		_hx_BIG_ENDIAN = (int)0;
            	}
{
            	HX_STACK_FRAME("openfl.utils._Endian.Endian_Impl_","boot",0x6ccbdf76,"openfl.utils._Endian.Endian_Impl_.boot","openfl/utils/Endian.hx",7,0xb1ee6086)
