...
{
{
            	HX_STACK_FRAME("openfl.system.SecurityDomain","boot",0x2d5abdbb,"openfl.system.SecurityDomain.boot","openfl/system/SecurityDomain.hx",7,0x68641a39)
HXLINE(   7)		currentDomain =  ::openfl::_hx_system::SecurityDomain_obj::__new();
            	}
}
