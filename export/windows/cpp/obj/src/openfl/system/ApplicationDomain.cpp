...
void ApplicationDomain_obj::__construct( ::openfl::_hx_system::ApplicationDomain parentDomain){
            	HX_STACK_FRAME("openfl.system.ApplicationDomain","new",0x87171265,"openfl.system.ApplicationDomain.new","openfl/system/ApplicationDomain.hx",17,0xc87242cb)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(parentDomain,"parentDomain")
HXLINE(  17)		Bool _hx_tmp = hx::IsNotNull( parentDomain );
...
hx::ObjectPtr< ApplicationDomain_obj > ApplicationDomain_obj::__new( ::openfl::_hx_system::ApplicationDomain parentDomain)
{
	...
	_hx_result->__construct(parentDomain);
	return _hx_result;
}
...
hx::Class ApplicationDomain_obj::getDefinition(::String name){
            	HX_STACK_FRAME("openfl.system.ApplicationDomain","getDefinition",0xdd020c0e,"openfl.system.ApplicationDomain.getDefinition","openfl/system/ApplicationDomain.hx",32,0xc87242cb)
            	HX_STACK_THIS(this)
...
Bool ApplicationDomain_obj::hasDefinition(::String name){
            	HX_STACK_FRAME("openfl.system.ApplicationDomain","hasDefinition",0x9ae667d2,"openfl.system.ApplicationDomain.hasDefinition","openfl/system/ApplicationDomain.hx",39,0xc87242cb)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(name,"name")
HXLINE(  39)		hx::Class _hx_tmp = ::Type_obj::resolveClass(name);
HXDLIN(  39)		return hx::IsNotNull( _hx_tmp );
            	}
...
{
{
            	HX_STACK_FRAME("openfl.system.ApplicationDomain","boot",0xa532068d,"openfl.system.ApplicationDomain.boot","openfl/system/ApplicationDomain.hx",10,0xc87242cb)
HXLINE(  10)		currentDomain =  ::openfl::_hx_system::ApplicationDomain_obj::__new(null());
            	}
}
