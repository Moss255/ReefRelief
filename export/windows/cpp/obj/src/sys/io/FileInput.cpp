...
void FileInput_obj::__construct( ::Dynamic f){
            	HX_STACK_FRAME("sys.io.FileInput","new",0x565591b9,"sys.io.FileInput.new","C:\\HaxeToolkit\\haxe\\std/cpp/_std/sys/io/FileInput.hx",32,0x54202051)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(f,"f")
...
Int FileInput_obj::readByte(){
            	HX_STACK_FRAME("sys.io.FileInput","readByte",0x25e0b585,"sys.io.FileInput.readByte","C:\\HaxeToolkit\\haxe\\std/cpp/_std/sys/io/FileInput.hx",36,0x54202051)
            	HX_STACK_THIS(this)
HXLINE(  36)		try {
...
Int FileInput_obj::readBytes( ::haxe::io::Bytes s,Int p,Int l){
            	HX_STACK_FRAME("sys.io.FileInput","readBytes",0xfebe1f4e,"sys.io.FileInput.readBytes","C:\\HaxeToolkit\\haxe\\std/cpp/_std/sys/io/FileInput.hx",47,0x54202051)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(s,"s")
            	HX_STACK_ARG(p,"p")
            	HX_STACK_ARG(l,"l")
...
void FileInput_obj::close(){
            	HX_STACK_FRAME("sys.io.FileInput","close",0x735aa151,"sys.io.FileInput.close","C:\\HaxeToolkit\\haxe\\std/cpp/_std/sys/io/FileInput.hx",57,0x54202051)
            	HX_STACK_THIS(this)
