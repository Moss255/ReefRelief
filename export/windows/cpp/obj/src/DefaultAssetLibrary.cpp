...
HXLINE(  61)		::openfl::_legacy::text::Font_obj::registerFont(hx::ClassOf< ::__ASSET__assets_fonts_oswald_regular_ttf >());
...
HXLINE( 126)			Int _hx_tmp = ::Sys_obj::args()->indexOf(HX_("-livereload",b2,45,9f,14),null());
HXDLIN( 126)			if ((_hx_tmp > (int)-1)) {
            				HX_BEGIN_LOCAL_FUNC_S2(hx::LocalFunc,_hx_Closure_0, ::DefaultAssetLibrary,_gthis,::String,path) HXARGC(0)
            				void _hx_run(){
            					HX_STACK_FRAME("DefaultAssetLibrary","new",0xbc37e41e,"DefaultAssetLibrary.new","DefaultAssetLibrary.hx",132,0x0fc48912)
HXLINE( 134)					HX_VARI( Float,modified) = ( ( ::Date)(::sys::FileSystem_obj::stat(path)->__Field(HX_("mtime",fa,06,aa,0f),hx::paccDynamic)) )->getTime();
HXLINE( 136)					Bool _hx_tmp1 = (modified > _gthis->lastModified);
HXDLIN( 136)					if (_hx_tmp1) {
HXLINE( 138)						_gthis->lastModified = modified;
HXLINE( 139)						_gthis->loadManifest();
HXLINE( 141)						Bool _hx_tmp2 = hx::IsNotNull( _gthis->eventCallback );
...
HXLINE( 128)				HX_VARI( ::String,path) = ::sys::FileSystem_obj::fullPath(HX_("manifest",af,fb,29,d0));
HXLINE( 129)				this->lastModified = ( ( ::Date)(::sys::FileSystem_obj::stat(path)->__Field(HX_("mtime",fa,06,aa,0f),hx::paccDynamic)) )->getTime();
HXLINE( 131)				this->timer =  ::haxe::Timer_obj::__new((int)2000);
...
HXLINE( 166)		HX_VARI( ::hx::EnumBase,assetType) = this->type->get(id).StaticCast< ::hx::EnumBase >();
HXLINE( 168)		Bool _hx_tmp = hx::IsNotNull( assetType );
...
HXLINE( 170)					_hx_tmp2 = hx::IsEq( type,::openfl::_legacy::AssetType_obj::MUSIC_dyn() );
            				}
            				else {
...
HXLINE( 170)						_hx_tmp1 = hx::IsEq( assetType,::openfl::_legacy::AssetType_obj::SOUND_dyn() );
            					}
            					else {
...
HXLINE( 176)				_hx_tmp4 = hx::IsNull( type );
            			}
            			else {
...
HXLINE( 176)					_hx_tmp3 = hx::IsEq( type,::openfl::_legacy::AssetType_obj::TEXT_dyn() );
            				}
            				else {
...
HXLINE( 184)		return false;
 ...
 ::openfl::_legacy::display::BitmapData DefaultAssetLibrary_obj::getBitmapData(::String id){
            	...
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(id,"id")
HXLINE( 191)		Bool _hx_tmp = this->className->exists(id);
HXDLIN( 191)		if (_hx_tmp) {
HXLINE( 193)			return hx::TCast<  ::openfl::_legacy::display::BitmapData >::cast(::Type_obj::createInstance(this->className->get(id),::cpp::VirtualArray_obj::__new(0)));
            		}
            		else {
...
HXLINE( 191)		return null();
 ...
 ::openfl::_legacy::utils::ByteArray DefaultAssetLibrary_obj::getBytes(::String id){
            	...
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(id,"id")
HXLINE( 206)		Bool _hx_tmp = this->className->exists(id);
HXDLIN( 206)		if (_hx_tmp) {
HXLINE( 208)			return hx::TCast<  ::openfl::_legacy::utils::ByteArray >::cast(::Type_obj::createInstance(this->className->get(id),::cpp::VirtualArray_obj::__new(0)));
            		}
            		else {
...
HXLINE( 206)		return null();
 ...
 ::openfl::_legacy::text::Font DefaultAssetLibrary_obj::getFont(::String id){
            	...
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(id,"id")
HXLINE( 221)		Bool _hx_tmp = this->className->exists(id);
HXDLIN( 221)		if (_hx_tmp) {
HXLINE( 223)			HX_VARI(  ::Dynamic,fontClass) = this->className->get(id);
HXLINE( 224)			::openfl::_legacy::text::Font_obj::registerFont(fontClass);
HXLINE( 225)			return hx::TCast<  ::openfl::_legacy::text::Font >::cast(::Type_obj::createInstance(fontClass,::cpp::VirtualArray_obj::__new(0)));
            		}
            		else {
HXLINE( 229)			return  ::openfl::_legacy::text::Font_obj::__new(( (::String)(this->path->get(id)) ),null(),null());
            		}
HXLINE( 221)		return null();
 ...
 ::openfl::_legacy::media::Sound DefaultAssetLibrary_obj::getMusic(::String id){
            	...
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(id,"id")
HXLINE( 238)		Bool _hx_tmp = this->className->exists(id);
HXDLIN( 238)		if (_hx_tmp) {
HXLINE( 240)			return hx::TCast<  ::openfl::_legacy::media::Sound >::cast(::Type_obj::createInstance(this->className->get(id),::cpp::VirtualArray_obj::__new(0)));
            		}
            		else {
HXLINE( 244)			return  ::openfl::_legacy::media::Sound_obj::__new( ::openfl::_legacy::net::URLRequest_obj::__new(( (::String)(this->path->get(id)) )),null(),true);
            		}
...
::String DefaultAssetLibrary_obj::getPath(::String id){
            	HX_STACK_FRAME("DefaultAssetLibrary","getPath",0x9de06019,"DefaultAssetLibrary.getPath","DefaultAssetLibrary.hx",259,0x0fc48912)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(id,"id")
HXLINE( 259)		return ( (::String)(this->path->get(id)) );
            	}
 ...
 ::openfl::_legacy::media::Sound DefaultAssetLibrary_obj::getSound(::String id){
            	...
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(id,"id")
HXLINE( 268)		Bool _hx_tmp = this->className->exists(id);
HXDLIN( 268)		if (_hx_tmp) {
HXLINE( 270)			return hx::TCast<  ::openfl::_legacy::media::Sound >::cast(::Type_obj::createInstance(this->className->get(id),::cpp::VirtualArray_obj::__new(0)));
            		}
            		else {
HXLINE( 274)			 ::openfl::_legacy::net::URLRequest _hx_tmp1 =  ::openfl::_legacy::net::URLRequest_obj::__new(( (::String)(this->path->get(id)) ));
HXDLIN( 274)			Bool _hx_tmp2 = hx::IsEq( this->type->get(id).StaticCast< ::hx::EnumBase >(),::openfl::_legacy::AssetType_obj::MUSIC_dyn() );
HXDLIN( 274)			return  ::openfl::_legacy::media::Sound_obj::__new(_hx_tmp1,null(),_hx_tmp2);
            		}
...
::String DefaultAssetLibrary_obj::getText(::String id){
            	...
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(id,"id")
HXLINE( 283)		HX_VARI(  ::openfl::_legacy::utils::ByteArray,bytes) = this->getBytes(id);
HXLINE( 285)		Bool _hx_tmp = hx::IsNull( bytes );
...
::Array< ::String > DefaultAssetLibrary_obj::list(::hx::EnumBase type){
            	...
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(type,"type")
HXLINE( 307)		HX_VARI( ::Array< ::String >,items) = ::Array_obj< ::String >::__new(0);
HXLINE( 309)		{
HXLINE( 309)			HX_VARI(  ::Dynamic,tmp) = this->type->keys();
HXDLIN( 309)			while(true){
HXLINE( 309)				Bool _hx_tmp = !(( (Bool)( ::Dynamic(tmp->__Field(HX_("hasNext",6d,a5,46,18),hx::paccDynamic))()) ));
HXDLIN( 309)				if (_hx_tmp) {
HXLINE( 309)					goto _hx_goto_0;
            				}
HXDLIN( 309)				HX_VARI( ::String,id) = ( (::String)( ::Dynamic(tmp->__Field(HX_("next",f3,84,02,49),hx::paccDynamic))()) );
HXLINE( 311)				Bool _hx_tmp1;
HXDLIN( 311)				Bool _hx_tmp2 = hx::IsNotNull( type );
HXDLIN( 311)				if (_hx_tmp2) {
HXLINE( 311)					_hx_tmp1 = this->exists(id,type);
            				}
            				else {
HXLINE( 311)					_hx_tmp1 = true;
            				}
HXDLIN( 311)				if (_hx_tmp1) {
HXLINE( 313)					items->push(id);
            				}
            			}
            			_hx_goto_0:;
            		}
...
HXLINE( 356)			HX_VARI(  ::openfl::_legacy::utils::ByteArray,bytes) = ::openfl::_legacy::utils::ByteArray_obj::readFile(HX_("manifest",af,fb,29,d0));
HXLINE( 359)			Bool _hx_tmp = hx::IsNotNull( bytes );
HXDLIN( 359)			if (_hx_tmp) {
HXLINE( 361)				bytes->position = (int)0;
HXLINE( 363)				Bool _hx_tmp1 = (bytes->length > (int)0);
HXDLIN( 363)				if (_hx_tmp1) {
HXLINE( 365)					HX_VARI( ::String,data) = bytes->readUTFBytes(bytes->length);
HXLINE( 367)					Bool _hx_tmp2;
HXDLIN( 367)					Bool _hx_tmp3 = hx::IsNotNull( data );
HXDLIN( 367)					if (_hx_tmp3) {
HXLINE( 367)						_hx_tmp2 = (data.length > (int)0);
            					}
            					else {
HXLINE( 367)						_hx_tmp2 = false;
            					}
HXDLIN( 367)					if (_hx_tmp2) {
HXLINE( 369)						HX_VARI( ::cpp::VirtualArray,manifest) = ( (::cpp::VirtualArray)(::haxe::Unserializer_obj::run(data)) );
HXLINE( 371)						{
HXLINE( 371)							HX_VARI( Int,_g) = (int)0;
HXDLIN( 371)							while((_g < manifest->get_length())){
HXLINE( 371)								HX_VARI(  ::Dynamic,asset) = manifest->__get(_g);
HXDLIN( 371)								++_g;
HXLINE( 373)								::String key = ( (::String)(asset->__Field(HX_("id",db,5b,00,00),hx::paccDynamic)) );
HXDLIN( 373)								Bool _hx_tmp4 = this->className->exists(key);
HXDLIN( 373)								if (!(_hx_tmp4)) {
HXLINE( 375)									{
HXLINE( 375)										::String key1 = ( (::String)(asset->__Field(HX_("id",db,5b,00,00),hx::paccDynamic)) );
HXDLIN( 375)										::String value = ( (::String)(asset->__Field(HX_("path",a5,e5,51,4a),hx::paccDynamic)) );
HXDLIN( 375)										this->path->set(key1,value);
            									}
HXLINE( 376)									{
HXLINE( 376)										::String key2 = ( (::String)(asset->__Field(HX_("id",db,5b,00,00),hx::paccDynamic)) );
HXDLIN( 376)										::hx::EnumBase value1 = ::Type_obj::createEnum(hx::ClassOf< ::openfl::_legacy::AssetType >(), ::Dynamic(asset->__Field(HX_("type",ba,f2,08,4d),hx::paccDynamic)),null());
HXDLIN( 376)										this->type->set(key2,value1);
            									}
            								}
            							}
            						}
...
HXLINE( 388)				::haxe::Log_obj::trace(HX_("Warning: Could not load asset manifest (bytes was null)",83,9c,5b,2e),hx::SourceInfo(HX_("DefaultAssetLibrary.hx",12,89,c4,0f),388,HX_("DefaultAssetLibrary",2c,3d,78,3a),HX_("loadManifest",f5,e7,92,89)));
            			...
            			if (_hx_e.IsClass<  ::Dynamic >() ){
            				HX_STACK_BEGIN_CATCH
            				 ::Dynamic e = _hx_e;
HXLINE( 394)				::String _hx_tmp5 = ::Std_obj::string(e);
HXDLIN( 394)				::haxe::Log_obj::trace(((HX_("Warning: Could not load asset manifest (",73,7e,fd,21) + _hx_tmp5) + HX_(")",29,00,00,00)),hx::SourceInfo(HX_("DefaultAssetLibrary.hx",12,89,c4,0f),394,HX_("DefaultAssetLibrary",2c,3d,78,3a),HX_("loadManifest",f5,e7,92,89)));
            			}
            			else {
...
HXLINE( 419)			Bool _hx_tmp = hx::IsNull( bytes );
HXDLIN( 419)			if (_hx_tmp) {
HXLINE( 421)				handler(null());
            			}
            			else {
HXLINE( 425)				::String _hx_tmp1 = bytes->readUTFBytes(bytes->length);
HXDLIN( 425)				handler(_hx_tmp1);
            			}
            		}
            	...
            	HX_STACK_ARG(id,"id")
            	HX_STACK_ARG(handler,"handler")
HXLINE( 417)		HX_VARI(  ::Dynamic,callback) =  ::Dynamic(new _hx_Closure_0(handler));
...
HXLINE( 440)			HX_VARI(  ::Dynamic,message) = ::DefaultAssetLibrary_obj::workerIncomingQueue->pop(true);
HXLINE( 442)			if (hx::IsEq( message,HX_("WORK",d1,c9,bd,39) )) {
HXLINE( 444)				HX_VARI(  ::Dynamic,getMethod) = ::DefaultAssetLibrary_obj::workerIncomingQueue->pop(true);
HXLINE( 445)				HX_VARI(  ::Dynamic,id) = ::DefaultAssetLibrary_obj::workerIncomingQueue->pop(true);
HXLINE( 446)				HX_VARI(  ::Dynamic,handler) = ::DefaultAssetLibrary_obj::workerIncomingQueue->pop(true);
HXLINE( 448)				HX_VARI(  ::Dynamic,data) = getMethod(id);
...
HXLINE( 478)		Bool _hx_tmp = (::DefaultAssetLibrary_obj::loading > ::DefaultAssetLibrary_obj::loaded);
HXDLIN( 478)		if (_hx_tmp) {
HXLINE( 480)			Bool _hx_tmp1 = hx::IsNull( ::DefaultAssetLibrary_obj::workerThread );
...
HXLINE( 486)			HX_VARI(  ::Dynamic,message) = ::DefaultAssetLibrary_obj::workerResult->pop(false);
HXLINE( 488)			while(hx::IsEq( message,HX_("RESULT",dd,14,07,bb) )){
HXLINE( 490)				::DefaultAssetLibrary_obj::loaded++;
HXLINE( 492)				HX_VARI(  ::Dynamic,data) = ::DefaultAssetLibrary_obj::workerResult->pop(true);
HXLINE( 493)				HX_VARI(  ::Dynamic,handler) = ::DefaultAssetLibrary_obj::workerResult->pop(true);
HXLINE( 495)				Bool _hx_tmp2 = hx::IsNotNull( handler );
...
HXLINE( 507)			Bool _hx_tmp3 = hx::IsNotNull( ::DefaultAssetLibrary_obj::workerThread );
