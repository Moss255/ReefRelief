...
::hscript::Expr Expr_obj::EArray(::hx::EnumBase e,::hx::EnumBase index)
{
...
::hscript::Expr Expr_obj::EBinop(::String op,::hx::EnumBase e1,::hx::EnumBase e2)
{
...
::hscript::Expr Expr_obj::ECall(::hx::EnumBase e,::Array< ::Dynamic> params)
{
	return hx::CreateEnum< Expr_obj >(HX_("ECall",83,4b,39,e7),8,2)->_hx_init(0,e)->_hx_init(1,params);
}

::hscript::Expr Expr_obj::EConst(::hx::EnumBase c)
{
...
::hscript::Expr Expr_obj::EField(::hx::EnumBase e,::String f)
{
	return hx::CreateEnum< Expr_obj >(HX_("EField",35,ea,60,2a),5,2)->_hx_init(0,e)->_hx_init(1,f);
}

::hscript::Expr Expr_obj::EFor(::String v,::hx::EnumBase it,::hx::EnumBase e)
{
	return hx::CreateEnum< Expr_obj >(HX_("EFor",c4,37,d1,2d),11,3)->_hx_init(0,v)->_hx_init(1,it)->_hx_init(2,e);
}

::hscript::Expr Expr_obj::EFunction(::Array< ::Dynamic> args,::hx::EnumBase e,::String name,::hx::EnumBase ret)
{
...
::hscript::Expr Expr_obj::EIf(::hx::EnumBase cond,::hx::EnumBase e1,::hx::EnumBase e2)
{
