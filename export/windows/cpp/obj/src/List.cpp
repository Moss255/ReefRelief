...
void List_obj::__construct(){
            	HX_STACK_FRAME("List","new",0xed890070,"List.new","C:\\HaxeToolkit\\haxe\\std/List.hx",44,0x1e139e47)
            	HX_STACK_THIS(this)
...
void List_obj::add( ::Dynamic item){
            	HX_STACK_FRAME("List","add",0xed7f2231,"List.add","C:\\HaxeToolkit\\haxe\\std/List.hx",52,0x1e139e47)
            	HX_STACK_THIS(this)
...
void List_obj::push( ::Dynamic item){
            	HX_STACK_FRAME("List","push",0xebb5efca,"List.push","C:\\HaxeToolkit\\haxe\\std/List.hx",67,0x1e139e47)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(item,"item")
...
Bool List_obj::remove( ::Dynamic v){
            	HX_STACK_FRAME("List","remove",0x4b44d634,"List.remove","C:\\HaxeToolkit\\haxe\\std/List.hx",137,0x1e139e47)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(v,"v")
