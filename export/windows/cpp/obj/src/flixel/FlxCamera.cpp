...
HXLINE( 388)		this->_helperMatrix =  ::flixel::math::FlxMatrix_obj::__new(null(),null(),null(),null(),null(),null());
HXLINE( 365)		Float X1 = (int)0;
HXDLIN( 365)		Float Y1 = (int)0;
HXDLIN( 365)		Float Width1 = (int)0;
HXDLIN( 365)		Float Height1 = (int)0;
HXDLIN( 365)		HX_VARI(  ::flixel::math::FlxRect,_this) = ::flixel::math::FlxRect_obj::_pool->get();
HXDLIN( 365)		_this->x = X1;
HXDLIN( 365)		_this->y = Y1;
HXDLIN( 365)		_this->width = Width1;
HXDLIN( 365)		_this->height = Height1;
HXDLIN( 365)		_this->_inPool = false;
HXDLIN( 365)		this->_bounds = _this;
HXLINE( 360)		this->_scrollRect =  ::openfl::_legacy::display::Sprite_obj::__new();
...
HXLINE( 741)		this->_flashRect =  ::openfl::_legacy::geom::Rectangle_obj::__new((int)0,(int)0,this->width,this->height);
HXLINE( 743)		this->flashSprite->addChild(this->_scrollRect);
HXLINE( 744)		this->_scrollRect->set_scrollRect( ::openfl::_legacy::geom::Rectangle_obj::__new(null(),null(),null(),null()));
HXLINE( 746)		this->pixelPerfectRender = ::flixel::FlxG_obj::renderBlit;
HXLINE( 748)		Bool _hx_tmp2 = ::flixel::FlxG_obj::renderBlit;
HXDLIN( 748)		if (_hx_tmp2) {
HXLINE( 750)			this->screen =  ::flixel::FlxSprite_obj::__new(null(),null(),null());
HXLINE( 751)			this->buffer =  ::openfl::_legacy::display::BitmapData_obj::__new(this->width,this->height,true,(int)0,null());
HXLINE( 752)			this->screen->set_pixels(this->buffer);
HXLINE( 753)			this->screen->origin->set(null(),null());
HXLINE( 754)			this->_flashBitmap =  ::openfl::_legacy::display::Bitmap_obj::__new(this->buffer,null(),null());
HXLINE( 755)			this->_scrollRect->addChild(this->_flashBitmap);
HXLINE( 756)			this->_fill =  ::openfl::_legacy::display::BitmapData_obj::__new(this->width,this->height,true,(int)0,null());
            		}
            		else {
HXLINE( 760)			this->canvas =  ::openfl::_legacy::display::Sprite_obj::__new();
HXLINE( 761)			this->_scrollRect->addChild(this->canvas);
HXLINE( 762)			this->_transform =  ::openfl::_legacy::geom::Matrix_obj::__new(null(),null(),null(),null(),null(),null());
HXLINE( 765)			this->debugLayer =  ::openfl::_legacy::display::Sprite_obj::__new();
...
HXDLIN( 442)		Bool _hx_tmp7 = hx::IsNotNull( this->_currentDrawItem );
...
HXLINE( 453)		Bool _hx_tmp8 = hx::IsNotNull( ::flixel::FlxCamera_obj::_storageTilesHead );
...
HXLINE( 462)			itemToReturn =  ::flixel::graphics::tile::FlxDrawTilesItem_obj::__new();
            		}
...
HXLINE( 475)		Bool _hx_tmp9 = hx::IsNull( this->_headOfDrawStack );
HXDLIN( 475)		if (_hx_tmp9) {
HXLINE( 477)			this->_headOfDrawStack = itemToReturn;
            		}
HXLINE( 480)		Bool _hx_tmp10 = hx::IsNotNull( this->_currentDrawItem );
...
HXDLIN( 497)		Bool _hx_tmp5 = hx::IsNotNull( this->_currentDrawItem );
...
HXLINE( 516)		Bool _hx_tmp = hx::IsNotNull( ::flixel::FlxCamera_obj::_storageTrianglesHead );
...
HXLINE( 525)			itemToReturn =  ::flixel::graphics::tile::FlxDrawTrianglesItem_obj::__new();
            		}
...
HXLINE( 536)		Bool _hx_tmp1 = hx::IsNull( this->_headOfDrawStack );
HXDLIN( 536)		if (_hx_tmp1) {
HXLINE( 538)			this->_headOfDrawStack = itemToReturn;
            		}
HXLINE( 541)		Bool _hx_tmp2 = hx::IsNotNull( this->_currentDrawItem );
...
HXLINE( 557)			Bool _hx_tmp = !(hx::IsNotNull( currTiles ));
HXDLIN( 557)			if (_hx_tmp) {
HXLINE( 557)				goto _hx_goto_0;
            			}
...
HXLINE( 569)			Bool _hx_tmp1 = !(hx::IsNotNull( currTriangles ));
HXDLIN( 569)			if (_hx_tmp1) {
HXLINE( 569)				goto _hx_goto_1;
            			}
...
HXLINE( 588)			Bool _hx_tmp = !(hx::IsNotNull( currItem ));
HXDLIN( 588)			if (_hx_tmp) {
HXLINE( 588)				goto _hx_goto_2;
            			}
...
void FlxCamera_obj::drawPixels( ::flixel::graphics::frames::FlxFrame frame, ::openfl::_legacy::display::BitmapData pixels, ::flixel::math::FlxMatrix matrix, ::openfl::_legacy::geom::ColorTransform transform,::hx::EnumBase blend, ::Dynamic __o_smoothing, ::Dynamic shader){
 ::Dynamic smoothing = __o_smoothing.Default(false);
            	HX_STACK_FRAME("flixel.FlxCamera","drawPixels",0x80c6bc1a,"flixel.FlxCamera.drawPixels","flixel/FlxCamera.hx",598,0xe7aeb95a)
            	HX_STACK_THIS(this)
            	...
            	HX_STACK_ARG(smoothing,"smoothing")
            	HX_STACK_ARG(shader,"shader")
HXLINE( 598)		Bool _hx_tmp = ::flixel::FlxG_obj::renderBlit;
HXDLIN( 598)		if (_hx_tmp) {
HXLINE( 600)			Bool _hx_tmp1;
HXDLIN( 600)			if (!(smoothing)) {
HXLINE( 600)				_hx_tmp1 = this->antialiasing;
            			}
            			else {
HXLINE( 600)				_hx_tmp1 = true;
            			}
HXDLIN( 600)			this->buffer->draw(pixels,matrix,null(),blend,null(),_hx_tmp1);
            		}
            		else {
HXLINE( 604)			HX_VAR( Bool,isColored);
HXDLIN( 604)			Bool _hx_tmp2 = hx::IsNotNull( transform );
...
HXDLIN( 605)			Bool _hx_tmp3 = hx::IsNotNull( transform );
...
HXLINE( 610)			HX_VARI(  ::flixel::graphics::tile::FlxDrawTilesItem,drawItem) = this->startQuadBatch(frame->parent,isColored,hasColorOffsets,blend,smoothing,shader);
HXLINE( 612)			drawItem->addQuad(frame,matrix,transform);
            		}
            	}
...
void FlxCamera_obj::copyPixels( ::flixel::graphics::frames::FlxFrame frame, ::openfl::_legacy::display::BitmapData pixels, ::openfl::_legacy::geom::Rectangle sourceRect, ::openfl::_legacy::geom::Point destPoint, ::openfl::_legacy::geom::ColorTransform transform,::hx::EnumBase blend, ::Dynamic __o_smoothing, ::Dynamic shader){
 ::Dynamic smoothing = __o_smoothing.Default(false);
            	HX_STACK_FRAME("flixel.FlxCamera","copyPixels",0xf4c7a68b,"flixel.FlxCamera.copyPixels","flixel/FlxCamera.hx",619,0xe7aeb95a)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(frame,"frame")
            	HX_STACK_ARG(pixels,"pixels")
            	...
            	HX_STACK_ARG(smoothing,"smoothing")
            	HX_STACK_ARG(shader,"shader")
HXLINE( 619)		Bool _hx_tmp = ::flixel::FlxG_obj::renderBlit;
HXDLIN( 619)		if (_hx_tmp) {
HXLINE( 621)			Bool _hx_tmp1 = hx::IsNotNull( pixels );
HXDLIN( 621)			if (_hx_tmp1) {
HXLINE( 623)				this->buffer->copyPixels(pixels,sourceRect,destPoint,null(),null(),true);
            			}
            			else {
HXLINE( 625)				Bool _hx_tmp2 = hx::IsNotNull( frame );
...
HXLINE( 633)			Float _hx_tmp3 = (destPoint->x + frame->offset->x);
HXDLIN( 633)			Float _hx_tmp4 = (destPoint->y + frame->offset->y);
HXDLIN( 633)			this->_helperMatrix->translate(_hx_tmp3,_hx_tmp4);
HXLINE( 635)			HX_VAR( Bool,isColored);
HXDLIN( 635)			Bool _hx_tmp5 = hx::IsNotNull( transform );
HXDLIN( 635)			if (_hx_tmp5) {
...
HXDLIN( 636)			Bool _hx_tmp6 = hx::IsNotNull( transform );
HXDLIN( 636)			if (_hx_tmp6) {
...
Bool smoothing = __o_smoothing.Default(false);
            	HX_STACK_FRAME("flixel.FlxCamera","drawTriangles",0x78d375de,"flixel.FlxCamera.drawTriangles","flixel/FlxCamera.hx",651,0xe7aeb95a)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(graphic,"graphic")
            	...
            	HX_STACK_ARG(smoothing,"smoothing")
HXLINE( 651)		Bool _hx_tmp = ::flixel::FlxG_obj::renderBlit;
HXDLIN( 651)		if (_hx_tmp) {
HXLINE( 653)			Bool _hx_tmp1 = hx::IsNull( position );
...
HXDLIN( 656)				Float Width = this->width;
HXDLIN( 656)				Float Height = this->height;
HXDLIN( 656)				_this->x = (int)0;
HXDLIN( 656)				_this->y = (int)0;
HXDLIN( 656)				_this->width = Width;
HXDLIN( 656)				_this->height = Height;
            			}
...
HXDLIN( 663)			Float X = (int)0;
HXDLIN( 663)			Float Y = (int)0;
HXDLIN( 663)			Float Width1 = (int)0;
HXDLIN( 663)			Float Height1 = (int)0;
HXDLIN( 663)			_this1->x = X;
HXDLIN( 663)			_this1->y = Y;
HXDLIN( 663)			_this1->width = Width1;
HXDLIN( 663)			_this1->height = Height1;
HXLINE( 664)			{
HXLINE( 664)				Int len = ::flixel::FlxCamera_obj::drawVertices->length;
HXDLIN( 664)				::flixel::FlxCamera_obj::drawVertices->removeRange((int)0,len);
            			}
...
HXLINE( 671)				{
HXLINE( 671)					Int index = currentVertexPosition++;
HXDLIN( 671)					::flixel::FlxCamera_obj::drawVertices[index] = tempX;
            				}
HXLINE( 672)				{
HXLINE( 672)					Int index1 = currentVertexPosition++;
HXDLIN( 672)					::flixel::FlxCamera_obj::drawVertices[index1] = tempY;
            				}
...
HXLINE( 680)					Bool _hx_tmp2 = (tempX < _this1->x);
HXDLIN( 680)					if (_hx_tmp2) {
HXLINE( 680)						hx::AddEq(_this1->width,(_this1->x - tempX));
HXDLIN( 680)						_this1->x = tempX;
            					}
HXDLIN( 680)					Bool _hx_tmp3 = (tempY < _this1->y);
HXDLIN( 680)					if (_hx_tmp3) {
HXLINE( 680)						hx::AddEq(_this1->height,(_this1->y - tempY));
HXDLIN( 680)						_this1->y = tempY;
            					}
HXDLIN( 680)					Bool _hx_tmp4 = (tempX > (_this1->x + _this1->width));
HXDLIN( 680)					if (_hx_tmp4) {
HXLINE( 680)						_this1->width = (tempX - _this1->x);
            					}
HXDLIN( 680)					Bool _hx_tmp5 = (tempY > (_this1->y + _this1->height));
HXDLIN( 680)					if (_hx_tmp5) {
HXLINE( 680)						_this1->height = (tempY - _this1->y);
            					}
            				}
HXLINE( 683)				hx::AddEq(i,(int)2);
            			}
HXLINE( 686)			Bool _hx_tmp6 = position->_weak;
...
HXDLIN( 688)			Bool _hx_tmp7;
HXDLIN( 688)			Bool _hx_tmp8;
HXDLIN( 688)			if (((_this1->x + _this1->width) > _this2->x)) {
HXLINE( 688)				_hx_tmp8 = (_this1->x < (_this2->x + _this2->width));
            			}
            			else {
HXLINE( 688)				_hx_tmp8 = false;
            			}
HXDLIN( 688)			if (_hx_tmp8) {
HXLINE( 688)				_hx_tmp7 = ((_this1->y + _this1->height) > _this2->y);
            			}
            			else {
HXLINE( 688)				_hx_tmp7 = false;
            			}
HXDLIN( 688)			if (_hx_tmp7) {
HXLINE( 688)				result = (_this1->y < (_this2->y + _this2->height));
            			}
            			else {
HXLINE( 688)				result = false;
            			}
HXDLIN( 688)			Bool _hx_tmp9 = _this1->_weak;
HXDLIN( 688)			if (_hx_tmp9) {
HXLINE( 688)				Bool _hx_tmp10 = !(_this1->_inPool);
HXDLIN( 688)				if (_hx_tmp10) {
...
HXLINE( 690)				Int pos = (::flixel::FlxCamera_obj::drawVertices->length - verticesLength);
HXDLIN( 690)				::flixel::FlxCamera_obj::drawVertices->removeRange(pos,verticesLength);
            			}
            			else {
...
HXLINE( 700)				Bool _hx_tmp11 = ::flixel::FlxG_obj::debugger->drawDebug;
...
HXLINE( 711)			Bool _hx_tmp12 = !(_this1->_inPool);
HXDLIN( 711)			if (_hx_tmp12) {
...
HXDLIN( 715)				Float Width2 = this->width;
HXDLIN( 715)				Float Height2 = this->height;
HXDLIN( 715)				_this3->x = (int)0;
HXDLIN( 715)				_this3->y = (int)0;
HXDLIN( 715)				_this3->width = Width2;
HXDLIN( 715)				_this3->height = Height2;
            			}
HXLINE( 716)			HX_VAR( Bool,isColored);
HXDLIN( 716)			Bool _hx_tmp13 = hx::IsNotNull( colors );
HXDLIN( 716)			if (_hx_tmp13) {
...
HXLINE( 790)		Bool _hx_tmp = ::flixel::FlxG_obj::renderBlit;
...
HXLINE( 806)			Bool _hx_tmp1 = hx::IsNotNull( this->canvas );
...
HXLINE( 815)			Bool _hx_tmp2 = hx::IsNotNull( this->_headOfDrawStack );
...
HXLINE( 847)		Bool _hx_tmp = hx::IsNotNull( this->target );
...
HXLINE( 856)		::Array< ::Dynamic> _hx_tmp1;
HXDLIN( 856)		if (this->filtersEnabled) {
HXLINE( 856)			_hx_tmp1 = this->_filters;
            		}
            		else {
HXLINE( 856)			_hx_tmp1 = null();
            		}
HXDLIN( 856)		this->flashSprite->set_filters(_hx_tmp1);
...
HXDLIN( 870)		Bool _hx_tmp = hx::IsNull( this->minScrollX );
...
HXDLIN( 871)		Bool _hx_tmp1 = hx::IsNull( this->maxScrollX );
...
HXDLIN( 872)		Bool _hx_tmp2 = hx::IsNull( this->minScrollY );
HXDLIN( 872)		if (_hx_tmp2) {
...
HXDLIN( 873)		Bool _hx_tmp3 = hx::IsNull( this->maxScrollY );
...
HXDLIN( 876)		Bool _hx_tmp4 = hx::IsNotNull( maxX );
...
HXDLIN( 876)		Bool _hx_tmp5;
HXDLIN( 876)		Bool _hx_tmp6 = hx::IsNotNull( minX );
HXDLIN( 876)		if (_hx_tmp6) {
HXLINE( 876)			_hx_tmp5 = hx::IsLess( Value,minX );
            		}
            		else {
HXLINE( 876)			_hx_tmp5 = false;
            		}
...
HXDLIN( 876)		Float _hx_tmp7;
HXDLIN( 876)		Bool _hx_tmp8;
HXDLIN( 876)		Bool _hx_tmp9 = hx::IsNotNull( Max );
HXDLIN( 876)		if (_hx_tmp9) {
HXLINE( 876)			_hx_tmp8 = hx::IsGreater( lowerBound,Max );
            		}
            		else {
HXLINE( 876)			_hx_tmp8 = false;
            		}
HXDLIN( 876)		if (_hx_tmp8) {
HXLINE( 876)			_hx_tmp7 = Max;
            		}
            		else {
HXLINE( 876)			_hx_tmp7 = lowerBound;
            		}
HXDLIN( 876)		this->scroll->set_x(_hx_tmp7);
HXLINE( 877)		HX_VARI_NAME( Float,Value1,"Value") = this->scroll->y;
HXDLIN( 877)		HX_VAR_NAME(  ::Dynamic,Max1,"Max");
HXDLIN( 877)		Bool _hx_tmp10 = hx::IsNotNull( maxY );
...
HXDLIN( 877)		Bool _hx_tmp11;
HXDLIN( 877)		Bool _hx_tmp12 = hx::IsNotNull( minY );
HXDLIN( 877)		if (_hx_tmp12) {
HXLINE( 877)			_hx_tmp11 = hx::IsLess( Value1,minY );
            		}
            		else {
HXLINE( 877)			_hx_tmp11 = false;
            		}
HXDLIN( 877)		if (_hx_tmp11) {
HXLINE( 877)			lowerBound1 = minY;
            		}
            		else {
HXLINE( 877)			lowerBound1 = Value1;
            		}
HXDLIN( 877)		Float _hx_tmp13;
HXDLIN( 877)		Bool _hx_tmp14;
HXDLIN( 877)		Bool _hx_tmp15 = hx::IsNotNull( Max1 );
HXDLIN( 877)		if (_hx_tmp15) {
HXLINE( 877)			_hx_tmp14 = hx::IsGreater( lowerBound1,Max1 );
            		}
            		else {
HXLINE( 877)			_hx_tmp14 = false;
            		}
HXDLIN( 877)		if (_hx_tmp14) {
HXLINE( 877)			_hx_tmp13 = Max1;
            		}
            		else {
HXLINE( 877)			_hx_tmp13 = lowerBound1;
            		}
HXDLIN( 877)		this->scroll->set_y(_hx_tmp13);
            	}
...
HXLINE(1022)				Bool _hx_tmp2 = hx::IsNotNull( this->_fxShakeComplete );
...
HXDLIN(1031)					Float _hx_tmp3 = _g->get_x();
HXDLIN(1031)					Float _hx_tmp4 = (-(this->_fxShakeIntensity) * this->width);
HXDLIN(1031)					Float _hx_tmp5 = (this->_fxShakeIntensity * this->width);
HXDLIN(1031)					Float _hx_tmp6 = ::flixel::FlxG_obj::random->_hx_float(_hx_tmp4,_hx_tmp5,null());
HXDLIN(1031)					Float _hx_tmp7 = ((_hx_tmp6 * this->zoom) * ::flixel::FlxG_obj::scaleMode->scale->x);
HXDLIN(1031)					_g->set_x((_hx_tmp3 + _hx_tmp7));
            				}
...
HXDLIN(1035)					Float _hx_tmp8 = _g1->get_y();
HXDLIN(1035)					Float _hx_tmp9 = (-(this->_fxShakeIntensity) * this->height);
HXDLIN(1035)					Float _hx_tmp10 = (this->_fxShakeIntensity * this->height);
HXDLIN(1035)					Float _hx_tmp11 = ::flixel::FlxG_obj::random->_hx_float(_hx_tmp9,_hx_tmp10,null());
HXDLIN(1035)					Float _hx_tmp12 = ((_hx_tmp11 * this->zoom) * ::flixel::FlxG_obj::scaleMode->scale->y);
HXDLIN(1035)					_g1->set_y((_hx_tmp8 + _hx_tmp12));
            				}
            			}
            		}
            	}
...
void FlxCamera_obj::updateFlashSpritePosition(){
            	...
            	HX_STACK_THIS(this)
HXLINE(1047)		Bool _hx_tmp = hx::IsNotNull( this->flashSprite );
HXDLIN(1047)		if (_hx_tmp) {
HXLINE(1049)			Float _hx_tmp1 = ((this->x * ::flixel::FlxG_obj::scaleMode->scale->x) + this->_flashOffset->x);
HXDLIN(1049)			this->flashSprite->set_x(_hx_tmp1);
HXLINE(1050)			Float _hx_tmp2 = ((this->y * ::flixel::FlxG_obj::scaleMode->scale->y) + this->_flashOffset->y);
HXDLIN(1050)			this->flashSprite->set_y(_hx_tmp2);
            		}
            	}
...
void FlxCamera_obj::updateFlashOffset(){
            	...
            	HX_STACK_THIS(this)
HXLINE(1060)		Float _hx_tmp = (((this->width * ((Float)0.5)) * ::flixel::FlxG_obj::scaleMode->scale->x) * this->initialZoom);
HXDLIN(1060)		this->_flashOffset->set_x(_hx_tmp);
HXLINE(1061)		Float _hx_tmp1 = (((this->height * ((Float)0.5)) * ::flixel::FlxG_obj::scaleMode->scale->y) * this->initialZoom);
HXDLIN(1061)		this->_flashOffset->set_y(_hx_tmp1);
            	}
...
HXDLIN(1074)		Bool _hx_tmp = hx::IsNotNull( this->_scrollRect );
...
HXLINE(1076)		Bool _hx_tmp1 = hx::IsNotNull( rect );
HXDLIN(1076)		if (_hx_tmp1) {
HXLINE(1078)			rect->x = (rect->y = (int)0);
HXLINE(1079)			Float _hx_tmp2 = (this->width * this->initialZoom);
HXDLIN(1079)			rect->width = (_hx_tmp2 * ::flixel::FlxG_obj::scaleMode->scale->x);
HXLINE(1080)			Float _hx_tmp3 = (this->height * this->initialZoom);
HXDLIN(1080)			rect->height = (_hx_tmp3 * ::flixel::FlxG_obj::scaleMode->scale->y);
HXLINE(1081)			this->_scrollRect->set_scrollRect(rect);
HXLINE(1082)			Float _hx_tmp4 = (((Float)-0.5) * rect->width);
HXDLIN(1082)			this->_scrollRect->set_x(_hx_tmp4);
HXLINE(1083)			Float _hx_tmp5 = (((Float)-0.5) * rect->height);
HXDLIN(1083)			this->_scrollRect->set_y(_hx_tmp5);
            		}
            	}
...
void FlxCamera_obj::updateInternalSpritePositions(){
            	...
            	HX_STACK_THIS(this)
HXLINE(1094)		Bool _hx_tmp = ::flixel::FlxG_obj::renderBlit;
HXDLIN(1094)		if (_hx_tmp) {
HXLINE(1096)			Bool _hx_tmp1 = hx::IsNotNull( this->_flashBitmap );
HXDLIN(1096)			if (_hx_tmp1) {
HXLINE(1098)				Bool _hx_tmp2;
HXDLIN(1098)				Bool _hx_tmp3;
HXDLIN(1098)				Bool _hx_tmp4 = !(this->regen);
HXDLIN(1098)				if (_hx_tmp4) {
HXLINE(1098)					Int _hx_tmp5 = this->width;
HXDLIN(1098)					Int _hx_tmp6 = this->buffer->get_width();
HXDLIN(1098)					_hx_tmp3 = (_hx_tmp5 != _hx_tmp6);
            				}
            				else {
HXLINE(1098)					_hx_tmp3 = true;
            				}
HXDLIN(1098)				if (!(_hx_tmp3)) {
HXLINE(1098)					Int _hx_tmp7 = this->height;
HXDLIN(1098)					Int _hx_tmp8 = this->buffer->get_height();
HXDLIN(1098)					_hx_tmp2 = (_hx_tmp7 != _hx_tmp8);
            				}
            				else {
HXLINE(1098)					_hx_tmp2 = true;
            				}
HXDLIN(1098)				this->regen = _hx_tmp2;
HXLINE(1100)				Float _hx_tmp9 = (((((Float)-0.5) * this->width) * (this->scaleX - this->initialZoom)) * ::flixel::FlxG_obj::scaleMode->scale->x);
HXDLIN(1100)				this->_flashBitmap->set_x(_hx_tmp9);
HXLINE(1101)				Float _hx_tmp10 = (((((Float)-0.5) * this->height) * (this->scaleY - this->initialZoom)) * ::flixel::FlxG_obj::scaleMode->scale->y);
HXDLIN(1101)				this->_flashBitmap->set_y(_hx_tmp10);
            			}
            		}
            		else {
HXLINE(1106)			Bool _hx_tmp11 = hx::IsNotNull( this->canvas );
HXDLIN(1106)			if (_hx_tmp11) {
HXLINE(1108)				Float _hx_tmp12 = (((((Float)-0.5) * this->width) * (this->scaleX - this->initialZoom)) * ::flixel::FlxG_obj::scaleMode->scale->x);
HXDLIN(1108)				this->canvas->set_x(_hx_tmp12);
HXLINE(1109)				Float _hx_tmp13 = (((((Float)-0.5) * this->height) * (this->scaleY - this->initialZoom)) * ::flixel::FlxG_obj::scaleMode->scale->y);
HXDLIN(1109)				this->canvas->set_y(_hx_tmp13);
HXLINE(1111)				this->canvas->set_scaleX(this->totalScaleX);
HXLINE(1112)				this->canvas->set_scaleY(this->totalScaleY);
HXLINE(1115)				Bool _hx_tmp14 = hx::IsNotNull( this->debugLayer );
HXDLIN(1115)				if (_hx_tmp14) {
HXLINE(1117)					Float _hx_tmp15 = this->canvas->get_x();
HXDLIN(1117)					this->debugLayer->set_x(_hx_tmp15);
HXLINE(1118)					Float _hx_tmp16 = this->canvas->get_y();
HXDLIN(1118)					this->debugLayer->set_y(_hx_tmp16);
...
HXLINE(1152)		Int _hx_tmp2 = ( ( ::hx::EnumBase)(Style) )->_hx_getIndex();
HXDLIN(1152)		switch((int)(_hx_tmp2)){
            			case (int)0: {
HXLINE(1155)				Bool _hx_tmp3 = hx::IsNotNull( this->target );
...
HXDLIN(1165)				this->deadzone = _this1;
            			...
            			break;
            			case (int)2: {
HXLINE(1168)				Float _hx_tmp4 = ::Math_obj::max(this->width,this->height);
HXDLIN(1168)				helper = ((Float)_hx_tmp4 / (Float)(int)4);
...
HXDLIN(1169)				this->deadzone = _this2;
            			...
            			break;
            			case (int)3: {
HXLINE(1172)				Float _hx_tmp5 = ::Math_obj::max(this->width,this->height);
HXDLIN(1172)				helper = ((Float)_hx_tmp5 / (Float)(int)8);
...
HXDLIN(1190)			Bool _hx_tmp = point->_weak;
...
HXLINE(1200)		Float _hx_tmp = (point->x - (this->width * ((Float)0.5)));
HXDLIN(1200)		Float _hx_tmp1 = (point->y - (this->height * ((Float)0.5)));
HXDLIN(1200)		this->scroll->set(_hx_tmp,_hx_tmp1);
HXLINE(1201)		Bool _hx_tmp2 = point->_weak;
...
HXLINE(1219)		Bool _hx_tmp1 = (Duration <= (int)0);
...
HXLINE(1243)		Bool _hx_tmp1 = (Duration <= (int)0);
...
HXLINE(1250)		Float _hx_tmp2;
HXDLIN(1250)		if (this->_fxFadeIn) {
HXLINE(1250)			_hx_tmp2 = ((Float)0.999999);
            		}
            		else {
HXLINE(1250)			_hx_tmp2 = ((Float)0.000001);
            		}
HXDLIN(1250)		this->_fxFadeAlpha = _hx_tmp2;
...
HXLINE(1309)		Bool _hx_tmp = hx::IsNotNull( this->target );
HXDLIN(1309)		if (_hx_tmp) {
HXLINE(1311)			Bool _hx_tmp1 = hx::IsNull( Camera->deadzone );
HXDLIN(1311)			if (_hx_tmp1) {
HXLINE(1313)				this->deadzone = null();
            			}
            			else {
HXLINE(1317)				Bool _hx_tmp2 = hx::IsNull( this->deadzone );
HXDLIN(1317)				if (_hx_tmp2) {
HXLINE(1319)					Float X = (int)0;
HXDLIN(1319)					Float Y = (int)0;
HXDLIN(1319)					Float Width = (int)0;
HXDLIN(1319)					Float Height = (int)0;
HXDLIN(1319)					HX_VARI(  ::flixel::math::FlxRect,_this) = ::flixel::math::FlxRect_obj::_pool->get();
HXDLIN(1319)					_this->x = X;
HXDLIN(1319)					_this->y = Y;
HXDLIN(1319)					_this->width = Width;
HXDLIN(1319)					_this->height = Height;
...
HXDLIN(1321)					Bool _hx_tmp3 = Rect->_weak;
HXDLIN(1321)					if (_hx_tmp3) {
HXLINE(1321)						Bool _hx_tmp4 = !(Rect->_inPool);
...
Float FxAlpha = __o_FxAlpha.Default(((Float)1.0));
            	HX_STACK_FRAME("flixel.FlxCamera","fill",0xa57a338c,"flixel.FlxCamera.fill","flixel/FlxCamera.hx",1335,0xe7aeb95a)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(Color,"Color")
            	HX_STACK_ARG(BlendAlpha,"BlendAlpha")
            	HX_STACK_ARG(FxAlpha,"FxAlpha")
            	HX_STACK_ARG(graphics,"graphics")
HXLINE(1335)		Bool _hx_tmp = ::flixel::FlxG_obj::renderBlit;
...
HXDLIN(1354)			Bool _hx_tmp1 = hx::IsNull( graphics );
...
HXLINE(1359)			Int _hx_tmp2 = (this->width + (int)2);
HXDLIN(1359)			Int _hx_tmp3 = (this->height + (int)2);
HXDLIN(1359)			targetGraphics->drawRect((int)-1,(int)-1,_hx_tmp2,_hx_tmp3);
...
HXLINE(1373)		Bool _hx_tmp = (this->_fxFlashAlpha > ((Float)0.0));
HXDLIN(1373)		if (_hx_tmp) {
HXLINE(1375)			alphaComponent = ((int)((int)this->_fxFlashColor >> (int)(int)24) & (int)(int)255);
HXLINE(1377)			Bool _hx_tmp1 = ::flixel::FlxG_obj::renderBlit;
HXDLIN(1377)			if (_hx_tmp1) {
HXLINE(1379)				Float _hx_tmp2;
HXDLIN(1379)				if ((alphaComponent <= (int)0)) {
HXLINE(1379)					_hx_tmp2 = (int)255;
            				}
            				else {
HXLINE(1379)					_hx_tmp2 = alphaComponent;
            				}
HXDLIN(1379)				Float _hx_tmp3 = (_hx_tmp2 * this->_fxFlashAlpha);
HXDLIN(1379)				Int _hx_tmp4 = ::Std_obj::_hx_int(_hx_tmp3);
HXDLIN(1379)				Int _hx_tmp5 = (((int)_hx_tmp4 << (int)(int)24) + ((int)this->_fxFlashColor & (int)(int)16777215));
HXDLIN(1379)				this->fill(_hx_tmp5,null(),null(),null());
            			}
            			else {
HXLINE(1383)				Int _hx_tmp6 = ((int)this->_fxFlashColor & (int)(int)16777215);
HXDLIN(1383)				Float _hx_tmp7;
HXDLIN(1383)				if ((alphaComponent <= (int)0)) {
HXLINE(1383)					_hx_tmp7 = (int)255;
            				}
            				else {
HXLINE(1383)					_hx_tmp7 = alphaComponent;
            				}
HXDLIN(1383)				Float _hx_tmp8 = ((Float)(_hx_tmp7 * this->_fxFlashAlpha) / (Float)(int)255);
HXDLIN(1383)				 ::openfl::_legacy::display::Graphics _hx_tmp9 = this->canvas->get_graphics();
HXDLIN(1383)				this->fill(_hx_tmp6,true,_hx_tmp8,_hx_tmp9);
            			}
            		}
HXLINE(1388)		Bool _hx_tmp10 = (this->_fxFadeAlpha > ((Float)0.0));
HXDLIN(1388)		if (_hx_tmp10) {
HXLINE(1390)			alphaComponent = ((int)((int)this->_fxFadeColor >> (int)(int)24) & (int)(int)255);
HXLINE(1392)			Bool _hx_tmp11 = ::flixel::FlxG_obj::renderBlit;
HXDLIN(1392)			if (_hx_tmp11) {
HXLINE(1394)				Float _hx_tmp12;
HXDLIN(1394)				if ((alphaComponent <= (int)0)) {
HXLINE(1394)					_hx_tmp12 = (int)255;
            				}
            				else {
HXLINE(1394)					_hx_tmp12 = alphaComponent;
            				}
HXDLIN(1394)				Float _hx_tmp13 = (_hx_tmp12 * this->_fxFadeAlpha);
HXDLIN(1394)				Int _hx_tmp14 = ::Std_obj::_hx_int(_hx_tmp13);
HXDLIN(1394)				Int _hx_tmp15 = (((int)_hx_tmp14 << (int)(int)24) + ((int)this->_fxFadeColor & (int)(int)16777215));
HXDLIN(1394)				this->fill(_hx_tmp15,null(),null(),null());
            			}
            			else {
HXLINE(1398)				Int _hx_tmp16 = ((int)this->_fxFadeColor & (int)(int)16777215);
HXDLIN(1398)				Float _hx_tmp17;
HXDLIN(1398)				if ((alphaComponent <= (int)0)) {
HXLINE(1398)					_hx_tmp17 = (int)255;
            				}
            				else {
HXLINE(1398)					_hx_tmp17 = alphaComponent;
            				}
HXDLIN(1398)				Float _hx_tmp18 = ((Float)(_hx_tmp17 * this->_fxFadeAlpha) / (Float)(int)255);
HXDLIN(1398)				 ::openfl::_legacy::display::Graphics _hx_tmp19 = this->canvas->get_graphics();
HXDLIN(1398)				this->fill(_hx_tmp16,true,_hx_tmp18,_hx_tmp19);
            			}
            		}
            	}
...
HXDLIN(1409)		Int _hx_tmp3 = this->buffer->get_width();
HXDLIN(1409)		if ((_hx_tmp2 == _hx_tmp3)) {
HXLINE(1409)			Int _hx_tmp4 = this->height;
HXDLIN(1409)			Int _hx_tmp5 = this->buffer->get_height();
HXDLIN(1409)			_hx_tmp1 = (_hx_tmp4 != _hx_tmp5);
            		}
            		else {
...
HXLINE(1412)			this->buffer =  ::openfl::_legacy::display::BitmapData_obj::__new(this->width,this->height,true,(int)0,null());
...
HXLINE(1419)			this->_fill =  ::openfl::_legacy::display::BitmapData_obj::__new(this->width,this->height,true,(int)0,null());
...
HXLINE(1503)		Bool _hx_tmp = ::flixel::FlxG_obj::renderBlit;
...
Float FlxCamera_obj::set_followLerp(Float Value){
            	HX_STACK_FRAME("flixel.FlxCamera","set_followLerp",0xf2f9b78e,"flixel.FlxCamera.set_followLerp","flixel/FlxCamera.hx",1531,0xe7aeb95a)
            	HX_STACK_THIS(this)
...
HXDLIN(1531)		Bool _hx_tmp2 = hx::IsNotNull( Max );
...
HXLINE(1574)		Bool _hx_tmp1 = ::flixel::FlxG_obj::renderBlit;
...
HXLINE(1597)		Bool _hx_tmp = ::flixel::FlxG_obj::renderBlit;
HXDLIN(1597)		if (_hx_tmp) {
HXLINE(1599)			Bool _hx_tmp1 = hx::IsNull( this->_flashBitmap );
...
HXLINE(1610)		Float _hx_tmp2 = ((Float)((int)((int)this->color >> (int)(int)16) & (int)(int)255) / (Float)(int)255);
HXDLIN(1610)		colorTransform->redMultiplier = _hx_tmp2;
HXLINE(1611)		Float _hx_tmp3 = ((Float)((int)((int)this->color >> (int)(int)8) & (int)(int)255) / (Float)(int)255);
HXDLIN(1611)		colorTransform->greenMultiplier = _hx_tmp3;
HXLINE(1612)		Int _hx_tmp4 = ((int)this->color & (int)(int)255);
HXDLIN(1612)		colorTransform->blueMultiplier = ((Float)_hx_tmp4 / (Float)(int)255);
HXLINE(1614)		Bool _hx_tmp5 = ::flixel::FlxG_obj::renderBlit;
HXDLIN(1614)		if (_hx_tmp5) {
...
HXLINE(1629)		Bool _hx_tmp = ::flixel::FlxG_obj::renderBlit;
...
HXLINE(1652)		Bool _hx_tmp = hx::IsNotNull( this->flashSprite );
...
{
{
            	HX_STACK_FRAME("flixel.FlxCamera","boot",0xa2d9e93b,"flixel.FlxCamera.boot","flixel/FlxCamera.hx",420,0xe7aeb95a)
HXLINE( 420)		HX_VARI_NAME( ::Array< Float >,this1,"this") = ::Array_obj< Float >::__new();
HXDLIN( 420)		this1->__SetSizeExact(null());
HXDLIN( 420)		drawVertices = this1;
            	}
{
            	HX_STACK_FRAME("flixel.FlxCamera","boot",0xa2d9e93b,"flixel.FlxCamera.boot","flixel/FlxCamera.hx",424,0xe7aeb95a)
HXLINE( 424)		trianglesSprite =  ::openfl::_legacy::display::Sprite_obj::__new();
            	}
{
...
HXDLIN( 429)		renderPoint = point;
            	}
{
            	HX_STACK_FRAME("flixel.FlxCamera","boot",0xa2d9e93b,"flixel.FlxCamera.boot","flixel/FlxCamera.hx",430,0xe7aeb95a)
HXLINE( 430)		Float X = (int)0;
HXDLIN( 430)		Float Y = (int)0;
HXDLIN( 430)		Float Width = (int)0;
HXDLIN( 430)		Float Height = (int)0;
HXDLIN( 430)		HX_VARI(  ::flixel::math::FlxRect,_this) = ::flixel::math::FlxRect_obj::_pool->get();
HXDLIN( 430)		_this->x = X;
HXDLIN( 430)		_this->y = Y;
HXDLIN( 430)		_this->width = Width;
HXDLIN( 430)		_this->height = Height;
HXDLIN( 430)		_this->_inPool = false;
HXDLIN( 430)		renderRect = _this;
            	}
}
