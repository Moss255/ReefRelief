...
HXLINE( 101)				this->add(anim->name,anim->frames,anim->frameRate,anim->looped,null(),null());
            			}
            			_hx_goto_0:;
            		}
...
HXLINE( 703)		::flixel::graphics::frames::FlxFrame_obj::sort(AnimFrames,Prefix.length,postFix.length);
HXLINE( 705)		{
...
HXDLIN( 705)				++_g;
HXLINE( 707)				Int _hx_tmp1 = this->_sprite->frames->frames->indexOf(animFrame,null());
HXDLIN( 707)				AddTo->push(_hx_tmp1);
            			}
            		}
            	}
