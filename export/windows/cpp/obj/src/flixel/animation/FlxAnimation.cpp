...
HXLINE( 127)			Int _hx_tmp2 = ::flixel::FlxG_obj::random->_hx_int((int)0,maxFrameIndex,null());
HXDLIN( 127)			this->set_curFrame(_hx_tmp2);
            		}
            		else {
HXLINE( 130)			Bool _hx_tmp3 = (Frame > maxFrameIndex);
...
void FlxAnimation_obj::restart(){
            	HX_STACK_FRAME("flixel.animation.FlxAnimation","restart",0xc2d3272f,"flixel.animation.FlxAnimation.restart","flixel/animation/FlxAnimation.hx",143,0x660bc6ae)
            	HX_STACK_THIS(this)
...
HXLINE( 177)		Bool _hx_tmp = this->finished;
...
HXLINE( 189)			hx::SubEq(this->_frameTimer,this->delay);
HXLINE( 190)			Bool _hx_tmp3 = this->reversed;
HXDLIN( 190)			if (_hx_tmp3) {
HXLINE( 192)				Bool _hx_tmp4;
HXDLIN( 192)				if (this->looped) {
HXLINE( 192)					_hx_tmp4 = (this->curFrame == (int)0);
            				}
            				else {
HXLINE( 192)					_hx_tmp4 = false;
            				}
HXDLIN( 192)				if (_hx_tmp4) {
HXLINE( 193)					Int _hx_tmp5 = (this->frames->length - (int)1);
HXDLIN( 193)					this->set_curFrame(_hx_tmp5);
            				}
            				else {
HXLINE( 195)					HX_VARI(  ::flixel::animation::FlxAnimation,_g) = hx::ObjectPtr<OBJ_>(this);
HXDLIN( 195)					Int _hx_tmp6 = (_g->curFrame - (int)1);
HXDLIN( 195)					_g->set_curFrame(_hx_tmp6);
            				}
            			}
            			else {
HXLINE( 199)				Bool _hx_tmp7;
HXDLIN( 199)				if (this->looped) {
HXLINE( 199)					_hx_tmp7 = (this->curFrame == (this->frames->length - (int)1));
            				}
            				else {
...
HXDLIN( 202)					Int _hx_tmp8 = (_g1->curFrame + (int)1);
HXDLIN( 202)					_g1->set_curFrame(_hx_tmp8);
            				}
            			}
            		}
            		_hx_goto_0:;
 ...
 ::flixel::animation::FlxBaseAnimation FlxAnimation_obj::clone( ::flixel::animation::FlxAnimationController Parent){
            	HX_STACK_FRAME("flixel.animation.FlxAnimation","clone",0x4847dabd,"flixel.animation.FlxAnimation.clone","flixel/animation/FlxAnimation.hx",209,0x660bc6ae)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(Parent,"Parent")
HXLINE( 209)		return  ::flixel::animation::FlxAnimation_obj::__new(Parent,this->name,this->frames,this->frameRate,this->looped,this->flipX,this->flipY);
            	}
...
HXLINE( 242)		Int _hx_tmp2 = this->frames->__get(this->curFrame);
HXDLIN( 242)		this->set_curIndex(_hx_tmp2);
HXLINE( 244)		Bool _hx_tmp3;
HXDLIN( 244)		if (this->finished) {
HXLINE( 244)			_hx_tmp3 = hx::IsNotNull( this->parent );
            		}
            		else {
...
HXDLIN( 245)			Bool _hx_tmp4 = hx::IsNotNull( _this->finishCallback );
...
Int FlxAnimation_obj::get_numFrames(){
            	HX_STACK_FRAME("flixel.animation.FlxAnimation","get_numFrames",0x65f5f5c3,"flixel.animation.FlxAnimation.get_numFrames","flixel/animation/FlxAnimation.hx",252,0x660bc6ae)
            	HX_STACK_THIS(this)
