...
void FlxG_obj::resizeGame(Int Width,Int Height){
            	HX_STACK_FRAME("flixel.FlxG","resizeGame",0x80aafe0d,"flixel.FlxG.resizeGame","flixel/FlxG.hx",305,0x8e176836)
...
void FlxG_obj::resizeWindow(Int Width,Int Height){
            	HX_STACK_FRAME("flixel.FlxG","resizeWindow",0x41839acb,"flixel.FlxG.resizeWindow","flixel/FlxG.hx",315,0x8e176836)
            	HX_STACK_ARG(Width,"Width")
            	HX_STACK_ARG(Height,"Height")
...
void FlxG_obj::resetGame(){
            	HX_STACK_FRAME("flixel.FlxG","resetGame",0x7560e13a,"flixel.FlxG.resetGame","flixel/FlxG.hx",327,0x8e176836)
...
void FlxG_obj::switchState( ::flixel::FlxState nextState){
            	HX_STACK_FRAME("flixel.FlxG","switchState",0xbec45396,"flixel.FlxG.switchState","flixel/FlxG.hx",336,0x8e176836)
            	HX_STACK_ARG(nextState,"nextState")
HXLINE( 336)		Bool _hx_tmp = ::flixel::FlxG_obj::game->_state->switchTo(nextState);
...
HXLINE( 346)		hx::Class _hx_tmp = ::Type_obj::getClass(::flixel::FlxG_obj::game->_state);
HXDLIN( 346)		HX_VARI(  ::flixel::FlxState,nextState) = ( ( ::flixel::FlxState)(::Type_obj::createInstance(_hx_tmp,::cpp::VirtualArray_obj::__new(0))) );
HXDLIN( 346)		Bool _hx_tmp1 = ::flixel::FlxG_obj::game->_state->switchTo(nextState);
...
HXLINE( 365)		Bool _hx_tmp = hx::IsNull( ObjectOrGroup1 );
HXDLIN( 365)		if (_hx_tmp) {
HXLINE( 367)			ObjectOrGroup1 = ::flixel::FlxG_obj::game->_state;
            		}
HXLINE( 369)		Bool _hx_tmp1 = hx::IsEq( ObjectOrGroup2,ObjectOrGroup1 );
...
Int AlphaTolerance = __o_AlphaTolerance.Default(255);
            	HX_STACK_FRAME("flixel.FlxG","pixelPerfectOverlap",0x4d139839,"flixel.FlxG.pixelPerfectOverlap","flixel/FlxG.hx",393,0x8e176836)
...
Bool FlxG_obj::collide( ::flixel::FlxBasic ObjectOrGroup1, ::flixel::FlxBasic ObjectOrGroup2, ::Dynamic NotifyCallback){
            	HX_STACK_FRAME("flixel.FlxG","collide",0x7b6cbb17,"flixel.FlxG.collide","flixel/FlxG.hx",412,0x8e176836)
            	HX_STACK_ARG(ObjectOrGroup1,"ObjectOrGroup1")
            	HX_STACK_ARG(ObjectOrGroup2,"ObjectOrGroup2")
            	HX_STACK_ARG(NotifyCallback,"NotifyCallback")
...
void FlxG_obj::removePostProcess( ::flixel::effects::postprocess::PostProcess postProcess){
            	...
            	HX_STACK_ARG(postProcess,"postProcess")
HXLINE( 480)		Bool _hx_tmp = ::flixel::FlxG_obj::game->postProcesses->remove(postProcess);
...
HXLINE( 495)		Bool _hx_tmp = (postProcesses->length > (int)0);
...
HXLINE( 497)					HX_VARI( Int,i) = _g1++;
HXLINE( 499)					 ::flixel::effects::postprocess::PostProcess _hx_tmp1 = postProcesses->__get((i + (int)1)).StaticCast<  ::flixel::effects::postprocess::PostProcess >();
HXDLIN( 499)					postProcesses->__get(i).StaticCast<  ::flixel::effects::postprocess::PostProcess >()->set_to(_hx_tmp1);
            				}
            			}
...
HXLINE( 517)		Bool _hx_tmp = !( ::EReg_obj::__new(HX_("^https?://",48,ee,dd,38),HX_("",00,00,00,00))->match(URL));
HXDLIN( 517)		if (_hx_tmp) {
HXLINE( 518)			prefix = HX_("http://",52,75,cd,5a);
            		}
HXLINE( 519)		::openfl::_legacy::Lib_obj::getURL( ::openfl::_legacy::net::URLRequest_obj::__new((prefix + URL)),Target);
            	}
...
HXLINE( 529)		Float _hx_tmp = ::Math_obj::abs(Width);
HXDLIN( 529)		::flixel::FlxG_obj::width = ::Std_obj::_hx_int(_hx_tmp);
HXLINE( 530)		Float _hx_tmp1 = ::Math_obj::abs(Height);
HXDLIN( 530)		::flixel::FlxG_obj::height = ::Std_obj::_hx_int(_hx_tmp1);
...
HXLINE( 542)		::flixel::FlxG_obj::keys = ::flixel::FlxG_obj::inputs->add_flixel_input_keyboard_FlxKeyboard( ::flixel::input::keyboard::FlxKeyboard_obj::__new());
HXLINE( 546)		 ::flixel::input::mouse::FlxMouse _hx_tmp2 = ::flixel::FlxG_obj::inputs->add_flixel_input_mouse_FlxMouse( ::flixel::input::mouse::FlxMouse_obj::__new(::flixel::FlxG_obj::game->_inputContainer));
HXDLIN( 546)		::flixel::FlxG_obj::set_mouse(_hx_tmp2);
HXLINE( 554)		::flixel::FlxG_obj::gamepads = ::flixel::FlxG_obj::inputs->add_flixel_input_gamepad_FlxGamepadManager( ::flixel::input::gamepad::FlxGamepadManager_obj::__new());
HXLINE( 564)		::flixel::FlxG_obj::save->bind(HX_("flixel",5c,42,70,3d));
HXLINE( 566)		::flixel::FlxG_obj::plugins =  ::flixel::_hx_system::frontEnds::PluginFrontEnd_obj::__new();
HXLINE( 567)		::flixel::FlxG_obj::vcr =  ::flixel::_hx_system::frontEnds::VCRFrontEnd_obj::__new();
HXLINE( 570)		::flixel::FlxG_obj::sound =  ::flixel::_hx_system::frontEnds::SoundFrontEnd_obj::__new();
            	}
...
HXDLIN( 612)			{
HXLINE( 612)				Float _hx_tmp = ::Math_obj::random();
HXDLIN( 612)				HX_VARI( Int,Value) = ::Std_obj::_hx_int((_hx_tmp * (int)2147483647));
...
HXDLIN( 612)				 ::Dynamic _hx_tmp1;
HXDLIN( 612)				if ((lowerBound > (int)2147483646)) {
HXLINE( 612)					_hx_tmp1 = (int)2147483646;
            				}
            				else {
HXLINE( 612)					_hx_tmp1 = lowerBound;
            				}
HXDLIN( 612)				HX_VARI( Int,NewSeed) = ::Std_obj::_hx_int(_hx_tmp1);
HXDLIN( 612)				HX_VAR_NAME( Float,lowerBound1,"lowerBound");
HXDLIN( 612)				if ((NewSeed < (int)1)) {
HXLINE( 612)					lowerBound1 = (int)1;
            				}
            				else {
HXLINE( 612)					lowerBound1 = NewSeed;
            				}
HXDLIN( 612)				 ::Dynamic _hx_tmp2;
HXDLIN( 612)				if ((lowerBound1 > (int)2147483646)) {
HXLINE( 612)					_hx_tmp2 = (int)2147483646;
            				}
            				else {
HXLINE( 612)					_hx_tmp2 = lowerBound1;
            				}
HXDLIN( 612)				HX_VARI_NAME( Int,NewSeed1,"NewSeed") = ::Std_obj::_hx_int(_hx_tmp2);
HXDLIN( 612)				HX_VAR_NAME( Float,lowerBound2,"lowerBound");
HXDLIN( 612)				if ((NewSeed1 < (int)1)) {
HXLINE( 612)					lowerBound2 = (int)1;
            				}
            				else {
HXLINE( 612)					lowerBound2 = NewSeed1;
            				}
HXDLIN( 612)				 ::Dynamic _hx_tmp3;
HXDLIN( 612)				if ((lowerBound2 > (int)2147483646)) {
HXLINE( 612)					_hx_tmp3 = (int)2147483646;
            				}
            				else {
HXLINE( 612)					_hx_tmp3 = lowerBound2;
            				}
HXDLIN( 612)				Float _hx_tmp4 = (_this->internalSeed = ::Std_obj::_hx_int(_hx_tmp3));
HXDLIN( 612)				Int _hx_tmp5 = ::Std_obj::_hx_int(_hx_tmp4);
HXDLIN( 612)				_this->initialSeed = _hx_tmp5;
            			}
            		}
...
HXDLIN( 624)			Float Width = (::flixel::FlxG_obj::width + (int)20);
HXDLIN( 624)			Float Height = (::flixel::FlxG_obj::height + (int)20);
HXDLIN( 624)			_this1->x = (int)-10;
HXDLIN( 624)			_this1->y = (int)-10;
HXDLIN( 624)			_this1->width = Width;
HXDLIN( 624)			_this1->height = Height;
            		}
...
HXLINE( 638)		Bool _hx_tmp = hx::IsNull( ::flixel::FlxG_obj::mouse );
...
HXLINE( 645)		Bool _hx_tmp1 = hx::IsNotNull( result );
...
HXLINE( 657)		Bool _hx_tmp = (Framerate < ::flixel::FlxG_obj::drawFramerate);
...
HXLINE( 667)		Bool _hx_tmp1 = (::flixel::FlxG_obj::game->_maxAccumulation < ::flixel::FlxG_obj::game->_stepMS);
...
Int FlxG_obj::set_drawFramerate(Int Framerate){
            	...
            	HX_STACK_ARG(Framerate,"Framerate")
HXLINE( 677)		Bool _hx_tmp = (Framerate > ::flixel::FlxG_obj::updateFramerate);
...
HXLINE( 682)		Float _hx_tmp1 = ::Math_obj::abs(Framerate);
HXDLIN( 682)		::flixel::FlxG_obj::drawFramerate = ::Std_obj::_hx_int(_hx_tmp1);
HXLINE( 684)		 ::openfl::_legacy::display::Stage _hx_tmp2 = ::flixel::FlxG_obj::game->get_stage();
HXDLIN( 684)		Bool _hx_tmp3 = hx::IsNotNull( _hx_tmp2 );
HXDLIN( 684)		if (_hx_tmp3) {
HXLINE( 686)			::flixel::FlxG_obj::game->get_stage()->set_frameRate(::flixel::FlxG_obj::drawFramerate);
            		}
HXLINE( 689)		Float _hx_tmp4 = ((Float)(int)2000 / (Float)::flixel::FlxG_obj::drawFramerate);
HXDLIN( 689)		::flixel::FlxG_obj::game->_maxAccumulation = (_hx_tmp4 - (int)1);
HXLINE( 691)		Bool _hx_tmp5 = (::flixel::FlxG_obj::game->_maxAccumulation < ::flixel::FlxG_obj::game->_stepMS);
...
Bool FlxG_obj::get_fullscreen(){
            	HX_STACK_FRAME("flixel.FlxG","get_fullscreen",0xfece4c0b,"flixel.FlxG.get_fullscreen","flixel/FlxG.hx",701,0x8e176836)
HXLINE( 701)		::hx::EnumBase _hx_tmp = ::openfl::_legacy::Lib_obj::get_current()->get_stage()->get_displayState();
HXDLIN( 701)		if (hx::IsNotEq( _hx_tmp,::openfl::_legacy::display::StageDisplayState_obj::FULL_SCREEN_dyn() )) {
HXLINE( 702)			::hx::EnumBase _hx_tmp1 = ::openfl::_legacy::Lib_obj::get_current()->get_stage()->get_displayState();
HXLINE( 701)			return hx::IsEq( _hx_tmp1,::openfl::_legacy::display::StageDisplayState_obj::FULL_SCREEN_INTERACTIVE_dyn() );
            		}
            		else {
...
HXLINE( 707)		::hx::EnumBase _hx_tmp;
HXDLIN( 707)		if (Value) {
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(FlxG_obj,set_fullscreen,return )
 ...
 ::openfl::_legacy::display::Stage FlxG_obj::get_stage(){
            	HX_STACK_FRAME("flixel.FlxG","get_stage",0xb2caaaee,"flixel.FlxG.get_stage","flixel/FlxG.hx",713,0x8e176836)
...
STATIC_HX_DEFINE_DYNAMIC_FUNC0(FlxG_obj,get_stage,return )
 ...
 ::flixel::FlxState FlxG_obj::get_state(){
            	HX_STACK_FRAME("flixel.FlxG","get_state",0xb2cab641,"flixel.FlxG.get_state","flixel/FlxG.hx",718,0x8e176836)
...
{
{
            	HX_STACK_FRAME("flixel.FlxG","boot",0x0ca22ef9,"flixel.FlxG.boot","flixel/FlxG.hx",70,0x8e176836)
HXLINE(  70)		autoPause = true;
            	}
{
            	HX_STACK_FRAME("flixel.FlxG","boot",0x0ca22ef9,"flixel.FlxG.boot","flixel/FlxG.hx",75,0x8e176836)
HXLINE(  75)		fixedTimestep = true;
            	}
{
            	HX_STACK_FRAME("flixel.FlxG","boot",0x0ca22ef9,"flixel.FlxG.boot","flixel/FlxG.hx",79,0x8e176836)
HXLINE(  79)		timeScale = ((Float)1);
            	}
{
            	HX_STACK_FRAME("flixel.FlxG","boot",0x0ca22ef9,"flixel.FlxG.boot","flixel/FlxG.hx",84,0x8e176836)
HXLINE(  84)		worldDivisions = (int)6;
            	}
{
            	HX_STACK_FRAME("flixel.FlxG","boot",0x0ca22ef9,"flixel.FlxG.boot","flixel/FlxG.hx",95,0x8e176836)
HXLINE(  95)		VERSION =  ::flixel::_hx_system::FlxVersion_obj::__new((int)4,(int)2,(int)0);
            	}
{
            	HX_STACK_FRAME("flixel.FlxG","boot",0x0ca22ef9,"flixel.FlxG.boot","flixel/FlxG.hx",139,0x8e176836)
HXLINE( 139)		elapsed = ((Float)0);
            	}
{
            	HX_STACK_FRAME("flixel.FlxG","boot",0x0ca22ef9,"flixel.FlxG.boot","flixel/FlxG.hx",144,0x8e176836)
HXLINE( 144)		maxElapsed = ((Float)0.1);
            	}
{
            	HX_STACK_FRAME("flixel.FlxG","boot",0x0ca22ef9,"flixel.FlxG.boot","flixel/FlxG.hx",159,0x8e176836)
HXLINE( 159)		scaleMode = ( ( ::flixel::_hx_system::scaleModes::BaseScaleMode)( ::flixel::_hx_system::scaleModes::RatioScaleMode_obj::__new(null())) );
            	}
{
            	HX_STACK_FRAME("flixel.FlxG","boot",0x0ca22ef9,"flixel.FlxG.boot","flixel/FlxG.hx",169,0x8e176836)
HXLINE( 169)		Float X = (int)0;
HXDLIN( 169)		Float Y = (int)0;
HXDLIN( 169)		Float Width = (int)0;
HXDLIN( 169)		Float Height = (int)0;
HXDLIN( 169)		HX_VARI(  ::flixel::math::FlxRect,_this) = ::flixel::math::FlxRect_obj::_pool->get();
HXDLIN( 169)		_this->x = X;
HXDLIN( 169)		_this->y = Y;
HXDLIN( 169)		_this->width = Width;
HXDLIN( 169)		_this->height = Height;
HXDLIN( 169)		_this->_inPool = false;
HXDLIN( 169)		worldBounds = _this;
            	}
{
            	HX_STACK_FRAME("flixel.FlxG","boot",0x0ca22ef9,"flixel.FlxG.boot","flixel/FlxG.hx",175,0x8e176836)
HXLINE( 175)		save =  ::flixel::util::FlxSave_obj::__new();
            	}
{
            	HX_STACK_FRAME("flixel.FlxG","boot",0x0ca22ef9,"flixel.FlxG.boot","flixel/FlxG.hx",180,0x8e176836)
HXLINE( 180)		random =  ::flixel::math::FlxRandom_obj::__new(null());
            	}
{
            	HX_STACK_FRAME("flixel.FlxG","boot",0x0ca22ef9,"flixel.FlxG.boot","flixel/FlxG.hx",201,0x8e176836)
HXLINE( 201)		swipes = ::Array_obj< ::Dynamic>::__new(0);
            	}
{
            	HX_STACK_FRAME("flixel.FlxG","boot",0x0ca22ef9,"flixel.FlxG.boot","flixel/FlxG.hx",243,0x8e176836)
HXLINE( 243)		inputs =  ::flixel::_hx_system::frontEnds::InputFrontEnd_obj::__new();
            	}
{
            	HX_STACK_FRAME("flixel.FlxG","boot",0x0ca22ef9,"flixel.FlxG.boot","flixel/FlxG.hx",247,0x8e176836)
HXLINE( 247)		console =  ::flixel::_hx_system::frontEnds::ConsoleFrontEnd_obj::__new();
            	}
{
            	HX_STACK_FRAME("flixel.FlxG","boot",0x0ca22ef9,"flixel.FlxG.boot","flixel/FlxG.hx",251,0x8e176836)
HXLINE( 251)		log =  ::flixel::_hx_system::frontEnds::LogFrontEnd_obj::__new();
            	}
{
            	HX_STACK_FRAME("flixel.FlxG","boot",0x0ca22ef9,"flixel.FlxG.boot","flixel/FlxG.hx",255,0x8e176836)
HXLINE( 255)		bitmapLog =  ::flixel::_hx_system::frontEnds::BitmapLogFrontEnd_obj::__new();
            	}
{
            	HX_STACK_FRAME("flixel.FlxG","boot",0x0ca22ef9,"flixel.FlxG.boot","flixel/FlxG.hx",259,0x8e176836)
HXLINE( 259)		watch =  ::flixel::_hx_system::frontEnds::WatchFrontEnd_obj::__new();
            	}
{
            	HX_STACK_FRAME("flixel.FlxG","boot",0x0ca22ef9,"flixel.FlxG.boot","flixel/FlxG.hx",264,0x8e176836)
HXLINE( 264)		debugger =  ::flixel::_hx_system::frontEnds::DebuggerFrontEnd_obj::__new();
            	}
{
            	HX_STACK_FRAME("flixel.FlxG","boot",0x0ca22ef9,"flixel.FlxG.boot","flixel/FlxG.hx",274,0x8e176836)
HXLINE( 274)		bitmap =  ::flixel::_hx_system::frontEnds::BitmapFrontEnd_obj::__new();
            	}
{
            	HX_STACK_FRAME("flixel.FlxG","boot",0x0ca22ef9,"flixel.FlxG.boot","flixel/FlxG.hx",278,0x8e176836)
HXLINE( 278)		cameras =  ::flixel::_hx_system::frontEnds::CameraFrontEnd_obj::__new();
            	}
{
            	HX_STACK_FRAME("flixel.FlxG","boot",0x0ca22ef9,"flixel.FlxG.boot","flixel/FlxG.hx",284,0x8e176836)
HXLINE( 284)		initialWidth = (int)0;
            	}
{
            	HX_STACK_FRAME("flixel.FlxG","boot",0x0ca22ef9,"flixel.FlxG.boot","flixel/FlxG.hx",285,0x8e176836)
HXLINE( 285)		initialHeight = (int)0;
            	}
{
            	HX_STACK_FRAME("flixel.FlxG","boot",0x0ca22ef9,"flixel.FlxG.boot","flixel/FlxG.hx",286,0x8e176836)
HXLINE( 286)		initialZoom = ((Float)0);
            	}
{
            	HX_STACK_FRAME("flixel.FlxG","boot",0x0ca22ef9,"flixel.FlxG.boot","flixel/FlxG.hx",298,0x8e176836)
HXLINE( 298)		signals =  ::flixel::_hx_system::frontEnds::SignalFrontEnd_obj::__new();
            	}
}
