...
static void IFlxParticle_obj_sMarkStatics(HX_MARK_PARAMS) {
	HX_MARK_MEMBER_NAME(IFlxParticle_obj::__mClass,"__mClass");
};

#ifdef HXCPP_VISIT_ALLOCS
static void IFlxParticle_obj_sVisitStatics(HX_VISIT_PARAMS) {
...
void IFlxParticle_obj::__register()
{
	...
	__mClass->mMarkFunc = IFlxParticle_obj_sMarkStatics;
...
#ifdef HXCPP_VISIT_ALLOCS
	__mClass->mVisitFunc = IFlxParticle_obj_sVisitStatics;
#endif
