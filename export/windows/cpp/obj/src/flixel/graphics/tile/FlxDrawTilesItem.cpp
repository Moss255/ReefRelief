...
Int FlxDrawTilesItem_obj::get_numTiles(){
            	HX_STACK_FRAME("flixel.graphics.tile.FlxDrawTilesItem","get_numTiles",0xd57429e5,"flixel.graphics.tile.FlxDrawTilesItem.get_numTiles","flixel/graphics/tile/FlxDrawTilesItem.hx",109,0xdffe6dcc)
            	HX_STACK_THIS(this)
HXLINE( 110)		HX_VARI( Int,elementsPerTile) = (int)8;
HXLINE( 111)		if (this->colored) {
HXLINE( 112)			elementsPerTile = (int)11;
            		}
HXLINE( 118)		Float _hx_tmp = ((Float)this->position / (Float)elementsPerTile);
HXDLIN( 118)		return ::Std_obj::_hx_int(_hx_tmp);
            	}
...
Int FlxDrawTilesItem_obj::get_numVertices(){
            	HX_STACK_FRAME("flixel.graphics.tile.FlxDrawTilesItem","get_numVertices",0x8b0e8f99,"flixel.graphics.tile.FlxDrawTilesItem.get_numVertices","flixel/graphics/tile/FlxDrawTilesItem.hx",123,0xdffe6dcc)
            	HX_STACK_THIS(this)
HXLINE( 123)		Int _hx_tmp = this->get_numTiles();
HXDLIN( 123)		return ((int)4 * _hx_tmp);
            	}


Int FlxDrawTilesItem_obj::get_numTriangles(){
            	HX_STACK_FRAME("flixel.graphics.tile.FlxDrawTilesItem","get_numTriangles",0x37fe0d0b,"flixel.graphics.tile.FlxDrawTilesItem.get_numTriangles","flixel/graphics/tile/FlxDrawTilesItem.hx",128,0xdffe6dcc)
            	HX_STACK_THIS(this)
HXLINE( 128)		Int _hx_tmp = this->get_numTiles();
HXDLIN( 128)		return ((int)2 * _hx_tmp);
            	}
