...
HXDLIN(  57)		Bool _hx_tmp1 = hx::IsNull( border );
...
HXLINE(  59)		this->framesHash =  ::haxe::ds::StringMap_obj::__new();
HXLINE(  61)		Bool _hx_tmp2 = hx::IsNotNull( parent );
...
void *FlxFramesCollection_obj::_hx_getInterface(int inHash) {
 ...
 ::flixel::graphics::frames::FlxFrame FlxFramesCollection_obj::getByName(::String name){
            	HX_STACK_FRAME("flixel.graphics.frames.FlxFramesCollection","getByName",0xec0f52c9,"flixel.graphics.frames.FlxFramesCollection.getByName","flixel/graphics/frames/FlxFramesCollection.hx",75,0xe09dd200)
            	HX_STACK_THIS(this)
...
HX_DEFINE_DYNAMIC_FUNC1(FlxFramesCollection_obj,getByName,return )
 ...
 ::flixel::graphics::frames::FlxFrame FlxFramesCollection_obj::getByIndex(Int index){
            	HX_STACK_FRAME("flixel.graphics.frames.FlxFramesCollection","getByIndex",0xc8e928d4,"flixel.graphics.frames.FlxFramesCollection.getByIndex","flixel/graphics/frames/FlxFramesCollection.hx",86,0xe09dd200)
            	HX_STACK_THIS(this)
...
HXLINE( 137)		HX_VARI(  ::flixel::graphics::frames::FlxFrame,frame) =  ::flixel::graphics::frames::FlxFrame_obj::__new(this->parent,null(),null(),null());
HXLINE( 138)		frame->type = (int)2;
HXLINE( 139)		Float X = (int)0;
HXDLIN( 139)		Float Y = (int)0;
HXDLIN( 139)		Float Width = (int)0;
HXDLIN( 139)		Float Height = (int)0;
HXDLIN( 139)		HX_VARI(  ::flixel::math::FlxRect,_this) = ::flixel::math::FlxRect_obj::_pool->get();
HXDLIN( 139)		_this->x = X;
HXDLIN( 139)		_this->y = Y;
HXDLIN( 139)		_this->width = Width;
HXDLIN( 139)		_this->height = Height;
...
HXLINE( 153)		HX_VARI(  ::flixel::graphics::frames::FlxFrame,frame) =  ::flixel::graphics::frames::FlxFrame_obj::__new(this->parent,null(),null(),null());
HXLINE( 154)		 ::flixel::math::FlxRect _hx_tmp = this->checkFrame(region,null());
HXDLIN( 154)		frame->set_frame(_hx_tmp);
...
HXDLIN( 173)		Bool _hx_tmp1 = hx::IsNotNull( name );
...
HXLINE( 178)		HX_VARI(  ::flixel::graphics::frames::FlxFrame,texFrame) =  ::flixel::graphics::frames::FlxFrame_obj::__new(this->parent,angle,flipX,flipY);
...
HXLINE( 182)		 ::flixel::math::FlxRect _hx_tmp2 = this->checkFrame(frame,name);
HXDLIN( 182)		texFrame->set_frame(_hx_tmp2);
...
HXDLIN( 198)		Bool _hx_tmp1 = hx::IsNotNull( Max );
HXDLIN( 198)		if (_hx_tmp1) {
HXLINE( 198)			_hx_tmp = hx::IsGreater( lowerBound,Max );
            		}
            		else {
...
HXDLIN( 199)		Bool _hx_tmp3 = hx::IsNotNull( Max1 );
HXDLIN( 199)		if (_hx_tmp3) {
HXLINE( 199)			_hx_tmp2 = hx::IsGreater( lowerBound1,Max1 );
            		}
            		else {
...
HXDLIN( 201)		Bool _hx_tmp5 = hx::IsNotNull( Max2 );
HXDLIN( 201)		if (_hx_tmp5) {
HXLINE( 201)			_hx_tmp4 = hx::IsGreater( lowerBound2,Max2 );
            		}
            		else {
...
HXDLIN( 202)		Bool _hx_tmp7 = hx::IsNotNull( Max3 );
HXDLIN( 202)		if (_hx_tmp7) {
HXLINE( 202)			_hx_tmp6 = hx::IsGreater( lowerBound3,Max3 );
            		}
            		else {
HXLINE( 202)			_hx_tmp6 = false;
            		}
...
HXLINE( 206)		Bool _hx_tmp8;
HXDLIN( 206)		if (!((frame->width <= (int)0))) {
HXLINE( 206)			_hx_tmp8 = (frame->height <= (int)0);
            		}
            		else {
HXLINE( 206)			_hx_tmp8 = true;
            		}
...
HXDLIN( 221)		Bool _hx_tmp1 = hx::IsNotNull( name );
...
HXLINE( 229)		Bool _hx_tmp2 = hx::IsNotNull( name );
...
HX_DEFINE_DYNAMIC_FUNC1(FlxFramesCollection_obj,pushFrame,return )
 ...
 ::flixel::graphics::frames::FlxFramesCollection FlxFramesCollection_obj::addBorder( ::flixel::math::FlxPoint border){
            	HX_STACK_FRAME("flixel.graphics.frames.FlxFramesCollection","addBorder",0x7da91fbe,"flixel.graphics.frames.FlxFramesCollection.addBorder","flixel/graphics/frames/FlxFramesCollection.hx",245,0xe09dd200)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(border,"border")
...
::String FlxFramesCollection_obj::toString(){
            	HX_STACK_FRAME("flixel.graphics.frames.FlxFramesCollection","toString",0xfe5297fb,"flixel.graphics.frames.FlxFramesCollection.toString","flixel/graphics/frames/FlxFramesCollection.hx",251,0xe09dd200)
            	HX_STACK_THIS(this)
HXLINE( 252)		HX_VARI(  ::flixel::util::LabelValuePair,_this) = ::flixel::util::LabelValuePair_obj::_pool->get();
HXDLIN( 252)		_this->label = HX_("frames",a6,af,85,ac);
HXDLIN( 252)		_this->value = this->frames;
HXLINE( 253)		HX_VARI_NAME(  ::flixel::util::LabelValuePair,_this1,"_this") = ::flixel::util::LabelValuePair_obj::_pool->get();
HXDLIN( 253)		_this1->label = HX_("type",ba,f2,08,4d);
HXDLIN( 253)		_this1->value = this->type;
...
Int FlxFramesCollection_obj::get_numFrames(){
            	HX_STACK_FRAME("flixel.graphics.frames.FlxFramesCollection","get_numFrames",0xbd2728b4,"flixel.graphics.frames.FlxFramesCollection.get_numFrames","flixel/graphics/frames/FlxFramesCollection.hx",258,0xe09dd200)
            	HX_STACK_THIS(this)
