...
HXLINE( 475)				HX_VARI( ::hx::EnumBase,collectionType) = _g1->__get(_g).StaticCast< ::hx::EnumBase >();
HXDLIN( 475)				++_g;
HXLINE( 477)				collections = ( (::cpp::VirtualArray)(this->frameCollections->get(collectionType)) );
...
void FlxGraphic_obj::addFrameCollection( ::flixel::graphics::frames::FlxFramesCollection collection){
            	HX_STACK_FRAME("flixel.graphics.FlxGraphic","addFrameCollection",0x06dd03b1,"flixel.graphics.FlxGraphic.addFrameCollection","flixel/graphics/FlxGraphic.hx",492,0xb3633517)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(collection,"collection")
HXLINE( 492)		Bool _hx_tmp = hx::IsNotNull( collection->type );
HXDLIN( 492)		if (_hx_tmp) {
HXLINE( 494)			HX_VARI( ::hx::EnumBase,type) = collection->type;
HXDLIN( 494)			HX_VARI( ::cpp::VirtualArray,collections) = ( (::cpp::VirtualArray)(this->frameCollections->get(type)) );
HXDLIN( 494)			Bool _hx_tmp1 = hx::IsNull( collections );
HXDLIN( 494)			if (_hx_tmp1) {
HXLINE( 494)				collections = ::Array_obj< ::Dynamic>::__new();
HXDLIN( 494)				this->frameCollections->set(type,collections);
            			}
...
HXLINE( 508)		Bool _hx_tmp = hx::IsNull( collections );
...
HXLINE( 525)		HX_VARI(  ::flixel::graphics::frames::FlxFrame,frame) =  ::flixel::graphics::frames::FlxFrame_obj::__new(hx::ObjectPtr<OBJ_>(this),null(),null(),null());
HXLINE( 526)		frame->type = (int)2;
HXLINE( 527)		Float X = (int)0;
HXDLIN( 527)		Float Y = (int)0;
HXDLIN( 527)		Float Width = (int)0;
HXDLIN( 527)		Float Height = (int)0;
HXDLIN( 527)		HX_VARI(  ::flixel::math::FlxRect,_this) = ::flixel::math::FlxRect_obj::_pool->get();
...
HXDLIN( 528)			Bool _hx_tmp = size->_weak;
...
HX_DEFINE_DYNAMIC_FUNC1(FlxGraphic_obj,getEmptyFrame,return )
 ...
 ::openfl::_legacy::display::Tilesheet FlxGraphic_obj::get_tilesheet(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 537)		Bool _hx_tmp = hx::IsNull( this->_tilesheet );
HXDLIN( 537)		if (_hx_tmp) {
HXLINE( 539)			HX_VARI( Bool,dumped) = this->isDumped;
HXLINE( 541)			if (dumped) {
HXLINE( 542)				this->undump();
            			}
HXLINE( 544)			this->_tilesheet =  ::openfl::_legacy::display::Tilesheet_obj::__new(this->bitmap);
...
HXLINE( 560)		Bool _hx_tmp = hx::IsNotNull( this->assetsClass );
HXDLIN( 560)		if (_hx_tmp) {
HXLINE( 562)			hx::Class source = this->assetsClass;
HXDLIN( 562)			newBitmap = ( ( ::openfl::_legacy::display::BitmapData)(::Type_obj::createInstance(source,::cpp::VirtualArray_obj::__new(2)->init(0,(int)0)->init(1,(int)0))) );
            		}
            		else {
HXLINE( 564)			Bool _hx_tmp1 = hx::IsNotNull( this->assetsKey );
HXDLIN( 564)			if (_hx_tmp1) {
HXLINE( 566)				HX_VARI( ::String,id) = this->assetsKey;
HXDLIN( 566)				Bool _hx_tmp2 = ::openfl::_legacy::Assets_obj::exists(id,null());
...
HXLINE( 569)		Bool _hx_tmp3 = hx::IsNotNull( newBitmap );
HXDLIN( 569)		if (_hx_tmp3) {
HXLINE( 571)			Bool Unique = this->unique;
HXDLIN( 571)			if (Unique) {
...
Bool FlxGraphic_obj::get_canBeDumped(){
            	HX_STACK_FRAME("flixel.graphics.FlxGraphic","get_canBeDumped",0x9b8a5e36,"flixel.graphics.FlxGraphic.get_canBeDumped","flixel/graphics/FlxGraphic.hx",579,0xb3633517)
            	HX_STACK_THIS(this)
HXLINE( 579)		Bool _hx_tmp = hx::IsNull( this->assetsClass );
...
Int FlxGraphic_obj::get_useCount(){
            	HX_STACK_FRAME("flixel.graphics.FlxGraphic","get_useCount",0x2bcc1fb8,"flixel.graphics.FlxGraphic.get_useCount","flixel/graphics/FlxGraphic.hx",584,0xb3633517)
            	HX_STACK_THIS(this)
...
Bool FlxGraphic_obj::get_destroyOnNoUse(){
            	HX_STACK_FRAME("flixel.graphics.FlxGraphic","get_destroyOnNoUse",0x7e860bbd,"flixel.graphics.FlxGraphic.get_destroyOnNoUse","flixel/graphics/FlxGraphic.hx",599,0xb3633517)
            	HX_STACK_THIS(this)
...
HX_DEFINE_DYNAMIC_FUNC1(FlxGraphic_obj,set_destroyOnNoUse,return )
 ...
 ::flixel::graphics::frames::FlxImageFrame FlxGraphic_obj::get_imageFrame(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 614)		Bool _hx_tmp = hx::IsNull( this->_imageFrame );
...
HX_DEFINE_DYNAMIC_FUNC0(FlxGraphic_obj,get_imageFrame,return )
 ...
 ::flixel::graphics::frames::FlxAtlasFrames FlxGraphic_obj::get_atlasFrames(){
            	HX_STACK_FRAME("flixel.graphics.FlxGraphic","get_atlasFrames",0x774c10a1,"flixel.graphics.FlxGraphic.get_atlasFrames","flixel/graphics/FlxGraphic.hx",624,0xb3633517)
            	HX_STACK_THIS(this)
...
HX_DEFINE_DYNAMIC_FUNC0(FlxGraphic_obj,get_atlasFrames,return )
 ...
 ::openfl::_legacy::display::BitmapData FlxGraphic_obj::set_bitmap( ::openfl::_legacy::display::BitmapData value){
            	...
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(value,"value")
HXLINE( 629)		Bool _hx_tmp = hx::IsNotNull( value );
...
HXLINE( 635)				_hx_tmp1 = hx::IsNotNull( this->_tilesheet );
            			}
            			else {
HXLINE( 635)				_hx_tmp1 = false;
            			}
HXDLIN( 635)			if (_hx_tmp1) {
HXLINE( 636)				this->_tilesheet =  ::openfl::_legacy::display::Tilesheet_obj::__new(this->bitmap);
            			}
            		}
...
HXLINE(  52)		HX_VARI(  ::flixel::graphics::FlxGraphic,graphic) = ::flixel::FlxG_obj::bitmap->_cache->get(key).StaticCast<  ::flixel::graphics::FlxGraphic >();
...
HXLINE(  89)		HX_VARI(  ::flixel::graphics::FlxGraphic,graphic) = ::flixel::FlxG_obj::bitmap->_cache->get(key).StaticCast<  ::flixel::graphics::FlxGraphic >();
...
HXLINE( 124)			graphic = ::flixel::FlxG_obj::bitmap->_cache->get(key).StaticCast<  ::flixel::graphics::FlxGraphic >();
...
HXLINE( 130)		graphic = ::flixel::FlxG_obj::bitmap->_cache->get(key).StaticCast<  ::flixel::graphics::FlxGraphic >();
...
HXLINE( 161)		HX_VARI(  ::flixel::graphics::FlxGraphic,graphic) = ::flixel::FlxG_obj::bitmap->_cache->get(key).StaticCast<  ::flixel::graphics::FlxGraphic >();
...
HXLINE( 210)		::flixel::FlxG_obj::bitmap->_cache->set(graphic->key,graphic);
...
HXLINE( 228)		HX_VARI(  ::flixel::graphics::FlxGraphic,graphic) = ::flixel::FlxG_obj::bitmap->_cache->get(key).StaticCast<  ::flixel::graphics::FlxGraphic >();
...
HXLINE( 269)			::flixel::FlxG_obj::bitmap->_cache->set(graphic->key,graphic);
            		}
            		else {
