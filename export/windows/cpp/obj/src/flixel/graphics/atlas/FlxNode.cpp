...
Bool rotated = __o_rotated.Default(false);
            	HX_STACK_FRAME("flixel.graphics.atlas.FlxNode","new",0xeedfd332,"flixel.graphics.atlas.FlxNode.new","flixel/graphics/atlas/FlxNode.hx",75,0x6d18bb9f)
            	HX_STACK_THIS(this)
...
void FlxNode_obj::destroy(){
            	HX_STACK_FRAME("flixel.graphics.atlas.FlxNode","destroy",0x006100cc,"flixel.graphics.atlas.FlxNode.destroy","flixel/graphics/atlas/FlxNode.hx",86,0x6d18bb9f)
            	HX_STACK_THIS(this)
...
HX_DEFINE_DYNAMIC_FUNC2(FlxNode_obj,canPlace,return )
 ...
 ::flixel::graphics::frames::FlxTileFrames FlxNode_obj::getTileFrames( ::flixel::math::FlxPoint tileSize, ::flixel::math::FlxPoint tileSpacing, ::flixel::math::FlxPoint tileBorder){
            	HX_STACK_FRAME("flixel.graphics.atlas.FlxNode","getTileFrames",0xf6655efc,"flixel.graphics.atlas.FlxNode.getTileFrames","flixel/graphics/atlas/FlxNode.hx",110,0x6d18bb9f)
            	HX_STACK_THIS(this)
...
HXDLIN( 112)		HX_VARI(  ::flixel::graphics::frames::FlxFrame,frame) = _this->framesHash->get(this->key).StaticCast<  ::flixel::graphics::frames::FlxFrame >();
HXLINE( 114)		Bool _hx_tmp = hx::IsNotNull( frame );
...
HXLINE( 117)			Bool _hx_tmp1 = hx::IsNotNull( tileBorder );
...
HX_DEFINE_DYNAMIC_FUNC3(FlxNode_obj,getTileFrames,return )
 ...
 ::flixel::graphics::frames::FlxImageFrame FlxNode_obj::getImageFrame(){
            	HX_STACK_FRAME("flixel.graphics.atlas.FlxNode","getImageFrame",0xf79a185a,"flixel.graphics.atlas.FlxNode.getImageFrame","flixel/graphics/atlas/FlxNode.hx",132,0x6d18bb9f)
            	HX_STACK_THIS(this)
...
HXDLIN( 134)		HX_VARI(  ::flixel::graphics::frames::FlxFrame,frame) = _this->framesHash->get(this->key).StaticCast<  ::flixel::graphics::frames::FlxFrame >();
HXLINE( 136)		Bool _hx_tmp = hx::IsNotNull( frame );
...
Int FlxNode_obj::set_width(Int value){
            	HX_STACK_FRAME("flixel.graphics.atlas.FlxNode","set_width",0x9871eabb,"flixel.graphics.atlas.FlxNode.set_width","flixel/graphics/atlas/FlxNode.hx",165,0x6d18bb9f)
            	HX_STACK_THIS(this)
...
Int FlxNode_obj::set_height(Int value){
            	HX_STACK_FRAME("flixel.graphics.atlas.FlxNode","set_height",0x818af192,"flixel.graphics.atlas.FlxNode.set_height","flixel/graphics/atlas/FlxNode.hx",176,0x6d18bb9f)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(value,"value")
