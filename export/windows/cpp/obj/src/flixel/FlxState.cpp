...
void FlxState_obj::create(){
            	HX_STACK_FRAME("flixel.FlxState","create",0x1148b519,"flixel.FlxState.create","flixel/FlxState.hx",56,0xdf96844c)
            	HX_STACK_THIS(this)
            	}
...
void FlxState_obj::draw(){
            	HX_STACK_FRAME("flixel.FlxState","draw",0x1022c8e1,"flixel.FlxState.draw","flixel/FlxState.hx",59,0xdf96844c)
            	HX_STACK_THIS(this)
...
HXLINE(  65)		Bool _hx_tmp1 = hx::IsNotNull( this->subState );
...
void FlxState_obj::openSubState( ::flixel::FlxSubState SubState){
            	HX_STACK_FRAME("flixel.FlxState","openSubState",0x3d5ea838,"flixel.FlxState.openSubState","flixel/FlxState.hx",72,0xdf96844c)
            	HX_STACK_THIS(this)
...
void FlxState_obj::closeSubState(){
            	HX_STACK_FRAME("flixel.FlxState","closeSubState",0x519577cc,"flixel.FlxState.closeSubState","flixel/FlxState.hx",82,0xdf96844c)
            	HX_STACK_THIS(this)
...
void FlxState_obj::resetSubState(){
            	HX_STACK_FRAME("flixel.FlxState","resetSubState",0x772d18e3,"flixel.FlxState.resetSubState","flixel/FlxState.hx",89,0xdf96844c)
            	HX_STACK_THIS(this)
HXLINE(  91)		Bool _hx_tmp = hx::IsNotNull( this->subState );
HXDLIN(  91)		if (_hx_tmp) {
HXLINE(  93)			Bool _hx_tmp1 = hx::IsNotNull( this->subState->closeCallback );
HXDLIN(  93)			if (_hx_tmp1) {
HXLINE(  95)				this->subState->closeCallback();
            			}
HXLINE(  97)			Bool _hx_tmp2 = this->destroySubStates;
...
HXLINE( 107)		Bool _hx_tmp3 = hx::IsNotNull( this->subState );
HXDLIN( 107)		if (_hx_tmp3) {
HXLINE( 110)			Bool _hx_tmp4 = !(this->persistentUpdate);
...
void FlxState_obj::destroy(){
            	HX_STACK_FRAME("flixel.FlxState","destroy",0x2171383d,"flixel.FlxState.destroy","flixel/FlxState.hx",126,0xdf96844c)
            	HX_STACK_THIS(this)
HXLINE( 127)		Bool _hx_tmp = hx::IsNotNull( this->subState );
...
Bool FlxState_obj::switchTo( ::flixel::FlxState nextState){
            	HX_STACK_FRAME("flixel.FlxState","switchTo",0x5e95c7ec,"flixel.FlxState.switchTo","flixel/FlxState.hx",143,0xdf96844c)
            	HX_STACK_THIS(this)
...
void FlxState_obj::onFocusLost(){
            	HX_STACK_FRAME("flixel.FlxState","onFocusLost",0x8c2b4d80,"flixel.FlxState.onFocusLost","flixel/FlxState.hx",150,0xdf96844c)
            	HX_STACK_THIS(this)
            	}
...
void FlxState_obj::onFocus(){
            	HX_STACK_FRAME("flixel.FlxState","onFocus",0x97b2097c,"flixel.FlxState.onFocus","flixel/FlxState.hx",156,0xdf96844c)
            	HX_STACK_THIS(this)
            	}
...
void FlxState_obj::onResize(Int Width,Int Height){
            	HX_STACK_FRAME("flixel.FlxState","onResize",0x38e71fd0,"flixel.FlxState.onResize","flixel/FlxState.hx",164,0xdf96844c)
            	HX_STACK_THIS(this)
...
void FlxState_obj::tryUpdate(Float elapsed){
            	HX_STACK_FRAME("flixel.FlxState","tryUpdate",0xc75023a7,"flixel.FlxState.tryUpdate","flixel/FlxState.hx",168,0xdf96844c)
            	HX_STACK_THIS(this)
