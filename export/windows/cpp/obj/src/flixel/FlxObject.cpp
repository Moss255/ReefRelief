...
HXLINE( 583)		Float X1 = (int)0;
HXDLIN( 583)		Float Y1 = (int)0;
HXDLIN( 583)		Float Width1 = (int)0;
HXDLIN( 583)		Float Height1 = (int)0;
HXDLIN( 583)		HX_VARI(  ::flixel::math::FlxRect,_this) = ::flixel::math::FlxRect_obj::_pool->get();
HXDLIN( 583)		_this->x = X1;
HXDLIN( 583)		_this->y = Y1;
HXDLIN( 583)		_this->width = Width1;
HXDLIN( 583)		_this->height = Height1;
...
HXDLIN( 661)		Bool _hx_tmp1 = hx::IsNotNull( this->path );
...
HXLINE( 664)		Bool _hx_tmp2 = this->moves;
...
HXLINE( 679)		hx::AddEq(this->angularVelocity,velocityDelta);
HXLINE( 680)		{
HXLINE( 680)			HX_VARI(  ::flixel::FlxObject,_g) = hx::ObjectPtr<OBJ_>(this);
HXDLIN( 680)			Float _hx_tmp = (_g->angle + (this->angularVelocity * elapsed));
HXDLIN( 680)			_g->set_angle(_hx_tmp);
            		}
HXLINE( 681)		hx::AddEq(this->angularVelocity,velocityDelta);
...
HXDLIN( 684)			Float _hx_tmp1 = (_g1->x + velocityDelta);
HXDLIN( 684)			_g1->set_x(_hx_tmp1);
            		}
HXLINE( 685)		HX_VARI( Float,delta) = (this->velocity->x * elapsed);
HXLINE( 686)		{
HXLINE( 686)			HX_VARI_NAME(  ::flixel::math::FlxPoint,_g2,"_g") = this->velocity;
HXDLIN( 686)			Float _hx_tmp2 = (_g2->x + velocityDelta);
HXDLIN( 686)			_g2->set_x(_hx_tmp2);
            		}
HXLINE( 687)		{
HXLINE( 687)			HX_VARI_NAME(  ::flixel::FlxObject,_g3,"_g") = hx::ObjectPtr<OBJ_>(this);
HXDLIN( 687)			Float _hx_tmp3 = (_g3->x + delta);
HXDLIN( 687)			_g3->set_x(_hx_tmp3);
            		}
...
HXDLIN( 690)			Float _hx_tmp4 = (_g4->y + velocityDelta);
HXDLIN( 690)			_g4->set_y(_hx_tmp4);
            		}
HXLINE( 691)		delta = (this->velocity->y * elapsed);
HXLINE( 692)		{
HXLINE( 692)			HX_VARI_NAME(  ::flixel::math::FlxPoint,_g5,"_g") = this->velocity;
HXDLIN( 692)			Float _hx_tmp5 = (_g5->y + velocityDelta);
HXDLIN( 692)			_g5->set_y(_hx_tmp5);
            		}
HXLINE( 693)		{
HXLINE( 693)			HX_VARI_NAME(  ::flixel::FlxObject,_g6,"_g") = hx::ObjectPtr<OBJ_>(this);
HXDLIN( 693)			Float _hx_tmp6 = (_g6->y + delta);
HXDLIN( 693)			_g6->set_y(_hx_tmp6);
            		}
            	}
...
HXLINE( 703)		Bool _hx_tmp = ::flixel::FlxG_obj::debugger->drawDebug;
...
HXLINE( 721)		Bool _hx_tmp = hx::IsNotNull( group );
...
HXLINE( 726)		Bool _hx_tmp1 = (ObjectOrGroup->flixelType == (int)3);
...
HXDLIN( 737)			Float _hx_tmp4 = object->x;
HXDLIN( 737)			Float _hx_tmp5 = object->get_width();
HXDLIN( 737)			Bool _hx_tmp6 = ((_hx_tmp4 + _hx_tmp5) > this->x);
HXDLIN( 737)			if (_hx_tmp6) {
HXLINE( 737)				Float _hx_tmp7 = object->x;
HXDLIN( 737)				Float _hx_tmp8 = this->x;
HXDLIN( 737)				Float _hx_tmp9 = this->get_width();
HXDLIN( 737)				_hx_tmp3 = (_hx_tmp7 < (_hx_tmp8 + _hx_tmp9));
            			}
            			else {
HXLINE( 737)				_hx_tmp3 = false;
            			}
HXDLIN( 737)			if (_hx_tmp3) {
HXLINE( 738)				Float _hx_tmp10 = object->y;
HXDLIN( 738)				Float _hx_tmp11 = object->get_height();
HXLINE( 737)				_hx_tmp2 = ((_hx_tmp10 + _hx_tmp11) > this->y);
            			}
            			else {
HXLINE( 737)				_hx_tmp2 = false;
            			}
HXDLIN( 737)			if (_hx_tmp2) {
HXLINE( 738)				Float _hx_tmp12 = object->y;
HXDLIN( 738)				Float _hx_tmp13 = this->y;
HXDLIN( 738)				Float _hx_tmp14 = this->get_height();
HXLINE( 737)				return (_hx_tmp12 < (_hx_tmp13 + _hx_tmp14));
            			}
            			else {
HXLINE( 737)				return false;
            			}
            		}
HXLINE( 741)		Bool _hx_tmp15 = hx::IsNull( Camera );
...
HXLINE( 747)		Bool _hx_tmp16;
HXDLIN( 747)		Bool _hx_tmp17;
HXDLIN( 747)		Float _hx_tmp18 = objectScreenPos->x;
HXDLIN( 747)		Float _hx_tmp19 = object->get_width();
HXDLIN( 747)		Bool _hx_tmp20 = ((_hx_tmp18 + _hx_tmp19) > this->_point->x);
HXDLIN( 747)		if (_hx_tmp20) {
HXLINE( 747)			Float _hx_tmp21 = objectScreenPos->x;
HXDLIN( 747)			Float _hx_tmp22 = this->_point->x;
HXDLIN( 747)			Float _hx_tmp23 = this->get_width();
HXDLIN( 747)			_hx_tmp17 = (_hx_tmp21 < (_hx_tmp22 + _hx_tmp23));
            		}
            		else {
HXLINE( 747)			_hx_tmp17 = false;
            		}
HXDLIN( 747)		if (_hx_tmp17) {
HXLINE( 748)			Float _hx_tmp24 = objectScreenPos->y;
HXDLIN( 748)			Float _hx_tmp25 = object->get_height();
HXLINE( 747)			_hx_tmp16 = ((_hx_tmp24 + _hx_tmp25) > this->_point->y);
            		}
            		else {
HXLINE( 747)			_hx_tmp16 = false;
            		}
HXDLIN( 747)		if (_hx_tmp16) {
HXLINE( 748)			Float _hx_tmp26 = objectScreenPos->y;
HXDLIN( 748)			Float _hx_tmp27 = this->_point->y;
HXDLIN( 748)			Float _hx_tmp28 = this->get_height();
HXLINE( 747)			return (_hx_tmp26 < (_hx_tmp27 + _hx_tmp28));
            		}
            		else {
...
Bool FlxObject_obj::overlapsCallback( ::flixel::FlxBasic ObjectOrGroup,Float X,Float Y,Bool InScreenSpace, ::flixel::FlxCamera Camera){
            	HX_STACK_FRAME("flixel.FlxObject","overlapsCallback",0xe4196e20,"flixel.FlxObject.overlapsCallback","flixel/FlxObject.hx",754,0xf0fe0d80)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(ObjectOrGroup,"ObjectOrGroup")
            	HX_STACK_ARG(X,"X")
            	HX_STACK_ARG(Y,"Y")
...
HXLINE( 772)		Bool _hx_tmp = hx::IsNotNull( group );
...
HXLINE( 777)		Bool _hx_tmp1 = (ObjectOrGroup->flixelType == (int)3);
HXDLIN( 777)		if (_hx_tmp1) {
HXLINE( 783)			HX_VARI(  ::flixel::tile::FlxBaseTilemap,tilemap) = ( ( ::flixel::tile::FlxBaseTilemap)(ObjectOrGroup) );
HXLINE( 784)			Float _hx_tmp2 = (tilemap->x - (X - this->x));
HXDLIN( 784)			Float _hx_tmp3 = (tilemap->y - (Y - this->y));
HXDLIN( 784)			return tilemap->overlapsAt(_hx_tmp2,_hx_tmp3,hx::ObjectPtr<OBJ_>(this),InScreenSpace,Camera);
            		}
...
HXDLIN( 790)			Bool _hx_tmp5;
HXDLIN( 790)			Float _hx_tmp6 = object->x;
HXDLIN( 790)			Float _hx_tmp7 = object->get_width();
HXDLIN( 790)			if (((_hx_tmp6 + _hx_tmp7) > X)) {
HXLINE( 790)				Float _hx_tmp8 = object->x;
HXDLIN( 790)				Float _hx_tmp9 = this->get_width();
HXDLIN( 790)				_hx_tmp5 = (_hx_tmp8 < (X + _hx_tmp9));
            			}
            			else {
HXLINE( 790)				_hx_tmp5 = false;
            			}
HXDLIN( 790)			if (_hx_tmp5) {
HXLINE( 791)				Float _hx_tmp10 = object->y;
HXDLIN( 791)				Float _hx_tmp11 = object->get_height();
HXLINE( 790)				_hx_tmp4 = ((_hx_tmp10 + _hx_tmp11) > Y);
            			}
            			else {
HXLINE( 790)				_hx_tmp4 = false;
            			}
HXDLIN( 790)			if (_hx_tmp4) {
HXLINE( 791)				Float _hx_tmp12 = object->y;
HXDLIN( 791)				Float _hx_tmp13 = this->get_height();
HXLINE( 790)				return (_hx_tmp12 < (Y + _hx_tmp13));
            			}
            			else {
HXLINE( 790)				return false;
            			}
            		}
HXLINE( 794)		Bool _hx_tmp14 = hx::IsNull( Camera );
...
HXLINE( 800)		Bool _hx_tmp15;
HXDLIN( 800)		Bool _hx_tmp16;
HXDLIN( 800)		Float _hx_tmp17 = objectScreenPos->x;
HXDLIN( 800)		Float _hx_tmp18 = object->get_width();
HXDLIN( 800)		Bool _hx_tmp19 = ((_hx_tmp17 + _hx_tmp18) > this->_point->x);
HXDLIN( 800)		if (_hx_tmp19) {
HXLINE( 800)			Float _hx_tmp20 = objectScreenPos->x;
HXDLIN( 800)			Float _hx_tmp21 = this->_point->x;
HXDLIN( 800)			Float _hx_tmp22 = this->get_width();
HXDLIN( 800)			_hx_tmp16 = (_hx_tmp20 < (_hx_tmp21 + _hx_tmp22));
            		}
            		else {
HXLINE( 800)			_hx_tmp16 = false;
            		}
HXDLIN( 800)		if (_hx_tmp16) {
HXLINE( 801)			Float _hx_tmp23 = objectScreenPos->y;
HXDLIN( 801)			Float _hx_tmp24 = object->get_height();
HXLINE( 800)			_hx_tmp15 = ((_hx_tmp23 + _hx_tmp24) > this->_point->y);
            		}
            		else {
HXLINE( 800)			_hx_tmp15 = false;
            		}
HXDLIN( 800)		if (_hx_tmp15) {
HXLINE( 801)			Float _hx_tmp25 = objectScreenPos->y;
HXDLIN( 801)			Float _hx_tmp26 = this->_point->y;
HXDLIN( 801)			Float _hx_tmp27 = this->get_height();
HXLINE( 800)			return (_hx_tmp25 < (_hx_tmp26 + _hx_tmp27));
            		}
            		else {
...
Bool FlxObject_obj::overlapsAtCallback( ::flixel::FlxBasic ObjectOrGroup,Float X,Float Y,Bool InScreenSpace, ::flixel::FlxCamera Camera){
            	HX_STACK_FRAME("flixel.FlxObject","overlapsAtCallback",0xb90836f3,"flixel.FlxObject.overlapsAtCallback","flixel/FlxObject.hx",807,0xf0fe0d80)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(ObjectOrGroup,"ObjectOrGroup")
            	HX_STACK_ARG(X,"X")
            	HX_STACK_ARG(Y,"Y")
...
HXDLIN( 822)			Bool _hx_tmp2 = (point->x >= this->x);
HXDLIN( 822)			if (_hx_tmp2) {
HXLINE( 822)				Float _hx_tmp3 = point->x;
HXDLIN( 822)				Float _hx_tmp4 = this->x;
HXDLIN( 822)				Float _hx_tmp5 = this->get_width();
HXDLIN( 822)				_hx_tmp1 = (_hx_tmp3 < (_hx_tmp4 + _hx_tmp5));
            			}
            			else {
...
HXLINE( 822)				Float _hx_tmp6 = point->y;
HXDLIN( 822)				Float _hx_tmp7 = this->y;
HXDLIN( 822)				Float _hx_tmp8 = this->get_height();
HXDLIN( 822)				return (_hx_tmp6 < (_hx_tmp7 + _hx_tmp8));
            			}
            			else {
HXLINE( 822)				return false;
            			}
            		}
HXLINE( 825)		Bool _hx_tmp9 = hx::IsNull( Camera );
HXDLIN( 825)		if (_hx_tmp9) {
...
HXLINE( 832)		Bool _hx_tmp10 = point->_weak;
HXDLIN( 832)		if (_hx_tmp10) {
HXLINE( 832)			point->put();
            		}
HXLINE( 833)		Bool _hx_tmp11;
HXDLIN( 833)		Bool _hx_tmp12;
HXDLIN( 833)		Bool _hx_tmp13 = (xPos >= this->_point->x);
HXDLIN( 833)		if (_hx_tmp13) {
HXLINE( 833)			Float _hx_tmp14 = this->_point->x;
HXDLIN( 833)			Float _hx_tmp15 = this->get_width();
HXDLIN( 833)			_hx_tmp12 = (xPos < (_hx_tmp14 + _hx_tmp15));
            		}
            		else {
HXLINE( 833)			_hx_tmp12 = false;
            		}
HXDLIN( 833)		if (_hx_tmp12) {
HXLINE( 833)			_hx_tmp11 = (yPos >= this->_point->y);
            		}
            		else {
HXLINE( 833)			_hx_tmp11 = false;
            		}
HXDLIN( 833)		if (_hx_tmp11) {
HXLINE( 833)			Float _hx_tmp16 = this->_point->y;
HXDLIN( 833)			Float _hx_tmp17 = this->get_height();
HXDLIN( 833)			return (yPos < (_hx_tmp16 + _hx_tmp17));
            		}
            		else {
...
Bool FlxObject_obj::inWorldBounds(){
            	HX_STACK_FRAME("flixel.FlxObject","inWorldBounds",0x89d0e9f3,"flixel.FlxObject.inWorldBounds","flixel/FlxObject.hx",843,0xf0fe0d80)
            	HX_STACK_THIS(this)
HXLINE( 843)		Bool _hx_tmp;
HXDLIN( 843)		Bool _hx_tmp1;
HXDLIN( 843)		Float _hx_tmp2 = this->x;
HXDLIN( 843)		Float _hx_tmp3 = this->get_width();
HXDLIN( 843)		if (((_hx_tmp2 + _hx_tmp3) > ::flixel::FlxG_obj::worldBounds->x)) {
...
HXDLIN( 843)			Float _hx_tmp5 = this->get_height();
HXDLIN( 843)			_hx_tmp = ((_hx_tmp4 + _hx_tmp5) > ::flixel::FlxG_obj::worldBounds->y);
            		}
            		else {
...
HX_DEFINE_DYNAMIC_FUNC0(FlxObject_obj,inWorldBounds,return )
 ...
 ::flixel::math::FlxPoint FlxObject_obj::getScreenPosition( ::flixel::math::FlxPoint point, ::flixel::FlxCamera Camera){
            	...
            	HX_STACK_ARG(point,"point")
            	HX_STACK_ARG(Camera,"Camera")
HXLINE( 855)		Bool _hx_tmp = hx::IsNull( point );
...
HXLINE( 859)		Bool _hx_tmp1 = hx::IsNull( Camera );
HXDLIN( 859)		if (_hx_tmp1) {
HXLINE( 861)			Camera = ::flixel::FlxG_obj::camera;
            		}
HXLINE( 864)		point->set(this->x,this->y);
HXLINE( 865)		Bool _hx_tmp2 = this->pixelPerfectPosition;
HXDLIN( 865)		if (_hx_tmp2) {
HXLINE( 867)			Int _hx_tmp3 = ::Math_obj::floor(point->x);
HXDLIN( 867)			point->set_x(_hx_tmp3);
HXDLIN( 867)			Int _hx_tmp4 = ::Math_obj::floor(point->y);
HXDLIN( 867)			point->set_y(_hx_tmp4);
            		}
HXLINE( 870)		Float X = (Camera->scroll->x * this->scrollFactor->x);
HXDLIN( 870)		Float Y = (Camera->scroll->y * this->scrollFactor->y);
HXDLIN( 870)		{
HXLINE( 870)			HX_VARI(  ::flixel::math::FlxPoint,_g) = point;
HXDLIN( 870)			Float _hx_tmp5 = (_g->x - X);
HXDLIN( 870)			_g->set_x(_hx_tmp5);
            		}
HXDLIN( 870)		{
HXLINE( 870)			HX_VARI_NAME(  ::flixel::math::FlxPoint,_g1,"_g") = point;
HXDLIN( 870)			Float _hx_tmp6 = (_g1->y - Y);
HXDLIN( 870)			_g1->set_y(_hx_tmp6);
            		}
...
HX_DEFINE_DYNAMIC_FUNC2(FlxObject_obj,getScreenPosition,return )
 ...
 ::flixel::math::FlxPoint FlxObject_obj::getPosition( ::flixel::math::FlxPoint point){
            	...
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(point,"point")
HXLINE( 875)		Bool _hx_tmp = hx::IsNull( point );
...
HX_DEFINE_DYNAMIC_FUNC1(FlxObject_obj,getPosition,return )
 ...
 ::flixel::math::FlxPoint FlxObject_obj::getMidpoint( ::flixel::math::FlxPoint point){
            	...
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(point,"point")
HXLINE( 888)		Bool _hx_tmp = hx::IsNull( point );
...
HXLINE( 892)		Float _hx_tmp1 = this->x;
HXDLIN( 892)		Float _hx_tmp2 = this->get_width();
HXDLIN( 892)		Float _hx_tmp3 = (_hx_tmp1 + (_hx_tmp2 * ((Float)0.5)));
HXDLIN( 892)		Float _hx_tmp4 = this->y;
HXDLIN( 892)		Float _hx_tmp5 = this->get_height();
HXDLIN( 892)		return point->set(_hx_tmp3,(_hx_tmp4 + (_hx_tmp5 * ((Float)0.5))));
            	}
...
HXLINE( 897)		Bool _hx_tmp = hx::IsNull( rect );
HXDLIN( 897)		if (_hx_tmp) {
HXLINE( 898)			Float X = (int)0;
HXDLIN( 898)			Float Y = (int)0;
HXDLIN( 898)			Float Width = (int)0;
HXDLIN( 898)			Float Height = (int)0;
HXDLIN( 898)			HX_VARI(  ::flixel::math::FlxRect,_this) = ::flixel::math::FlxRect_obj::_pool->get();
HXDLIN( 898)			_this->x = X;
HXDLIN( 898)			_this->y = Y;
HXDLIN( 898)			_this->width = Width;
HXDLIN( 898)			_this->height = Height;
HXDLIN( 898)			_this->_inPool = false;
HXDLIN( 898)			rect = _this;
            		}
HXLINE( 899)		Float X1 = this->x;
HXDLIN( 899)		Float Y1 = this->y;
HXDLIN( 899)		Float Width1 = this->get_width();
HXDLIN( 899)		Float Height1 = this->get_height();
HXDLIN( 899)		rect->x = X1;
HXDLIN( 899)		rect->y = Y1;
HXDLIN( 899)		rect->width = Width1;
HXDLIN( 899)		rect->height = Height1;
...
Bool FlxObject_obj::isOnScreen( ::flixel::FlxCamera Camera){
            	...
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(Camera,"Camera")
HXLINE( 927)		Bool _hx_tmp = hx::IsNull( Camera );
...
HXDLIN( 932)		Bool _hx_tmp2;
HXDLIN( 932)		Float _hx_tmp3 = this->_point->x;
HXDLIN( 932)		Float _hx_tmp4 = this->get_width();
HXDLIN( 932)		if (((_hx_tmp3 + _hx_tmp4) > (int)0)) {
HXLINE( 932)			_hx_tmp2 = (this->_point->x < Camera->width);
            		}
            		else {
HXLINE( 932)			_hx_tmp2 = false;
            		}
HXDLIN( 932)		if (_hx_tmp2) {
HXLINE( 932)			Float _hx_tmp5 = this->_point->y;
HXDLIN( 932)			Float _hx_tmp6 = this->get_height();
HXDLIN( 932)			_hx_tmp1 = ((_hx_tmp5 + _hx_tmp6) > (int)0);
            		}
            		else {
...
Bool FlxObject_obj::isPixelPerfectRender( ::flixel::FlxCamera Camera){
            	...
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(Camera,"Camera")
HXLINE( 940)		Bool _hx_tmp = hx::IsNull( Camera );
HXDLIN( 940)		if (_hx_tmp) {
HXLINE( 942)			Camera = ::flixel::FlxG_obj::camera;
            		}
HXLINE( 945)		Bool _hx_tmp1 = hx::IsNull( this->pixelPerfectRender );
...
Bool FlxObject_obj::isTouching(Int Direction){
            	HX_STACK_FRAME("flixel.FlxObject","isTouching",0x23c6647c,"flixel.FlxObject.isTouching","flixel/FlxObject.hx",957,0xf0fe0d80)
            	HX_STACK_THIS(this)
...
Bool FlxObject_obj::justTouched(Int Direction){
            	HX_STACK_FRAME("flixel.FlxObject","justTouched",0xbcba8e43,"flixel.FlxObject.justTouched","flixel/FlxObject.hx",969,0xf0fe0d80)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(Direction,"Direction")
...
HXLINE( 981)		Bool _hx_tmp = (this->health <= (int)0);
...
HXLINE( 995)		Bool _hx_tmp = hx::IsNull( axes );
...
HXLINE( 999)			Float _hx_tmp1 = ((Float)::flixel::FlxG_obj::width / (Float)(int)2);
HXDLIN( 999)			Float _hx_tmp2 = this->get_width();
HXDLIN( 999)			this->set_x((_hx_tmp1 - ((Float)_hx_tmp2 / (Float)(int)2)));
            		}
HXLINE(1000)		if (hx::IsNotEq( axes,::flixel::util::FlxAxes_obj::X_dyn() )) {
HXLINE(1001)			Float _hx_tmp3 = ((Float)::flixel::FlxG_obj::height / (Float)(int)2);
HXDLIN(1001)			Float _hx_tmp4 = this->get_height();
HXDLIN(1001)			this->set_y((_hx_tmp3 - ((Float)_hx_tmp4 / (Float)(int)2)));
            		}
...
HXDLIN(1043)				Bool _hx_tmp1 = hx::IsNotNull( this->path );
...
HXDLIN(1062)		Bool _hx_tmp2 = ::flixel::FlxG_obj::renderBlit;
HXDLIN(1062)		if (_hx_tmp2) {
...
HXLINE(1064)		Bool _hx_tmp3 = ::flixel::FlxG_obj::renderBlit;
...
HXLINE(1071)		Bool _hx_tmp = hx::IsNull( color );
...
HX_DEFINE_DYNAMIC_FUNC4(FlxObject_obj,drawDebugBoundingBox,(void))
 ...
 ::openfl::_legacy::display::Graphics FlxObject_obj::beginDrawDebug( ::flixel::FlxCamera camera){
            	HX_STACK_FRAME("flixel.FlxObject","beginDrawDebug",0x8677cfb5,"flixel.FlxObject.beginDrawDebug","flixel/FlxObject.hx",1090,0xf0fe0d80)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(camera,"camera")
HXLINE(1090)		Bool _hx_tmp = ::flixel::FlxG_obj::renderBlit;
...
void FlxObject_obj::endDrawDebug( ::flixel::FlxCamera camera){
            	HX_STACK_FRAME("flixel.FlxObject","endDrawDebug",0x2518e603,"flixel.FlxObject.endDrawDebug","flixel/FlxObject.hx",1103,0xf0fe0d80)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(camera,"camera")
HXLINE(1103)		Bool _hx_tmp = ::flixel::FlxG_obj::renderBlit;
...
HXLINE(1115)		Bool _hx_tmp = this->isPixelPerfectRender(camera);
...
::String FlxObject_obj::toString(){
            	HX_STACK_FRAME("flixel.FlxObject","toString",0x9e14e2db,"flixel.FlxObject.toString","flixel/FlxObject.hx",1128,0xf0fe0d80)
            	HX_STACK_THIS(this)
...
HXLINE(1134)		HX_VARI_NAME(  ::flixel::util::LabelValuePair,_this5,"_this") = ::flixel::util::LabelValuePair_obj::_pool->get();
HXDLIN(1134)		_this5->label = HX_("velocity",1d,02,fe,1e);
HXDLIN(1134)		_this5->value = this->velocity;
...
Float FlxObject_obj::set_x(Float NewX){
            	HX_STACK_FRAME("flixel.FlxObject","set_x",0xb024e5cc,"flixel.FlxObject.set_x","flixel/FlxObject.hx",1140,0xf0fe0d80)
            	HX_STACK_THIS(this)
...
Float FlxObject_obj::set_y(Float NewY){
            	HX_STACK_FRAME("flixel.FlxObject","set_y",0xb024e5cd,"flixel.FlxObject.set_y","flixel/FlxObject.hx",1146,0xf0fe0d80)
            	HX_STACK_THIS(this)
...
Float FlxObject_obj::get_width(){
            	HX_STACK_FRAME("flixel.FlxObject","get_width",0x99b5e94e,"flixel.FlxObject.get_width","flixel/FlxObject.hx",1180,0xf0fe0d80)
            	HX_STACK_THIS(this)
...
Float FlxObject_obj::get_height(){
            	HX_STACK_FRAME("flixel.FlxObject","get_height",0x9bc5b39f,"flixel.FlxObject.get_height","flixel/FlxObject.hx",1186,0xf0fe0d80)
            	HX_STACK_THIS(this)
...
Bool FlxObject_obj::get_solid(){
            	HX_STACK_FRAME("flixel.FlxObject","get_solid",0x5018e773,"flixel.FlxObject.get_solid","flixel/FlxObject.hx",1192,0xf0fe0d80)
            	HX_STACK_THIS(this)
...
Float FlxObject_obj::set_angle(Float Value){
            	HX_STACK_FRAME("flixel.FlxObject","set_angle",0xd5866327,"flixel.FlxObject.set_angle","flixel/FlxObject.hx",1205,0xf0fe0d80)
            	HX_STACK_THIS(this)
...
Bool FlxObject_obj::set_moves(Bool Value){
            	HX_STACK_FRAME("flixel.FlxObject","set_moves",0xbf09eb96,"flixel.FlxObject.set_moves","flixel/FlxObject.hx",1211,0xf0fe0d80)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(Value,"Value")
...
Bool FlxObject_obj::set_immovable(Bool Value){
            	HX_STACK_FRAME("flixel.FlxObject","set_immovable",0xc5b8805e,"flixel.FlxObject.set_immovable","flixel/FlxObject.hx",1217,0xf0fe0d80)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(Value,"Value")
...
Bool FlxObject_obj::set_pixelPerfectRender(Bool Value){
            	HX_STACK_FRAME("flixel.FlxObject","set_pixelPerfectRender",0x84233609,"flixel.FlxObject.set_pixelPerfectRender","flixel/FlxObject.hx",1223,0xf0fe0d80)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(Value,"Value")
...
Int FlxObject_obj::set_allowCollisions(Int Value){
            	HX_STACK_FRAME("flixel.FlxObject","set_allowCollisions",0x7975d9fe,"flixel.FlxObject.set_allowCollisions","flixel/FlxObject.hx",1229,0xf0fe0d80)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(Value,"Value")
...
Int FlxObject_obj::set_debugBoundingBoxColorSolid(Int color){
            	HX_STACK_FRAME("flixel.FlxObject","set_debugBoundingBoxColorSolid",0xb8a23688,"flixel.FlxObject.set_debugBoundingBoxColorSolid","flixel/FlxObject.hx",1235,0xf0fe0d80)
            	HX_STACK_THIS(this)
...
Int FlxObject_obj::set_debugBoundingBoxColorNotSolid(Int color){
            	HX_STACK_FRAME("flixel.FlxObject","set_debugBoundingBoxColorNotSolid",0x55ae1bdb,"flixel.FlxObject.set_debugBoundingBoxColorNotSolid","flixel/FlxObject.hx",1240,0xf0fe0d80)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(color,"color")
...
Int FlxObject_obj::set_debugBoundingBoxColorPartial(Int color){
            	HX_STACK_FRAME("flixel.FlxObject","set_debugBoundingBoxColorPartial",0x34746b1e,"flixel.FlxObject.set_debugBoundingBoxColorPartial","flixel/FlxObject.hx",1245,0xf0fe0d80)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(color,"color")
...
HXLINE(1255)		Bool _hx_tmp = hx::IsNotNull( this->path );
HXDLIN(1255)		if (_hx_tmp) {
HXLINE(1256)			this->path->object = null();
            		}
HXLINE(1258)		Bool _hx_tmp1 = hx::IsNotNull( path );
...
HXDLIN( 122)			Float _hx_tmp;
HXDLIN( 122)			if ((obj1delta > (int)0)) {
HXLINE( 122)				_hx_tmp = obj1delta;
            			}
            			else {
HXLINE( 122)				_hx_tmp = (int)0;
            			}
HXDLIN( 122)			Float X = (Object1->x - _hx_tmp);
HXDLIN( 122)			Float Y = Object1->last->y;
HXDLIN( 122)			Float _hx_tmp1 = Object1->get_width();
HXDLIN( 122)			Float Width = (_hx_tmp1 + obj1deltaAbs);
...
HXDLIN( 123)			Float _hx_tmp2;
HXDLIN( 123)			if ((obj2delta > (int)0)) {
HXLINE( 123)				_hx_tmp2 = obj2delta;
            			}
            			else {
HXLINE( 123)				_hx_tmp2 = (int)0;
            			}
HXDLIN( 123)			Float X1 = (Object2->x - _hx_tmp2);
HXDLIN( 123)			Float Y1 = Object2->last->y;
HXDLIN( 123)			Float _hx_tmp3 = Object2->get_width();
HXDLIN( 123)			Float Width1 = (_hx_tmp3 + obj2deltaAbs);
HXDLIN( 123)			Float Height1 = Object2->get_height();
HXDLIN( 123)			_this1->x = X1;
...
HXDLIN( 125)			Bool _hx_tmp6;
HXDLIN( 125)			if (((_this->x + _this->width) > _this1->x)) {
HXLINE( 125)				_hx_tmp6 = (_this->x < (_this1->x + _this1->width));
            			}
            			else {
HXLINE( 125)				_hx_tmp6 = false;
            			}
HXDLIN( 125)			if (_hx_tmp6) {
HXLINE( 125)				_hx_tmp5 = ((_this->y + _this->height) > _this1->y);
            			}
            			else {
HXLINE( 125)				_hx_tmp5 = false;
            			}
HXDLIN( 125)			if (_hx_tmp5) {
HXLINE( 125)				_hx_tmp4 = (_this->y < (_this1->y + _this1->height));
            			}
            			else {
...
HXLINE( 132)					Float _hx_tmp7 = Object1->x;
HXDLIN( 132)					Float _hx_tmp8 = Object1->get_width();
HXDLIN( 132)					overlap = ((_hx_tmp7 + _hx_tmp8) - Object2->x);
HXLINE( 133)					Bool _hx_tmp9;
HXDLIN( 133)					Bool _hx_tmp10;
HXDLIN( 133)					Bool _hx_tmp11;
HXDLIN( 133)					if (checkMaxOverlap) {
HXLINE( 133)						_hx_tmp11 = (overlap > maxOverlap);
            					}
            					else {
HXLINE( 133)						_hx_tmp11 = false;
            					}
HXDLIN( 133)					if (!(_hx_tmp11)) {
HXLINE( 133)						_hx_tmp10 = (((int)Object1->allowCollisions & (int)(int)16) == (int)0);
            					}
            					else {
HXLINE( 133)						_hx_tmp10 = true;
            					}
HXDLIN( 133)					if (!(_hx_tmp10)) {
HXLINE( 133)						_hx_tmp9 = (((int)Object2->allowCollisions & (int)(int)1) == (int)0);
            					}
            					else {
HXLINE( 133)						_hx_tmp9 = true;
            					}
HXDLIN( 133)					if (_hx_tmp9) {
HXLINE( 135)						overlap = (int)0;
            					}
            					else {
HXLINE( 139)						hx::OrEq(Object1->touching,(int)16);
HXLINE( 140)						hx::OrEq(Object2->touching,(int)1);
            					}
            				}
            				else {
HXLINE( 143)					if ((obj1delta < obj2delta)) {
HXLINE( 145)						Float _hx_tmp12 = Object1->x;
HXDLIN( 145)						Float _hx_tmp13 = Object2->get_width();
HXDLIN( 145)						overlap = ((_hx_tmp12 - _hx_tmp13) - Object2->x);
HXLINE( 146)						Bool _hx_tmp14;
HXDLIN( 146)						Bool _hx_tmp15;
HXDLIN( 146)						Bool _hx_tmp16;
HXDLIN( 146)						if (checkMaxOverlap) {
HXLINE( 146)							_hx_tmp16 = (-(overlap) > maxOverlap);
            						}
            						else {
HXLINE( 146)							_hx_tmp16 = false;
            						}
HXDLIN( 146)						if (!(_hx_tmp16)) {
HXLINE( 146)							_hx_tmp15 = (((int)Object1->allowCollisions & (int)(int)1) == (int)0);
            						}
            						else {
HXLINE( 146)							_hx_tmp15 = true;
            						}
HXDLIN( 146)						if (!(_hx_tmp15)) {
HXLINE( 146)							_hx_tmp14 = (((int)Object2->allowCollisions & (int)(int)16) == (int)0);
            						}
            						else {
...
HXLINE( 152)							hx::OrEq(Object1->touching,(int)1);
HXLINE( 153)							hx::OrEq(Object2->touching,(int)16);
            						}
            					}
            				}
            			}
...
HXLINE( 179)		Bool _hx_tmp1 = (Object1->flixelType == (int)3);
...
HXLINE( 184)		Bool _hx_tmp2 = (Object2->flixelType == (int)3);
...
HXLINE( 197)				_hx_tmp3 = !(obj2immovable);
            			}
            			else {
HXLINE( 197)				_hx_tmp3 = false;
            			}
HXDLIN( 197)			if (_hx_tmp3) {
HXLINE( 199)				hx::MultEq(overlap,((Float)0.5));
HXLINE( 200)				Float _hx_tmp4 = (Object1->x - overlap);
HXDLIN( 200)				Object1->set_x(_hx_tmp4);
HXLINE( 201)				{
HXLINE( 201)					Float _hx_tmp5 = (Object2->x + overlap);
HXDLIN( 201)					Object2->set_x(_hx_tmp5);
            				}
HXLINE( 203)				Float _hx_tmp6 = ((Float)((obj2v * obj2v) * Object2->mass) / (Float)Object1->mass);
HXDLIN( 203)				Float _hx_tmp7 = ::Math_obj::sqrt(_hx_tmp6);
HXDLIN( 203)				Int _hx_tmp8;
HXDLIN( 203)				if ((obj2v > (int)0)) {
HXLINE( 203)					_hx_tmp8 = (int)1;
            				}
            				else {
HXLINE( 203)					_hx_tmp8 = (int)-1;
            				}
HXDLIN( 203)				HX_VARI( Float,obj1velocity) = (_hx_tmp7 * _hx_tmp8);
HXLINE( 204)				Float _hx_tmp9 = ((Float)((obj1v * obj1v) * Object1->mass) / (Float)Object2->mass);
HXDLIN( 204)				Float _hx_tmp10 = ::Math_obj::sqrt(_hx_tmp9);
HXDLIN( 204)				Int _hx_tmp11;
HXDLIN( 204)				if ((obj1v > (int)0)) {
HXLINE( 204)					_hx_tmp11 = (int)1;
            				}
            				else {
HXLINE( 204)					_hx_tmp11 = (int)-1;
            				}
HXDLIN( 204)				HX_VARI( Float,obj2velocity) = (_hx_tmp10 * _hx_tmp11);
HXLINE( 205)				HX_VARI( Float,average) = ((obj1velocity + obj2velocity) * ((Float)0.5));
HXLINE( 206)				hx::SubEq(obj1velocity,average);
HXLINE( 207)				hx::SubEq(obj2velocity,average);
HXLINE( 208)				Float _hx_tmp12 = (average + (obj1velocity * Object1->elasticity));
HXDLIN( 208)				Object1->velocity->set_x(_hx_tmp12);
HXLINE( 209)				Float _hx_tmp13 = (average + (obj2velocity * Object2->elasticity));
HXDLIN( 209)				Object2->velocity->set_x(_hx_tmp13);
            			}
            			else {
HXLINE( 211)				if (!(obj1immovable)) {
HXLINE( 213)					Float _hx_tmp14 = (Object1->x - overlap);
HXDLIN( 213)					Object1->set_x(_hx_tmp14);
HXLINE( 214)					Float _hx_tmp15 = (obj2v - (obj1v * Object1->elasticity));
HXDLIN( 214)					Object1->velocity->set_x(_hx_tmp15);
            				}
            				else {
HXLINE( 216)					if (!(obj2immovable)) {
HXLINE( 218)						{
HXLINE( 218)							Float _hx_tmp16 = (Object2->x + overlap);
HXDLIN( 218)							Object2->set_x(_hx_tmp16);
            						}
HXLINE( 219)						Float _hx_tmp17 = (obj1v - (obj2v * Object2->elasticity));
HXDLIN( 219)						Object2->velocity->set_x(_hx_tmp17);
            					}
            				}
            			}
...
Bool FlxObject_obj::updateTouchingFlagsX( ::flixel::FlxObject Object1, ::flixel::FlxObject Object2){
            	...
            	HX_STACK_ARG(Object1,"Object1")
            	HX_STACK_ARG(Object2,"Object2")
HXLINE( 237)		Bool _hx_tmp = (Object1->flixelType == (int)3);
...
HXLINE( 242)		Bool _hx_tmp1 = (Object2->flixelType == (int)3);
...
HXLINE( 248)		Float _hx_tmp2 = ::flixel::FlxObject_obj::computeOverlapX(Object1,Object2,false);
HXDLIN( 248)		return (_hx_tmp2 != (int)0);
            	}
...
HXLINE( 270)				_hx_tmp = obj1delta;
            			}
            			else {
HXLINE( 270)				_hx_tmp = (int)0;
            			}
HXDLIN( 270)			Float Y = (Object1->y - _hx_tmp);
HXDLIN( 270)			Float Width = Object1->get_width();
HXDLIN( 270)			Float _hx_tmp1 = Object1->get_height();
HXDLIN( 270)			Float Height = (_hx_tmp1 + obj1deltaAbs);
...
HXDLIN( 271)			Float _hx_tmp2;
HXDLIN( 271)			if ((obj2delta > (int)0)) {
HXLINE( 271)				_hx_tmp2 = obj2delta;
            			}
            			else {
HXLINE( 271)				_hx_tmp2 = (int)0;
            			}
HXDLIN( 271)			Float Y1 = (Object2->y - _hx_tmp2);
HXDLIN( 271)			Float Width1 = Object2->get_width();
HXDLIN( 271)			Float _hx_tmp3 = Object2->get_height();
HXDLIN( 271)			Float Height1 = (_hx_tmp3 + obj2deltaAbs);
...
HXLINE( 273)				_hx_tmp6 = (_this->x < (_this1->x + _this1->width));
            			}
            			else {
HXLINE( 273)				_hx_tmp6 = false;
            			}
HXDLIN( 273)			if (_hx_tmp6) {
HXLINE( 273)				_hx_tmp5 = ((_this->y + _this->height) > _this1->y);
            			}
            			else {
HXLINE( 273)				_hx_tmp5 = false;
            			}
HXDLIN( 273)			if (_hx_tmp5) {
HXLINE( 273)				_hx_tmp4 = (_this->y < (_this1->y + _this1->height));
            			}
            			else {
...
HXLINE( 280)					Float _hx_tmp7 = Object1->y;
HXDLIN( 280)					Float _hx_tmp8 = Object1->get_height();
HXDLIN( 280)					overlap = ((_hx_tmp7 + _hx_tmp8) - Object2->y);
HXLINE( 281)					Bool _hx_tmp9;
HXDLIN( 281)					Bool _hx_tmp10;
HXDLIN( 281)					Bool _hx_tmp11;
HXDLIN( 281)					if (checkMaxOverlap) {
HXLINE( 281)						_hx_tmp11 = (overlap > maxOverlap);
            					}
            					else {
HXLINE( 281)						_hx_tmp11 = false;
            					}
HXDLIN( 281)					if (!(_hx_tmp11)) {
HXLINE( 281)						_hx_tmp10 = (((int)Object1->allowCollisions & (int)(int)4096) == (int)0);
            					}
            					else {
HXLINE( 281)						_hx_tmp10 = true;
            					}
HXDLIN( 281)					if (!(_hx_tmp10)) {
HXLINE( 281)						_hx_tmp9 = (((int)Object2->allowCollisions & (int)(int)256) == (int)0);
            					}
            					else {
HXLINE( 281)						_hx_tmp9 = true;
            					}
HXDLIN( 281)					if (_hx_tmp9) {
HXLINE( 283)						overlap = (int)0;
            					}
            					else {
HXLINE( 287)						hx::OrEq(Object1->touching,(int)4096);
HXLINE( 288)						hx::OrEq(Object2->touching,(int)256);
            					}
            				}
            				else {
HXLINE( 291)					if ((obj1delta < obj2delta)) {
HXLINE( 293)						Float _hx_tmp12 = Object1->y;
HXDLIN( 293)						Float _hx_tmp13 = Object2->get_height();
HXDLIN( 293)						overlap = ((_hx_tmp12 - _hx_tmp13) - Object2->y);
HXLINE( 294)						Bool _hx_tmp14;
HXDLIN( 294)						Bool _hx_tmp15;
HXDLIN( 294)						Bool _hx_tmp16;
HXDLIN( 294)						if (checkMaxOverlap) {
HXLINE( 294)							_hx_tmp16 = (-(overlap) > maxOverlap);
            						}
            						else {
HXLINE( 294)							_hx_tmp16 = false;
            						}
HXDLIN( 294)						if (!(_hx_tmp16)) {
HXLINE( 294)							_hx_tmp15 = (((int)Object1->allowCollisions & (int)(int)256) == (int)0);
            						}
            						else {
HXLINE( 294)							_hx_tmp15 = true;
            						}
HXDLIN( 294)						if (!(_hx_tmp15)) {
HXLINE( 294)							_hx_tmp14 = (((int)Object2->allowCollisions & (int)(int)4096) == (int)0);
            						}
            						else {
...
HXLINE( 300)							hx::OrEq(Object1->touching,(int)256);
HXLINE( 301)							hx::OrEq(Object2->touching,(int)4096);
            						}
            					}
            				}
            			}
...
HXLINE( 327)		Bool _hx_tmp1 = (Object1->flixelType == (int)3);
...
HXLINE( 332)		Bool _hx_tmp2 = (Object2->flixelType == (int)3);
...
HXLINE( 347)				_hx_tmp3 = !(obj2immovable);
            			}
            			else {
HXLINE( 347)				_hx_tmp3 = false;
            			}
HXDLIN( 347)			if (_hx_tmp3) {
HXLINE( 349)				hx::MultEq(overlap,((Float)0.5));
HXLINE( 350)				Float _hx_tmp4 = (Object1->y - overlap);
HXDLIN( 350)				Object1->set_y(_hx_tmp4);
HXLINE( 351)				{
HXLINE( 351)					Float _hx_tmp5 = (Object2->y + overlap);
HXDLIN( 351)					Object2->set_y(_hx_tmp5);
            				}
HXLINE( 353)				Float _hx_tmp6 = ((Float)((obj2v * obj2v) * Object2->mass) / (Float)Object1->mass);
HXDLIN( 353)				Float _hx_tmp7 = ::Math_obj::sqrt(_hx_tmp6);
HXDLIN( 353)				Int _hx_tmp8;
HXDLIN( 353)				if ((obj2v > (int)0)) {
HXLINE( 353)					_hx_tmp8 = (int)1;
            				}
            				else {
HXLINE( 353)					_hx_tmp8 = (int)-1;
            				}
HXDLIN( 353)				HX_VARI( Float,obj1velocity) = (_hx_tmp7 * _hx_tmp8);
HXLINE( 354)				Float _hx_tmp9 = ((Float)((obj1v * obj1v) * Object1->mass) / (Float)Object2->mass);
HXDLIN( 354)				Float _hx_tmp10 = ::Math_obj::sqrt(_hx_tmp9);
HXDLIN( 354)				Int _hx_tmp11;
HXDLIN( 354)				if ((obj1v > (int)0)) {
HXLINE( 354)					_hx_tmp11 = (int)1;
            				}
            				else {
HXLINE( 354)					_hx_tmp11 = (int)-1;
            				}
HXDLIN( 354)				HX_VARI( Float,obj2velocity) = (_hx_tmp10 * _hx_tmp11);
HXLINE( 355)				HX_VARI( Float,average) = ((obj1velocity + obj2velocity) * ((Float)0.5));
HXLINE( 356)				hx::SubEq(obj1velocity,average);
HXLINE( 357)				hx::SubEq(obj2velocity,average);
HXLINE( 358)				Float _hx_tmp12 = (average + (obj1velocity * Object1->elasticity));
HXDLIN( 358)				Object1->velocity->set_y(_hx_tmp12);
HXLINE( 359)				Float _hx_tmp13 = (average + (obj2velocity * Object2->elasticity));
HXDLIN( 359)				Object2->velocity->set_y(_hx_tmp13);
            			}
            			else {
HXLINE( 361)				if (!(obj1immovable)) {
HXLINE( 363)					Float _hx_tmp14 = (Object1->y - overlap);
HXDLIN( 363)					Object1->set_y(_hx_tmp14);
HXLINE( 364)					Float _hx_tmp15 = (obj2v - (obj1v * Object1->elasticity));
HXDLIN( 364)					Object1->velocity->set_y(_hx_tmp15);
HXLINE( 366)					Bool _hx_tmp16;
HXDLIN( 366)					Bool _hx_tmp17;
HXDLIN( 366)					Bool _hx_tmp18;
HXDLIN( 366)					if (Object1->collisonXDrag) {
HXLINE( 366)						_hx_tmp18 = Object2->active;
            					}
            					else {
HXLINE( 366)						_hx_tmp18 = false;
            					}
HXDLIN( 366)					if (_hx_tmp18) {
HXLINE( 366)						_hx_tmp17 = Object2->moves;
            					}
            					else {
HXLINE( 366)						_hx_tmp17 = false;
            					}
HXDLIN( 366)					if (_hx_tmp17) {
HXLINE( 366)						_hx_tmp16 = (obj1delta > obj2delta);
            					}
            					else {
HXLINE( 366)						_hx_tmp16 = false;
            					}
HXDLIN( 366)					if (_hx_tmp16) {
HXLINE( 368)						Float _hx_tmp19 = (Object1->x + (Object2->x - Object2->last->x));
HXDLIN( 368)						Object1->set_x(_hx_tmp19);
            					}
            				}
            				else {
HXLINE( 371)					if (!(obj2immovable)) {
HXLINE( 373)						{
HXLINE( 373)							Float _hx_tmp20 = (Object2->y + overlap);
HXDLIN( 373)							Object2->set_y(_hx_tmp20);
            						}
HXLINE( 374)						Float _hx_tmp21 = (obj1v - (obj2v * Object2->elasticity));
HXDLIN( 374)						Object2->velocity->set_y(_hx_tmp21);
HXLINE( 376)						Bool _hx_tmp22;
HXDLIN( 376)						Bool _hx_tmp23;
HXDLIN( 376)						Bool _hx_tmp24;
HXDLIN( 376)						if (Object2->collisonXDrag) {
HXLINE( 376)							_hx_tmp24 = Object1->active;
            						}
            						else {
HXLINE( 376)							_hx_tmp24 = false;
            						}
HXDLIN( 376)						if (_hx_tmp24) {
HXLINE( 376)							_hx_tmp23 = Object1->moves;
            						}
            						else {
HXLINE( 376)							_hx_tmp23 = false;
            						}
HXDLIN( 376)						if (_hx_tmp23) {
HXLINE( 376)							_hx_tmp22 = (obj1delta < obj2delta);
            						}
            						else {
HXLINE( 376)							_hx_tmp22 = false;
            						}
HXDLIN( 376)						if (_hx_tmp22) {
HXLINE( 378)							Float _hx_tmp25 = (Object2->x + (Object1->x - Object1->last->x));
HXDLIN( 378)							Object2->set_x(_hx_tmp25);
            						}
            					}
            				}
            			}
...
Bool FlxObject_obj::updateTouchingFlagsY( ::flixel::FlxObject Object1, ::flixel::FlxObject Object2){
            	...
            	HX_STACK_ARG(Object1,"Object1")
            	HX_STACK_ARG(Object2,"Object2")
HXLINE( 397)		Bool _hx_tmp = (Object1->flixelType == (int)3);
...
HXLINE( 402)		Bool _hx_tmp1 = (Object2->flixelType == (int)3);
...
HXLINE( 408)		Float _hx_tmp2 = ::flixel::FlxObject_obj::computeOverlapY(Object1,Object2,false);
HXDLIN( 408)		return (_hx_tmp2 != (int)0);
            	}
...
HXDLIN(  70)		_firstSeparateFlxRect = _this;
            	}
{
            	HX_STACK_FRAME("flixel.FlxObject","boot",0x1dc312e1,"flixel.FlxObject.boot","flixel/FlxObject.hx",72,0xf0fe0d80)
...
HXDLIN(  72)		_secondSeparateFlxRect = _this;
            	}
}
