...
HXLINE(  45)		Bool _hx_tmp = ::flixel::FlxG_obj::renderTile;
HXDLIN(  45)		if (_hx_tmp) {
HXLINE(  47)			this->_bgSprite =  ::flixel::_hx_system::FlxBGSprite_obj::__new();
            		}
...
void FlxSubState_obj::draw(){
            	...
            	HX_STACK_THIS(this)
HXLINE(  55)		Bool _hx_tmp = ::flixel::FlxG_obj::renderBlit;
...
void FlxSubState_obj::close(){
            	HX_STACK_FRAME("flixel.FlxSubState","close",0x85a9195b,"flixel.FlxSubState.close","flixel/FlxSubState.hx",84,0xd8a3e54e)
            	HX_STACK_THIS(this)
HXLINE(  84)		Bool _hx_tmp;
HXDLIN(  84)		Bool _hx_tmp1 = hx::IsNotNull( this->_parentState );
...
Int FlxSubState_obj::get_bgColor(){
            	HX_STACK_FRAME("flixel.FlxSubState","get_bgColor",0x02e53f58,"flixel.FlxSubState.get_bgColor","flixel/FlxSubState.hx",93,0xd8a3e54e)
            	HX_STACK_THIS(this)
