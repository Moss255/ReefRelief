...
HXLINE( 225)		this->postProcessLayer =  ::openfl::_legacy::display::Sprite_obj::__new();
...
HXLINE( 256)		this->_inputContainer =  ::openfl::_legacy::display::Sprite_obj::__new();
...
HXDLIN( 276)		Bool _hx_tmp1 = hx::IsNull( InitialState );
...
void FlxGame_obj::create( ::Dynamic _){
            	...
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(_,"_")
HXLINE( 294)		 ::openfl::_legacy::display::Stage _hx_tmp = this->get_stage();
HXDLIN( 294)		Bool _hx_tmp1 = hx::IsNull( _hx_tmp );
...
HXLINE( 301)		Int _hx_tmp2 = ( (Int)(this->getTimer()) );
HXDLIN( 301)		this->_total = (_hx_tmp2 - this->_startTime);
...
HXLINE( 321)		Int _hx_tmp3 = ::openfl::_legacy::Lib_obj::get_current()->get_stage()->get_stageWidth();
HXDLIN( 321)		Int _hx_tmp4 = ::openfl::_legacy::Lib_obj::get_current()->get_stage()->get_stageHeight();
HXDLIN( 321)		this->debugger =  ::flixel::_hx_system::debug::FlxDebugger_obj::__new(_hx_tmp3,_hx_tmp4);
...
HXLINE( 334)		this->_focusLostScreen = ( ( ::flixel::_hx_system::ui::FlxFocusLostScreen)(::Type_obj::createInstance(this->_customFocusLostScreen,::cpp::VirtualArray_obj::__new(0))) );
HXLINE( 335)		this->addChild(this->_focusLostScreen);
...
HXLINE( 349)				_hx_tmp5 = hx::IsNotNull( ::flixel::_hx_system::FlxSplash_obj::nextState );
            			}
            			else {
HXLINE( 349)				_hx_tmp5 = true;
            			}
...
HXDLIN( 349)				Bool _hx_tmp6 = hx::IsNull( ::flixel::_hx_system::FlxSplash_obj::nextState );
...
HXDLIN( 349)				this->_requestedState =  ::flixel::_hx_system::FlxSplash_obj::__new(null());
HXDLIN( 349)				this->_skipSplash = true;
            			}
HXDLIN( 349)			Bool _hx_tmp7 = ::Std_obj::is(this->_requestedState,hx::ClassOf< ::flixel::FlxSubState >());
...
HXLINE( 352)		Bool _hx_tmp8 = (::flixel::FlxG_obj::updateFramerate < ::flixel::FlxG_obj::drawFramerate);
...
HXLINE( 365)		Int _hx_tmp9 = ::openfl::_legacy::Lib_obj::get_current()->get_stage()->get_stageWidth();
HXDLIN( 365)		Int _hx_tmp10 = ::openfl::_legacy::Lib_obj::get_current()->get_stage()->get_stageHeight();
HXDLIN( 365)		this->resizeGame(_hx_tmp9,_hx_tmp10);
...
void FlxGame_obj::onFocus( ::Dynamic _){
            	...
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(_,"_")
HXLINE( 381)		Bool _hx_tmp = !(this->_onFocusFiredOnce);
...
HXLINE( 395)		this->_state->onFocus();
HXLINE( 397)		if (!(::flixel::FlxG_obj::autoPause)) {
HXLINE( 399)			return;
            		}
HXLINE( 403)		Bool _hx_tmp1 = hx::IsNotNull( this->_focusLostScreen );
HXDLIN( 403)		if (_hx_tmp1) {
HXLINE( 405)			this->_focusLostScreen->set_visible(false);
            		}
...
HXLINE( 431)		this->_state->onFocusLost();
HXLINE( 433)		if (!(::flixel::FlxG_obj::autoPause)) {
HXLINE( 435)			return;
            		}
HXLINE( 439)		Bool _hx_tmp = hx::IsNotNull( this->_focusLostScreen );
HXDLIN( 439)		if (_hx_tmp) {
HXLINE( 441)			this->_focusLostScreen->set_visible(true);
            		}
...
HXLINE( 463)		Bool _hx_tmp = ::flixel::FlxG_obj::renderTile;
...
HXLINE( 486)		Bool _hx_tmp = hx::IsNotNull( this->_focusLostScreen );
HXDLIN( 486)		if (_hx_tmp) {
HXLINE( 488)			this->_focusLostScreen->draw();
            		}
HXLINE( 493)		Bool _hx_tmp1 = hx::IsNotNull( this->soundTray );
...
HXDLIN( 517)		Bool _hx_tmp2 = hx::IsNotNull( this->soundTray );
...
HXLINE( 523)			_hx_tmp3 = !(::flixel::FlxG_obj::autoPause);
            		}
            		else {
HXLINE( 523)			_hx_tmp3 = true;
            		}
HXDLIN( 523)		if (_hx_tmp3) {
HXLINE( 525)			Bool _hx_tmp4 = ::flixel::FlxG_obj::vcr->paused;
HXDLIN( 525)			if (_hx_tmp4) {
HXLINE( 527)				Bool _hx_tmp5 = ::flixel::FlxG_obj::vcr->stepRequested;
...
HXLINE( 538)						Bool _hx_tmp6 = this->debugger->interaction->isActive();
...
HXLINE( 547)			Bool _hx_tmp7 = ::flixel::FlxG_obj::fixedTimestep;
HXDLIN( 547)			if (_hx_tmp7) {
HXLINE( 549)				hx::AddEq(this->_accumulator,this->_elapsedMS);
HXLINE( 550)				Float _hx_tmp8;
HXDLIN( 550)				if ((this->_accumulator > this->_maxAccumulation)) {
HXLINE( 550)					_hx_tmp8 = this->_maxAccumulation;
            				}
            				else {
HXLINE( 550)					_hx_tmp8 = this->_accumulator;
            				}
HXDLIN( 550)				this->_accumulator = _hx_tmp8;
HXLINE( 552)				while((this->_accumulator >= this->_stepMS)){
HXLINE( 554)					this->step();
HXLINE( 555)					hx::SubEq(this->_accumulator,this->_stepMS);
            				}
            			}
            			else {
...
HXLINE( 591)			Bool _hx_tmp1 = hx::IsNull( ::flixel::_hx_system::FlxSplash_obj::nextState );
...
HXLINE( 599)			this->_requestedState =  ::flixel::_hx_system::FlxSplash_obj::__new(null());
HXLINE( 600)			this->_skipSplash = true;
            		}
HXLINE( 604)		Bool _hx_tmp2 = ::Std_obj::is(this->_requestedState,hx::ClassOf< ::flixel::FlxSubState >());
...
HXLINE( 636)		Bool _hx_tmp = hx::IsNotNull( this->_state );
...
HXLINE( 651)		Bool _hx_tmp1 = this->_gameJustStarted;
HXDLIN( 651)		if (_hx_tmp1) {
HXLINE( 653)			this->gameStart();
            		}
HXLINE( 657)		{
HXLINE( 657)			HX_VARI(  ::Dynamic,anyObject) = this->_state;
HXDLIN( 657)			this->debugger->console->registeredObjects->set(HX_("state",11,76,0b,84),anyObject);
HXDLIN( 657)			::flixel::_hx_system::debug::console::ConsoleUtil_obj::registerObject(HX_("state",11,76,0b,84),anyObject);
            		}
            	}
...
void FlxGame_obj::step(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 676)		Bool _hx_tmp = this->_resetGame;
...
HXLINE( 678)					_hx_tmp1 = hx::IsNotNull( ::flixel::_hx_system::FlxSplash_obj::nextState );
            				}
            				else {
...
HXDLIN( 678)					Bool _hx_tmp2 = hx::IsNull( ::flixel::_hx_system::FlxSplash_obj::nextState );
...
HXDLIN( 678)					this->_requestedState =  ::flixel::_hx_system::FlxSplash_obj::__new(null());
HXDLIN( 678)					this->_skipSplash = true;
            				}
HXDLIN( 678)				Bool _hx_tmp3 = ::Std_obj::is(this->_requestedState,hx::ClassOf< ::flixel::FlxSubState >());
...
HXLINE( 682)		this->handleReplayRequests();
...
HXLINE( 743)		Bool _hx_tmp1 = ::flixel::FlxG_obj::debugger->visible;
HXDLIN( 743)		if (_hx_tmp1) {
HXLINE( 744)			Int _hx_tmp2 = ( (Int)(this->getTimer()) );
HXDLIN( 744)			this->ticks = (_hx_tmp2 - this->_startTime);
            		}
HXLINE( 747)		this->updateElapsed();
HXLINE( 749)		::flixel::FlxG_obj::signals->preUpdate->dispatch();
HXLINE( 751)		this->updateInput();
HXLINE( 754)		Bool _hx_tmp3 = hx::IsNotNull( this->postProcesses->__get((int)0).StaticCast<  ::flixel::effects::postprocess::PostProcess >() );
...
HXLINE( 763)						_hx_tmp4 = plugin->active;
            					}
            					else {
HXLINE( 763)						_hx_tmp4 = false;
            					}
...
HXDLIN( 767)					++_g2;
HXDLIN( 767)					Bool _hx_tmp5;
HXDLIN( 767)					Bool _hx_tmp6;
HXDLIN( 767)					Bool _hx_tmp7 = hx::IsNotNull( camera );
HXDLIN( 767)					if (_hx_tmp7) {
HXLINE( 767)						_hx_tmp6 = camera->exists;
            					}
            					else {
HXLINE( 767)						_hx_tmp6 = false;
            					}
HXDLIN( 767)					if (_hx_tmp6) {
HXLINE( 767)						_hx_tmp5 = camera->active;
            					}
            					else {
HXLINE( 767)						_hx_tmp5 = false;
            					}
...
HXLINE( 771)		Int _hx_tmp8 = ( (Int)(this->getTimer()) );
HXDLIN( 771)		Int _hx_tmp9 = ((_hx_tmp8 - this->_startTime) - this->ticks);
HXDLIN( 771)		this->debugger->stats->flixelUpdate(_hx_tmp9);
HXLINE( 775)		::flixel::util::FlxArrayUtil_obj::clearArray(::flixel::FlxG_obj::swipes,null());
HXLINE( 778)		::Array< ::Dynamic> _hx_tmp10;
HXDLIN( 778)		if (this->filtersEnabled) {
HXLINE( 778)			_hx_tmp10 = this->_filters;
            		}
            		else {
HXLINE( 778)			_hx_tmp10 = null();
            		}
HXDLIN( 778)		this->set_filters(_hx_tmp10);
            	}
...
void FlxGame_obj::updateElapsed(){
            	HX_STACK_FRAME("flixel.FlxGame","updateElapsed",0x372d9117,"flixel.FlxGame.updateElapsed","flixel/FlxGame.hx",783,0x34f39fed)
            	HX_STACK_THIS(this)
HXLINE( 783)		Bool _hx_tmp = ::flixel::FlxG_obj::fixedTimestep;
HXDLIN( 783)		if (_hx_tmp) {
HXLINE( 785)			::flixel::FlxG_obj::elapsed = (::flixel::FlxG_obj::timeScale * this->_stepSeconds);
            		}
            		else {
HXLINE( 789)			Float _hx_tmp1 = ::flixel::FlxG_obj::timeScale;
HXDLIN( 789)			Float _hx_tmp2 = ((Float)this->_elapsedMS / (Float)(int)1000);
HXDLIN( 789)			::flixel::FlxG_obj::elapsed = (_hx_tmp1 * _hx_tmp2);
HXLINE( 791)			HX_VARI( Float,max) = (::flixel::FlxG_obj::maxElapsed * ::flixel::FlxG_obj::timeScale);
HXLINE( 792)			Bool _hx_tmp3 = (::flixel::FlxG_obj::elapsed > max);
...
HXLINE( 868)		Bool _hx_tmp1 = ::flixel::FlxG_obj::debugger->visible;
HXDLIN( 868)		if (_hx_tmp1) {
HXLINE( 869)			Int _hx_tmp2 = ( (Int)(this->getTimer()) );
HXDLIN( 869)			this->ticks = (_hx_tmp2 - this->_startTime);
            		}
HXLINE( 872)		::flixel::FlxG_obj::signals->preDraw->dispatch();
HXLINE( 874)		Bool _hx_tmp3 = ::flixel::FlxG_obj::renderTile;
HXDLIN( 874)		if (_hx_tmp3) {
HXLINE( 876)			::flixel::graphics::tile::FlxTilesheet_obj::_DRAWCALLS = (int)0;
            		}
HXLINE( 880)		Bool _hx_tmp4 = hx::IsNotNull( this->postProcesses->__get((int)0).StaticCast<  ::flixel::effects::postprocess::PostProcess >() );
...
HXDLIN( 886)					Bool _hx_tmp7 = hx::IsNotNull( camera );
HXDLIN( 886)					if (_hx_tmp7) {
HXLINE( 886)						_hx_tmp6 = !(camera->exists);
            					}
            					else {
HXLINE( 886)						_hx_tmp6 = true;
            					}
HXDLIN( 886)					if (!(_hx_tmp6)) {
HXLINE( 886)						_hx_tmp5 = !(camera->visible);
            					}
            					else {
HXLINE( 886)						_hx_tmp5 = true;
            					}
HXDLIN( 886)					if (_hx_tmp5) {
HXLINE( 886)						continue;
            					}
HXDLIN( 886)					Bool _hx_tmp8 = ::flixel::FlxG_obj::renderBlit;
HXDLIN( 886)					if (_hx_tmp8) {
HXLINE( 886)						camera->checkResize();
HXDLIN( 886)						Bool _hx_tmp9 = _this->useBufferLocking;
HXDLIN( 886)						if (_hx_tmp9) {
HXLINE( 886)							camera->buffer->lock();
            						}
            					}
HXDLIN( 886)					Bool _hx_tmp10 = ::flixel::FlxG_obj::renderTile;
HXDLIN( 886)					if (_hx_tmp10) {
...
HXDLIN( 886)					Bool _hx_tmp11 = ::flixel::FlxG_obj::renderBlit;
HXDLIN( 886)					if (_hx_tmp11) {
HXLINE( 886)						camera->fill(camera->bgColor,camera->useBgAlphaBlending,null(),null());
HXDLIN( 886)						camera->screen->dirty = true;
            					}
            					else {
HXLINE( 886)						Int _hx_tmp12 = ((int)camera->bgColor & (int)(int)16777215);
HXDLIN( 886)						Float _hx_tmp13 = ((Float)((int)((int)camera->bgColor >> (int)(int)24) & (int)(int)255) / (Float)(int)255);
HXDLIN( 886)						camera->fill(_hx_tmp12,camera->useBgAlphaBlending,_hx_tmp13,null());
            					}
            				}
            			}
            		}
...
HXDLIN( 888)				++_g2;
HXDLIN( 888)				Bool _hx_tmp14;
HXDLIN( 888)				if (plugin->exists) {
HXLINE( 888)					_hx_tmp14 = plugin->visible;
            				}
            				else {
HXLINE( 888)					_hx_tmp14 = false;
            				}
HXDLIN( 888)				if (_hx_tmp14) {
HXLINE( 888)					plugin->draw();
            				}
            			}
            		}
HXLINE( 890)		this->_state->draw();
HXLINE( 892)		Bool _hx_tmp15 = ::flixel::FlxG_obj::renderTile;
HXDLIN( 892)		if (_hx_tmp15) {
HXLINE( 894)			Bool _hx_tmp16 = ::flixel::FlxG_obj::renderTile;
HXDLIN( 894)			if (_hx_tmp16) {
...
HXDLIN( 894)					++_g3;
HXDLIN( 894)					Bool _hx_tmp17;
HXDLIN( 894)					Bool _hx_tmp18;
HXDLIN( 894)					Bool _hx_tmp19 = hx::IsNotNull( camera1 );
HXDLIN( 894)					if (_hx_tmp19) {
HXLINE( 894)						_hx_tmp18 = camera1->exists;
            					}
            					else {
HXLINE( 894)						_hx_tmp18 = false;
            					}
HXDLIN( 894)					if (_hx_tmp18) {
HXLINE( 894)						_hx_tmp17 = camera1->visible;
            					}
            					else {
HXLINE( 894)						_hx_tmp17 = false;
            					}
HXDLIN( 894)					if (_hx_tmp17) {
...
HXDLIN( 901)					++_g4;
HXDLIN( 901)					Bool _hx_tmp20;
HXDLIN( 901)					Bool _hx_tmp21;
HXDLIN( 901)					Bool _hx_tmp22 = hx::IsNotNull( camera2 );
HXDLIN( 901)					if (_hx_tmp22) {
HXLINE( 901)						_hx_tmp21 = !(camera2->exists);
            					}
            					else {
HXLINE( 901)						_hx_tmp21 = true;
            					}
HXDLIN( 901)					if (!(_hx_tmp21)) {
HXLINE( 901)						_hx_tmp20 = !(camera2->visible);
            					}
            					else {
HXLINE( 901)						_hx_tmp20 = true;
            					}
HXDLIN( 901)					if (_hx_tmp20) {
HXLINE( 901)						continue;
            					}
HXDLIN( 901)					camera2->drawFX();
HXDLIN( 901)					Bool _hx_tmp23 = ::flixel::FlxG_obj::renderBlit;
HXDLIN( 901)					if (_hx_tmp23) {
HXLINE( 901)						Bool _hx_tmp24 = _this1->useBufferLocking;
HXDLIN( 901)						if (_hx_tmp24) {
...
HXLINE( 906)		Int _hx_tmp25 = ( (Int)(this->getTimer()) );
HXDLIN( 906)		Int _hx_tmp26 = ((_hx_tmp25 - this->_startTime) - this->ticks);
HXDLIN( 906)		this->debugger->stats->flixelDraw(_hx_tmp26);
            	}
...
Int FlxGame_obj::getTicks(){
            	HX_STACK_FRAME("flixel.FlxGame","getTicks",0x73d7349c,"flixel.FlxGame.getTicks","flixel/FlxGame.hx",912,0x34f39fed)
            	HX_STACK_THIS(this)
...
Int _hx_run(){
            	HX_STACK_FRAME("flixel.FlxGame","__default_getTimer",0xda03b289,"flixel.FlxGame.__default_getTimer","flixel/FlxGame.hx",918,0x34f39fed)
            	HX_STACK_THIS(this)
