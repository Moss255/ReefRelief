...
HXLINE( 479)		Bool _hx_tmp = hx::IsNotNull( this->_setXCallback );
HXDLIN( 479)		if (_hx_tmp) {
HXLINE( 481)			Bool _hx_tmp1 = hx::IsNull( this->_setYCallback );
HXDLIN( 481)			if (_hx_tmp1) {
HXLINE( 482)				this->_setYCallback = setXCallback;
            			}
HXLINE( 483)			Bool _hx_tmp2 = hx::IsNull( this->_setXYCallback );
...
HXLINE( 491)		Bool _hx_tmp = hx::IsNotNull( this->_setXYCallback );
...
HXLINE( 499)		Bool _hx_tmp = hx::IsNotNull( this->_setXCallback );
...
HXLINE( 507)		Bool _hx_tmp = hx::IsNotNull( this->_setYCallback );
