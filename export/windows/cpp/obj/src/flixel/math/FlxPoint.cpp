...
HXDLIN( 163)			Float _hx_tmp = (_g->x * k);
HXDLIN( 163)			_g->set_x(_hx_tmp);
            		}
HXLINE( 164)		{
HXLINE( 164)			HX_VARI_NAME(  ::flixel::math::FlxPoint,_g1,"_g") = hx::ObjectPtr<OBJ_>(this);
HXDLIN( 164)			Float _hx_tmp1 = (_g1->y * k);
HXDLIN( 164)			_g1->set_y(_hx_tmp1);
            		}
...
HXLINE( 178)		Bool _hx_tmp = point->_weak;
...
HX_DEFINE_DYNAMIC_FUNC1(FlxPoint_obj,copyFrom,return )
 ...
 ::flixel::math::FlxPoint FlxPoint_obj::copyTo( ::flixel::math::FlxPoint point){
            	...
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(point,"point")
HXLINE( 190)		Bool _hx_tmp = hx::IsNull( point );
...
HX_DEFINE_DYNAMIC_FUNC1(FlxPoint_obj,copyFromFlash,return )
 ...
 ::openfl::_legacy::geom::Point FlxPoint_obj::copyToFlash( ::openfl::_legacy::geom::Point FlashPoint){
            	...
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(FlashPoint,"FlashPoint")
HXLINE( 220)		Bool _hx_tmp = hx::IsNull( FlashPoint );
HXDLIN( 220)		if (_hx_tmp) {
HXLINE( 222)			FlashPoint =  ::openfl::_legacy::geom::Point_obj::__new(null(),null());
            		}
...
HX_DEFINE_DYNAMIC_FUNC1(FlxPoint_obj,copyToFlash,return )
 ...
 ::openfl::_legacy::geom::Point FlxPoint_obj::addToFlash( ::openfl::_legacy::geom::Point FlashPoint){
            	...
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(FlashPoint,"FlashPoint")
HXLINE( 238)		hx::AddEq(FlashPoint->x,this->x);
HXLINE( 239)		hx::AddEq(FlashPoint->y,this->y);
...
HX_DEFINE_DYNAMIC_FUNC1(FlxPoint_obj,addToFlash,return )
 ...
 ::openfl::_legacy::geom::Point FlxPoint_obj::subtractFromFlash( ::openfl::_legacy::geom::Point FlashPoint){
            	...
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(FlashPoint,"FlashPoint")
HXLINE( 252)		hx::SubEq(FlashPoint->x,this->x);
HXLINE( 253)		hx::SubEq(FlashPoint->y,this->y);
...
Bool FlxPoint_obj::inCoords(Float RectX,Float RectY,Float RectWidth,Float RectHeight){
            	HX_STACK_FRAME("flixel.math.FlxPoint","inCoords",0x2c48255f,"flixel.math.FlxPoint.inCoords","flixel/math/FlxPoint.hx",269,0xb3e1cd2c)
            	HX_STACK_THIS(this)
...
Bool FlxPoint_obj::inRect( ::flixel::math::FlxRect Rect){
            	HX_STACK_FRAME("flixel.math.FlxPoint","inRect",0x14ec4c25,"flixel.math.FlxPoint.inRect","flixel/math/FlxPoint.hx",280,0xb3e1cd2c)
            	HX_STACK_THIS(this)
...
HXLINE( 293)		Bool _hx_tmp = point->_weak;
...
HX_DEFINE_DYNAMIC_FUNC1(FlxPoint_obj,distanceTo,return )
 ...
 ::flixel::math::FlxPoint FlxPoint_obj::floor(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 302)		Int _hx_tmp = ::Math_obj::floor(this->x);
HXDLIN( 302)		this->set_x(_hx_tmp);
HXLINE( 303)		Int _hx_tmp1 = ::Math_obj::floor(this->y);
HXDLIN( 303)		this->set_y(_hx_tmp1);
...
HX_DEFINE_DYNAMIC_FUNC0(FlxPoint_obj,floor,return )
 ...
 ::flixel::math::FlxPoint FlxPoint_obj::ceil(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 312)		Int _hx_tmp = ::Math_obj::ceil(this->x);
HXDLIN( 312)		this->set_x(_hx_tmp);
HXLINE( 313)		Int _hx_tmp1 = ::Math_obj::ceil(this->y);
HXDLIN( 313)		this->set_y(_hx_tmp1);
...
HX_DEFINE_DYNAMIC_FUNC0(FlxPoint_obj,ceil,return )
 ...
 ::flixel::math::FlxPoint FlxPoint_obj::round(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 322)		Int _hx_tmp = ::Math_obj::round(this->x);
HXDLIN( 322)		this->set_x(_hx_tmp);
HXLINE( 323)		Int _hx_tmp1 = ::Math_obj::round(this->y);
HXDLIN( 323)		this->set_y(_hx_tmp1);
...
HXLINE( 337)			Int _hx_tmp = ::Math_obj::ceil(n);
HXDLIN( 337)			hx::SubEq(n,((int)((int)_hx_tmp >> (int)(int)1) << (int)(int)1));
            		}
            		else {
HXLINE( 337)			if ((n < (int)-1)) {
HXLINE( 337)				Int _hx_tmp1 = ::Math_obj::ceil(-(n));
HXDLIN( 337)				hx::AddEq(n,((int)((int)_hx_tmp1 >> (int)(int)1) << (int)(int)1));
            			}
            		}
...
HXDLIN( 338)		hx::MultEq(n1,((Float)0.3183098862));
HXDLIN( 338)		if ((n1 > (int)1)) {
HXLINE( 338)			Int _hx_tmp2 = ::Math_obj::ceil(n1);
HXDLIN( 338)			hx::SubEq(n1,((int)((int)_hx_tmp2 >> (int)(int)1) << (int)(int)1));
            		}
            		else {
HXLINE( 338)			if ((n1 < (int)-1)) {
HXLINE( 338)				Int _hx_tmp3 = ::Math_obj::ceil(-(n1));
HXDLIN( 338)				hx::AddEq(n1,((int)((int)_hx_tmp3 >> (int)(int)1) << (int)(int)1));
            			}
            		}
...
HXLINE( 342)		Float _hx_tmp4 = (((cos * dx) - (sin * dy)) + Pivot->x);
HXDLIN( 342)		this->set_x(_hx_tmp4);
HXLINE( 343)		Float _hx_tmp5 = (((sin * dx) + (cos * dy)) + Pivot->y);
HXDLIN( 343)		this->set_y(_hx_tmp5);
HXLINE( 345)		Bool _hx_tmp6 = Pivot->_weak;
...
HXLINE( 364)			HX_VARI( Float,c2) = ((int)3 * c1);
...
HXLINE( 375)			Float _hx_tmp1;
HXDLIN( 375)			if ((y < (int)0)) {
HXLINE( 375)				_hx_tmp1 = -(angle);
            			}
            			else {
HXLINE( 375)				_hx_tmp1 = angle;
            			}
HXDLIN( 375)			angle = (_hx_tmp1 * ((Float)(int)180 / (Float)::Math_obj::PI));
HXLINE( 377)			Bool _hx_tmp2 = (angle > (int)90);
HXDLIN( 377)			if (_hx_tmp2) {
HXLINE( 379)				hx::SubEq(angle,(int)270);
            			}
            			else {
HXLINE( 383)				hx::AddEq(angle,(int)90);
            			}
            		}
HXLINE( 387)		Bool _hx_tmp3 = point->_weak;
...
HXDLIN( 399)		Float aValueA = this->x;
HXDLIN( 399)		Float aValueB = point->x;
HXDLIN( 399)		Float _hx_tmp = ::Math_obj::abs((aValueA - aValueB));
HXDLIN( 399)		if ((_hx_tmp <= ((Float)0.0000001))) {
HXLINE( 399)			Float aValueA1 = this->y;
HXDLIN( 399)			Float aValueB1 = point->y;
HXDLIN( 399)			Float _hx_tmp1 = ::Math_obj::abs((aValueA1 - aValueB1));
HXDLIN( 399)			result = (_hx_tmp1 <= ((Float)0.0000001));
            		}
            		else {
HXLINE( 399)			result = false;
            		}
HXLINE( 400)		Bool _hx_tmp2 = point->_weak;
...
HXLINE( 416)		HX_VARI( Float,x1) = (((this->x * matrix->a) + (this->y * matrix->c)) + matrix->tx);
HXLINE( 417)		HX_VARI( Float,y1) = (((this->x * matrix->b) + (this->y * matrix->d)) + matrix->ty);
HXLINE( 419)		return this->set(x1,y1);
            	}
...
::String FlxPoint_obj::toString(){
            	HX_STACK_FRAME("flixel.math.FlxPoint","toString",0x13b40828,"flixel.math.FlxPoint.toString","flixel/math/FlxPoint.hx",427,0xb3e1cd2c)
            	HX_STACK_THIS(this)
...
Float FlxPoint_obj::set_x(Float Value){
            	HX_STACK_FRAME("flixel.math.FlxPoint","set_x",0x1a631e5f,"flixel.math.FlxPoint.set_x","flixel/math/FlxPoint.hx",437,0xb3e1cd2c)
            	HX_STACK_THIS(this)
...
Float FlxPoint_obj::set_y(Float Value){
            	HX_STACK_FRAME("flixel.math.FlxPoint","set_y",0x1a631e60,"flixel.math.FlxPoint.set_y","flixel/math/FlxPoint.hx",445,0xb3e1cd2c)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(Value,"Value")
...
::Dynamic FlxPoint_obj::get_pool(){
            	HX_STACK_FRAME("flixel.math.FlxPoint","get_pool",0xa55c73e1,"flixel.math.FlxPoint.get_pool","flixel/math/FlxPoint.hx",450,0xb3e1cd2c)
