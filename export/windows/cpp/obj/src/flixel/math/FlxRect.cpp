...
HXLINE( 372)		Bool _hx_tmp = hx::IsNull( result );
HXDLIN( 372)		if (_hx_tmp) {
HXLINE( 373)			Float X = (int)0;
HXDLIN( 373)			Float Y = (int)0;
HXDLIN( 373)			Float Width = (int)0;
HXDLIN( 373)			Float Height = (int)0;
HXDLIN( 373)			HX_VARI(  ::flixel::math::FlxRect,_this) = ::flixel::math::FlxRect_obj::_pool->get();
...
HXLINE( 377)		if ((x1 <= x0)) {
HXLINE( 379)			Bool _hx_tmp1 = rect->_weak;
HXDLIN( 379)			if (_hx_tmp1) {
HXLINE( 379)				Bool _hx_tmp2 = !(rect->_inPool);
...
HXLINE( 385)		if ((y1 <= y0)) {
HXLINE( 387)			Bool _hx_tmp3 = rect->_weak;
HXDLIN( 387)			if (_hx_tmp3) {
HXLINE( 387)				Bool _hx_tmp4 = !(rect->_inPool);
...
HXLINE( 391)		Bool _hx_tmp5 = rect->_weak;
HXDLIN( 391)		if (_hx_tmp5) {
HXLINE( 391)			Bool _hx_tmp6 = !(rect->_inPool);
HXDLIN( 391)			if (_hx_tmp6) {
...
::String FlxRect_obj::toString(){
            	HX_STACK_FRAME("flixel.math.FlxRect","toString",0x7047e358,"flixel.math.FlxRect.toString","flixel/math/FlxRect.hx",400,0x2aef791c)
            	HX_STACK_THIS(this)
...
Float FlxRect_obj::get_left(){
            	HX_STACK_FRAME("flixel.math.FlxRect","get_left",0xff43d63c,"flixel.math.FlxRect.get_left","flixel/math/FlxRect.hx",409,0x2aef791c)
            	HX_STACK_THIS(this)
...
Float FlxRect_obj::set_left(Float Value){
            	HX_STACK_FRAME("flixel.math.FlxRect","set_left",0xada12fb0,"flixel.math.FlxRect.set_left","flixel/math/FlxRect.hx",413,0x2aef791c)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(Value,"Value")
HXLINE( 414)		hx::SubEq(this->width,(Value - this->x));
...
Float FlxRect_obj::get_right(){
            	HX_STACK_FRAME("flixel.math.FlxRect","get_right",0xd324ac07,"flixel.math.FlxRect.get_right","flixel/math/FlxRect.hx",420,0x2aef791c)
            	HX_STACK_THIS(this)
...
Float FlxRect_obj::set_right(Float Value){
            	HX_STACK_FRAME("flixel.math.FlxRect","set_right",0xb6759813,"flixel.math.FlxRect.set_right","flixel/math/FlxRect.hx",424,0x2aef791c)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(Value,"Value")
...
Float FlxRect_obj::get_top(){
            	HX_STACK_FRAME("flixel.math.FlxRect","get_top",0x81be1600,"flixel.math.FlxRect.get_top","flixel/math/FlxRect.hx",431,0x2aef791c)
            	HX_STACK_THIS(this)
...
Float FlxRect_obj::set_top(Float Value){
            	HX_STACK_FRAME("flixel.math.FlxRect","set_top",0x74bfa70c,"flixel.math.FlxRect.set_top","flixel/math/FlxRect.hx",435,0x2aef791c)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(Value,"Value")
HXLINE( 436)		hx::SubEq(this->height,(Value - this->y));
...
Float FlxRect_obj::get_bottom(){
            	HX_STACK_FRAME("flixel.math.FlxRect","get_bottom",0x04446c60,"flixel.math.FlxRect.get_bottom","flixel/math/FlxRect.hx",442,0x2aef791c)
            	HX_STACK_THIS(this)
...
Float FlxRect_obj::set_bottom(Float Value){
            	HX_STACK_FRAME("flixel.math.FlxRect","set_bottom",0x07c20ad4,"flixel.math.FlxRect.set_bottom","flixel/math/FlxRect.hx",446,0x2aef791c)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(Value,"Value")
...
Bool FlxRect_obj::get_isEmpty(){
            	HX_STACK_FRAME("flixel.math.FlxRect","get_isEmpty",0x5fa91f2e,"flixel.math.FlxRect.get_isEmpty","flixel/math/FlxRect.hx",453,0x2aef791c)
            	HX_STACK_THIS(this)
...
::Dynamic FlxRect_obj::get_pool(){
            	HX_STACK_FRAME("flixel.math.FlxRect","get_pool",0x01f04f11,"flixel.math.FlxRect.get_pool","flixel/math/FlxRect.hx",458,0x2aef791c)
