...
HXLINE( 156)		this->_filledBarPoint =  ::openfl::_legacy::geom::Point_obj::__new(null(),null());
HXLINE( 157)		this->_filledBarRect =  ::openfl::_legacy::geom::Rectangle_obj::__new(null(),null(),null(),null());
HXLINE( 158)		Bool _hx_tmp1 = ::flixel::FlxG_obj::renderBlit;
HXDLIN( 158)		if (_hx_tmp1) {
HXLINE( 160)			this->_zeroOffset =  ::openfl::_legacy::geom::Point_obj::__new(null(),null());
HXLINE( 161)			this->_emptyBarRect =  ::openfl::_legacy::geom::Rectangle_obj::__new(null(),null(),null(),null());
...
HXLINE( 349)					emptyBar =  ::openfl::_legacy::display::BitmapData_obj::__new(this->barWidth,this->barHeight,true,border,null());
HXLINE( 350)					Int _hx_tmp17 = (this->barWidth - (int)2);
HXDLIN( 350)					Int _hx_tmp18 = (this->barHeight - (int)2);
HXDLIN( 350)					emptyBar->fillRect( ::openfl::_legacy::geom::Rectangle_obj::__new((int)1,(int)1,_hx_tmp17,_hx_tmp18),empty);
            				}
            				else {
HXLINE( 354)					emptyBar =  ::openfl::_legacy::display::BitmapData_obj::__new(this->barWidth,this->barHeight,true,empty,null());
            				}
...
HXLINE( 366)				this->_emptyBar =  ::openfl::_legacy::display::BitmapData_obj::__new(this->barWidth,this->barHeight,true,border,null());
HXLINE( 367)				Int _hx_tmp20 = (this->barWidth - (int)2);
HXDLIN( 367)				Int _hx_tmp21 = (this->barHeight - (int)2);
HXDLIN( 367)				this->_emptyBar->fillRect( ::openfl::_legacy::geom::Rectangle_obj::__new((int)1,(int)1,_hx_tmp20,_hx_tmp21),empty);
            			}
            			else {
HXLINE( 371)				this->_emptyBar =  ::openfl::_legacy::display::BitmapData_obj::__new(this->barWidth,this->barHeight,true,empty,null());
            			}
...
HXLINE( 402)					filledBar =  ::openfl::_legacy::display::BitmapData_obj::__new(this->barWidth,this->barHeight,true,border,null());
HXLINE( 403)					Int _hx_tmp17 = (this->barWidth - (int)2);
HXDLIN( 403)					Int _hx_tmp18 = (this->barHeight - (int)2);
HXDLIN( 403)					filledBar->fillRect( ::openfl::_legacy::geom::Rectangle_obj::__new((int)1,(int)1,_hx_tmp17,_hx_tmp18),fill);
            				}
            				else {
HXLINE( 407)					filledBar =  ::openfl::_legacy::display::BitmapData_obj::__new(this->barWidth,this->barHeight,true,fill,null());
            				}
...
HXLINE( 419)				this->_filledBar =  ::openfl::_legacy::display::BitmapData_obj::__new(this->barWidth,this->barHeight,true,border,null());
HXLINE( 420)				Int _hx_tmp20 = (this->barWidth - (int)2);
HXDLIN( 420)				Int _hx_tmp21 = (this->barHeight - (int)2);
HXDLIN( 420)				this->_filledBar->fillRect( ::openfl::_legacy::geom::Rectangle_obj::__new((int)1,(int)1,_hx_tmp20,_hx_tmp21),fill);
            			}
            			else {
HXLINE( 424)				this->_filledBar =  ::openfl::_legacy::display::BitmapData_obj::__new(this->barWidth,this->barHeight,true,fill,null());
            			}
...
HXLINE( 484)					emptyBar =  ::openfl::_legacy::display::BitmapData_obj::__new(this->barWidth,this->barHeight,true,border,null());
...
HXLINE( 501)				this->_emptyBar =  ::openfl::_legacy::display::BitmapData_obj::__new(this->barWidth,this->barHeight,true,border,null());
...
HXLINE( 548)					filledBar =  ::openfl::_legacy::display::BitmapData_obj::__new(this->barWidth,this->barHeight,true,border,null());
...
HXLINE( 565)				this->_filledBar =  ::openfl::_legacy::display::BitmapData_obj::__new(this->barWidth,this->barHeight,true,border,null());
...
HXLINE( 797)		Bool _hx_tmp13 = ::flixel::FlxG_obj::renderBlit;
...
HXLINE( 805)		Bool _hx_tmp = hx::IsNotNull( this->parent );
HXDLIN( 805)		if (_hx_tmp) {
HXLINE( 807)			 ::Dynamic _hx_tmp1 = ::Reflect_obj::getProperty(this->parent,this->parentVariable);
HXDLIN( 807)			Float _hx_tmp2 = this->get_value();
HXDLIN( 807)			if (hx::IsNotEq( _hx_tmp1,_hx_tmp2 )) {
HXLINE( 809)				this->updateValueFromParent();
            			}
HXLINE( 812)			Bool _hx_tmp3 = !(this->fixedPosition);
HXDLIN( 812)			if (_hx_tmp3) {
HXLINE( 814)				 ::Dynamic _hx_tmp4 = ( ::Dynamic(this->parent->__Field(HX_("x",78,00,00,00),hx::paccDynamic)) + this->positionOffset->x);
HXDLIN( 814)				this->set_x(_hx_tmp4);
HXLINE( 815)				 ::Dynamic _hx_tmp5 = ( ::Dynamic(this->parent->__Field(HX_("y",79,00,00,00),hx::paccDynamic)) + this->positionOffset->y);
HXDLIN( 815)				this->set_y(_hx_tmp5);
            			}
            		}
...
HXDLIN( 832)		Float _hx_tmp1 = this->get_percent();
HXDLIN( 832)		if ((_hx_tmp1 > (int)0)) {
...
HXDLIN( 834)				++_g;
HXLINE( 836)				Bool _hx_tmp2;
HXDLIN( 836)				Bool _hx_tmp3;
HXDLIN( 836)				if (!(!(camera->visible))) {
HXLINE( 836)					_hx_tmp3 = !(camera->exists);
            				}
            				else {
HXLINE( 836)					_hx_tmp3 = true;
            				}
HXDLIN( 836)				if (!(_hx_tmp3)) {
HXLINE( 836)					_hx_tmp2 = !(this->isOnScreen(camera));
            				}
            				else {
...
HXLINE( 848)				Bool _hx_tmp4 = (this->angle != (int)0);
...
HXDLIN( 850)					Float _hx_tmp5 = (_this->a * sin);
HXDLIN( 850)					Float _hx_tmp6 = (_this->b * cos);
HXDLIN( 850)					_this->b = (_hx_tmp5 + _hx_tmp6);
HXDLIN( 850)					_this->a = a1;
HXDLIN( 850)					HX_VARI( Float,c1) = ((_this->c * cos) - (_this->d * sin));
HXDLIN( 850)					Float _hx_tmp7 = (_this->c * sin);
HXDLIN( 850)					Float _hx_tmp8 = (_this->d * cos);
HXDLIN( 850)					_this->d = (_hx_tmp7 + _hx_tmp8);
HXDLIN( 850)					_this->c = c1;
HXDLIN( 850)					HX_VARI( Float,tx1) = ((_this->tx * cos) - (_this->ty * sin));
HXDLIN( 850)					Float _hx_tmp9 = (_this->tx * sin);
HXDLIN( 850)					Float _hx_tmp10 = (_this->ty * cos);
HXDLIN( 850)					_this->ty = (_hx_tmp9 + _hx_tmp10);
HXDLIN( 850)					_this->tx = tx1;
            				}
HXLINE( 853)				{
HXLINE( 853)					HX_VARI_NAME(  ::flixel::math::FlxPoint,_this1,"_this") = this->_point;
HXDLIN( 853)					Float X = this->origin->x;
HXDLIN( 853)					Float Y = this->origin->y;
HXDLIN( 853)					{
HXLINE( 853)						Float _hx_tmp11 = (_this1->x + X);
HXDLIN( 853)						_this1->set_x(_hx_tmp11);
            					}
HXDLIN( 853)					{
HXLINE( 853)						Float _hx_tmp12 = (_this1->y + Y);
HXDLIN( 853)						_this1->set_y(_hx_tmp12);
            					}
            				}
HXLINE( 854)				Bool _hx_tmp13 = this->isPixelPerfectRender(camera);
HXDLIN( 854)				if (_hx_tmp13) {
HXLINE( 856)					HX_VARI_NAME(  ::flixel::math::FlxPoint,_this2,"_this") = this->_point;
HXDLIN( 856)					Int _hx_tmp14 = ::Math_obj::floor(_this2->x);
HXDLIN( 856)					_this2->set_x(_hx_tmp14);
HXDLIN( 856)					Int _hx_tmp15 = ::Math_obj::floor(_this2->y);
HXDLIN( 856)					_this2->set_y(_hx_tmp15);
            				}
...
HXLINE( 860)				camera->drawPixels(this->_frontFrame,null(),this->_matrix,this->colorTransform,this->blend,this->antialiasing,this->shader);
 ...
 ::openfl::_legacy::display::BitmapData FlxBar_obj::set_pixels( ::openfl::_legacy::display::BitmapData Pixels){
            	HX_STACK_FRAME("flixel.ui.FlxBar","set_pixels",0x3c70e2cf,"flixel.ui.FlxBar.set_pixels","flixel/ui/FlxBar.hx",867,0x9c56c8d5)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(Pixels,"Pixels")
HXLINE( 867)		Bool _hx_tmp = ::flixel::FlxG_obj::renderTile;
...
::String FlxBar_obj::toString(){
            	HX_STACK_FRAME("flixel.ui.FlxBar","toString",0x909c22d1,"flixel.ui.FlxBar.toString","flixel/ui/FlxBar.hx",879,0x9c56c8d5)
            	HX_STACK_THIS(this)
...
Float FlxBar_obj::get_percent(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 890)		Float _hx_tmp = this->get_value();
HXDLIN( 890)		if ((_hx_tmp > this->max)) {
HXLINE( 892)			return this->_maxPercent;
            		}
HXLINE( 895)		Float _hx_tmp1 = this->get_value();
HXDLIN( 895)		Float _hx_tmp2 = (((Float)(_hx_tmp1 - this->min) / (Float)this->range) * this->_maxPercent);
HXDLIN( 895)		return ::Math_obj::floor(_hx_tmp2);
            	}
...
HXLINE( 902)			Float _hx_tmp1 = (this->pct * newPct);
HXDLIN( 902)			this->set_value(_hx_tmp1);
            		}
...
HXLINE( 909)		Float _hx_tmp = this->min;
HXDLIN( 909)		Float _hx_tmp1 = ::Math_obj::min(newValue,this->max);
HXDLIN( 909)		this->value = ::Math_obj::max(_hx_tmp,_hx_tmp1);
HXLINE( 911)		Bool _hx_tmp2;
HXDLIN( 911)		Float _hx_tmp3 = this->get_value();
HXDLIN( 911)		if ((_hx_tmp3 == this->min)) {
HXLINE( 911)			_hx_tmp2 = hx::IsNotNull( this->emptyCallback );
            		}
            		else {
...
HXLINE( 916)		Bool _hx_tmp4;
HXDLIN( 916)		Float _hx_tmp5 = this->get_value();
HXDLIN( 916)		if ((_hx_tmp5 == this->max)) {
HXLINE( 916)			_hx_tmp4 = hx::IsNotNull( this->filledCallback );
            		}
            		else {
HXLINE( 916)			_hx_tmp4 = false;
            		}
HXDLIN( 916)		if (_hx_tmp4) {
HXLINE( 918)			this->filledCallback();
            		}
HXLINE( 921)		Bool _hx_tmp6;
HXDLIN( 921)		Float _hx_tmp7 = this->get_value();
HXDLIN( 921)		if ((_hx_tmp7 == this->min)) {
HXLINE( 921)			_hx_tmp6 = this->killOnEmpty;
            		}
            		else {
HXLINE( 921)			_hx_tmp6 = false;
            		}
HXDLIN( 921)		if (_hx_tmp6) {
...
Float FlxBar_obj::get_value(){
            	HX_STACK_FRAME("flixel.ui.FlxBar","get_value",0x44dc6a03,"flixel.ui.FlxBar.get_value","flixel/ui/FlxBar.hx",939,0x9c56c8d5)
            	HX_STACK_THIS(this)
...
HXLINE( 960)		Bool _hx_tmp = ::flixel::FlxG_obj::renderTile;
HXDLIN( 960)		if (_hx_tmp) {
HXLINE( 962)			this->frontFrames = value;
HXLINE( 963)			 ::flixel::graphics::frames::FlxFrame _hx_tmp1;
HXDLIN( 963)			Bool _hx_tmp2 = hx::IsNotNull( value );
HXDLIN( 963)			if (_hx_tmp2) {
HXLINE( 963)				_hx_tmp1 = value->get_frame()->copyTo(this->_frontFrame);
            			}
            			else {
HXLINE( 963)				_hx_tmp1 = null();
            			}
HXDLIN( 963)			this->_frontFrame = _hx_tmp1;
            		}
            		else {
HXLINE( 967)			 ::openfl::_legacy::display::BitmapData _hx_tmp3 = value->get_frame()->paint(null(),null(),null(),null());
HXDLIN( 967)			this->createImageFilledBar(_hx_tmp3,null());
            		}
...
HX_DEFINE_DYNAMIC_FUNC0(FlxBar_obj,get_backFrames,return )
 ...
 ::flixel::graphics::frames::FlxImageFrame FlxBar_obj::set_backFrames( ::flixel::graphics::frames::FlxImageFrame value){
            	...
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(value,"value")
HXLINE( 984)		Bool _hx_tmp = ::flixel::FlxG_obj::renderTile;
HXDLIN( 984)		if (_hx_tmp) {
HXLINE( 986)			this->set_frames(value);
            		}
            		else {
HXLINE( 990)			 ::openfl::_legacy::display::BitmapData _hx_tmp1 = value->get_frame()->paint(null(),null(),null(),null());
HXDLIN( 990)			this->createImageEmptyBar(_hx_tmp1,null());
            		}
