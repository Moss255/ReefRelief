...
HXLINE( 145)		this->mouseButtons = ::Array_obj< Int >::fromData( _hx_array_data_0,1);
HXLINE( 140)		this->allowSwiping = true;
HXLINE( 135)		this->statusAnimations = ::Array_obj< ::String >::fromData( _hx_array_data_1,3);
HXLINE( 130)		this->labelAlphas = ::Array_obj< Float >::fromData( _hx_array_data_2,3);
...
HXLINE( 210)		this->onUp =  ::flixel::ui::_FlxButton::FlxButtonEvent_obj::__new(OnClick,null());
HXLINE( 211)		this->onDown =  ::flixel::ui::_FlxButton::FlxButtonEvent_obj::__new(null(),null());
HXLINE( 212)		this->onOver =  ::flixel::ui::_FlxButton::FlxButtonEvent_obj::__new(null(),null());
HXLINE( 213)		this->onOut =  ::flixel::ui::_FlxButton::FlxButtonEvent_obj::__new(null(),null());
...
HXLINE( 229)		this->input =  ::flixel::input::FlxInput_obj::__new((int)0);
            	}
...
HXLINE( 249)		Int _hx_tmp = (this->animation->_sprite->numFrames - (int)1);
HXDLIN( 249)		Float _hx_tmp1 = ::Math_obj::min(frameIndex,_hx_tmp);
HXDLIN( 249)		frameIndex = ::Std_obj::_hx_int(_hx_tmp1);
...
void FlxTypedButton_flixel_text_FlxText_obj::destroy(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 258)		 ::flixel::text::FlxText _hx_tmp = ( ( ::flixel::text::FlxText)(::flixel::util::FlxDestroyUtil_obj::destroy(this->label)) );
HXDLIN( 258)		this->set_label(_hx_tmp);
...
HXLINE( 288)		Bool _hx_tmp = this->visible;
HXDLIN( 288)		if (_hx_tmp) {
HXLINE( 292)			this->updateButton();
HXLINE( 296)			Bool _hx_tmp1 = (this->lastStatus != this->status);
...
void FlxTypedButton_flixel_text_FlxText_obj::updateStatusAnimation(){
            	HX_STACK_FRAME("flixel.ui.FlxTypedButton_flixel_text_FlxText","updateStatusAnimation",0xca93861e,"flixel.ui.FlxTypedButton_flixel_text_FlxText.updateStatusAnimation","flixel/ui/FlxButton.hx",306,0xc64cf442)
            	HX_STACK_THIS(this)
HXLINE( 306)		::String _hx_tmp = this->statusAnimations->__get(this->status);
HXDLIN( 306)		this->animation->play(_hx_tmp,null(),null(),null());
            	}
...
HXDLIN( 316)		Bool _hx_tmp1 = hx::IsNotNull( this->_spriteLabel );
...
HXLINE( 318)			::Array< ::Dynamic> _hx_tmp2 = this->get_cameras();
HXDLIN( 318)			this->_spriteLabel->set_cameras(_hx_tmp2);
...
HXLINE( 331)		Bool _hx_tmp = hx::IsNotNull( this->_spriteLabel );
...
HXLINE( 351)		Bool _hx_tmp = hx::IsNotNull( buttonNode );
...
HXLINE( 355)			HX_VARI(  ::flixel::graphics::frames::FlxTileFrames,tileFrames) = buttonNode->getTileFrames(point,null(),null());
HXLINE( 356)			this->set_frames(tileFrames);
            		}
HXLINE( 359)		Bool _hx_tmp1;
HXDLIN( 359)		if (result) {
HXLINE( 359)			_hx_tmp1 = hx::IsNotNull( this->label );
            		}
            		else {
...
HXLINE( 362)			Bool _hx_tmp2 = result;
...
HXLINE( 364)			Bool _hx_tmp3 = hx::IsNotNull( labelNode );
HXDLIN( 364)			if (_hx_tmp3) {
HXLINE( 366)				 ::flixel::graphics::frames::FlxImageFrame _hx_tmp4 = labelNode->getImageFrame();
HXDLIN( 366)				this->label->set_frames(_hx_tmp4);
            			}
            		}
...
HXDLIN( 391)		Bool _hx_tmp1 = (this->status != (int)0);
HXDLIN( 391)		if (_hx_tmp1) {
HXLINE( 392)			if (!(!(overlapFound))) {
HXLINE( 392)				Bool _hx_tmp2 = hx::IsNotNull( this->currentInput );
...
HXDLIN( 406)						Bool _hx_tmp1 = hx::IsNotNull( button );
...
HXDLIN( 437)		Bool _hx_tmp2 = (this->maxInputMovement != ::Math_obj::POSITIVE_INFINITY);
...
HXDLIN( 438)			 ::flixel::math::FlxPoint _hx_tmp3 = pointer->getScreenPosition(null(),point);
HXDLIN( 438)			Float _hx_tmp4 = justPressedPosition->distanceTo(_hx_tmp3);
HXLINE( 437)			_hx_tmp1 = (_hx_tmp4 > this->maxInputMovement);
            		}
            		else {
...
HXLINE( 443)			 ::flixel::math::FlxPoint _hx_tmp5 = pointer->getWorldPosition(camera,this->_point);
HXDLIN( 443)			Bool _hx_tmp6 = this->overlapsPoint(_hx_tmp5,true,camera);
HXDLIN( 443)			if (_hx_tmp6) {
...
void FlxTypedButton_flixel_text_FlxText_obj::updateStatus(::Dynamic input){
            	HX_STACK_FRAME("flixel.ui.FlxTypedButton_flixel_text_FlxText","updateStatus",0xf1701806,"flixel.ui.FlxTypedButton_flixel_text_FlxText.updateStatus","flixel/ui/FlxButton.hx",457,0xc64cf442)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(input,"input")
HXLINE( 457)		Bool _hx_tmp = ::flixel::input::IFlxInput_obj::get_justPressed(input);
HXDLIN( 457)		if (_hx_tmp) {
HXLINE( 459)			this->currentInput = input;
HXLINE( 460)			this->onDownHandler();
            		}
            		else {
HXLINE( 462)			Bool _hx_tmp1 = (this->status == (int)0);
HXDLIN( 462)			if (_hx_tmp1) {
HXLINE( 465)				Bool _hx_tmp2;
HXDLIN( 465)				Bool _hx_tmp3 = this->allowSwiping;
HXDLIN( 465)				if (_hx_tmp3) {
HXLINE( 465)					_hx_tmp2 = ::flixel::input::IFlxInput_obj::get_pressed(input);
            				}
            				else {
...
void FlxTypedButton_flixel_text_FlxText_obj::updateLabelPosition(){
            	HX_STACK_FRAME("flixel.ui.FlxTypedButton_flixel_text_FlxText","updateLabelPosition",0x2a00d069,"flixel.ui.FlxTypedButton_flixel_text_FlxText.updateLabelPosition","flixel/ui/FlxButton.hx",478,0xc64cf442)
            	HX_STACK_THIS(this)
HXLINE( 478)		Bool _hx_tmp = hx::IsNotNull( this->_spriteLabel );
HXDLIN( 478)		if (_hx_tmp) {
HXLINE( 480)			Float _hx_tmp1;
HXDLIN( 480)			Bool _hx_tmp2 = this->pixelPerfectPosition;
HXDLIN( 480)			if (_hx_tmp2) {
HXLINE( 480)				_hx_tmp1 = ::Math_obj::floor(this->x);
            			}
            			else {
HXLINE( 480)				_hx_tmp1 = this->x;
            			}
HXDLIN( 480)			Float _hx_tmp3 = (_hx_tmp1 + this->labelOffsets->__get(this->status).StaticCast<  ::flixel::math::FlxPoint >()->x);
HXDLIN( 480)			this->_spriteLabel->set_x(_hx_tmp3);
HXLINE( 481)			Float _hx_tmp4;
HXDLIN( 481)			Bool _hx_tmp5 = this->pixelPerfectPosition;
HXDLIN( 481)			if (_hx_tmp5) {
HXLINE( 481)				_hx_tmp4 = ::Math_obj::floor(this->y);
            			}
            			else {
HXLINE( 481)				_hx_tmp4 = this->y;
            			}
HXDLIN( 481)			Float _hx_tmp6 = (_hx_tmp4 + this->labelOffsets->__get(this->status).StaticCast<  ::flixel::math::FlxPoint >()->y);
HXDLIN( 481)			this->_spriteLabel->set_y(_hx_tmp6);
            		}
            	}
...
void FlxTypedButton_flixel_text_FlxText_obj::updateLabelAlpha(){
            	HX_STACK_FRAME("flixel.ui.FlxTypedButton_flixel_text_FlxText","updateLabelAlpha",0x3fb91f9e,"flixel.ui.FlxTypedButton_flixel_text_FlxText.updateLabelAlpha","flixel/ui/FlxButton.hx",487,0xc64cf442)
            	HX_STACK_THIS(this)
HXLINE( 487)		Bool _hx_tmp;
HXDLIN( 487)		Bool _hx_tmp1 = hx::IsNotNull( this->_spriteLabel );
...
HXLINE( 489)			Float _hx_tmp2 = (this->alpha * this->labelAlphas->__get(this->status));
HXDLIN( 489)			this->_spriteLabel->set_alpha(_hx_tmp2);
            		}
            	}
...
void FlxTypedButton_flixel_text_FlxText_obj::onUpEventListener( ::Dynamic _){
            	HX_STACK_FRAME("flixel.ui.FlxTypedButton_flixel_text_FlxText","onUpEventListener",0xcc8c5f29,"flixel.ui.FlxTypedButton_flixel_text_FlxText.onUpEventListener","flixel/ui/FlxButton.hx",500,0xc64cf442)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(_,"_")
...
HXDLIN( 516)			Bool _hx_tmp = hx::IsNotNull( _this->callback );
HXDLIN( 516)			if (_hx_tmp) {
HXLINE( 516)				_this->callback();
            			}
HXDLIN( 516)			Bool _hx_tmp1 = hx::IsNotNull( _this->sound );
...
HXDLIN( 527)			Bool _hx_tmp = hx::IsNotNull( _this->callback );
HXDLIN( 527)			if (_hx_tmp) {
HXLINE( 527)				_this->callback();
            			}
HXDLIN( 527)			Bool _hx_tmp1 = hx::IsNotNull( _this->sound );
...
HXDLIN( 537)			Bool _hx_tmp = hx::IsNotNull( _this->callback );
HXDLIN( 537)			if (_hx_tmp) {
HXLINE( 537)				_this->callback();
            			}
HXDLIN( 537)			Bool _hx_tmp1 = hx::IsNotNull( _this->sound );
...
HXDLIN( 548)			Bool _hx_tmp = hx::IsNotNull( _this->callback );
HXDLIN( 548)			if (_hx_tmp) {
HXLINE( 548)				_this->callback();
            			}
HXDLIN( 548)			Bool _hx_tmp1 = hx::IsNotNull( _this->sound );
...
HXLINE( 553)		Bool _hx_tmp = hx::IsNotNull( Value );
...
Bool FlxTypedButton_flixel_text_FlxText_obj::get_justReleased(){
            	HX_STACK_FRAME("flixel.ui.FlxTypedButton_flixel_text_FlxText","get_justReleased",0x234d62fd,"flixel.ui.FlxTypedButton_flixel_text_FlxText.get_justReleased","flixel/ui/FlxButton.hx",598,0xc64cf442)
            	HX_STACK_THIS(this)
...
Bool FlxTypedButton_flixel_text_FlxText_obj::get_released(){
            	HX_STACK_FRAME("flixel.ui.FlxTypedButton_flixel_text_FlxText","get_released",0x17b1c6b1,"flixel.ui.FlxTypedButton_flixel_text_FlxText.get_released","flixel/ui/FlxButton.hx",603,0xc64cf442)
            	HX_STACK_THIS(this)
...
Bool FlxTypedButton_flixel_text_FlxText_obj::get_pressed(){
            	HX_STACK_FRAME("flixel.ui.FlxTypedButton_flixel_text_FlxText","get_pressed",0x60818f2e,"flixel.ui.FlxTypedButton_flixel_text_FlxText.get_pressed","flixel/ui/FlxButton.hx",608,0xc64cf442)
            	HX_STACK_THIS(this)
...
Bool FlxTypedButton_flixel_text_FlxText_obj::get_justPressed(){
            	HX_STACK_FRAME("flixel.ui.FlxTypedButton_flixel_text_FlxText","get_justPressed",0x5f690062,"flixel.ui.FlxTypedButton_flixel_text_FlxText.get_justPressed","flixel/ui/FlxButton.hx",613,0xc64cf442)
            	HX_STACK_THIS(this)
