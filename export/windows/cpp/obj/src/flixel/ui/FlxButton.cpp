...
HXDLIN(  60)				Float _hx_tmp1 = (point->y + (int)3);
HXDLIN(  60)				point->set(_hx_tmp,_hx_tmp1);
            			}
            		}
HXLINE(  63)		Bool _hx_tmp2 = hx::IsNotNull( Text );
HXDLIN(  63)		if (_hx_tmp2) {
HXLINE(  63)			Float _hx_tmp3 = (this->x + this->labelOffsets->__get((int)0).StaticCast<  ::flixel::math::FlxPoint >()->x);
HXDLIN(  63)			Float _hx_tmp4 = (this->y + this->labelOffsets->__get((int)0).StaticCast<  ::flixel::math::FlxPoint >()->y);
HXDLIN(  63)			this->set_label( ::flixel::text::FlxText_obj::__new(_hx_tmp3,_hx_tmp4,(int)80,Text,null(),null()));
HXDLIN(  63)			this->label->setFormat(null(),(int)8,(int)3355443,HX_("center",d5,25,db,05),null(),null(),null());
HXDLIN(  63)			Float _hx_tmp5 = this->labelAlphas->__get(this->status);
HXDLIN(  63)			this->label->set_alpha(_hx_tmp5);
...
HXLINE(  73)		Bool _hx_tmp = hx::IsNotNull( this->label );
HXDLIN(  73)		if (_hx_tmp) {
HXLINE(  75)			Float _hx_tmp1 = this->get_width();
HXDLIN(  75)			Int _hx_tmp2 = (this->label->frameWidth = ::Std_obj::_hx_int(_hx_tmp1));
HXDLIN(  75)			this->label->set_fieldWidth(_hx_tmp2);
HXLINE(  76)			Int _hx_tmp3 = ::Std_obj::_hx_int(this->label->_defaultFormat->size);
HXDLIN(  76)			this->label->set_size(_hx_tmp3);
            		}
            	}


void FlxButton_obj::initLabel(::String Text){
            	HX_STACK_FRAME("flixel.ui.FlxButton","initLabel",0xd1ec8c72,"flixel.ui.FlxButton.initLabel","flixel/ui/FlxButton.hx",82,0xc64cf442)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(Text,"Text")
HXLINE(  82)		Bool _hx_tmp = hx::IsNotNull( Text );
HXDLIN(  82)		if (_hx_tmp) {
HXLINE(  84)			Float _hx_tmp1 = (this->x + this->labelOffsets->__get((int)0).StaticCast<  ::flixel::math::FlxPoint >()->x);
HXDLIN(  84)			Float _hx_tmp2 = (this->y + this->labelOffsets->__get((int)0).StaticCast<  ::flixel::math::FlxPoint >()->y);
HXDLIN(  84)			this->set_label( ::flixel::text::FlxText_obj::__new(_hx_tmp1,_hx_tmp2,(int)80,Text,null(),null()));
HXLINE(  85)			this->label->setFormat(null(),(int)8,(int)3355443,HX_("center",d5,25,db,05),null(),null(),null());
HXLINE(  86)			Float _hx_tmp3 = this->labelAlphas->__get(this->status);
HXDLIN(  86)			this->label->set_alpha(_hx_tmp3);
...
::String FlxButton_obj::get_text(){
            	HX_STACK_FRAME("flixel.ui.FlxButton","get_text",0x7dcfb448,"flixel.ui.FlxButton.get_text","flixel/ui/FlxButton.hx",93,0xc64cf442)
            	HX_STACK_THIS(this)
HXLINE(  93)		Bool _hx_tmp = hx::IsNotNull( this->label );
...
::String FlxButton_obj::set_text(::String Text){
            	...
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(Text,"Text")
HXLINE(  98)		Bool _hx_tmp = hx::IsNull( this->label );
HXDLIN(  98)		if (_hx_tmp) {
HXLINE( 100)			Bool _hx_tmp1 = hx::IsNotNull( Text );
HXDLIN( 100)			if (_hx_tmp1) {
HXLINE( 100)				Float _hx_tmp2 = (this->x + this->labelOffsets->__get((int)0).StaticCast<  ::flixel::math::FlxPoint >()->x);
HXDLIN( 100)				Float _hx_tmp3 = (this->y + this->labelOffsets->__get((int)0).StaticCast<  ::flixel::math::FlxPoint >()->y);
HXDLIN( 100)				this->set_label( ::flixel::text::FlxText_obj::__new(_hx_tmp2,_hx_tmp3,(int)80,Text,null(),null()));
HXDLIN( 100)				this->label->setFormat(null(),(int)8,(int)3355443,HX_("center",d5,25,db,05),null(),null(),null());
HXDLIN( 100)				Float _hx_tmp4 = this->labelAlphas->__get(this->status);
HXDLIN( 100)				this->label->set_alpha(_hx_tmp4);
...
{
{
            	HX_STACK_FRAME("flixel.ui.FlxButton","boot",0xff46bf44,"flixel.ui.FlxButton.boot","flixel/ui/FlxButton.hx",30,0xc64cf442)
HXLINE(  30)		NORMAL = (int)0;
            	}
{
            	HX_STACK_FRAME("flixel.ui.FlxButton","boot",0xff46bf44,"flixel.ui.FlxButton.boot","flixel/ui/FlxButton.hx",34,0xc64cf442)
HXLINE(  34)		HIGHLIGHT = (int)1;
            	}
{
            	HX_STACK_FRAME("flixel.ui.FlxButton","boot",0xff46bf44,"flixel.ui.FlxButton.boot","flixel/ui/FlxButton.hx",38,0xc64cf442)
