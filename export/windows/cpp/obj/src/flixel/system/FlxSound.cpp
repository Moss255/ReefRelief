...
HXLINE( 211)		Bool _hx_tmp = hx::IsNull( this->_transform );
HXDLIN( 211)		if (_hx_tmp) {
HXLINE( 212)			this->_transform =  ::openfl::media::SoundTransform_obj::__new(null(),null());
            		}
...
HXLINE( 225)		Bool _hx_tmp = hx::IsNotNull( this->_channel );
...
HXLINE( 232)		Bool _hx_tmp1 = hx::IsNotNull( this->_sound );
...
HXDLIN( 259)			Float _hx_tmp2 = targetPosition->distanceTo(point);
HXDLIN( 259)			radialMultiplier = ((Float)_hx_tmp2 / (Float)this->_radius);
...
HXDLIN( 261)			 ::Dynamic _hx_tmp3;
HXDLIN( 261)			if ((lowerBound > (int)1)) {
HXLINE( 261)				_hx_tmp3 = (int)1;
            			}
            			else {
HXLINE( 261)				_hx_tmp3 = lowerBound;
            			}
HXDLIN( 261)			radialMultiplier = ((int)1 - _hx_tmp3);
HXLINE( 263)			Bool _hx_tmp4 = this->_proximityPan;
...
HXDLIN( 266)				 ::Dynamic _hx_tmp5;
HXDLIN( 266)				if ((lowerBound1 > (int)1)) {
HXLINE( 266)					_hx_tmp5 = (int)1;
            				}
            				else {
HXLINE( 266)					_hx_tmp5 = lowerBound1;
            				}
HXDLIN( 266)				this->_transform->pan = _hx_tmp5;
            			}
            		}
HXLINE( 270)		this->_volumeAdjust = radialMultiplier;
HXLINE( 271)		this->updateTransform();
HXLINE( 273)		Bool _hx_tmp6 = (this->_transform->volume > (int)0);
HXDLIN( 273)		if (_hx_tmp6) {
HXLINE( 275)			Float _hx_tmp7 = this->_channel->get_leftPeak();
HXDLIN( 275)			this->amplitudeLeft = ((Float)_hx_tmp7 / (Float)this->_transform->volume);
HXLINE( 276)			Float _hx_tmp8 = this->_channel->get_rightPeak();
HXDLIN( 276)			this->amplitudeRight = ((Float)_hx_tmp8 / (Float)this->_transform->volume);
HXLINE( 277)			Float _hx_tmp9 = (this->amplitudeLeft + this->amplitudeRight);
HXDLIN( 277)			this->amplitude = (_hx_tmp9 * ((Float)0.5));
            		}
            		else {
...
HXDLIN( 286)		Bool _hx_tmp11 = hx::IsNotNull( this->endTime );
HXDLIN( 286)		if (_hx_tmp11) {
HXLINE( 286)			_hx_tmp10 = hx::IsGreaterEq( this->_time,this->endTime );
            		}
            		else {
...
HXLINE( 307)		Bool _hx_tmp = hx::IsNull( EmbeddedSound );
HXDLIN( 307)		if (_hx_tmp) {
HXLINE( 308)			return hx::ObjectPtr<OBJ_>(this);
            		}
HXLINE( 310)		this->cleanup(true,null());
HXLINE( 312)		Bool _hx_tmp1 = ::Std_obj::is(EmbeddedSound,hx::ClassOf< ::openfl::_legacy::media::Sound >());
HXDLIN( 312)		if (_hx_tmp1) {
HXLINE( 314)			this->_sound = EmbeddedSound;
            		}
            		else {
HXLINE( 316)			Bool _hx_tmp2 = ::Std_obj::is(EmbeddedSound,hx::ClassOf< ::hx::Class >());
...
HXLINE( 320)				Bool _hx_tmp3 = ::Std_obj::is(EmbeddedSound,hx::ClassOf< ::String >());
HXDLIN( 320)				if (_hx_tmp3) {
HXLINE( 322)					Bool _hx_tmp4;
HXDLIN( 322)					Bool _hx_tmp5 = !(::openfl::_legacy::Assets_obj::exists(EmbeddedSound,::openfl::_legacy::AssetType_obj::SOUND_dyn()));
HXDLIN( 322)					if (_hx_tmp5) {
HXLINE( 322)						_hx_tmp4 = ::openfl::_legacy::Assets_obj::exists(EmbeddedSound,::openfl::_legacy::AssetType_obj::MUSIC_dyn());
            					}
            					else {
HXLINE( 322)						_hx_tmp4 = true;
            					}
HXDLIN( 322)					if (_hx_tmp4) {
HXLINE( 324)						this->_sound = ::openfl::_legacy::Assets_obj::getSound(EmbeddedSound,null());
            					}
            					else {
...
HXLINE( 346)		this->_sound =  ::openfl::_legacy::media::Sound_obj::__new(null(),null(),null());
HXLINE( 347)		this->_sound->addEventListener(::openfl::_legacy::events::Event_obj::ID3,this->gotID3_dyn(),null(),null(),null());
HXLINE( 348)		this->_sound->load( ::openfl::_legacy::net::URLRequest_obj::__new(SoundURL),null(),null());
...
HXDLIN( 382)		Bool _hx_tmp1 = hx::IsNull( this->_sound );
...
HXLINE( 426)			Bool _hx_tmp = hx::IsNotNull( this->_channel );
HXDLIN( 426)			if (_hx_tmp) {
HXLINE( 427)				return hx::ObjectPtr<OBJ_>(this);
            			}
            		}
HXLINE( 429)		Bool _hx_tmp1 = this->_paused;
...
HX_DEFINE_DYNAMIC_FUNC3(FlxSound_obj,play,return )
 ...
 ::flixel::_hx_system::FlxSound FlxSound_obj::resume(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 443)		Bool _hx_tmp = this->_paused;
...
HX_DEFINE_DYNAMIC_FUNC0(FlxSound_obj,resume,return )
 ...
 ::flixel::_hx_system::FlxSound FlxSound_obj::pause(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 453)		Bool _hx_tmp = hx::IsNull( this->_channel );
...
Float Duration = __o_Duration.Default(1);
 ::Dynamic To = __o_To.Default(0);
            	...
            	HX_STACK_ARG(To,"To")
            	HX_STACK_ARG(onComplete,"onComplete")
HXLINE( 479)		Bool _hx_tmp = hx::IsNotNull( this->fadeTween );
...
Float To = __o_To.Default(1);
            	...
            	HX_STACK_ARG(To,"To")
            	HX_STACK_ARG(onComplete,"onComplete")
HXLINE( 495)		Bool _hx_tmp = hx::IsNull( this->_channel );
HXDLIN( 495)		if (_hx_tmp) {
HXLINE( 496)			this->play(null(),null(),null());
            		}
HXLINE( 498)		Bool _hx_tmp1 = hx::IsNotNull( this->fadeTween );
...
void FlxSound_obj::volumeTween(Float f){
            	HX_STACK_FRAME("flixel.system.FlxSound","volumeTween",0x6ac0ca2d,"flixel.system.FlxSound.volumeTween","flixel/system/FlxSound.hx",507,0x7d78fc74)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(f,"f")
...
Float FlxSound_obj::getActualVolume(){
            	HX_STACK_FRAME("flixel.system.FlxSound","getActualVolume",0xa3e81aba,"flixel.system.FlxSound.getActualVolume","flixel/system/FlxSound.hx",517,0x7d78fc74)
            	HX_STACK_THIS(this)
...
HXDLIN( 541)		Float _hx_tmp1 = (_hx_tmp * ::flixel::FlxG_obj::sound->volume);
HXLINE( 543)		Float _hx_tmp2;
HXDLIN( 543)		Bool _hx_tmp3 = hx::IsNotNull( this->group );
HXDLIN( 543)		if (_hx_tmp3) {
HXLINE( 543)			_hx_tmp2 = this->group->volume;
            		}
            		else {
HXLINE( 543)			_hx_tmp2 = (int)1;
            		}
HXLINE( 541)		Float _hx_tmp4 = ((_hx_tmp1 * _hx_tmp2) * this->_volume);
HXLINE( 539)		this->_transform->volume = (_hx_tmp4 * this->_volumeAdjust);
HXLINE( 545)		Bool _hx_tmp5 = hx::IsNotNull( this->_channel );
...
void FlxSound_obj::startSound(Float StartTime){
            	...
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(StartTime,"StartTime")
HXLINE( 555)		Bool _hx_tmp = hx::IsNull( this->_sound );
...
HXLINE( 561)		Bool _hx_tmp1 = hx::IsNotNull( this->_channel );
...
void FlxSound_obj::stopped( ::Dynamic _){
            	...
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(_,"_")
HXLINE( 582)		Bool _hx_tmp = hx::IsNotNull( this->onComplete );
HXDLIN( 582)		if (_hx_tmp) {
HXLINE( 583)			this->onComplete();
            		}
HXLINE( 585)		Bool _hx_tmp1 = this->looped;
...
HXLINE( 611)		Bool _hx_tmp = hx::IsNotNull( this->_channel );
...
void FlxSound_obj::onFocus(){
            	HX_STACK_FRAME("flixel.system.FlxSound","onFocus",0x8be62035,"flixel.system.FlxSound.onFocus","flixel/system/FlxSound.hx",641,0x7d78fc74)
            	HX_STACK_THIS(this)
HXLINE( 641)		Bool _hx_tmp = !(this->_alreadyPaused);
...
HXLINE( 662)			Bool _hx_tmp = hx::IsNotNull( oldGroup );
...
Bool FlxSound_obj::get_playing(){
            	HX_STACK_FRAME("flixel.system.FlxSound","get_playing",0xced03f81,"flixel.system.FlxSound.get_playing","flixel/system/FlxSound.hx",675,0x7d78fc74)
            	HX_STACK_THIS(this)
...
Float FlxSound_obj::get_volume(){
            	HX_STACK_FRAME("flixel.system.FlxSound","get_volume",0x12b7dd27,"flixel.system.FlxSound.get_volume","flixel/system/FlxSound.hx",680,0x7d78fc74)
            	HX_STACK_THIS(this)
...
Float FlxSound_obj::get_pitch(){
            	HX_STACK_FRAME("flixel.system.FlxSound","get_pitch",0xd6f2b113,"flixel.system.FlxSound.get_pitch","flixel/system/FlxSound.hx",693,0x7d78fc74)
            	HX_STACK_THIS(this)
...
Float FlxSound_obj::set_pitch(Float v){
            	...
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(v,"v")
HXLINE( 698)		Bool _hx_tmp = hx::IsNotNull( this->_channel );
...
Float FlxSound_obj::get_pan(){
            	HX_STACK_FRAME("flixel.system.FlxSound","get_pan",0x17e93bf0,"flixel.system.FlxSound.get_pan","flixel/system/FlxSound.hx",706,0x7d78fc74)
            	HX_STACK_THIS(this)
...
Float FlxSound_obj::set_pan(Float pan){
            	HX_STACK_FRAME("flixel.system.FlxSound","set_pan",0x0aeaccfc,"flixel.system.FlxSound.set_pan","flixel/system/FlxSound.hx",711,0x7d78fc74)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(pan,"pan")
...
Float FlxSound_obj::get_time(){
            	HX_STACK_FRAME("flixel.system.FlxSound","get_time",0xd6d6221a,"flixel.system.FlxSound.get_time","flixel/system/FlxSound.hx",716,0x7d78fc74)
            	HX_STACK_THIS(this)
...
HXLINE( 721)		Bool _hx_tmp = hx::IsNotNull( this->_channel );
...
Float FlxSound_obj::get_length(){
            	HX_STACK_FRAME("flixel.system.FlxSound","get_length",0x526c4833,"flixel.system.FlxSound.get_length","flixel/system/FlxSound.hx",731,0x7d78fc74)
            	HX_STACK_THIS(this)
...
::String FlxSound_obj::toString(){
            	HX_STACK_FRAME("flixel.system.FlxSound","toString",0x428d6b30,"flixel.system.FlxSound.toString","flixel/system/FlxSound.hx",736,0x7d78fc74)
            	HX_STACK_THIS(this)
HXLINE( 737)		HX_VARI(  ::flixel::util::LabelValuePair,_this) = ::flixel::util::LabelValuePair_obj::_pool->get();
HXDLIN( 737)		_this->label = HX_("playing",6e,0f,18,8a);
HXDLIN( 737)		_this->value = hx::IsNotNull( this->_channel );
HXLINE( 738)		 ::Dynamic value = this->_time;
...
HXDLIN( 738)		_this1->value = value;
HXLINE( 739)		 ::Dynamic value1 = this->_length;
...
HXDLIN( 739)		_this2->value = value1;
HXLINE( 740)		 ::Dynamic value2 = this->_volume;
...
HXDLIN( 740)		_this3->value = value2;
