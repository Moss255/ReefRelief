...
HXLINE(  56)		HX_VARI(  ::openfl::_legacy::display::Bitmap,tmp) =  ::openfl::_legacy::display::Bitmap_obj::__new( ::openfl::_legacy::display::BitmapData_obj::__new(this->_width,(int)30,true,(int)2130706432,null()),null(),null());
HXLINE(  57)		this->screenCenter();
HXLINE(  58)		this->addChild(tmp);
HXLINE(  60)		HX_VARI(  ::openfl::_legacy::text::TextField,text) =  ::openfl::_legacy::text::TextField_obj::__new();
HXLINE(  61)		Float _hx_tmp = tmp->get_width();
HXDLIN(  61)		text->set_width(_hx_tmp);
HXLINE(  62)		Float _hx_tmp1 = tmp->get_height();
HXDLIN(  62)		text->set_height(_hx_tmp1);
HXLINE(  63)		text->set_multiline(true);
HXLINE(  64)		text->set_wordWrap(true);
HXLINE(  65)		text->set_selectable(false);
HXLINE(  74)		HX_VARI(  ::openfl::_legacy::text::TextFormat,dtf) =  ::openfl::_legacy::text::TextFormat_obj::__new(::flixel::_hx_system::FlxAssets_obj::FONT_DEFAULT,(int)10,(int)16777215,null(),null(),null(),null(),null(),null(),null(),null(),null(),null());
...
HXLINE(  85)				HX_VARI( Int,i) = _g++;
HXLINE(  87)				tmp =  ::openfl::_legacy::display::Bitmap_obj::__new( ::openfl::_legacy::display::BitmapData_obj::__new((int)4,(i + (int)1),false,(int)-1,null()),null(),null());
HXLINE(  88)				tmp->set_x(bx);
HXLINE(  89)				tmp->set_y(by);
HXLINE(  90)				this->addChild(tmp);
HXLINE(  91)				this->_bars->push(tmp);
HXLINE(  92)				hx::AddEq(bx,(int)6);
HXLINE(  93)				--by;
            			}
            		}
...
void FlxSoundTray_obj::update(Float MS){
            	HX_STACK_FRAME("flixel.system.ui.FlxSoundTray","update",0x9cbad657,"flixel.system.ui.FlxSoundTray.update","flixel/system/ui/FlxSoundTray.hx",106,0x04618f9d)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(MS,"MS")
HXLINE( 106)		Bool _hx_tmp = (this->_timer > (int)0);
HXDLIN( 106)		if (_hx_tmp) {
HXLINE( 108)			hx::SubEq(this->_timer,((Float)MS / (Float)(int)1000));
            		}
            		else {
HXLINE( 110)			Float _hx_tmp1 = this->get_y();
HXDLIN( 110)			Bool _hx_tmp2 = (_hx_tmp1 > -(this->get_height()));
HXDLIN( 110)			if (_hx_tmp2) {
HXLINE( 112)				{
HXLINE( 112)					HX_VARI(  ::flixel::_hx_system::ui::FlxSoundTray,_g) = hx::ObjectPtr<OBJ_>(this);
HXDLIN( 112)					Float _hx_tmp3 = _g->get_y();
HXDLIN( 112)					Float _hx_tmp4 = (_hx_tmp3 - ((((Float)MS / (Float)(int)1000) * ::flixel::FlxG_obj::height) * (int)2));
HXDLIN( 112)					_g->set_y(_hx_tmp4);
            				}
HXLINE( 114)				Float _hx_tmp5 = this->get_y();
HXDLIN( 114)				Bool _hx_tmp6 = (_hx_tmp5 <= -(this->get_height()));
...
HXLINE( 137)			Bool _hx_tmp = hx::IsNotNull( sound );
...
HXLINE( 145)		Float _hx_tmp1 = (::flixel::FlxG_obj::sound->volume * (int)10);
HXDLIN( 145)		HX_VARI( Int,globalVolume) = ::Math_obj::round(_hx_tmp1);
...
HXDLIN( 170)		Float _hx_tmp2 = ::flixel::FlxG_obj::game->get_x();
HXDLIN( 170)		this->set_x((_hx_tmp1 - _hx_tmp2));
            	}
