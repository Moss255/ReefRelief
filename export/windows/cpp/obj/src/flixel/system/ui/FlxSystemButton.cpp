...
void FlxSystemButton_obj::onMouseOver( ::Dynamic _){
            	...
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(_,"_")
HXLINE( 115)		Bool _hx_tmp = this->enabled;
HXDLIN( 115)		if (_hx_tmp) {
HXLINE( 116)			HX_VARI(  ::flixel::_hx_system::ui::FlxSystemButton,_g) = hx::ObjectPtr<OBJ_>(this);
HXDLIN( 116)			Float _hx_tmp1 = _g->get_alpha();
HXDLIN( 116)			_g->set_alpha((_hx_tmp1 - ((Float)0.2)));
            		}
            	}
...
void FlxSystemButton_obj::onMouseOut( ::Dynamic _){
            	HX_STACK_FRAME("flixel.system.ui.FlxSystemButton","onMouseOut",0x67e0ddf0,"flixel.system.ui.FlxSystemButton.onMouseOut","flixel/system/ui/FlxSystemButton.hx",121,0x167fa379)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(_,"_")
HXLINE( 121)		Bool _hx_tmp = this->enabled;
HXDLIN( 121)		if (_hx_tmp) {
HXLINE( 122)			HX_VARI(  ::flixel::_hx_system::ui::FlxSystemButton,_g) = hx::ObjectPtr<OBJ_>(this);
HXDLIN( 122)			Float _hx_tmp1 = _g->get_alpha();
HXDLIN( 122)			_g->set_alpha((_hx_tmp1 + ((Float)0.2)));
            		}
            	}
...
HXLINE( 127)		Bool _hx_tmp = this->toggleMode;
HXDLIN( 127)		if (_hx_tmp) {
HXLINE( 128)			Float _hx_tmp1;
HXDLIN( 128)			if (Value) {
HXLINE( 128)				_hx_tmp1 = ((Float)0.3);
            			}
            			else {
HXLINE( 128)				_hx_tmp1 = (int)1;
            			}
HXDLIN( 128)			this->set_alpha(_hx_tmp1);
            		}
