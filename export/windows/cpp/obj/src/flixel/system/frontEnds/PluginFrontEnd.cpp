...
HXLINE( 108)		 ::flixel::util::FlxTimerManager _hx_tmp = (::flixel::util::FlxTimer_obj::globalManager =  ::flixel::util::FlxTimerManager_obj::__new());
HXDLIN( 108)		this->add_flixel_util_FlxTimerManager(_hx_tmp);
HXLINE( 109)		 ::flixel::tweens::FlxTweenManager _hx_tmp1 = (::flixel::tweens::FlxTween_obj::globalManager =  ::flixel::tweens::FlxTweenManager_obj::__new());
...
HXDLIN(  24)				++_g;
HXLINE(  26)				::String _hx_tmp = ::flixel::util::FlxStringUtil_obj::getClassName(Plugin,true);
HXDLIN(  26)				::String _hx_tmp1 = ::flixel::util::FlxStringUtil_obj::getClassName(plugin,true);
HXDLIN(  26)				if ((_hx_tmp == _hx_tmp1)) {
