...
HXLINE( 152)			Bool _hx_tmp1 = ::Std_obj::is(Graphic,hx::ClassOf< ::openfl::_legacy::display::BitmapData >());
...
void BitmapFrontEnd_obj::removeByKey(::String key){
            	HX_STACK_FRAME("flixel.system.frontEnds.BitmapFrontEnd","removeByKey",0x593bffb1,"flixel.system.frontEnds.BitmapFrontEnd.removeByKey","flixel/system/frontEnds/BitmapFrontEnd.hx",302,0x91a05ae2)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(key,"key")
HXLINE( 302)		Bool _hx_tmp;
HXDLIN( 302)		Bool _hx_tmp1 = hx::IsNotNull( key );
...
void BitmapFrontEnd_obj::removeIfNoUse( ::flixel::graphics::FlxGraphic graphic){
            	HX_STACK_FRAME("flixel.system.frontEnds.BitmapFrontEnd","removeIfNoUse",0x6b036552,"flixel.system.frontEnds.BitmapFrontEnd.removeIfNoUse","flixel/system/frontEnds/BitmapFrontEnd.hx",313,0x91a05ae2)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(graphic,"graphic")
HXLINE( 313)		Bool _hx_tmp;
HXDLIN( 313)		Bool _hx_tmp1;
HXDLIN( 313)		Bool _hx_tmp2 = hx::IsNotNull( graphic );
HXDLIN( 313)		if (_hx_tmp2) {
HXLINE( 313)			Int _hx_tmp3 = graphic->get_useCount();
HXDLIN( 313)			_hx_tmp1 = (_hx_tmp3 == (int)0);
            		}
            		else {
...
void BitmapFrontEnd_obj::clearCache(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 323)		Bool _hx_tmp = hx::IsNull( this->_cache );
HXDLIN( 323)		if (_hx_tmp) {
HXLINE( 324)			this->_cache =  ::haxe::ds::StringMap_obj::__new();
            		}
HXLINE( 326)		{
HXLINE( 326)			HX_VARI(  ::Dynamic,tmp) = this->_cache->keys();
HXDLIN( 326)			while(true){
HXLINE( 326)				Bool _hx_tmp1 = !(( (Bool)( ::Dynamic(tmp->__Field(HX_("hasNext",6d,a5,46,18),hx::paccDynamic))()) ));
HXDLIN( 326)				if (_hx_tmp1) {
HXLINE( 326)					goto _hx_goto_6;
            				}
HXDLIN( 326)				HX_VARI( ::String,key) = ( (::String)( ::Dynamic(tmp->__Field(HX_("next",f3,84,02,49),hx::paccDynamic))()) );
HXLINE( 328)				HX_VARI(  ::flixel::graphics::FlxGraphic,obj) = this->_cache->get(key).StaticCast<  ::flixel::graphics::FlxGraphic >();
HXLINE( 329)				Bool _hx_tmp2;
HXDLIN( 329)				Bool _hx_tmp3;
HXDLIN( 329)				Bool _hx_tmp4 = hx::IsNotNull( obj );
HXDLIN( 329)				if (_hx_tmp4) {
HXLINE( 329)					_hx_tmp3 = !(obj->persist);
            				}
            				else {
HXLINE( 329)					_hx_tmp3 = false;
            				}
HXDLIN( 329)				if (_hx_tmp3) {
HXLINE( 329)					Int _hx_tmp5 = obj->get_useCount();
HXDLIN( 329)					_hx_tmp2 = (_hx_tmp5 <= (int)0);
            				}
            				else {
HXLINE( 329)					_hx_tmp2 = false;
            				}
HXDLIN( 329)				if (_hx_tmp2) {
HXLINE( 331)					this->removeByKey(key);
            				}
            			}
            			_hx_goto_6:;
            		}
...
void BitmapFrontEnd_obj::reset(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 341)		Bool _hx_tmp = hx::IsNull( this->_cache );
HXDLIN( 341)		if (_hx_tmp) {
HXLINE( 342)			this->_cache =  ::haxe::ds::StringMap_obj::__new();
            		}
HXLINE( 344)		{
HXLINE( 344)			HX_VARI(  ::Dynamic,tmp) = this->_cache->keys();
HXDLIN( 344)			while(true){
HXLINE( 344)				Bool _hx_tmp1 = !(( (Bool)( ::Dynamic(tmp->__Field(HX_("hasNext",6d,a5,46,18),hx::paccDynamic))()) ));
HXDLIN( 344)				if (_hx_tmp1) {
HXLINE( 344)					goto _hx_goto_7;
            				}
HXDLIN( 344)				HX_VARI( ::String,key) = ( (::String)( ::Dynamic(tmp->__Field(HX_("next",f3,84,02,49),hx::paccDynamic))()) );
HXLINE( 346)				HX_VARI(  ::flixel::graphics::FlxGraphic,obj) = this->_cache->get(key).StaticCast<  ::flixel::graphics::FlxGraphic >();
HXLINE( 347)				Bool _hx_tmp2 = hx::IsNotNull( obj );
HXDLIN( 347)				if (_hx_tmp2) {
HXLINE( 349)					this->removeByKey(key);
            				}
            			}
            			_hx_goto_7:;
            		}
...
void BitmapFrontEnd_obj::clearUnused(){
            	HX_STACK_FRAME("flixel.system.frontEnds.BitmapFrontEnd","clearUnused",0x9cfedd10,"flixel.system.frontEnds.BitmapFrontEnd.clearUnused","flixel/system/frontEnds/BitmapFrontEnd.hx",360,0x91a05ae2)
            	HX_STACK_THIS(this)
HXLINE( 360)		HX_VARI(  ::Dynamic,tmp) = this->_cache->keys();
HXDLIN( 360)		while(true){
HXLINE( 360)			Bool _hx_tmp = !(( (Bool)( ::Dynamic(tmp->__Field(HX_("hasNext",6d,a5,46,18),hx::paccDynamic))()) ));
HXDLIN( 360)			if (_hx_tmp) {
HXLINE( 360)				goto _hx_goto_8;
            			}
HXDLIN( 360)			HX_VARI( ::String,key) = ( (::String)( ::Dynamic(tmp->__Field(HX_("next",f3,84,02,49),hx::paccDynamic))()) );
HXLINE( 362)			HX_VARI(  ::flixel::graphics::FlxGraphic,obj) = this->_cache->get(key).StaticCast<  ::flixel::graphics::FlxGraphic >();
HXLINE( 363)			Bool _hx_tmp1;
HXDLIN( 363)			Bool _hx_tmp2;
HXDLIN( 363)			Bool _hx_tmp3;
HXDLIN( 363)			Bool _hx_tmp4 = hx::IsNotNull( obj );
HXDLIN( 363)			if (_hx_tmp4) {
HXLINE( 363)				Int _hx_tmp5 = obj->get_useCount();
HXDLIN( 363)				_hx_tmp3 = (_hx_tmp5 <= (int)0);
            			}
            			else {
HXLINE( 363)				_hx_tmp3 = false;
            			}
HXDLIN( 363)			if (_hx_tmp3) {
HXLINE( 363)				_hx_tmp2 = !(obj->persist);
            			}
            			else {
HXLINE( 363)				_hx_tmp2 = false;
            			}
HXDLIN( 363)			if (_hx_tmp2) {
HXLINE( 363)				_hx_tmp1 = obj->get_destroyOnNoUse();
            			}
            			else {
HXLINE( 363)				_hx_tmp1 = false;
            			}
HXDLIN( 363)			if (_hx_tmp1) {
HXLINE( 365)				this->removeByKey(key);
            			}
            		}
            		_hx_goto_8:;
            	}
...
Int BitmapFrontEnd_obj::get_maxTextureSize(){
            	HX_STACK_FRAME("flixel.system.frontEnds.BitmapFrontEnd","get_maxTextureSize",0x8d42ecd4,"flixel.system.frontEnds.BitmapFrontEnd.get_maxTextureSize","flixel/system/frontEnds/BitmapFrontEnd.hx",373,0x91a05ae2)
            	HX_STACK_THIS(this)
...
HX_DEFINE_DYNAMIC_FUNC0(BitmapFrontEnd_obj,get_maxTextureSize,return )
 ...
 ::flixel::graphics::frames::FlxFrame BitmapFrontEnd_obj::get_whitePixel(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 379)		Bool _hx_tmp = hx::IsNull( this->_whitePixel );
HXDLIN( 379)		if (_hx_tmp) {
HXLINE( 381)			HX_VARI(  ::openfl::_legacy::display::BitmapData,bd) =  ::openfl::_legacy::display::BitmapData_obj::__new((int)10,(int)10,true,(int)-1,null());
