...
::String Name = __o_Name.Default(HX_HCSTRING("","\x00","\x00","\x00","\x00"));
            	HX_STACK_FRAME("flixel.system.frontEnds.BitmapLogFrontEnd","add",0xa17c2360,"flixel.system.frontEnds.BitmapLogFrontEnd.add","flixel/system/frontEnds/BitmapLogFrontEnd.hx",11,0x20ede752)
            	HX_STACK_THIS(this)
...
void BitmapLogFrontEnd_obj::clear(){
            	HX_STACK_FRAME("flixel.system.frontEnds.BitmapLogFrontEnd","clear",0x3f6bb08c,"flixel.system.frontEnds.BitmapLogFrontEnd.clear","flixel/system/frontEnds/BitmapLogFrontEnd.hx",21,0x20ede752)
            	HX_STACK_THIS(this)
...
Int Index = __o_Index.Default(-1);
            	HX_STACK_FRAME("flixel.system.frontEnds.BitmapLogFrontEnd","clearAt",0xb622249f,"flixel.system.frontEnds.BitmapLogFrontEnd.clearAt","flixel/system/frontEnds/BitmapLogFrontEnd.hx",32,0x20ede752)
            	HX_STACK_THIS(this)
...
HXLINE(  43)		{
HXLINE(  43)			HX_VARI(  ::Dynamic,tmp) = ::flixel::FlxG_obj::bitmap->_cache->iterator();
...
HXDLIN(  43)				HX_VARI(  ::flixel::graphics::FlxGraphic,cachedGraphic) = ( ( ::flixel::graphics::FlxGraphic)( ::Dynamic(tmp->__Field(HX_("next",f3,84,02,49),hx::paccDynamic))()) );
HXLINE(  45)				::flixel::FlxG_obj::game->debugger->bitmapLog->add(cachedGraphic->bitmap,cachedGraphic->key);
            			}
            			_hx_goto_0:;
            		}
            	}
