...
void CameraFrontEnd_obj::__construct(){
            	...
            	HX_STACK_THIS(this)
HXLINE(  40)		this->_cameraRect =  ::openfl::_legacy::geom::Rectangle_obj::__new(null(),null(),null(),null());
...
HXLINE( 105)		Bool _hx_tmp = hx::IsNull( NewCamera );
HXDLIN( 105)		if (_hx_tmp) {
HXLINE( 106)			NewCamera =  ::flixel::FlxCamera_obj::__new((int)0,(int)0,::flixel::FlxG_obj::width,::flixel::FlxG_obj::height,null());
            		}
...
HXDLIN( 178)			Bool _hx_tmp2 = hx::IsNotNull( camera );
...
HXLINE( 183)			Bool _hx_tmp3 = ::flixel::FlxG_obj::renderBlit;
HXDLIN( 183)			if (_hx_tmp3) {
HXLINE( 185)				camera->checkResize();
HXLINE( 187)				Bool _hx_tmp4 = this->useBufferLocking;
HXDLIN( 187)				if (_hx_tmp4) {
HXLINE( 189)					camera->buffer->lock();
            				}
            			}
HXLINE( 193)			Bool _hx_tmp5 = ::flixel::FlxG_obj::renderTile;
...
HXLINE( 203)			Bool _hx_tmp6 = ::flixel::FlxG_obj::renderBlit;
...
HXLINE( 210)				Int _hx_tmp7 = ((int)camera->bgColor & (int)(int)16777215);
HXDLIN( 210)				Float _hx_tmp8 = ((Float)((int)((int)camera->bgColor >> (int)(int)24) & (int)(int)255) / (Float)(int)255);
HXDLIN( 210)				camera->fill(_hx_tmp7,camera->useBgAlphaBlending,_hx_tmp8,null());
            			}
            		}
            	}
...
void CameraFrontEnd_obj::render(){
            	HX_STACK_FRAME("flixel.system.frontEnds.CameraFrontEnd","render",0xab0985f3,"flixel.system.frontEnds.CameraFrontEnd.render","flixel/system/frontEnds/CameraFrontEnd.hx",218,0x7a57d3ec)
            	HX_STACK_THIS(this)
HXLINE( 218)		Bool _hx_tmp = ::flixel::FlxG_obj::renderTile;
...
HXDLIN( 222)				Bool _hx_tmp3 = hx::IsNotNull( camera );
HXDLIN( 222)				if (_hx_tmp3) {
HXLINE( 222)					_hx_tmp2 = camera->exists;
            				}
            				else {
HXLINE( 222)					_hx_tmp2 = false;
            				}
HXDLIN( 222)				if (_hx_tmp2) {
HXLINE( 222)					_hx_tmp1 = camera->visible;
            				}
            				else {
...
HXDLIN( 238)			Bool _hx_tmp2 = hx::IsNotNull( camera );
...
HXLINE( 245)			Bool _hx_tmp3 = ::flixel::FlxG_obj::renderBlit;
HXDLIN( 245)			if (_hx_tmp3) {
HXLINE( 247)				Bool _hx_tmp4 = this->useBufferLocking;
...
HXDLIN( 265)			Bool _hx_tmp2 = hx::IsNotNull( camera );
...
Int CameraFrontEnd_obj::get_bgColor(){
            	HX_STACK_FRAME("flixel.system.frontEnds.CameraFrontEnd","get_bgColor",0x99072db8,"flixel.system.frontEnds.CameraFrontEnd.get_bgColor","flixel/system/frontEnds/CameraFrontEnd.hx",286,0x7a57d3ec)
            	HX_STACK_THIS(this)
HXLINE( 286)		Bool _hx_tmp = hx::IsNull( ::flixel::FlxG_obj::camera );
