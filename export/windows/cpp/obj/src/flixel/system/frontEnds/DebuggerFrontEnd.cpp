...
HXLINE(  42)		this->visibilityChanged =  ::flixel::util::_FlxSignal::FlxSignal0_obj::__new();
HXLINE(  37)		this->drawDebugChanged =  ::flixel::util::_FlxSignal::FlxSignal0_obj::__new();
HXLINE(  33)		this->drawDebug = false;
HXLINE(  27)		this->toggleKeys = ::Array_obj< Int >::fromData( _hx_array_data_0,3);
...
void DebuggerFrontEnd_obj::resetLayout(){
            	HX_STACK_FRAME("flixel.system.frontEnds.DebuggerFrontEnd","resetLayout",0xc33ca418,"flixel.system.frontEnds.DebuggerFrontEnd.resetLayout","flixel/system/frontEnds/DebuggerFrontEnd.hx",64,0x2ebb4b30)
            	HX_STACK_THIS(this)
...
Bool UpdateLayout = __o_UpdateLayout.Default(true);
            	HX_STACK_FRAME("flixel.system.frontEnds.DebuggerFrontEnd","addButton",0x7066ab72,"flixel.system.frontEnds.DebuggerFrontEnd.addButton","flixel/system/frontEnds/DebuggerFrontEnd.hx",81,0x2ebb4b30)
            	HX_STACK_THIS(this)
...
HXLINE(  97)		Int _hx_tmp = ::flixel::_hx_system::debug::watch::Tracker_obj::objectsBeingTracked->indexOf(ObjectOrClass,null());
HXDLIN(  97)		if ((_hx_tmp != (int)-1)) {
...
HXLINE( 101)		Bool _hx_tmp1 = hx::IsNull( profile );
HXDLIN( 101)		if (_hx_tmp1) {
HXLINE( 103)			{
HXLINE( 104)				::String _hx_tmp2 = ::flixel::util::FlxStringUtil_obj::getClassName(ObjectOrClass,true);
HXLINE( 103)				::flixel::FlxG_obj::log->advanced(((HX_("Could not find a tracking profile for object of class '",1a,ec,71,30) + _hx_tmp2) + HX_("'.",27,22,00,00)),::flixel::_hx_system::debug::log::LogStyle_obj::ERROR,true);
            			}
HXLINE( 105)			return null();
            		}
            		else {
HXLINE( 108)			HX_VARI(  ::flixel::_hx_system::debug::FlxDebugger,_this) = ::flixel::FlxG_obj::game->debugger;
HXDLIN( 108)			HX_VARI(  ::flixel::_hx_system::debug::Window,window) =  ::flixel::_hx_system::debug::watch::Tracker_obj::__new(profile,ObjectOrClass,WindowTitle);
HXDLIN( 108)			_this->_windows->push(window);
HXDLIN( 108)			_this->addChild(window);
HXDLIN( 108)			Bool _hx_tmp3 = hx::IsNotNull( _this->_screenBounds );
HXDLIN( 108)			if (_hx_tmp3) {
HXLINE( 108)				_this->updateBounds();
...
HXLINE( 121)		Bool _hx_tmp = hx::IsNotNull( Profile );
...
Bool UpdateLayout = __o_UpdateLayout.Default(true);
            	HX_STACK_FRAME("flixel.system.frontEnds.DebuggerFrontEnd","removeButton",0xa0228237,"flixel.system.frontEnds.DebuggerFrontEnd.removeButton","flixel/system/frontEnds/DebuggerFrontEnd.hx",134,0x2ebb4b30)
            	HX_STACK_THIS(this)
