...
void VCRFrontEnd_obj::pause(){
            	HX_STACK_FRAME("flixel.system.frontEnds.VCRFrontEnd","pause",0x6797a245,"flixel.system.frontEnds.VCRFrontEnd.pause","flixel/system/frontEnds/VCRFrontEnd.hx",60,0xa1666a42)
            	HX_STACK_THIS(this)
HXLINE(  60)		Bool _hx_tmp = !(this->paused);
HXDLIN(  60)		if (_hx_tmp) {
HXLINE(  63)			Bool _hx_tmp1 = !(::flixel::FlxG_obj::mouse->useSystemCursor);
...
HXDLIN(  70)				_this->playbackToggleBtn->changeIcon( ::flixel::_hx_system::debug::GraphicArrowRight_obj::__new((int)0,(int)0,null(),null()));
            			}
            		}
            	}
...
void VCRFrontEnd_obj::resume(){
            	HX_STACK_FRAME("flixel.system.frontEnds.VCRFrontEnd","resume",0x5616837e,"flixel.system.frontEnds.VCRFrontEnd.resume","flixel/system/frontEnds/VCRFrontEnd.hx",80,0xa1666a42)
            	HX_STACK_THIS(this)
HXLINE(  80)		Bool _hx_tmp = this->paused;
HXDLIN(  80)		if (_hx_tmp) {
HXLINE(  83)			Bool _hx_tmp1 = !(::flixel::FlxG_obj::mouse->useSystemCursor);
...
HXDLIN(  90)				_this->playbackToggleBtn->changeIcon( ::flixel::_hx_system::debug::_VCR::GraphicPause_obj::__new((int)0,(int)0,null(),null()));
            			}
            		}
            	}
