...
HXLINE(  29)		::flixel::FlxG_obj::game->debugger->console->registeredFunctions->set(FunctionAlias,Function);
HXDLIN(  29)		::flixel::_hx_system::debug::console::ConsoleUtil_obj::registerFunction(FunctionAlias,Function);
            	}
...
HXLINE(  42)		::flixel::FlxG_obj::game->debugger->console->registeredObjects->set(ObjectAlias,AnyObject);
HXDLIN(  42)		::flixel::_hx_system::debug::console::ConsoleUtil_obj::registerObject(ObjectAlias,AnyObject);
            	}
...
void ConsoleFrontEnd_obj::registerClass(hx::Class cl){
            	...
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(cl,"cl")
HXLINE(  54)		HX_VARI( ::String,objectAlias) = ::flixel::util::FlxStringUtil_obj::getClassName(cl,true);
HXDLIN(  54)		::flixel::FlxG_obj::game->debugger->console->registeredObjects->set(objectAlias,cl);
HXDLIN(  54)		::flixel::_hx_system::debug::console::ConsoleUtil_obj::registerObject(objectAlias,cl);
            	}
