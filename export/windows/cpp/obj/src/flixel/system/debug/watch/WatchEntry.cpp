...
HXDLIN(  41)		this->defaultFormat =  ::openfl::_legacy::text::TextFormat_obj::__new(::flixel::_hx_system::FlxAssets_obj::FONT_DEBUGGER,(int)12,_hx_tmp,null(),null(),null(),null(),null(),null(),null(),null(),null(),null());
HXLINE(  42)		 ::openfl::_legacy::text::TextField _hx_tmp1 = ::flixel::_hx_system::debug::DebuggerUtil_obj::createTextField(null(),null(),null(),null());
HXDLIN(  42)		this->nameText = ( ( ::openfl::_legacy::text::TextField)(this->initTextField(_hx_tmp1)) );
...
HXLINE( 111)				return _g->_hx_getString(0);
            			...
            			break;
            			case (int)2: {
HXLINE( 111)				return ::flixel::_hx_system::debug::console::ConsoleUtil_obj::runCommand(_g->_hx_getString(0));
            			}
            			break;
            		}
