...
void GraphicCursorCross_obj::__construct(Int width,Int height, ::Dynamic __o_transparent, ::Dynamic __o_fillRGBA){
 ...
 ::Dynamic fillRGBA = __o_fillRGBA.Default(-1);
            	HX_STACK_FRAME("flixel.system.debug.interaction.tools.GraphicCursorCross","new",0x7ff5abab,"flixel.system.debug.interaction.tools.GraphicCursorCross.new","openfl/_legacy/Assets.hx",2010,0x9276b055)
            	HX_STACK_THIS(this)
...
HXLINE(2078)		 ::haxe::io::Bytes _hx_tmp = ::haxe::Resource_obj::getBytes(::flixel::_hx_system::debug::interaction::tools::GraphicCursorCross_obj::resourceName);
...
{
{
            	HX_STACK_FRAME("flixel.system.debug.interaction.tools.GraphicCursorCross","boot",0x6f198a87,"flixel.system.debug.interaction.tools.GraphicCursorCross.boot","openfl/_legacy/display/BitmapData.hx",22,0x0b92a012)
HXLINE(  22)		resourceName = HX_("__ASSET__:bitmap_flixel_system_debug_interaction_tools_GraphicCursorCross",12,f7,e2,fa);
            	}
}
