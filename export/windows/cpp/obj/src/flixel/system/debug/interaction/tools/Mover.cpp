...
HXLINE(  29)		this->setCursor( ::flixel::_hx_system::debug::interaction::tools::GraphicMoverTool_obj::__new((int)0,(int)0,null(),null()));
...
HXDLIN(  37)		Bool _hx_tmp1 = !(this->isActive());
...
HXLINE(  42)				_hx_tmp3 = this->_dragging;
            			}
            			else {
...
HXLINE(  44)				Bool _hx_tmp4 = this->_brain->pointerJustReleased;
...
HXDLIN(  56)				++_g;
HXLINE(  58)				Bool _hx_tmp = !(::Std_obj::is(member,hx::ClassOf< ::flixel::FlxObject >()));
HXDLIN(  58)				if (_hx_tmp) {
HXLINE(  59)					continue;
            				}
HXLINE(  62)				Bool _hx_tmp1 = hx::IsNotNull( member );
HXDLIN(  62)				if (_hx_tmp1) {
HXLINE(  64)					{
HXLINE(  64)						Float _hx_tmp2 = (member->x + dx);
HXDLIN(  64)						member->set_x(_hx_tmp2);
            					}
HXLINE(  65)					{
HXLINE(  65)						Float _hx_tmp3 = (member->y + dy);
HXDLIN(  65)						member->set_y(_hx_tmp3);
            					}
            				}
            			}
            		}
