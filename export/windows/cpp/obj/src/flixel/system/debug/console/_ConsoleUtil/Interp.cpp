...
void Interp_obj::__construct(){
            	HX_STACK_FRAME("flixel.system.debug.console._ConsoleUtil.Interp","new",0x56cfaa5b,"flixel.system.debug.console._ConsoleUtil.Interp.new","flixel/system/debug/console/ConsoleUtil.hx",151,0x2e8bcde6)
            	HX_STACK_THIS(this)
...
::Array< ::String > Interp_obj::getGlobals(){
            	HX_STACK_FRAME("flixel.system.debug.console._ConsoleUtil.Interp","getGlobals",0x79b1b71f,"flixel.system.debug.console._ConsoleUtil.Interp.getGlobals","flixel/system/debug/console/ConsoleUtil.hx",155,0x2e8bcde6)
            	HX_STACK_THIS(this)
HXLINE( 155)		 ::Dynamic _hx_tmp = this->locals->keys();
HXDLIN( 155)		::Array< ::String > _hx_tmp1 = this->toArray(_hx_tmp);
HXDLIN( 155)		 ::Dynamic _hx_tmp2 = this->variables->keys();
HXDLIN( 155)		::Array< ::String > _hx_tmp3 = this->toArray(_hx_tmp2);
HXDLIN( 155)		return _hx_tmp1->concat(_hx_tmp3);
            	}
...
::cpp::VirtualArray Interp_obj::toArray( ::Dynamic iterator){
            	HX_STACK_FRAME("flixel.system.debug.console._ConsoleUtil.Interp","toArray",0x1b83ad99,"flixel.system.debug.console._ConsoleUtil.Interp.toArray","flixel/system/debug/console/ConsoleUtil.hx",159,0x2e8bcde6)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(iterator,"iterator")
HXLINE( 160)		HX_VARI( ::cpp::VirtualArray,array) = ::cpp::VirtualArray_obj::__new(0);
HXLINE( 161)		while(true){
HXLINE( 161)			Bool _hx_tmp = !(( (Bool)( ::Dynamic(iterator->__Field(HX_("hasNext",6d,a5,46,18),hx::paccDynamic))()) ));
HXDLIN( 161)			if (_hx_tmp) {
HXLINE( 161)				goto _hx_goto_0;
            			}
HXDLIN( 161)			HX_VARI(  ::Dynamic,element) =  ::Dynamic(iterator->__Field(HX_("next",f3,84,02,49),hx::paccDynamic))();
HXLINE( 162)			array->push(element);
            		}
            		_hx_goto_0:;
HXLINE( 163)		return array;
            	}
...
HX_DEFINE_DYNAMIC_FUNC1(Interp_obj,toArray,return )
 ...
 ::Dynamic Interp_obj::get( ::Dynamic o,::String f){
            	HX_STACK_FRAME("flixel.system.debug.console._ConsoleUtil.Interp","get",0x56ca5a91,"flixel.system.debug.console._ConsoleUtil.Interp.get","flixel/system/debug/console/ConsoleUtil.hx",167,0x2e8bcde6)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(o,"o")
            	HX_STACK_ARG(f,"f")
HXLINE( 168)		Bool _hx_tmp = hx::IsNull( o );
HXDLIN( 168)		if (_hx_tmp) {
HXLINE( 169)			::hx::EnumBase e = ::hscript::Error_obj::EInvalidAccess(f);
HXDLIN( 169)			HX_STACK_DO_THROW(e);
            		}
HXLINE( 170)		return ::Reflect_obj::getProperty(o,f);
            	}


 ::Dynamic Interp_obj::set( ::Dynamic o,::String f, ::Dynamic v){
            	HX_STACK_FRAME("flixel.system.debug.console._ConsoleUtil.Interp","set",0x56d3759d,"flixel.system.debug.console._ConsoleUtil.Interp.set","flixel/system/debug/console/ConsoleUtil.hx",174,0x2e8bcde6)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(o,"o")
            	HX_STACK_ARG(f,"f")
            	HX_STACK_ARG(v,"v")
HXLINE( 175)		Bool _hx_tmp = hx::IsNull( o );
HXDLIN( 175)		if (_hx_tmp) {
HXLINE( 176)			::hx::EnumBase e = ::hscript::Error_obj::EInvalidAccess(f);
HXDLIN( 176)			HX_STACK_DO_THROW(e);
            		}
HXLINE( 177)		::Reflect_obj::setProperty(o,f,v);
HXLINE( 178)		return v;
            	}
