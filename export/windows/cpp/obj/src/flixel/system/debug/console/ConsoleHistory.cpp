...
HXLINE(  15)		Bool _hx_tmp = hx::IsNotNull(  ::Dynamic(::flixel::FlxG_obj::save->data->__Field(HX_("history",54,35,47,64),hx::paccDynamic)) );
HXDLIN(  15)		if (_hx_tmp) {
HXLINE(  17)			this->commands =  ::Dynamic(::flixel::FlxG_obj::save->data->__Field(HX_("history",54,35,47,64),hx::paccDynamic));
...
::String ConsoleHistory_obj::getPreviousCommand(){
            	...
            	HX_STACK_THIS(this)
HXLINE(  29)		Bool _hx_tmp = (this->index > (int)0);
...
::String ConsoleHistory_obj::getNextCommand(){
            	...
            	HX_STACK_THIS(this)
HXLINE(  36)		Bool _hx_tmp = (this->index < this->commands->length);
HXDLIN(  36)		if (_hx_tmp) {
HXLINE(  37)			this->index++;
            		}
HXLINE(  38)		Bool _hx_tmp1 = hx::IsNotNull( this->commands->__get(this->index) );
...
HXDLIN(  44)		Bool _hx_tmp1 = !(this->get_isEmpty());
HXDLIN(  44)		if (_hx_tmp1) {
HXLINE(  44)			::String _hx_tmp2 = this->getPreviousCommand();
HXDLIN(  44)			_hx_tmp = (_hx_tmp2 != command);
            		}
            		else {
...
HXLINE(  49)			Bool _hx_tmp3 = (this->commands->length > (int)50);
...
Bool ConsoleHistory_obj::get_isEmpty(){
            	HX_STACK_FRAME("flixel.system.debug.console.ConsoleHistory","get_isEmpty",0x5caf4b88,"flixel.system.debug.console.ConsoleHistory.get_isEmpty","flixel/system/debug/console/ConsoleHistory.hx",64,0xc796b240)
            	HX_STACK_THIS(this)
...
{
{
            	HX_STACK_FRAME("flixel.system.debug.console.ConsoleHistory","boot",0xdcf79d44,"flixel.system.debug.console.ConsoleHistory.boot","flixel/system/debug/console/ConsoleHistory.hx",5,0xc796b240)
