...
void Console_obj::createInputTextField(){
            	...
            	HX_STACK_THIS(this)
HXLINE(  98)		this->input =  ::openfl::_legacy::text::TextField_obj::__new();
HXLINE(  99)		this->input->set_embedFonts(true);
HXLINE( 100)		this->input->set_defaultTextFormat( ::openfl::_legacy::text::TextFormat_obj::__new(::flixel::_hx_system::FlxAssets_obj::FONT_DEBUGGER,(int)12,(int)16777215,false,false,false,null(),null(),null(),null(),null(),null(),null()));
...
void Console_obj::registerEventListeners(){
            		...
            		void _hx_run( ::Dynamic _){
            			HX_STACK_FRAME("flixel.system.debug.console.Console","registerEventListeners",0x714c11de,"flixel.system.debug.console.Console.registerEventListeners","flixel/system/debug/console/Console.hx",122,0x367943c8)
            			HX_STACK_ARG(_,"_")
HXLINE( 122)			_gthis->inputMouseDown = true;
            		...
            		void _hx_run( ::Dynamic _1){
            			HX_STACK_FRAME("flixel.system.debug.console.Console","registerEventListeners",0x714c11de,"flixel.system.debug.console.Console.registerEventListeners","flixel/system/debug/console/Console.hx",126,0x367943c8)
            			HX_STACK_ARG(_1,"_1")
...
void Console_obj::onFocusLost( ::Dynamic _){
            	...
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(_,"_")
HXLINE( 182)		Bool _hx_tmp = ::flixel::FlxG_obj::console->autoPause;
