...
HXLINE(  25)		super::__construct(HX_("Watch",2f,86,52,58), ::flixel::_hx_system::debug::GraphicWatch_obj::__new((int)0,(int)0,null(),null()),(int)0,(int)0,true,null(),closable);
HXLINE(  27)		this->entriesContainer =  ::openfl::_legacy::display::Sprite_obj::__new();
...
hx::ObjectPtr< Watch_obj > Watch_obj::__new(hx::Null< Bool >  __o_closable)
{
	...
	_hx_result->__construct(__o_closable);
	return _hx_result;
}
...
void Watch_obj::add(::String displayName,::hx::EnumBase data){
...
HXLINE(  37)		Bool _hx_tmp = this->isInvalid(displayName,data);
HXDLIN(  37)		if (_hx_tmp) {
HXLINE(  38)			return;
            		}
HXLINE(  40)		HX_VARI(  ::flixel::_hx_system::debug::watch::WatchEntry,existing) = this->getExistingEntry(displayName,data);
HXLINE(  41)		Bool _hx_tmp1 = hx::IsNotNull( existing );
HXDLIN(  41)		if (_hx_tmp1) {
HXLINE(  43)			Int _hx_tmp2 = ( ( ::hx::EnumBase)(data) )->_hx_getIndex();
HXDLIN(  43)			if ((_hx_tmp2 == (int)1)) {
...
Bool Watch_obj::isInvalid(::String displayName,::hx::EnumBase data){
            	HX_STACK_FRAME("flixel.system.debug.watch.Watch","isInvalid",0x369d7b87,"flixel.system.debug.watch.Watch.isInvalid","flixel/system/debug/watch/Watch.hx",57,0x446c9b58)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(displayName,"displayName")
            	HX_STACK_ARG(data,"data")
HXLINE(  57)		Int _hx_tmp = ( ( ::hx::EnumBase)(data) )->_hx_getIndex();
HXDLIN(  57)		switch((int)(_hx_tmp)){
            			case (int)0: {
HXLINE(  59)				HX_VARI( ::String,field) = data->_hx_getString(1);
HXLINE(  60)				Bool _hx_tmp1 = hx::IsNotNull( data->_hx_getObject(0) );
HXDLIN(  60)				if (_hx_tmp1) {
HXLINE(  57)					return hx::IsNull( field );
            				}
            				else {
HXLINE(  57)					return true;
            			...
            			break;
            			case (int)1: {
HXLINE(  62)				Bool _hx_tmp2 = hx::IsNotNull( displayName );
...
HXLINE(  64)				Bool _hx_tmp3 = hx::IsNotNull( expression );
...
HX_DEFINE_DYNAMIC_FUNC2(Watch_obj,isInvalid,return )
 ...
 ::flixel::_hx_system::debug::watch::WatchEntry Watch_obj::getExistingEntry(::String displayName,::hx::EnumBase data){
...
HXDLIN(  72)				Int _hx_tmp1 = ( ( ::hx::EnumBase)(data) )->_hx_getIndex();
HXDLIN(  72)				if ((_hx_tmp1 == (int)1)) {
...
void Watch_obj::addEntry(::String displayName,::hx::EnumBase data){
            	...
            	HX_STACK_ARG(displayName,"displayName")
            	HX_STACK_ARG(data,"data")
HXLINE(  85)		HX_VARI(  ::flixel::_hx_system::debug::watch::WatchEntry,entry) =  ::flixel::_hx_system::debug::watch::WatchEntry_obj::__new(displayName,data,this->removeEntry_dyn());
...
void Watch_obj::remove(::String displayName,::hx::EnumBase data){
...
HXLINE(  94)		Bool _hx_tmp = hx::IsNotNull( existing );
...
HXLINE( 100)				 ::flixel::_hx_system::debug::watch::WatchEntry _hx_tmp = array->__get((array->length - (int)1)).StaticCast<  ::flixel::_hx_system::debug::watch::WatchEntry >();
HXDLIN( 100)				array[index] = _hx_tmp;
...
void Watch_obj::updateSize(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 122)		Float _hx_tmp = this->getMaxMinWidth();
HXDLIN( 122)		Float _hx_tmp1 = (_hx_tmp + this->entriesContainerOffset->x);
HXLINE( 123)		Float _hx_tmp2 = this->entriesContainer->get_height();
HXDLIN( 123)		Float _hx_tmp3 = (_hx_tmp2 + this->entriesContainerOffset->y);
HXLINE( 121)		this->minSize->setTo(_hx_tmp1,_hx_tmp3);
...
Float Watch_obj::getMaxNameWidth(){
            		...
            		Float _hx_run( ::flixel::_hx_system::debug::watch::WatchEntry entry){
            			HX_STACK_FRAME("flixel.system.debug.watch.Watch","getMaxNameWidth",0x1ee45d07,"flixel.system.debug.watch.Watch.getMaxNameWidth","flixel/system/debug/watch/Watch.hx",140,0x446c9b58)
            			HX_STACK_ARG(entry,"entry")
...
Float Watch_obj::getMaxMinWidth(){
            		HX_BEGIN_LOCAL_FUNC_S0(hx::LocalFunc,_hx_Closure_0) HXARGC(1)
            		Float _hx_run( ::flixel::_hx_system::debug::watch::WatchEntry entry){
            			HX_STACK_FRAME("flixel.system.debug.watch.Watch","getMaxMinWidth",0x4606f748,"flixel.system.debug.watch.Watch.getMaxMinWidth","flixel/system/debug/watch/Watch.hx",145,0x446c9b58)
            			HX_STACK_ARG(entry,"entry")
...
HXLINE( 154)				Bool _hx_tmp = (value > max);
...
{
{
            	HX_STACK_FRAME("flixel.system.debug.watch.Watch","boot",0xd30b1f18,"flixel.system.debug.watch.Watch.boot","flixel/system/debug/watch/Watch.hx",17,0x446c9b58)
