...
HXLINE(  57)		this->restartBtn = Debugger->addButton(::flixel::util::FlxHorizontalAlign_obj::CENTER_dyn(), ::flixel::_hx_system::debug::_VCR::GraphicRestart_obj::__new((int)0,(int)0,null(),null()),::flixel::FlxG_obj::resetState_dyn(),null(),null());
HXLINE(  66)		this->playbackToggleBtn = Debugger->addButton(::flixel::util::FlxHorizontalAlign_obj::CENTER_dyn(), ::flixel::_hx_system::debug::_VCR::GraphicPause_obj::__new((int)0,(int)0,null(),null()),::flixel::FlxG_obj::vcr->pause_dyn(),null(),null());
HXLINE(  67)		this->stepBtn = Debugger->addButton(::flixel::util::FlxHorizontalAlign_obj::CENTER_dyn(), ::flixel::_hx_system::debug::_VCR::GraphicStep_obj::__new((int)0,(int)0,null(),null()),this->onStep_dyn(),null(),null());
            	}
...
hx::ObjectPtr< VCR_obj > VCR_obj::__new( ::flixel::_hx_system::debug::FlxDebugger Debugger)
{
	...
	_hx_result->__construct(Debugger);
	return _hx_result;
}
...
HXLINE( 141)		this->playbackToggleBtn->changeIcon( ::flixel::_hx_system::debug::GraphicArrowRight_obj::__new((int)0,(int)0,null(),null()));
            	}
...
HXLINE( 151)		this->playbackToggleBtn->changeIcon( ::flixel::_hx_system::debug::_VCR::GraphicPause_obj::__new((int)0,(int)0,null(),null()));
            	}
...
void VCR_obj::onStep(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 160)		Bool _hx_tmp = !(::flixel::FlxG_obj::vcr->paused);
