...
Bool Tool_obj::isActive(){
            	HX_STACK_FRAME("flixel.system.debug.interaction.tools.Tool","isActive",0xd2b72d4f,"flixel.system.debug.interaction.tools.Tool.isActive","flixel/system/debug/interaction/tools/Tool.hx",40,0xb5d06f0c)
            	HX_STACK_THIS(this)
...
HXLINE(  45)		 ::openfl::_legacy::display::BitmapData _hx_tmp = ( ( ::openfl::_legacy::display::BitmapData)(::Type_obj::createInstance(Icon,::cpp::VirtualArray_obj::__new(2)->init(0,(int)0)->init(1,(int)0))) );
HXDLIN(  45)		this->button =  ::flixel::_hx_system::ui::FlxSystemButton_obj::__new(_hx_tmp,this->onButtonClicked_dyn(),true);
...
void Tool_obj::onButtonClicked(){
            	HX_STACK_FRAME("flixel.system.debug.interaction.tools.Tool","onButtonClicked",0x655fe417,"flixel.system.debug.interaction.tools.Tool.onButtonClicked","flixel/system/debug/interaction/tools/Tool.hx",57,0xb5d06f0c)
            	HX_STACK_THIS(this)
...
::String Tool_obj::getName(){
            	HX_STACK_FRAME("flixel.system.debug.interaction.tools.Tool","getName",0xa49116e2,"flixel.system.debug.interaction.tools.Tool.getName","flixel/system/debug/interaction/tools/Tool.hx",62,0xb5d06f0c)
            	HX_STACK_THIS(this)
