...
HXLINE(2078)		 ::haxe::io::Bytes _hx_tmp = ::haxe::Resource_obj::getBytes(::flixel::_hx_system::debug::_VCR::GraphicOpen_obj::resourceName);
...
{
{
            	HX_STACK_FRAME("flixel.system.debug._VCR.GraphicOpen","boot",0xf9287e0e,"flixel.system.debug._VCR.GraphicOpen.boot","openfl/_legacy/display/BitmapData.hx",22,0x0b92a012)
HXLINE(  22)		resourceName = HX_("__ASSET__:bitmap_flixel_system_debug__VCR_GraphicOpen",38,bb,f9,19);
            	}
}
