...
HXLINE(2078)		 ::haxe::io::Bytes _hx_tmp = ::haxe::Resource_obj::getBytes(::flixel::_hx_system::debug::_VCR::GraphicStep_obj::resourceName);
...
{
{
            	HX_STACK_FRAME("flixel.system.debug._VCR.GraphicStep","boot",0xf66ea34c,"flixel.system.debug._VCR.GraphicStep.boot","openfl/_legacy/display/BitmapData.hx",22,0x0b92a012)
HXLINE(  22)		resourceName = HX_("__ASSET__:bitmap_flixel_system_debug__VCR_GraphicStep",ba,9e,a1,1c);
            	}
}
