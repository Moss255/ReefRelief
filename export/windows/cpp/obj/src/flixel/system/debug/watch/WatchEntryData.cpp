...
::flixel::_hx_system::debug::watch::WatchEntryData WatchEntryData_obj::EXPRESSION(::String expression)
{
	return hx::CreateEnum< WatchEntryData_obj >(HX_("EXPRESSION",98,85,a8,20),2,1)->_hx_init(0,expression);
}
...
{
	if (inName==HX_("EXPRESSION",98,85,a8,20)) return 1;
