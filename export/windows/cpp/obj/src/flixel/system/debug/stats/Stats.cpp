...
HXLINE(  98)		super::__construct(HX_("Stats",ff,e5,38,17), ::flixel::_hx_system::debug::GraphicStats_obj::__new((int)0,(int)0,null(),null()),(int)0,(int)0,false,null(),null());
HXLINE( 100)		Bool _hx_tmp = (::flixel::_hx_system::debug::stats::Stats_obj::MIN_HEIGHT == (int)0);
HXDLIN( 100)		if (_hx_tmp) {
HXLINE( 102)			Bool _hx_tmp1 = !(::flixel::FlxG_obj::renderTile);
...
HXLINE( 118)		Bool _hx_tmp2 = ::flixel::FlxG_obj::renderTile;
HXDLIN( 118)		if (_hx_tmp2) {
HXLINE( 120)			this->_drawCalls = ::Array_obj< Int >::__new(0);
            		}
HXLINE( 125)		Float _hx_tmp3 = this->_header->get_height();
HXDLIN( 125)		Int _hx_tmp4 = ::Std_obj::_hx_int(_hx_tmp3);
HXDLIN( 125)		HX_VARI( Int,graphY) = (_hx_tmp4 + (int)5);
HXLINE( 129)		this->fpsGraph =  ::flixel::_hx_system::debug::stats::StatsGraph_obj::__new((int)5,graphY,(int)140,(int)40,(int)-6881536,HX_("fps",e9,c7,4d,00),null(),null());
...
HXLINE( 134)		Float _hx_tmp5 = this->_header->get_height();
HXDLIN( 134)		Int _hx_tmp6 = ::Std_obj::_hx_int(_hx_tmp5);
HXDLIN( 134)		graphY = ((_hx_tmp6 + (int)40) + (int)20);
HXLINE( 136)		this->memoryGraph =  ::flixel::_hx_system::debug::stats::StatsGraph_obj::__new((int)5,graphY,(int)140,(int)40,(int)-16737025,HX_("MB",55,43,00,00),null(),null());
HXLINE( 137)		this->addChild(this->memoryGraph);
HXLINE( 139)		Float _hx_tmp7 = this->_header->get_height();
HXDLIN( 139)		Int _hx_tmp8 = ::Std_obj::_hx_int(_hx_tmp7);
HXDLIN( 139)		graphY = (_hx_tmp8 + (int)5);
HXLINE( 143)		this->updateTimeGraph =  ::flixel::_hx_system::debug::stats::StatsGraph_obj::__new((int)170,graphY,(int)130,(int)40,(int)-2305024,HX_("ms",66,5f,00,00),(int)35,HX_("Update",29,fa,99,bb));
HXLINE( 144)		this->updateTimeGraph->set_visible(false);
HXLINE( 145)		this->addChild(this->updateTimeGraph);
HXLINE( 147)		Float _hx_tmp9 = this->_header->get_height();
HXDLIN( 147)		Int _hx_tmp10 = ::Std_obj::_hx_int(_hx_tmp9);
HXDLIN( 147)		graphY = ((_hx_tmp10 + (int)40) + (int)20);
HXLINE( 149)		this->drawTimeGraph =  ::flixel::_hx_system::debug::stats::StatsGraph_obj::__new((int)170,graphY,(int)130,(int)40,(int)-5898236,HX_("ms",66,5f,00,00),(int)35,HX_("Draw",24,58,49,2d));
HXLINE( 150)		this->drawTimeGraph->set_visible(false);
HXLINE( 151)		this->addChild(this->drawTimeGraph);
HXLINE( 153)		 ::openfl::_legacy::text::TextField _hx_tmp11 = (this->_leftTextField = ::flixel::_hx_system::debug::DebuggerUtil_obj::createTextField((int)5,(int)125,(int)-1426063361,(int)11));
HXDLIN( 153)		this->addChild(_hx_tmp11);
HXLINE( 154)		 ::openfl::_legacy::text::TextField _hx_tmp12 = (this->_rightTextField = ::flixel::_hx_system::debug::DebuggerUtil_obj::createTextField((int)75,(int)125,(int)-1,(int)11));
HXDLIN( 154)		this->addChild(_hx_tmp12);
HXLINE( 156)		Bool _hx_tmp13 = this->_rightTextField->set_multiline(true);
HXDLIN( 156)		this->_leftTextField->set_multiline(_hx_tmp13);
HXLINE( 157)		Bool _hx_tmp14 = this->_rightTextField->set_wordWrap(true);
HXDLIN( 157)		this->_leftTextField->set_wordWrap(_hx_tmp14);
HXLINE( 159)		::String _hx_tmp15;
HXDLIN( 159)		if (::flixel::FlxG_obj::renderTile) {
HXLINE( 159)			_hx_tmp15 = HX_("\nDrawTiles:",e3,86,4d,5f);
            		}
            		else {
HXLINE( 159)			_hx_tmp15 = HX_("",00,00,00,00);
            		}
HXDLIN( 159)		this->_leftTextField->set_text(((HX_("Update: \nDraw:",9b,e1,5f,a0) + _hx_tmp15) + HX_("\nQuadTrees: \nLists:",e5,f7,d0,58)));
HXLINE( 161)		this->_toggleSizeButton =  ::flixel::_hx_system::ui::FlxSystemButton_obj::__new( ::flixel::_hx_system::debug::stats::_Stats::GraphicMaximizeButton_obj::__new((int)0,(int)0,null(),null()),this->toggleSize_dyn(),null());
...
void Stats_obj::start(){
            	HX_STACK_FRAME("flixel.system.debug.stats.Stats","start",0x6e8a565c,"flixel.system.debug.stats.Stats.start","flixel/system/debug/stats/Stats.hx",173,0xc15f23b8)
            	HX_STACK_THIS(this)
HXLINE( 173)		Bool _hx_tmp = this->_paused;
...
void Stats_obj::destroy(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 194)		Bool _hx_tmp = hx::IsNotNull( this->fpsGraph );
...
HXLINE( 242)		Bool _hx_tmp = (elapsed > (int)250);
HXDLIN( 242)		if (_hx_tmp) {
HXLINE( 244)			elapsed = (int)250;
            		}
HXLINE( 246)		this->_lastTime = time;
HXLINE( 248)		hx::AddEq(this->_updateTimer,elapsed);
HXLINE( 250)		this->_frameCount++;
HXLINE( 252)		Bool _hx_tmp1 = (this->_updateTimer > (int)250);
HXDLIN( 252)		if (_hx_tmp1) {
HXLINE( 254)			Int _hx_tmp2 = this->_frameCount;
HXDLIN( 254)			Float _hx_tmp3 = ((Float)(this->_currentTime - this->_itvTime) / (Float)(int)1000);
HXDLIN( 254)			this->fpsGraph->update(((Float)_hx_tmp2 / (Float)_hx_tmp3));
HXLINE( 255)			Int _hx_tmp4 = ::openfl::_legacy::_hx_system::System_obj::get_totalMemory();
HXDLIN( 255)			this->memoryGraph->update(((Float)((Float)_hx_tmp4 / (Float)(int)1024) / (Float)(int)1000));
...
HXLINE( 264)					hx::AddEq(this->updateTime,this->_update->__get(i));
            				}
            			}
HXLINE( 267)			{
...
HXLINE( 267)					HX_VARI_NAME( Int,i1,"i") = _g11++;
HXLINE( 269)					hx::AddEq(this->activeCount,this->_activeObject->__get(i1));
            				}
            			}
HXLINE( 271)			Float _hx_tmp5 = this->divide(this->activeCount,this->_activeObjectMarker);
HXDLIN( 271)			this->activeCount = ::Std_obj::_hx_int(_hx_tmp5);
...
HXLINE( 274)					HX_VARI_NAME( Int,i2,"i") = _g12++;
HXLINE( 276)					hx::AddEq(this->drawTime,this->_draw->__get(i2));
            				}
            			}
HXLINE( 279)			{
...
HXLINE( 279)					HX_VARI_NAME( Int,i3,"i") = _g13++;
HXLINE( 281)					hx::AddEq(this->visibleCount,this->_visibleObject->__get(i3));
            				}
            			}
HXLINE( 283)			Float _hx_tmp6 = this->divide(this->visibleCount,this->_visibleObjectMarker);
HXDLIN( 283)			this->visibleCount = ::Std_obj::_hx_int(_hx_tmp6);
HXLINE( 285)			Bool _hx_tmp7 = ::flixel::FlxG_obj::renderTile;
...
HXLINE( 287)						HX_VARI_NAME( Int,i4,"i") = _g14++;
HXLINE( 289)						hx::AddEq(this->drawCallsCount,this->_drawCalls->__get(i4));
            					}
            				}
HXLINE( 291)				Float _hx_tmp8 = this->divide(this->drawCallsCount,this->_drawCallsMarker);
HXDLIN( 291)				this->drawCallsCount = ::Std_obj::_hx_int(_hx_tmp8);
            			}
...
HXLINE( 298)			Bool _hx_tmp9 = ::flixel::FlxG_obj::renderTile;
HXDLIN( 298)			if (_hx_tmp9) {
HXLINE( 300)				this->_drawCallsMarker = (int)0;
            			}
HXLINE( 303)			hx::SubEq(this->_updateTimer,(int)250);
            		}
            	}
...
void Stats_obj::updateTexts(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 309)		Float _hx_tmp = this->divide(this->updateTime,this->_updateMarker);
HXDLIN( 309)		HX_VARI( Float,updTime) = ::flixel::math::FlxMath_obj::roundDecimal(_hx_tmp,(int)1);
HXLINE( 310)		Float _hx_tmp1 = this->divide(this->drawTime,this->_drawMarker);
HXDLIN( 310)		HX_VARI( Float,drwTime) = ::flixel::math::FlxMath_obj::roundDecimal(_hx_tmp1,(int)1);
HXLINE( 312)		this->drawTimeGraph->update(drwTime);
HXLINE( 313)		this->updateTimeGraph->update(updTime);
HXLINE( 316)		::String _hx_tmp2 = (((((((this->activeCount + HX_(" (",08,1c,00,00)) + updTime) + HX_("ms)\n",a7,a8,63,48)) + this->visibleCount) + HX_(" (",08,1c,00,00)) + drwTime) + HX_("ms)\n",a7,a8,63,48));
HXLINE( 318)		::String _hx_tmp3;
HXDLIN( 318)		if (::flixel::FlxG_obj::renderTile) {
HXLINE( 318)			_hx_tmp3 = (this->drawCallsCount + HX_("\n",0a,00,00,00));
            		}
            		else {
HXLINE( 318)			_hx_tmp3 = HX_("",00,00,00,00);
            		}
HXLINE( 316)		::String _hx_tmp4 = ((((_hx_tmp2 + _hx_tmp3) + ::flixel::_hx_system::FlxQuadTree_obj::_NUM_CACHED_QUAD_TREES) + HX_("\n",0a,00,00,00)) + ::flixel::_hx_system::FlxLinkedList_obj::_NUM_CACHED_FLX_LIST);
HXLINE( 315)		this->_rightTextField->set_text(_hx_tmp4);
            	}
...
Float Stats_obj::currentFps(){
            	HX_STACK_FRAME("flixel.system.debug.stats.Stats","currentFps",0x555240f6,"flixel.system.debug.stats.Stats.currentFps","flixel/system/debug/stats/Stats.hx",335,0xc15f23b8)
            	HX_STACK_THIS(this)
...
Float Stats_obj::intervalTime(){
            	HX_STACK_FRAME("flixel.system.debug.stats.Stats","intervalTime",0x37fba938,"flixel.system.debug.stats.Stats.intervalTime","flixel/system/debug/stats/Stats.hx",343,0xc15f23b8)
            	HX_STACK_THIS(this)
...
Float Stats_obj::currentMem(){
            	HX_STACK_FRAME("flixel.system.debug.stats.Stats","currentMem",0x55578722,"flixel.system.debug.stats.Stats.currentMem","flixel/system/debug/stats/Stats.hx",351,0xc15f23b8)
            	HX_STACK_THIS(this)
HXLINE( 351)		Int _hx_tmp = ::openfl::_legacy::_hx_system::System_obj::get_totalMemory();
HXDLIN( 351)		return ((Float)((Float)_hx_tmp / (Float)(int)1024) / (Float)(int)1000);
            	}
...
void Stats_obj::toggleSize(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 432)		Bool _hx_tmp = (this->_width == (int)160);
...
HXDLIN( 435)				Float _hx_tmp1 = _g->get_x();
HXDLIN( 435)				_g->set_x((_hx_tmp1 - (int)160));
            			}
HXLINE( 436)			this->drawTimeGraph->set_visible(true);
HXLINE( 437)			this->updateTimeGraph->set_visible(true);
HXLINE( 438)			this->_toggleSizeButton->changeIcon( ::flixel::_hx_system::debug::stats::_Stats::GraphicMinimizeButton_obj::__new((int)0,(int)0,null(),null()));
            		}
            		else {
...
HXDLIN( 443)				Float _hx_tmp2 = _g1->get_x();
HXDLIN( 443)				_g1->set_x((_hx_tmp2 + (int)160));
            			}
HXLINE( 444)			this->drawTimeGraph->set_visible(false);
HXLINE( 445)			this->updateTimeGraph->set_visible(false);
HXLINE( 446)			this->_toggleSizeButton->changeIcon( ::flixel::_hx_system::debug::stats::_Stats::GraphicMaximizeButton_obj::__new((int)0,(int)0,null(),null()));
            		}
...
HXLINE( 456)		Bool _hx_tmp = hx::IsNotNull( this->_toggleSizeButton );
HXDLIN( 456)		if (_hx_tmp) {
HXLINE( 458)			Int _hx_tmp1 = this->_width;
HXDLIN( 458)			Float _hx_tmp2 = this->_toggleSizeButton->get_width();
HXDLIN( 458)			this->_toggleSizeButton->set_x(((_hx_tmp1 - _hx_tmp2) - (int)3));
...
{
{
            	HX_STACK_FRAME("flixel.system.debug.stats.Stats","boot",0x57f87f78,"flixel.system.debug.stats.Stats.boot","flixel/system/debug/stats/Stats.hx",33,0xc15f23b8)
HXLINE(  33)		UPDATE_DELAY = (int)250;
            	}
{
            	HX_STACK_FRAME("flixel.system.debug.stats.Stats","boot",0x57f87f78,"flixel.system.debug.stats.Stats.boot","flixel/system/debug/stats/Stats.hx",37,0xc15f23b8)
HXLINE(  37)		INITIAL_WIDTH = (int)160;
            	}
{
            	HX_STACK_FRAME("flixel.system.debug.stats.Stats","boot",0x57f87f78,"flixel.system.debug.stats.Stats.boot","flixel/system/debug/stats/Stats.hx",41,0xc15f23b8)
HXLINE(  41)		MIN_HEIGHT = (int)0;
            	}
{
            	HX_STACK_FRAME("flixel.system.debug.stats.Stats","boot",0x57f87f78,"flixel.system.debug.stats.Stats.boot","flixel/system/debug/stats/Stats.hx",43,0xc15f23b8)
HXLINE(  43)		FPS_COLOR = (int)-6881536;
            	}
{
            	HX_STACK_FRAME("flixel.system.debug.stats.Stats","boot",0x57f87f78,"flixel.system.debug.stats.Stats.boot","flixel/system/debug/stats/Stats.hx",44,0xc15f23b8)
HXLINE(  44)		MEMORY_COLOR = (int)-16737025;
            	}
{
            	HX_STACK_FRAME("flixel.system.debug.stats.Stats","boot",0x57f87f78,"flixel.system.debug.stats.Stats.boot","flixel/system/debug/stats/Stats.hx",45,0xc15f23b8)
HXLINE(  45)		DRAW_TIME_COLOR = (int)-5898236;
            	}
{
            	HX_STACK_FRAME("flixel.system.debug.stats.Stats","boot",0x57f87f78,"flixel.system.debug.stats.Stats.boot","flixel/system/debug/stats/Stats.hx",46,0xc15f23b8)
HXLINE(  46)		UPDATE_TIME_COLOR = (int)-2305024;
            	}
{
            	HX_STACK_FRAME("flixel.system.debug.stats.Stats","boot",0x57f87f78,"flixel.system.debug.stats.Stats.boot","flixel/system/debug/stats/Stats.hx",48,0xc15f23b8)
HXLINE(  48)		LABEL_COLOR = (int)-1426063361;
            	}
{
            	HX_STACK_FRAME("flixel.system.debug.stats.Stats","boot",0x57f87f78,"flixel.system.debug.stats.Stats.boot","flixel/system/debug/stats/Stats.hx",49,0xc15f23b8)
HXLINE(  49)		TEXT_SIZE = (int)11;
            	}
{
            	HX_STACK_FRAME("flixel.system.debug.stats.Stats","boot",0x57f87f78,"flixel.system.debug.stats.Stats.boot","flixel/system/debug/stats/Stats.hx",50,0xc15f23b8)
