...
HXLINE(2078)		 ::haxe::io::Bytes _hx_tmp = ::haxe::Resource_obj::getBytes(::flixel::_hx_system::debug::_VCR::GraphicRecordOn_obj::resourceName);
...
{
{
            	HX_STACK_FRAME("flixel.system.debug._VCR.GraphicRecordOn","boot",0xcafa7e08,"flixel.system.debug._VCR.GraphicRecordOn.boot","openfl/_legacy/display/BitmapData.hx",22,0x0b92a012)
HXLINE(  22)		resourceName = HX_("__ASSET__:bitmap_flixel_system_debug__VCR_GraphicRecordOn",7e,48,e5,2b);
            	}
}
