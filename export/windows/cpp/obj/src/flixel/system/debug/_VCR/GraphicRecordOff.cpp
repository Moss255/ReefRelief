...
HXLINE(2078)		 ::haxe::io::Bytes _hx_tmp = ::haxe::Resource_obj::getBytes(::flixel::_hx_system::debug::_VCR::GraphicRecordOff_obj::resourceName);
...
{
{
            	HX_STACK_FRAME("flixel.system.debug._VCR.GraphicRecordOff","boot",0xee16538a,"flixel.system.debug._VCR.GraphicRecordOff.boot","openfl/_legacy/display/BitmapData.hx",22,0x0b92a012)
HXLINE(  22)		resourceName = HX_("__ASSET__:bitmap_flixel_system_debug__VCR_GraphicRecordOff",30,1f,ba,3c);
            	}
}
