...
HXLINE(  26)		this->_text =  ::openfl::_legacy::text::TextField_obj::__new();
...
HXLINE(  33)		this->_text->set_defaultTextFormat( ::openfl::_legacy::text::TextFormat_obj::__new(::flixel::_hx_system::FlxAssets_obj::FONT_DEBUGGER,(int)12,(int)16777215,null(),null(),null(),null(),null(),null(),null(),null(),null(),null()));
