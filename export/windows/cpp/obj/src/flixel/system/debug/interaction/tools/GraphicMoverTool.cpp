...
void GraphicMoverTool_obj::__construct(Int width,Int height, ::Dynamic __o_transparent, ::Dynamic __o_fillRGBA){
 ...
 ::Dynamic fillRGBA = __o_fillRGBA.Default(-1);
            	HX_STACK_FRAME("flixel.system.debug.interaction.tools.GraphicMoverTool","new",0x5d2174da,"flixel.system.debug.interaction.tools.GraphicMoverTool.new","openfl/_legacy/Assets.hx",2010,0x9276b055)
            	HX_STACK_THIS(this)
...
HXLINE(2078)		 ::haxe::io::Bytes _hx_tmp = ::haxe::Resource_obj::getBytes(::flixel::_hx_system::debug::interaction::tools::GraphicMoverTool_obj::resourceName);
...
{
{
            	HX_STACK_FRAME("flixel.system.debug.interaction.tools.GraphicMoverTool","boot",0x183dca78,"flixel.system.debug.interaction.tools.GraphicMoverTool.boot","openfl/_legacy/display/BitmapData.hx",22,0x0b92a012)
HXLINE(  22)		resourceName = HX_("__ASSET__:bitmap_flixel_system_debug_interaction_tools_GraphicMoverTool",81,a4,f3,1e);
            	}
}
