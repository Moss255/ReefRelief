...
static const ::String _hx_array_data_17[] = {
...
static const ::String _hx_array_data_18[] = {
...
static const ::String _hx_array_data_19[] = {
...
static const ::String _hx_array_data_20[] = {
...
static const ::String _hx_array_data_21[] = {
	HX_("emitting",c1,90,7b,58),HX_("frequency",9c,82,ea,bb),HX_("bounce",88,85,1d,66),
};
static const ::String _hx_array_data_22[] = {
...
static const ::String _hx_array_data_23[] = {
...
static const ::String _hx_array_data_24[] = {
...
static const ::String _hx_array_data_25[] = {
...
static const ::String _hx_array_data_26[] = {
...
HXLINE( 156)		::String _hx_tmp;
HXDLIN( 156)		Bool _hx_tmp1 = hx::IsNull( WindowTitle );
HXDLIN( 156)		if (_hx_tmp1) {
HXLINE( 156)			_hx_tmp = ::flixel::util::FlxStringUtil_obj::getClassName(this->_object,true);
            		}
            		else {
HXLINE( 156)			_hx_tmp = WindowTitle;
            		}
HXDLIN( 156)		this->_title->set_text(_hx_tmp);
HXLINE( 157)		this->set_visible(true);
HXLINE( 159)		Float _hx_tmp2 = this->entriesContainer->get_height();
HXDLIN( 159)		this->resize((int)200,(_hx_tmp2 + (int)30));
HXLINE( 162)		Int _hx_tmp3 = (::flixel::_hx_system::debug::watch::Tracker_obj::_numTrackerWindows * (int)80);
HXDLIN( 162)		this->set_x(_hx_tmp3);
HXLINE( 163)		Int _hx_tmp4 = ((::flixel::_hx_system::debug::watch::Tracker_obj::_numTrackerWindows * (int)25) + (int)20);
HXDLIN( 163)		this->set_y(_hx_tmp4);
...
hx::ObjectPtr< Tracker_obj > Tracker_obj::__new( ::flixel::_hx_system::debug::watch::TrackerProfile Profile, ::Dynamic ObjectOrClass,::String WindowTitle)
{
	...
	_hx_result->__construct(Profile,ObjectOrClass,WindowTitle);
	return _hx_result;
}
...
void Tracker_obj::initWatchEntries( ::flixel::_hx_system::debug::watch::TrackerProfile Profile){
            	HX_STACK_FRAME("flixel.system.debug.watch.Tracker","initWatchEntries",0xac4e4a0e,"flixel.system.debug.watch.Tracker.initWatchEntries","flixel/system/debug/watch/Tracker.hx",189,0x14368dcf)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(Profile,"Profile")
HXLINE( 189)		Bool _hx_tmp = hx::IsNotNull( Profile );
...
void Tracker_obj::addExtensions( ::flixel::_hx_system::debug::watch::TrackerProfile Profile){
            	...
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(Profile,"Profile")
HXLINE( 198)		Bool _hx_tmp = hx::IsNull( Profile->extensions );
...
HXDLIN( 201)				++_g;
HXLINE( 203)				Bool _hx_tmp1 = hx::IsNull( extension );
...
HXLINE( 207)				Bool _hx_tmp2 = hx::IsNotNull( extensionProfile );
...
HXLINE( 217)		Bool _hx_tmp = hx::IsNull( Variables );
...
HXDLIN( 220)				++_g;
HXLINE( 221)				::hx::EnumBase _hx_tmp1 = ::flixel::_hx_system::debug::watch::WatchEntryData_obj::FIELD(this->_object,variable);
HXDLIN( 221)				this->add(variable,_hx_tmp1);
            			}
            		}
            	}
...
void Tracker_obj::addProfile( ::flixel::_hx_system::debug::watch::TrackerProfile Profile){
            	HX_STACK_FRAME("flixel.system.debug.watch.Tracker","addProfile",0x17dc8565,"flixel.system.debug.watch.Tracker.addProfile","flixel/system/debug/watch/Tracker.hx",56,0x14368dcf)
            	HX_STACK_ARG(Profile,"Profile")
HXLINE(  56)		Bool _hx_tmp = hx::IsNotNull( Profile );
...
HXDLIN(  69)				Bool _hx_tmp1 = !(::Std_obj::is(Object,profile->objectClass));
...
void Tracker_obj::initProfiles(){
            	HX_STACK_FRAME("flixel.system.debug.watch.Tracker","initProfiles",0x6f40e3f7,"flixel.system.debug.watch.Tracker.initProfiles","flixel/system/debug/watch/Tracker.hx",82,0x14368dcf)
HXLINE(  82)		Bool _hx_tmp = hx::IsNull( ::flixel::_hx_system::debug::watch::Tracker_obj::profiles );
HXDLIN(  82)		if (_hx_tmp) {
HXLINE(  84)			::flixel::_hx_system::debug::watch::Tracker_obj::profiles = ::Array_obj< ::Dynamic>::__new(0);
HXLINE(  86)			{
HXLINE(  86)				HX_VARI(  ::flixel::_hx_system::debug::watch::TrackerProfile,Profile) =  ::flixel::_hx_system::debug::watch::TrackerProfile_obj::__new(hx::ClassOf< ::flixel::FlxG >(),::Array_obj< ::String >::fromData( _hx_array_data_4,14),null());
HXDLIN(  86)				Bool _hx_tmp1 = hx::IsNotNull( Profile );
...
HXLINE(  90)			{
HXLINE(  90)				HX_VARI_NAME(  ::flixel::_hx_system::debug::watch::TrackerProfile,Profile1,"Profile") =  ::flixel::_hx_system::debug::watch::TrackerProfile_obj::__new(hx::ClassOf< ::flixel::math::FlxPoint >(),::Array_obj< ::String >::fromData( _hx_array_data_5,2),null());
HXDLIN(  90)				Bool _hx_tmp2 = hx::IsNotNull( Profile1 );
...
HXLINE(  91)			{
HXLINE(  91)				HX_VARI_NAME(  ::flixel::_hx_system::debug::watch::TrackerProfile,Profile2,"Profile") =  ::flixel::_hx_system::debug::watch::TrackerProfile_obj::__new(hx::ClassOf< ::flixel::math::FlxRect >(),::Array_obj< ::String >::fromData( _hx_array_data_6,2),::Array_obj< ::Dynamic>::__new(1)->init(0,hx::ClassOf< ::flixel::math::FlxPoint >()));
HXDLIN(  91)				Bool _hx_tmp3 = hx::IsNotNull( Profile2 );
...
HXLINE(  93)			{
HXLINE(  93)				HX_VARI_NAME(  ::flixel::_hx_system::debug::watch::TrackerProfile,Profile3,"Profile") =  ::flixel::_hx_system::debug::watch::TrackerProfile_obj::__new(hx::ClassOf< ::flixel::FlxBasic >(),::Array_obj< ::String >::fromData( _hx_array_data_7,4),null());
HXDLIN(  93)				Bool _hx_tmp4 = hx::IsNotNull( Profile3 );
...
HXLINE(  94)			{
HXLINE(  94)				HX_VARI_NAME(  ::flixel::_hx_system::debug::watch::TrackerProfile,Profile4,"Profile") =  ::flixel::_hx_system::debug::watch::TrackerProfile_obj::__new(hx::ClassOf< ::flixel::FlxObject >(),::Array_obj< ::String >::fromData( _hx_array_data_8,5),::Array_obj< ::Dynamic>::__new(2)->init(0,hx::ClassOf< ::flixel::math::FlxRect >())->init(1,hx::ClassOf< ::flixel::FlxBasic >()));
HXDLIN(  94)				Bool _hx_tmp5 = hx::IsNotNull( Profile4 );
...
HXLINE(  95)			{
HXLINE(  95)				HX_VARI_NAME(  ::flixel::_hx_system::debug::watch::TrackerProfile,Profile5,"Profile") =  ::flixel::_hx_system::debug::watch::TrackerProfile_obj::__new(hx::ClassOf< ::flixel::tile::FlxTilemap >(),::Array_obj< ::String >::fromData( _hx_array_data_9,5),::Array_obj< ::Dynamic>::__new(1)->init(0,hx::ClassOf< ::flixel::FlxObject >()));
HXDLIN(  95)				Bool _hx_tmp6 = hx::IsNotNull( Profile5 );
...
HXLINE(  96)			{
HXLINE(  96)				HX_VARI_NAME(  ::flixel::_hx_system::debug::watch::TrackerProfile,Profile6,"Profile") =  ::flixel::_hx_system::debug::watch::TrackerProfile_obj::__new(hx::ClassOf< ::flixel::FlxSprite >(),::Array_obj< ::String >::fromData( _hx_array_data_10,6),::Array_obj< ::Dynamic>::__new(1)->init(0,hx::ClassOf< ::flixel::FlxObject >()));
HXDLIN(  96)				Bool _hx_tmp7 = hx::IsNotNull( Profile6 );
...
HXLINE(  97)			{
HXLINE(  97)				HX_VARI_NAME(  ::flixel::_hx_system::debug::watch::TrackerProfile,Profile7,"Profile") =  ::flixel::_hx_system::debug::watch::TrackerProfile_obj::__new(hx::ClassOf< ::flixel::ui::FlxTypedButton >(),::Array_obj< ::String >::fromData( _hx_array_data_11,2),::Array_obj< ::Dynamic>::__new(1)->init(0,hx::ClassOf< ::flixel::FlxSprite >()));
HXDLIN(  97)				Bool _hx_tmp8 = hx::IsNotNull( Profile7 );
...
HXLINE(  98)			{
HXLINE(  98)				HX_VARI_NAME(  ::flixel::_hx_system::debug::watch::TrackerProfile,Profile8,"Profile") =  ::flixel::_hx_system::debug::watch::TrackerProfile_obj::__new(hx::ClassOf< ::flixel::ui::FlxBar >(),::Array_obj< ::String >::fromData( _hx_array_data_12,6),::Array_obj< ::Dynamic>::__new(1)->init(0,hx::ClassOf< ::flixel::FlxSprite >()));
HXDLIN(  98)				Bool _hx_tmp9 = hx::IsNotNull( Profile8 );
...
HXLINE(  99)			{
HXLINE(  99)				HX_VARI_NAME(  ::flixel::_hx_system::debug::watch::TrackerProfile,Profile9,"Profile") =  ::flixel::_hx_system::debug::watch::TrackerProfile_obj::__new(hx::ClassOf< ::flixel::text::FlxText >(),::Array_obj< ::String >::fromData( _hx_array_data_13,9),::Array_obj< ::Dynamic>::__new(1)->init(0,hx::ClassOf< ::flixel::FlxSprite >()));
HXDLIN(  99)				Bool _hx_tmp10 = hx::IsNotNull( Profile9 );
...
HXLINE( 102)			{
HXLINE( 102)				HX_VARI_NAME(  ::flixel::_hx_system::debug::watch::TrackerProfile,Profile10,"Profile") =  ::flixel::_hx_system::debug::watch::TrackerProfile_obj::__new(hx::ClassOf< ::flixel::group::FlxTypedGroup >(),::Array_obj< ::String >::fromData( _hx_array_data_14,3),::Array_obj< ::Dynamic>::__new(1)->init(0,hx::ClassOf< ::flixel::FlxBasic >()));
HXDLIN( 102)				Bool _hx_tmp11 = hx::IsNotNull( Profile10 );
...
HXLINE( 103)			{
HXLINE( 103)				HX_VARI_NAME(  ::flixel::_hx_system::debug::watch::TrackerProfile,Profile11,"Profile") =  ::flixel::_hx_system::debug::watch::TrackerProfile_obj::__new(hx::ClassOf< ::flixel::group::FlxTypedSpriteGroup >(),null(),::Array_obj< ::Dynamic>::__new(2)->init(0,hx::ClassOf< ::flixel::FlxSprite >())->init(1,hx::ClassOf< ::flixel::group::FlxTypedGroup >()));
HXDLIN( 103)				Bool _hx_tmp12 = hx::IsNotNull( Profile11 );
...
HXLINE( 104)			{
HXLINE( 104)				HX_VARI_NAME(  ::flixel::_hx_system::debug::watch::TrackerProfile,Profile12,"Profile") =  ::flixel::_hx_system::debug::watch::TrackerProfile_obj::__new(hx::ClassOf< ::flixel::FlxState >(),::Array_obj< ::String >::fromData( _hx_array_data_15,4),::Array_obj< ::Dynamic>::__new(1)->init(0,hx::ClassOf< ::flixel::group::FlxTypedGroup >()));
HXDLIN( 104)				Bool _hx_tmp13 = hx::IsNotNull( Profile12 );
...
HXLINE( 106)			{
HXLINE( 106)				HX_VARI_NAME(  ::flixel::_hx_system::debug::watch::TrackerProfile,Profile13,"Profile") =  ::flixel::_hx_system::debug::watch::TrackerProfile_obj::__new(hx::ClassOf< ::flixel::FlxCamera >(),::Array_obj< ::String >::fromData( _hx_array_data_16,8),::Array_obj< ::Dynamic>::__new(2)->init(0,hx::ClassOf< ::flixel::FlxBasic >())->init(1,hx::ClassOf< ::flixel::math::FlxRect >()));
HXDLIN( 106)				Bool _hx_tmp14 = hx::IsNotNull( Profile13 );
...
HXLINE( 109)			{
HXLINE( 109)				HX_VARI_NAME(  ::flixel::_hx_system::debug::watch::TrackerProfile,Profile14,"Profile") =  ::flixel::_hx_system::debug::watch::TrackerProfile_obj::__new(hx::ClassOf< ::flixel::tweens::FlxTween >(),::Array_obj< ::String >::fromData( _hx_array_data_17,10),null());
HXDLIN( 109)				Bool _hx_tmp15 = hx::IsNotNull( Profile14 );
...
HXLINE( 112)			{
HXLINE( 112)				HX_VARI_NAME(  ::flixel::_hx_system::debug::watch::TrackerProfile,Profile15,"Profile") =  ::flixel::_hx_system::debug::watch::TrackerProfile_obj::__new(hx::ClassOf< ::flixel::util::FlxPath >(),::Array_obj< ::String >::fromData( _hx_array_data_18,6),null());
HXDLIN( 112)				Bool _hx_tmp16 = hx::IsNotNull( Profile15 );
HXDLIN( 112)				if (_hx_tmp16) {
...
HXLINE( 113)			{
HXLINE( 113)				HX_VARI_NAME(  ::flixel::_hx_system::debug::watch::TrackerProfile,Profile16,"Profile") =  ::flixel::_hx_system::debug::watch::TrackerProfile_obj::__new(hx::ClassOf< ::flixel::util::FlxTimer >(),::Array_obj< ::String >::fromData( _hx_array_data_19,9),null());
HXDLIN( 113)				Bool _hx_tmp17 = hx::IsNotNull( Profile16 );
...
HXLINE( 115)			{
HXLINE( 115)				HX_VARI_NAME(  ::flixel::_hx_system::debug::watch::TrackerProfile,Profile17,"Profile") =  ::flixel::_hx_system::debug::watch::TrackerProfile_obj::__new(hx::ClassOf< ::flixel::animation::FlxAnimationController >(),::Array_obj< ::String >::fromData( _hx_array_data_20,6),null());
HXDLIN( 115)				Bool _hx_tmp18 = hx::IsNotNull( Profile17 );
HXDLIN( 115)				if (_hx_tmp18) {
...
HXLINE( 117)			{
HXLINE( 117)				HX_VARI_NAME(  ::flixel::_hx_system::debug::watch::TrackerProfile,Profile18,"Profile") =  ::flixel::_hx_system::debug::watch::TrackerProfile_obj::__new(hx::ClassOf< ::flixel::effects::particles::FlxTypedEmitter >(),::Array_obj< ::String >::fromData( _hx_array_data_21,3),::Array_obj< ::Dynamic>::__new(2)->init(0,hx::ClassOf< ::flixel::group::FlxTypedGroup >())->init(1,hx::ClassOf< ::flixel::math::FlxRect >()));
HXDLIN( 117)				Bool _hx_tmp19 = hx::IsNotNull( Profile18 );
...
HXLINE( 121)			{
HXLINE( 121)				HX_VARI_NAME(  ::flixel::_hx_system::debug::watch::TrackerProfile,Profile19,"Profile") =  ::flixel::_hx_system::debug::watch::TrackerProfile_obj::__new(hx::ClassOf< ::flixel::input::mouse::FlxMouse >(),::Array_obj< ::String >::fromData( _hx_array_data_22,14),::Array_obj< ::Dynamic>::__new(1)->init(0,hx::ClassOf< ::flixel::math::FlxPoint >()));
HXDLIN( 121)				Bool _hx_tmp20 = hx::IsNotNull( Profile19 );
...
HXLINE( 130)			{
HXLINE( 130)				HX_VARI_NAME(  ::flixel::_hx_system::debug::watch::TrackerProfile,Profile20,"Profile") =  ::flixel::_hx_system::debug::watch::TrackerProfile_obj::__new(hx::ClassOf< ::flixel::input::gamepad::FlxGamepad >(),::Array_obj< ::String >::fromData( _hx_array_data_23,8),null());
HXDLIN( 130)				Bool _hx_tmp21 = hx::IsNotNull( Profile20 );
HXDLIN( 130)				if (_hx_tmp21) {
...
HXLINE( 134)			{
HXLINE( 134)				HX_VARI_NAME(  ::flixel::_hx_system::debug::watch::TrackerProfile,Profile21,"Profile") =  ::flixel::_hx_system::debug::watch::TrackerProfile_obj::__new(hx::ClassOf< ::flixel::input::FlxSwipe >(),::Array_obj< ::String >::fromData( _hx_array_data_24,6),null());
HXDLIN( 134)				Bool _hx_tmp22 = hx::IsNotNull( Profile21 );
...
HXLINE( 137)			{
HXLINE( 137)				HX_VARI_NAME(  ::flixel::_hx_system::debug::watch::TrackerProfile,Profile22,"Profile") =  ::flixel::_hx_system::debug::watch::TrackerProfile_obj::__new(hx::ClassOf< ::openfl::_legacy::display::DisplayObject >(),::Array_obj< ::String >::fromData( _hx_array_data_25,8),::Array_obj< ::Dynamic>::__new(1)->init(0,hx::ClassOf< ::flixel::math::FlxRect >()));
HXDLIN( 137)				Bool _hx_tmp23 = hx::IsNotNull( Profile22 );
HXDLIN( 137)				if (_hx_tmp23) {
...
HXLINE( 138)			{
HXLINE( 138)				HX_VARI_NAME(  ::flixel::_hx_system::debug::watch::TrackerProfile,Profile23,"Profile") =  ::flixel::_hx_system::debug::watch::TrackerProfile_obj::__new(hx::ClassOf< ::openfl::_legacy::geom::Point >(),null(),::Array_obj< ::Dynamic>::__new(1)->init(0,hx::ClassOf< ::flixel::math::FlxPoint >()));
HXDLIN( 138)				Bool _hx_tmp24 = hx::IsNotNull( Profile23 );
HXDLIN( 138)				if (_hx_tmp24) {
...
HXLINE( 139)			{
HXLINE( 139)				HX_VARI_NAME(  ::flixel::_hx_system::debug::watch::TrackerProfile,Profile24,"Profile") =  ::flixel::_hx_system::debug::watch::TrackerProfile_obj::__new(hx::ClassOf< ::openfl::_legacy::geom::Rectangle >(),null(),::Array_obj< ::Dynamic>::__new(1)->init(0,hx::ClassOf< ::flixel::math::FlxRect >()));
HXDLIN( 139)				Bool _hx_tmp25 = hx::IsNotNull( Profile24 );
...
HXLINE( 140)			{
HXLINE( 140)				HX_VARI_NAME(  ::flixel::_hx_system::debug::watch::TrackerProfile,Profile25,"Profile") =  ::flixel::_hx_system::debug::watch::TrackerProfile_obj::__new(hx::ClassOf< ::openfl::_legacy::geom::Matrix >(),::Array_obj< ::String >::fromData( _hx_array_data_26,6),null());
HXDLIN( 140)				Bool _hx_tmp26 = hx::IsNotNull( Profile25 );
HXDLIN( 140)				if (_hx_tmp26) {
...
{
{
            	HX_STACK_FRAME("flixel.system.debug.watch.Tracker","boot",0x1225c0cf,"flixel.system.debug.watch.Tracker.boot","flixel/system/debug/watch/Tracker.hx",50,0x14368dcf)
HXLINE(  50)		objectsBeingTracked = ::cpp::VirtualArray_obj::__new(0);
            	}
{
            	HX_STACK_FRAME("flixel.system.debug.watch.Tracker","boot",0x1225c0cf,"flixel.system.debug.watch.Tracker.boot","flixel/system/debug/watch/Tracker.hx",52,0x14368dcf)
