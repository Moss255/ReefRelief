...
HXDLIN(  52)				++_g;
HXLINE(  54)				 ::flixel::util::FlxTimer_obj::__new(null())->start(time,this->timerCallback_dyn(),null());
            			}
            		}
...
HXDLIN(  76)		::flixel::FlxG_obj::sound->load(_hx_tmp,null(),null(),null(),null(),null(),null(),null())->play(null(),null(),null());
            	}
