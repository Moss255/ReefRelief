...
HXLINE( 213)				Int _hx_tmp = this->mapping->axisIndexToRawID(i);
HXDLIN( 213)				HX_VARI(  ::flixel::input::gamepad::FlxGamepadButton,button) = this->getButton(_hx_tmp);
HXLINE( 214)				Bool _hx_tmp1 = hx::IsNotNull( button );
HXDLIN( 214)				if (_hx_tmp1) {
HXLINE( 217)					Float _hx_tmp2 = this->axis->__get(i);
HXDLIN( 217)					HX_VARI( Float,axisValue) = ::Math_obj::abs(_hx_tmp2);
HXDLIN( 217)					Bool _hx_tmp3 = this->mapping->isAxisFlipped(i);
HXDLIN( 217)					if (_hx_tmp3) {
HXLINE( 217)						hx::MultEq(axisValue,(int)-1);
            					}
HXDLIN( 217)					HX_VARI( Float,value) = axisValue;
HXLINE( 218)					Float _hx_tmp4 = this->get_deadZone();
HXDLIN( 218)					if ((value > _hx_tmp4)) {
HXLINE( 220)						button->press();
            					}
            					else {
HXLINE( 222)						Float _hx_tmp5 = this->get_deadZone();
HXDLIN( 222)						if ((value < _hx_tmp5)) {
...
HXDLIN( 232)				++_g2;
HXLINE( 234)				Bool _hx_tmp6 = hx::IsNotNull( button1 );
...
HXLINE( 522)			HX_VARI( Int,rawID) = this->mapping->getRawID(AxisButtonID);
HXLINE( 523)			HX_VARI( Float,axisValue) = this->getAxisValue(rawID);
HXDLIN( 523)			HX_VAR_NAME( Float,axisValue1,"axisValue");
HXDLIN( 523)			Float _hx_tmp = ::Math_obj::abs(axisValue);
HXDLIN( 523)			Float _hx_tmp1 = this->get_deadZone();
HXDLIN( 523)			if ((_hx_tmp > _hx_tmp1)) {
HXLINE( 523)				axisValue1 = axisValue;
            			}
            			else {
HXLINE( 523)				axisValue1 = (int)0;
            			}
HXDLIN( 523)			Bool _hx_tmp2 = this->mapping->isAxisFlipped(AxisButtonID);
HXDLIN( 523)			if (_hx_tmp2) {
HXLINE( 523)				hx::MultEq(axisValue1,(int)-1);
            			}
HXDLIN( 523)			return axisValue1;
            		}
            		else {
HXLINE( 528)			HX_VARI(  ::flixel::input::gamepad::FlxGamepadButton,btn) = this->getButton(fakeAxisRawID);
HXLINE( 529)			Bool _hx_tmp3 = hx::IsNull( btn );
HXDLIN( 529)			if (_hx_tmp3) {
HXLINE( 530)				return (int)0;
            			}
HXLINE( 531)			Bool _hx_tmp4;
HXDLIN( 531)			if ((btn->current != (int)1)) {
HXLINE( 531)				_hx_tmp4 = (btn->current == (int)2);
            			}
            			else {
...
HXDLIN( 625)				Bool _hx_tmp1 = hx::IsNotNull( button );
...
Bool FlxGamepad_obj::anyInput(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 638)		Bool _hx_tmp = this->anyButton(null());
...
HXLINE( 652)			_hx_tmp1 = (this->ball->y != (int)0);
            		}
            		else {
...
HXLINE( 657)		Bool _hx_tmp2;
HXDLIN( 657)		if ((this->hat->x == (int)0)) {
HXLINE( 657)			_hx_tmp2 = (this->hat->y != (int)0);
            		}
            		else {
...
HXLINE( 688)		Bool _hx_tmp1 = this->isAxisForAnalogStick(AxisID);
HXDLIN( 688)		if (_hx_tmp1) {
HXLINE( 690)			HX_VARI_NAME( Float,axisValue1,"axisValue") = axisValue;
HXDLIN( 690)			Bool _hx_tmp2 = this->mapping->isAxisFlipped(AxisID);
HXDLIN( 690)			if (_hx_tmp2) {
HXLINE( 690)				hx::MultEq(axisValue1,(int)-1);
            			}
...
Float FlxGamepad_obj::getAnalogXAxisValue( ::flixel::input::gamepad::FlxGamepadAnalogStick stick){
            	...
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(stick,"stick")
HXLINE( 698)		Bool _hx_tmp = hx::IsNull( stick );
...
Float FlxGamepad_obj::getAnalogYAxisValue( ::flixel::input::gamepad::FlxGamepadAnalogStick stick){
            	...
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(stick,"stick")
HXLINE( 708)		Bool _hx_tmp = hx::IsNull( stick );
...
Float FlxGamepad_obj::getAnalogAxisValueCircular( ::flixel::input::gamepad::FlxGamepadAnalogStick stick,Int axisID){
            	...
            	HX_STACK_ARG(stick,"stick")
            	HX_STACK_ARG(axisID,"axisID")
HXLINE( 718)		Bool _hx_tmp = hx::IsNull( stick );
...
HXLINE( 724)		Float _hx_tmp1 = ((vector->x * vector->x) + (vector->y * vector->y));
HXDLIN( 724)		HX_VARI( Float,length) = ::Math_obj::sqrt(_hx_tmp1);
HXLINE( 725)		vector->put();
HXLINE( 727)		Float _hx_tmp2 = this->get_deadZone();
HXDLIN( 727)		if ((length > _hx_tmp2)) {
...
HXLINE( 737)		Float _hx_tmp = ::Math_obj::abs(axisValue);
HXDLIN( 737)		Float _hx_tmp1 = this->get_deadZone();
HXDLIN( 737)		if ((_hx_tmp > _hx_tmp1)) {
...
HXDLIN( 744)		Bool _hx_tmp = this->mapping->isAxisFlipped(axis);
HXDLIN( 744)		if (_hx_tmp) {
HXLINE( 744)			hx::MultEq(axisValue,(int)-1);
            		}
HXDLIN( 744)		newValue = axisValue;
HXLINE( 745)		HX_VARI_NAME( Float,axisValue1,"axisValue") = oldValue;
HXDLIN( 745)		Bool _hx_tmp1 = this->mapping->isAxisFlipped(axis);
HXDLIN( 745)		if (_hx_tmp1) {
HXLINE( 745)			hx::MultEq(axisValue1,(int)-1);
            		}
...
HXDLIN( 748)		Bool _hx_tmp4 = hx::IsNotNull( leftStick );
HXDLIN( 748)		if (_hx_tmp4) {
HXLINE( 748)			_hx_tmp3 = (axis == leftStick->x);
            		}
            		else {
HXLINE( 748)			_hx_tmp3 = false;
            		}
HXDLIN( 748)		if (!(_hx_tmp3)) {
HXLINE( 748)			_hx_tmp2 = (axis == leftStick->y);
            		}
            		else {
...
HXDLIN( 748)			Bool _hx_tmp6;
HXDLIN( 748)			Bool _hx_tmp7 = hx::IsNotNull( rightStick );
HXDLIN( 748)			if (_hx_tmp7) {
HXLINE( 748)				_hx_tmp6 = (axis == rightStick->x);
            			}
            			else {
HXLINE( 748)				_hx_tmp6 = false;
            			}
HXDLIN( 748)			if (!(_hx_tmp6)) {
HXLINE( 748)				_hx_tmp5 = (axis == rightStick->y);
            			}
            			else {
HXLINE( 748)				_hx_tmp5 = true;
            			}
...
HXLINE( 749)			_hx_tmp8 = hx::IsEq( stick->mode,::flixel::input::gamepad::FlxAnalogToDigitalMode_obj::BOTH_dyn() );
            		}
            		else {
HXLINE( 749)			_hx_tmp8 = true;
            		}
...
HXLINE( 781)			Bool _hx_tmp1 = hx::IsNotNull( btn );
...
HXLINE( 783)				_hx_tmp2 = (oldValueSign > threshold);
            			}
            			else {
...
HXLINE( 786)				Bool _hx_tmp3 = hx::IsNotNull( btn1 );
...
HX_DEFINE_DYNAMIC_FUNC5(FlxGamepad_obj,handleAxisMoveSub,(void))
 ...
 ::flixel::input::gamepad::mappings::FlxGamepadMapping FlxGamepad_obj::createMappingForModel(::hx::EnumBase model){
            	HX_STACK_FRAME("flixel.input.gamepad.FlxGamepad","createMappingForModel",0x1a17db56,"flixel.input.gamepad.FlxGamepad.createMappingForModel","flixel/input/gamepad/FlxGamepad.hx",791,0xdb78a809)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(model,"model")
HXLINE( 791)		Int _hx_tmp = ( ( ::hx::EnumBase)(model) )->_hx_getIndex();
HXDLIN( 791)		switch((int)(_hx_tmp)){
            			case (int)0: {
HXLINE( 791)				return  ::flixel::input::gamepad::mappings::LogitechMapping_obj::__new(this->attachment);
            			}
            			break;
            			case (int)1: {
HXLINE( 791)				return  ::flixel::input::gamepad::mappings::OUYAMapping_obj::__new(this->attachment);
            			}
            			break;
            			case (int)2: {
HXLINE( 791)				return  ::flixel::input::gamepad::mappings::PS4Mapping_obj::__new(this->attachment);
            			}
            			break;
            			case (int)3: {
HXLINE( 791)				return  ::flixel::input::gamepad::mappings::PSVitaMapping_obj::__new(this->attachment);
            			}
            			break;
            			case (int)4: {
HXLINE( 791)				return  ::flixel::input::gamepad::mappings::XInputMapping_obj::__new(this->attachment);
            			}
            			break;
            			case (int)5: {
HXLINE( 791)				return  ::flixel::input::gamepad::mappings::MayflashWiiRemoteMapping_obj::__new(this->attachment);
            			}
            			break;
            			case (int)6: {
HXLINE( 791)				return  ::flixel::input::gamepad::mappings::WiiRemoteMapping_obj::__new(this->attachment);
            			}
            			break;
            			case (int)7: {
HXLINE( 791)				return  ::flixel::input::gamepad::mappings::MFiMapping_obj::__new(this->attachment);
            			}
            			break;
            			default:{
HXLINE( 791)				return  ::flixel::input::gamepad::mappings::XInputMapping_obj::__new(this->attachment);
...
Float FlxGamepad_obj::get_deadZone(){
            	HX_STACK_FRAME("flixel.input.gamepad.FlxGamepad","get_deadZone",0x3fdae195,"flixel.input.gamepad.FlxGamepad.get_deadZone","flixel/input/gamepad/FlxGamepad.hx",832,0xdb78a809)
            	HX_STACK_THIS(this)
HXLINE( 832)		Bool _hx_tmp = hx::IsNull( this->manager->globalDeadZone );
...
Float FlxGamepad_obj::set_deadZone(Float deadZone){
            	HX_STACK_FRAME("flixel.input.gamepad.FlxGamepad","set_deadZone",0x54d40509,"flixel.input.gamepad.FlxGamepad.set_deadZone","flixel/input/gamepad/FlxGamepad.hx",837,0xdb78a809)
            	HX_STACK_THIS(this)
...
::String FlxGamepad_obj::toString(){
            	HX_STACK_FRAME("flixel.input.gamepad.FlxGamepad","toString",0x4b874148,"flixel.input.gamepad.FlxGamepad.toString","flixel/input/gamepad/FlxGamepad.hx",842,0xdb78a809)
            	HX_STACK_THIS(this)
...
HXLINE( 844)		HX_VARI_NAME(  ::flixel::util::LabelValuePair,_this1,"_this") = ::flixel::util::LabelValuePair_obj::_pool->get();
HXDLIN( 844)		_this1->label = HX_("model",a9,23,58,0c);
HXDLIN( 844)		_this1->value = this->model;
HXLINE( 845)		 ::Dynamic value1 = this->get_deadZone();
...
HXDLIN( 845)		_this2->value = value1;
