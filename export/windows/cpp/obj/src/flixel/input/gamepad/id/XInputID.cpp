...
{
{
            	HX_STACK_FRAME("flixel.input.gamepad.id.XInputID","boot",0x5dbba0a3,"flixel.input.gamepad.id.XInputID.boot","flixel/input/gamepad/id/XInputID.hx",84,0x9958eee3)
HXLINE(  84)		A = (int)0;
            	}
{
            	HX_STACK_FRAME("flixel.input.gamepad.id.XInputID","boot",0x5dbba0a3,"flixel.input.gamepad.id.XInputID.boot","flixel/input/gamepad/id/XInputID.hx",85,0x9958eee3)
HXLINE(  85)		B = (int)1;
            	}
{
            	HX_STACK_FRAME("flixel.input.gamepad.id.XInputID","boot",0x5dbba0a3,"flixel.input.gamepad.id.XInputID.boot","flixel/input/gamepad/id/XInputID.hx",86,0x9958eee3)
HXLINE(  86)		X = (int)2;
            	}
{
            	HX_STACK_FRAME("flixel.input.gamepad.id.XInputID","boot",0x5dbba0a3,"flixel.input.gamepad.id.XInputID.boot","flixel/input/gamepad/id/XInputID.hx",87,0x9958eee3)
HXLINE(  87)		Y = (int)3;
            	}
{
            	HX_STACK_FRAME("flixel.input.gamepad.id.XInputID","boot",0x5dbba0a3,"flixel.input.gamepad.id.XInputID.boot","flixel/input/gamepad/id/XInputID.hx",89,0x9958eee3)
HXLINE(  89)		LB = (int)4;
            	}
{
            	HX_STACK_FRAME("flixel.input.gamepad.id.XInputID","boot",0x5dbba0a3,"flixel.input.gamepad.id.XInputID.boot","flixel/input/gamepad/id/XInputID.hx",90,0x9958eee3)
HXLINE(  90)		RB = (int)5;
            	}
{
            	HX_STACK_FRAME("flixel.input.gamepad.id.XInputID","boot",0x5dbba0a3,"flixel.input.gamepad.id.XInputID.boot","flixel/input/gamepad/id/XInputID.hx",92,0x9958eee3)
HXLINE(  92)		BACK = (int)6;
            	}
{
            	HX_STACK_FRAME("flixel.input.gamepad.id.XInputID","boot",0x5dbba0a3,"flixel.input.gamepad.id.XInputID.boot","flixel/input/gamepad/id/XInputID.hx",93,0x9958eee3)
HXLINE(  93)		START = (int)7;
            	}
{
            	HX_STACK_FRAME("flixel.input.gamepad.id.XInputID","boot",0x5dbba0a3,"flixel.input.gamepad.id.XInputID.boot","flixel/input/gamepad/id/XInputID.hx",103,0x9958eee3)
HXLINE( 103)		LEFT_STICK_CLICK = (int)8;
            	}
{
            	HX_STACK_FRAME("flixel.input.gamepad.id.XInputID","boot",0x5dbba0a3,"flixel.input.gamepad.id.XInputID.boot","flixel/input/gamepad/id/XInputID.hx",104,0x9958eee3)
HXLINE( 104)		RIGHT_STICK_CLICK = (int)9;
            	}
{
            	HX_STACK_FRAME("flixel.input.gamepad.id.XInputID","boot",0x5dbba0a3,"flixel.input.gamepad.id.XInputID.boot","flixel/input/gamepad/id/XInputID.hx",105,0x9958eee3)
HXLINE( 105)		GUIDE = (int)10;
            	}
{
            	HX_STACK_FRAME("flixel.input.gamepad.id.XInputID","boot",0x5dbba0a3,"flixel.input.gamepad.id.XInputID.boot","flixel/input/gamepad/id/XInputID.hx",111,0x9958eee3)
HXLINE( 111)		DPAD_UP = (int)11;
            	}
{
            	HX_STACK_FRAME("flixel.input.gamepad.id.XInputID","boot",0x5dbba0a3,"flixel.input.gamepad.id.XInputID.boot","flixel/input/gamepad/id/XInputID.hx",112,0x9958eee3)
HXLINE( 112)		DPAD_DOWN = (int)12;
            	}
{
            	HX_STACK_FRAME("flixel.input.gamepad.id.XInputID","boot",0x5dbba0a3,"flixel.input.gamepad.id.XInputID.boot","flixel/input/gamepad/id/XInputID.hx",113,0x9958eee3)
HXLINE( 113)		DPAD_LEFT = (int)13;
            	}
{
            	HX_STACK_FRAME("flixel.input.gamepad.id.XInputID","boot",0x5dbba0a3,"flixel.input.gamepad.id.XInputID.boot","flixel/input/gamepad/id/XInputID.hx",114,0x9958eee3)
HXLINE( 114)		DPAD_RIGHT = (int)14;
            	}
{
            	HX_STACK_FRAME("flixel.input.gamepad.id.XInputID","boot",0x5dbba0a3,"flixel.input.gamepad.id.XInputID.boot","flixel/input/gamepad/id/XInputID.hx",116,0x9958eee3)
HXLINE( 116)		LEFT_TRIGGER = (int)2;
            	}
{
            	HX_STACK_FRAME("flixel.input.gamepad.id.XInputID","boot",0x5dbba0a3,"flixel.input.gamepad.id.XInputID.boot","flixel/input/gamepad/id/XInputID.hx",117,0x9958eee3)
HXLINE( 117)		RIGHT_TRIGGER = (int)5;
            	}
{
            	HX_STACK_FRAME("flixel.input.gamepad.id.XInputID","boot",0x5dbba0a3,"flixel.input.gamepad.id.XInputID.boot","flixel/input/gamepad/id/XInputID.hx",119,0x9958eee3)
HXLINE( 119)		LEFT_ANALOG_STICK =  ::flixel::input::gamepad::FlxGamepadAnalogStick_obj::__new((int)0,(int)1, ::Dynamic(hx::Anon_obj::Create(4)
...
{
            	HX_STACK_FRAME("flixel.input.gamepad.id.XInputID","boot",0x5dbba0a3,"flixel.input.gamepad.id.XInputID.boot","flixel/input/gamepad/id/XInputID.hx",120,0x9958eee3)
HXLINE( 120)		RIGHT_ANALOG_STICK =  ::flixel::input::gamepad::FlxGamepadAnalogStick_obj::__new((int)3,(int)4, ::Dynamic(hx::Anon_obj::Create(4)
