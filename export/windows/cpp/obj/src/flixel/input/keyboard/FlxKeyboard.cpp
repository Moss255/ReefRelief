...
HXDLIN(  98)		Bool _hx_tmp1 = hx::IsNotNull( ::flixel::FlxG_obj::game->debugger );
...
HXLINE( 172)			Int _hx_tmp = i++;
HXDLIN( 172)			HX_VARI(  ::flixel::_hx_system::replay::CodeValuePair,o) = Record->__get(_hx_tmp).StaticCast<  ::flixel::_hx_system::replay::CodeValuePair >();
HXLINE( 173)			Int KeyCode = o->code;
HXDLIN( 173)			HX_VARI(  ::flixel::input::FlxInput,o2) = this->_keyListMap->get(KeyCode).StaticCast<  ::flixel::input::FlxInput >();
