...
HXLINE( 379)		this->_leftButton =  ::flixel::input::mouse::FlxMouseButton_obj::__new((int)-1);
...
HXLINE( 386)		this->_middleButton =  ::flixel::input::mouse::FlxMouseButton_obj::__new((int)-2);
HXLINE( 387)		this->_rightButton =  ::flixel::input::mouse::FlxMouseButton_obj::__new((int)-3);
...
HXLINE( 163)		Bool _hx_tmp = hx::IsNotNull( this->_cursor );
HXDLIN( 163)		if (_hx_tmp) {
HXLINE( 165)			::flixel::util::FlxDestroyUtil_obj::removeChild(this->cursorContainer,this->_cursor);
            		}
HXLINE( 169)		Bool _hx_tmp1 = hx::IsNull( Graphic );
HXDLIN( 169)		if (_hx_tmp1) {
HXLINE( 171)			Graphic =  ::flixel::input::mouse::_FlxMouse::GraphicCursor_obj::__new((int)0,(int)0,null(),null());
            		}
HXLINE( 174)		Bool _hx_tmp2 = ::Std_obj::is(Graphic,hx::ClassOf< ::hx::Class >());
...
HXLINE( 178)			Bool _hx_tmp3 = ::Std_obj::is(Graphic,hx::ClassOf< ::openfl::_legacy::display::BitmapData >());
HXDLIN( 178)			if (_hx_tmp3) {
HXLINE( 180)				this->_cursor =  ::openfl::_legacy::display::Bitmap_obj::__new(( ( ::openfl::_legacy::display::BitmapData)(Graphic) ),null(),null());
            			}
            			else {
HXLINE( 182)				Bool _hx_tmp4 = ::Std_obj::is(Graphic,hx::ClassOf< ::String >());
HXDLIN( 182)				if (_hx_tmp4) {
HXLINE( 184)					HX_VARI( ::String,id) = ( (::String)(Graphic) );
HXDLIN( 184)					 ::openfl::_legacy::display::BitmapData _hx_tmp5;
HXDLIN( 184)					Bool _hx_tmp6 = ::openfl::_legacy::Assets_obj::exists(id,null());
HXDLIN( 184)					if (_hx_tmp6) {
HXLINE( 184)						_hx_tmp5 = ::openfl::_legacy::Assets_obj::getBitmapData(id,false);
            					}
            					else {
...
HXDLIN( 184)						_hx_tmp5 = null();
            					}
HXDLIN( 184)					this->_cursor =  ::openfl::_legacy::display::Bitmap_obj::__new(_hx_tmp5,null(),null());
            				}
            				else {
HXLINE( 188)					this->_cursor =  ::openfl::_legacy::display::Bitmap_obj::__new( ::flixel::input::mouse::_FlxMouse::GraphicCursor_obj::__new((int)0,(int)0,null(),null()),null(),null());
            				}
            			}
            		}
...
void FlxMouse_obj::unload(){
            	HX_STACK_FRAME("flixel.input.mouse.FlxMouse","unload",0x5a7132db,"flixel.input.mouse.FlxMouse.unload","flixel/input/mouse/FlxMouse.hx",233,0xe4e80b89)
            	HX_STACK_THIS(this)
HXLINE( 233)		Bool _hx_tmp = hx::IsNotNull( this->_cursor );
HXDLIN( 233)		if (_hx_tmp) {
HXLINE( 235)			Bool _hx_tmp1 = this->cursorContainer->get_visible();
...
void FlxMouse_obj::destroy(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 321)		Bool _hx_tmp = hx::IsNotNull( this->_stage );
...
HXDLIN( 410)			Float _hx_tmp = ((Float)newX / (Float)::flixel::FlxG_obj::scaleMode->scale->x);
HXDLIN( 410)			this->_globalScreenX = ::Std_obj::_hx_int(_hx_tmp);
HXDLIN( 410)			Float _hx_tmp1 = ((Float)newY / (Float)::flixel::FlxG_obj::scaleMode->scale->y);
HXDLIN( 410)			this->_globalScreenY = ::Std_obj::_hx_int(_hx_tmp1);
HXDLIN( 410)			this->updatePositions();
            		}
HXLINE( 413)		Bool _hx_tmp2 = this->visible;
HXDLIN( 413)		if (_hx_tmp2) {
HXLINE( 415)			Float _hx_tmp3 = ::flixel::FlxG_obj::game->get_mouseX();
HXDLIN( 415)			this->cursorContainer->set_x(_hx_tmp3);
HXLINE( 416)			Float _hx_tmp4 = ::flixel::FlxG_obj::game->get_mouseY();
HXDLIN( 416)			this->cursorContainer->set_y(_hx_tmp4);
            		}
HXLINE( 421)		this->_leftButton->update();
HXLINE( 423)		this->_middleButton->update();
HXLINE( 424)		this->_rightButton->update();
HXLINE( 428)		Bool _hx_tmp5 = !(this->_wheelUsed);
...
HXLINE( 457)		Bool _hx_tmp = this->visible;
...
void FlxMouse_obj::onGameStart(){
            	HX_STACK_FRAME("flixel.input.mouse.FlxMouse","onGameStart",0x61da7695,"flixel.input.mouse.FlxMouse.onGameStart","flixel/input/mouse/FlxMouse.hx",470,0xe4e80b89)
            	HX_STACK_THIS(this)
...
void FlxMouse_obj::onMouseWheel( ::openfl::_legacy::events::MouseEvent FlashEvent){
            	HX_STACK_FRAME("flixel.input.mouse.FlxMouse","onMouseWheel",0xdc642911,"flixel.input.mouse.FlxMouse.onMouseWheel","flixel/input/mouse/FlxMouse.hx",478,0xe4e80b89)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(FlashEvent,"FlashEvent")
HXLINE( 478)		Bool _hx_tmp = this->enabled;
...
HXLINE( 532)		Bool _hx_tmp = this->visible;
...
void FlxMouse_obj::showCursor(){
            	HX_STACK_FRAME("flixel.input.mouse.FlxMouse","showCursor",0xa585e38f,"flixel.input.mouse.FlxMouse.showCursor","flixel/input/mouse/FlxMouse.hx",554,0xe4e80b89)
            	HX_STACK_THIS(this)
HXLINE( 554)		Bool _hx_tmp = this->useSystemCursor;
HXDLIN( 554)		if (_hx_tmp) {
HXLINE( 556)			::openfl::_legacy::ui::Mouse_obj::show();
            		}
            		else {
HXLINE( 560)			Bool _hx_tmp1 = hx::IsNull( this->_cursor );
...
HXLINE( 601)		return  ::flixel::_hx_system::replay::MouseRecord_obj::__new(this->_lastX,this->_lastY,this->_leftButton->current,this->_lastWheel);
            	}
...
HXLINE( 613)			this->_stage->dispatchEvent( ::openfl::_legacy::events::MouseEvent_obj::__new(::openfl::_legacy::events::MouseEvent_obj::MOUSE_UP,true,false,Record->x,Record->y,null(),null(),null(),null(),null(),null(),null(),null()));
            		}
