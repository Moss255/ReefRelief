...
HXLINE(  50)			 ::flixel::_hx_system::debug::Window _hx_tmp = array->__get((array->length - (int)1)).StaticCast<  ::flixel::_hx_system::debug::Window >();
...
HXLINE(  48)		HX_VARI( Int,index) = array->indexOf(element,null());
HXLINE(  49)		if ((index != (int)-1)) {
HXLINE(  50)			 ::flixel::_hx_system::debug::watch::WatchEntry _hx_tmp = array->__get((array->length - (int)1)).StaticCast<  ::flixel::_hx_system::debug::watch::WatchEntry >();
HXDLIN(  50)			array[index] = _hx_tmp;
...
HXLINE(  80)		 ::Dynamic _hx_tmp = array->__get((array->get_length() - (int)1));
HXDLIN(  80)		array->set(index,_hx_tmp);
HXLINE(  81)		array->pop();
...
HXLINE(  95)		Bool _hx_tmp = hx::IsNull( array );
HXDLIN(  95)		if (_hx_tmp) {
HXLINE(  96)			return array;
            		}
HXLINE(  98)		if (recursive) {
HXLINE( 100)			while((array->get_length() > (int)0)){
HXLINE( 102)				HX_VARI(  ::Dynamic,thing) = array->pop();
HXLINE( 103)				Bool _hx_tmp1 = ::Std_obj::is(thing,hx::ArrayBase::__mClass);
...
HXDLIN( 136)		Bool _hx_tmp1 = hx::IsNull( array1 );
...
HXDLIN( 138)		Bool _hx_tmp3 = hx::IsNull( array1 );
HXDLIN( 138)		if (_hx_tmp3) {
HXLINE( 138)			_hx_tmp2 = hx::IsNotNull( array2 );
            		}
            		else {
...
HXDLIN( 140)		Bool _hx_tmp5 = hx::IsNotNull( array1 );
HXDLIN( 140)		if (_hx_tmp5) {
HXLINE( 140)			_hx_tmp4 = hx::IsNull( array2 );
            		}
            		else {
...
HXDLIN( 157)		Bool _hx_tmp1 = hx::IsNotNull( array );
...
Bool FlxArrayUtil_obj::contains(::cpp::VirtualArray array, ::Dynamic element){
            	HX_STACK_FRAME("flixel.util.FlxArrayUtil","contains",0x2d55b70a,"flixel.util.FlxArrayUtil.contains","flixel/util/FlxArrayUtil.hx",164,0xa0dc755b)
            	HX_STACK_ARG(array,"array")
            	HX_STACK_ARG(element,"element")
HXLINE( 164)		Int _hx_tmp = array->indexOf(element,null());
HXDLIN( 164)		return (_hx_tmp != (int)-1);
            	}
