...
HXLINE( 158)		Bool _hx_tmp = hx::IsNotNull( Nodes );
...
HXLINE( 208)		Bool _hx_tmp = hx::IsNotNull( Nodes );
...
HXLINE( 220)		Bool _hx_tmp1 = (this->_nodes->length > (int)0);
...
HXLINE( 265)		Bool _hx_tmp = (NodeIndex < (int)0);
HXDLIN( 265)		if (_hx_tmp) {
HXLINE( 266)			NodeIndex = (int)0;
            		}
            		else {
HXLINE( 267)			Bool _hx_tmp1 = (NodeIndex > (this->_nodes->length - (int)1));
...
HXLINE( 282)		Bool _hx_tmp = hx::IsNull( this->object );
HXDLIN( 282)		if (_hx_tmp) {
HXLINE( 283)			return;
            		}
HXLINE( 285)		Bool _hx_tmp1 = this->_firstUpdate;
...
HXLINE( 295)		Bool _hx_tmp2 = this->autoCenter;
HXDLIN( 295)		if (_hx_tmp2) {
HXLINE( 297)			HX_VARI(  ::flixel::math::FlxPoint,_this) = ::flixel::util::FlxPath_obj::_point;
HXDLIN( 297)			Float _hx_tmp3 = this->object->get_width();
HXDLIN( 297)			Float X = (_hx_tmp3 * ((Float)0.5));
HXDLIN( 297)			Float _hx_tmp4 = this->object->get_height();
HXDLIN( 297)			Float Y = (_hx_tmp4 * ((Float)0.5));
HXDLIN( 297)			{
HXLINE( 297)				Float _hx_tmp5 = (_this->x + X);
HXDLIN( 297)				_this->set_x(_hx_tmp5);
            			}
HXDLIN( 297)			{
HXLINE( 297)				Float _hx_tmp6 = (_this->y + Y);
HXDLIN( 297)				_this->set_y(_hx_tmp6);
            			}
            		}
...
HXLINE( 308)			Float _hx_tmp7;
HXDLIN( 308)			if ((deltaX > (int)0)) {
HXLINE( 308)				_hx_tmp7 = deltaX;
            			}
            			else {
HXLINE( 308)				_hx_tmp7 = -(deltaX);
            			}
HXDLIN( 308)			Bool _hx_tmp8 = (_hx_tmp7 < (this->speed * elapsed));
...
HXLINE( 315)				Float _hx_tmp9;
HXDLIN( 315)				if ((deltaY > (int)0)) {
HXLINE( 315)					_hx_tmp9 = deltaY;
            				}
            				else {
HXLINE( 315)					_hx_tmp9 = -(deltaY);
            				}
HXDLIN( 315)				Bool _hx_tmp10 = (_hx_tmp9 < (this->speed * elapsed));
HXDLIN( 315)				if (_hx_tmp10) {
HXLINE( 317)					node = this->advancePath(null());
            				}
            			}
            			else {
HXLINE( 322)				Float _hx_tmp11 = ::Math_obj::sqrt(((deltaX * deltaX) + (deltaY * deltaY)));
HXDLIN( 322)				Bool _hx_tmp12 = (_hx_tmp11 < (this->speed * elapsed));
HXDLIN( 322)				if (_hx_tmp12) {
HXLINE( 324)					node = this->advancePath(null());
            				}
            			}
            		}
HXLINE( 329)		Bool _hx_tmp13;
HXDLIN( 329)		Bool _hx_tmp14 = hx::IsNotNull( this->object );
HXDLIN( 329)		if (_hx_tmp14) {
HXLINE( 329)			_hx_tmp13 = (this->speed != (int)0);
            		}
            		else {
HXLINE( 329)			_hx_tmp13 = false;
            		}
HXDLIN( 329)		if (_hx_tmp13) {
...
HXLINE( 335)			Bool _hx_tmp15 = this->autoCenter;
HXDLIN( 335)			if (_hx_tmp15) {
HXLINE( 337)				HX_VARI_NAME(  ::flixel::math::FlxPoint,_this1,"_this") = ::flixel::util::FlxPath_obj::_point;
HXDLIN( 337)				Float _hx_tmp16 = this->object->get_width();
HXDLIN( 337)				Float X1 = (_hx_tmp16 * ((Float)0.5));
HXDLIN( 337)				Float _hx_tmp17 = this->object->get_height();
HXDLIN( 337)				Float Y1 = (_hx_tmp17 * ((Float)0.5));
HXDLIN( 337)				{
HXLINE( 337)					Float _hx_tmp18 = (_this1->x + X1);
HXDLIN( 337)					_this1->set_x(_hx_tmp18);
            				}
HXDLIN( 337)				{
HXLINE( 337)					Float _hx_tmp19 = (_this1->y + Y1);
HXDLIN( 337)					_this1->set_y(_hx_tmp19);
            				}
            			}
HXLINE( 340)			HX_VARI_NAME(  ::flixel::math::FlxPoint,_this2,"_this") = ::flixel::util::FlxPath_obj::_point;
HXDLIN( 340)			HX_VAR( Bool,result);
HXDLIN( 340)			Float aValueA = _this2->x;
HXDLIN( 340)			Float aValueB = node->x;
HXDLIN( 340)			Float _hx_tmp20 = ::Math_obj::abs((aValueA - aValueB));
HXDLIN( 340)			if ((_hx_tmp20 <= ((Float)0.0000001))) {
HXLINE( 340)				Float aValueA1 = _this2->y;
HXDLIN( 340)				Float aValueB1 = node->y;
HXDLIN( 340)				Float _hx_tmp21 = ::Math_obj::abs((aValueA1 - aValueB1));
HXDLIN( 340)				result = (_hx_tmp21 <= ((Float)0.0000001));
            			}
            			else {
HXLINE( 340)				result = false;
            			}
HXDLIN( 340)			Bool _hx_tmp22 = node->_weak;
...
HXLINE( 350)			Bool _hx_tmp23 = this->_autoRotate;
...
HXLINE( 357)			Bool _hx_tmp24 = this->finished;
...
void FlxPath_obj::calculateVelocity( ::flixel::math::FlxPoint node,Bool horizontalOnly,Bool verticalOnly){
            	HX_STACK_FRAME("flixel.util.FlxPath","calculateVelocity",0x682aa4f2,"flixel.util.FlxPath.calculateVelocity","flixel/util/FlxPath.hx",366,0x22aae741)
            	HX_STACK_THIS(this)
...
HXLINE( 394)				HX_VARI(  ::flixel::math::FlxPoint,point) = ::flixel::math::FlxPoint_obj::_pool->get()->set((int)0,(int)0);
HXDLIN( 394)				point->_inPool = false;
HXDLIN( 394)				point->_weak = true;
HXDLIN( 394)				this->object->velocity->rotate(point,this->angle);
            			}
            		}
            	}
...
HXLINE( 408)			Bool _hx_tmp = hx::IsNotNull( oldNode );
HXDLIN( 408)			if (_hx_tmp) {
HXLINE( 410)				Bool _hx_tmp1 = (((int)this->_mode & (int)(int)1048576) == (int)0);
HXDLIN( 410)				if (_hx_tmp1) {
HXLINE( 412)					this->object->set_x(oldNode->x);
HXLINE( 413)					Bool _hx_tmp2 = this->autoCenter;
HXDLIN( 413)					if (_hx_tmp2) {
HXLINE( 414)						HX_VARI(  ::flixel::FlxObject,_g) = this->object;
HXDLIN( 414)						Float _hx_tmp3 = _g->x;
HXDLIN( 414)						Float _hx_tmp4 = this->object->get_width();
HXDLIN( 414)						_g->set_x((_hx_tmp3 - (_hx_tmp4 * ((Float)0.5))));
            					}
            				}
HXLINE( 416)				Bool _hx_tmp5 = (((int)this->_mode & (int)(int)65536) == (int)0);
HXDLIN( 416)				if (_hx_tmp5) {
HXLINE( 418)					this->object->set_y(oldNode->y);
HXLINE( 419)					Bool _hx_tmp6 = this->autoCenter;
HXDLIN( 419)					if (_hx_tmp6) {
HXLINE( 420)						HX_VARI_NAME(  ::flixel::FlxObject,_g1,"_g") = this->object;
HXDLIN( 420)						Float _hx_tmp7 = _g1->y;
HXDLIN( 420)						Float _hx_tmp8 = this->object->get_height();
HXDLIN( 420)						_g1->set_y((_hx_tmp7 - (_hx_tmp8 * ((Float)0.5))));
            					}
            				}
            			}
            		}
HXLINE( 425)		HX_VARI( Bool,callComplete) = false;
HXLINE( 426)		hx::AddEq(this->nodeIndex,this->_inc);
HXLINE( 428)		Bool _hx_tmp9 = (((int)this->_mode & (int)(int)1) > (int)0);
HXDLIN( 428)		if (_hx_tmp9) {
HXLINE( 430)			Bool _hx_tmp10 = (this->nodeIndex < (int)0);
...
HXLINE( 437)			Bool _hx_tmp11 = (((int)this->_mode & (int)(int)16) > (int)0);
HXDLIN( 437)			if (_hx_tmp11) {
HXLINE( 439)				Bool _hx_tmp12 = (this->nodeIndex >= this->_nodes->length);
HXDLIN( 439)				if (_hx_tmp12) {
HXLINE( 441)					callComplete = true;
HXLINE( 442)					this->nodeIndex = (int)0;
            				}
            			}
            			else {
HXLINE( 445)				Bool _hx_tmp13 = (((int)this->_mode & (int)(int)256) > (int)0);
HXDLIN( 445)				if (_hx_tmp13) {
HXLINE( 447)					Bool _hx_tmp14 = (this->nodeIndex < (int)0);
HXDLIN( 447)					if (_hx_tmp14) {
HXLINE( 449)						this->nodeIndex = (this->_nodes->length - (int)1);
HXLINE( 450)						callComplete = true;
HXLINE( 451)						Bool _hx_tmp15 = (this->nodeIndex < (int)0);
...
HXLINE( 457)					Bool _hx_tmp16 = (((int)this->_mode & (int)(int)4096) > (int)0);
HXDLIN( 457)					if (_hx_tmp16) {
HXLINE( 459)						Bool _hx_tmp17 = (this->_inc > (int)0);
HXDLIN( 459)						if (_hx_tmp17) {
HXLINE( 461)							Bool _hx_tmp18 = (this->nodeIndex >= this->_nodes->length);
HXDLIN( 461)							if (_hx_tmp18) {
HXLINE( 463)								this->nodeIndex = (this->_nodes->length - (int)2);
HXLINE( 464)								callComplete = true;
HXLINE( 465)								Bool _hx_tmp19 = (this->nodeIndex < (int)0);
...
HXLINE( 472)							Bool _hx_tmp20 = (this->nodeIndex < (int)0);
HXDLIN( 472)							if (_hx_tmp20) {
HXLINE( 474)								this->nodeIndex = (int)1;
HXLINE( 475)								callComplete = true;
HXLINE( 476)								Bool _hx_tmp21 = (this->nodeIndex >= this->_nodes->length);
HXDLIN( 476)								if (_hx_tmp21) {
HXLINE( 478)									this->nodeIndex = (this->_nodes->length - (int)1);
            								}
HXLINE( 480)								Bool _hx_tmp22 = (this->nodeIndex < (int)0);
HXDLIN( 480)								if (_hx_tmp22) {
...
HXLINE( 489)						Bool _hx_tmp23 = (this->nodeIndex >= this->_nodes->length);
HXDLIN( 489)						if (_hx_tmp23) {
...
HXLINE( 497)		Bool _hx_tmp24;
HXDLIN( 497)		if (callComplete) {
HXLINE( 497)			_hx_tmp24 = hx::IsNotNull( this->onComplete );
            		}
            		else {
HXLINE( 497)			_hx_tmp24 = false;
            		}
HXDLIN( 497)		if (_hx_tmp24) {
...
HXLINE( 514)		Bool _hx_tmp = hx::IsNotNull( this->object );
...
HXLINE( 528)		Bool _hx_tmp = hx::IsNotNull( this->_wasObjectImmovable );
...
HX_DEFINE_DYNAMIC_FUNC0(FlxPath_obj,destroy,(void))
 ...
 ::flixel::util::FlxPath FlxPath_obj::add(Float X,Float Y){
            	...
            	HX_STACK_ARG(X,"X")
            	HX_STACK_ARG(Y,"Y")
HXLINE( 554)		HX_VARI(  ::flixel::math::FlxPoint,point) = ::flixel::math::FlxPoint_obj::_pool->get()->set(X,Y);
HXDLIN( 554)		point->_inPool = false;
HXDLIN( 554)		this->_nodes->push(point);
...
HXLINE( 570)		HX_VARI(  ::flixel::math::FlxPoint,point) = ::flixel::math::FlxPoint_obj::_pool->get()->set(X,Y);
HXDLIN( 570)		point->_inPool = false;
HXDLIN( 570)		this->_nodes->insert(Index,point);
...
HXDLIN( 592)			this->_nodes->push(point);
            		}
...
HXDLIN( 617)			this->_nodes->insert(Index,point);
            		}
...
HXLINE( 634)			::Array< ::Dynamic> _hx_tmp = this->_nodes->splice(index,(int)1);
HXDLIN( 634)			return _hx_tmp->__get((int)0).StaticCast<  ::flixel::math::FlxPoint >();
            		}
...
HXLINE( 651)		Bool _hx_tmp = (Index >= (this->_nodes->length - (int)1));
HXDLIN( 651)		if (_hx_tmp) {
HXLINE( 653)			this->_nodes->pop().StaticCast<  ::flixel::math::FlxPoint >();
            		}
HXLINE( 655)		::Array< ::Dynamic> _hx_tmp1 = this->_nodes->splice(Index,(int)1);
HXDLIN( 655)		return _hx_tmp1->__get((int)0).StaticCast<  ::flixel::math::FlxPoint >();
            	}
...
HXDLIN( 697)		Bool _hx_tmp1 = hx::IsNotNull( this->_nodes );
...
HXLINE( 701)		Bool _hx_tmp2 = hx::IsNull( Camera );
...
HXLINE( 709)		Bool _hx_tmp3 = ::flixel::FlxG_obj::renderBlit;
...
HXLINE( 730)			Float _hx_tmp4 = (node->x - (Camera->scroll->x * this->object->scrollFactor->x));
HXDLIN( 730)			::flixel::util::FlxPath_obj::_point->set_x(_hx_tmp4);
HXLINE( 731)			Float _hx_tmp5 = (node->y - (Camera->scroll->y * this->object->scrollFactor->y));
HXDLIN( 731)			::flixel::util::FlxPath_obj::_point->set_y(_hx_tmp5);
HXLINE( 734)			HX_VARI( Int,nodeSize) = (int)2;
HXLINE( 735)			Bool _hx_tmp6;
HXDLIN( 735)			if ((i != (int)0)) {
HXLINE( 735)				_hx_tmp6 = (i == (l - (int)1));
            			}
            			else {
HXLINE( 735)				_hx_tmp6 = true;
            			}
HXDLIN( 735)			if (_hx_tmp6) {
...
HXLINE( 755)			Float _hx_tmp7 = (::flixel::util::FlxPath_obj::_point->x - (nodeSize * ((Float)0.5)));
HXDLIN( 755)			Float _hx_tmp8 = (::flixel::util::FlxPath_obj::_point->y - (nodeSize * ((Float)0.5)));
HXDLIN( 755)			gfx->drawRect(_hx_tmp7,_hx_tmp8,nodeSize,nodeSize);
...
HXLINE( 772)			Float _hx_tmp9 = (nextNode->x - (Camera->scroll->x * this->object->scrollFactor->x));
HXDLIN( 772)			::flixel::util::FlxPath_obj::_point->set_x(_hx_tmp9);
HXLINE( 773)			Float _hx_tmp10 = (nextNode->y - (Camera->scroll->y * this->object->scrollFactor->y));
HXDLIN( 773)			::flixel::util::FlxPath_obj::_point->set_y(_hx_tmp10);
HXLINE( 774)			gfx->lineTo(::flixel::util::FlxPath_obj::_point->x,::flixel::util::FlxPath_obj::_point->y);
HXLINE( 776)			++i;
            		}
HXLINE( 779)		Bool _hx_tmp11 = ::flixel::FlxG_obj::renderBlit;
HXDLIN( 779)		if (_hx_tmp11) {
...
::Array< ::Dynamic> FlxPath_obj::set_nodes(::Array< ::Dynamic> Nodes){
            	...
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(Nodes,"Nodes")
HXLINE( 794)		Bool _hx_tmp = hx::IsNotNull( Nodes );
...
{
{
            	HX_STACK_FRAME("flixel.util.FlxPath","boot",0xf481d243,"flixel.util.FlxPath.boot","flixel/util/FlxPath.hx",49,0x22aae741)
HXLINE(  49)		FORWARD = (int)0;
            	}
{
            	HX_STACK_FRAME("flixel.util.FlxPath","boot",0xf481d243,"flixel.util.FlxPath.boot","flixel/util/FlxPath.hx",53,0x22aae741)
HXLINE(  53)		BACKWARD = (int)1;
            	}
{
            	HX_STACK_FRAME("flixel.util.FlxPath","boot",0xf481d243,"flixel.util.FlxPath.boot","flixel/util/FlxPath.hx",57,0x22aae741)
HXLINE(  57)		LOOP_FORWARD = (int)16;
            	}
{
            	HX_STACK_FRAME("flixel.util.FlxPath","boot",0xf481d243,"flixel.util.FlxPath.boot","flixel/util/FlxPath.hx",61,0x22aae741)
HXLINE(  61)		LOOP_BACKWARD = (int)256;
            	}
{
            	HX_STACK_FRAME("flixel.util.FlxPath","boot",0xf481d243,"flixel.util.FlxPath.boot","flixel/util/FlxPath.hx",65,0x22aae741)
HXLINE(  65)		YOYO = (int)4096;
            	}
{
            	HX_STACK_FRAME("flixel.util.FlxPath","boot",0xf481d243,"flixel.util.FlxPath.boot","flixel/util/FlxPath.hx",69,0x22aae741)
HXLINE(  69)		HORIZONTAL_ONLY = (int)65536;
            	}
{
            	HX_STACK_FRAME("flixel.util.FlxPath","boot",0xf481d243,"flixel.util.FlxPath.boot","flixel/util/FlxPath.hx",73,0x22aae741)
HXLINE(  73)		VERTICAL_ONLY = (int)1048576;
            	}
{
            	HX_STACK_FRAME("flixel.util.FlxPath","boot",0xf481d243,"flixel.util.FlxPath.boot","flixel/util/FlxPath.hx",78,0x22aae741)
