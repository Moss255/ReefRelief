...
HXDLIN( 130)			HX_VARI(  ::openfl::_legacy::display::BitmapData,testA2) = ::flixel::util::FlxBitmapDataPool_obj::get(_hx_tmp29,_hx_tmp30,true,(int)0,false);
...
HXDLIN( 142)			HX_VARI(  ::openfl::_legacy::display::BitmapData,testB2) = ::flixel::util::FlxBitmapDataPool_obj::get(_hx_tmp34,_hx_tmp35,true,(int)0,false);
...
HXLINE( 157)				FlashRect =  ::openfl::_legacy::geom::Rectangle_obj::__new(null(),null(),null(),null());
            			}
...
HXLINE( 160)				FlashRect1 =  ::openfl::_legacy::geom::Rectangle_obj::__new(null(),null(),null(),null());
            			}
...
HXLINE( 176)				Bool _hx_tmp38 = (pixelsA->position < pixelsA->length);
HXDLIN( 176)				if (_hx_tmp38) {
HXLINE( 176)					Int pos = pixelsA->position++;
HXDLIN( 176)					alphaA = pixelsA->b->__get(pos);
            				}
            				else {
HXLINE( 176)					alphaA = pixelsA->_hx___throwEOFi();
            				}
HXLINE( 177)				Bool _hx_tmp39 = (pixelsB->position < pixelsB->length);
HXDLIN( 177)				if (_hx_tmp39) {
HXLINE( 177)					Int pos1 = pixelsB->position++;
HXDLIN( 177)					alphaB = pixelsB->b->__get(pos1);
            				}
            				else {
HXLINE( 177)					alphaB = pixelsB->_hx___throwEOFi();
            				}
HXLINE( 179)				Bool _hx_tmp40;
HXDLIN( 179)				if ((alphaA >= AlphaTolerance)) {
HXLINE( 179)					_hx_tmp40 = (alphaB >= AlphaTolerance);
            				}
            				else {
HXLINE( 179)					_hx_tmp40 = false;
            				}
HXDLIN( 179)				if (_hx_tmp40) {
HXLINE( 181)					hit = true;
...
HXLINE( 193)				Bool _hx_tmp41 = (pixelsA->position < pixelsA->length);
HXDLIN( 193)				if (_hx_tmp41) {
HXLINE( 193)					Int pos2 = pixelsA->position++;
HXDLIN( 193)					alphaA = pixelsA->b->__get(pos2);
            				}
            				else {
HXLINE( 193)					alphaA = pixelsA->_hx___throwEOFi();
            				}
HXLINE( 194)				Bool _hx_tmp42 = (pixelsB->position < pixelsB->length);
HXDLIN( 194)				if (_hx_tmp42) {
HXLINE( 194)					Int pos3 = pixelsB->position++;
HXDLIN( 194)					alphaB = pixelsB->b->__get(pos3);
            				}
            				else {
HXLINE( 194)					alphaB = pixelsB->_hx___throwEOFi();
            				}
HXLINE( 196)				Bool _hx_tmp43;
HXDLIN( 196)				if ((alphaA >= AlphaTolerance)) {
HXLINE( 196)					_hx_tmp43 = (alphaB >= AlphaTolerance);
            				}
            				else {
HXLINE( 196)					_hx_tmp43 = false;
            				}
HXDLIN( 196)				if (_hx_tmp43) {
HXLINE( 198)					hit = true;
...
HXLINE( 237)		HX_VARI(  ::openfl::_legacy::display::BitmapData,test) = Target->framePixels;
...
HXLINE(  35)		flashRect =  ::openfl::_legacy::geom::Rectangle_obj::__new(null(),null(),null(),null());
            	}
}
