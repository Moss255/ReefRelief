...
void FlxSave_obj::__construct(){
            	HX_STACK_FRAME("flixel.util.FlxSave","new",0x2c4b0107,"flixel.util.FlxSave.new","flixel/util/FlxSave.hx",35,0xc43cd0a9)
            	HX_STACK_THIS(this)
...
Int MinFileSize = __o_MinFileSize.Default(0);
            	...
            	HX_STACK_ARG(MinFileSize,"MinFileSize")
            	HX_STACK_ARG(OnComplete,"OnComplete")
HXLINE( 100)		Bool _hx_tmp = !(this->checkBinding());
...
HXLINE( 115)		::hx::EnumBase _hx_tmp1;
HXDLIN( 115)		if (hx::IsEq( result,(int)0 )) {
HXLINE( 115)			_hx_tmp1 = ::flixel::util::FlxSaveStatus_obj::SUCCESS_dyn();
            		}
            		else {
HXLINE( 115)			_hx_tmp1 = ::flixel::util::FlxSaveStatus_obj::PENDING_dyn();
            		}
HXDLIN( 115)		return this->onDone(_hx_tmp1);
            	}
...
Bool FlxSave_obj::erase(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 127)		Bool _hx_tmp = !(this->checkBinding());
...
HXLINE( 145)		Int _hx_tmp = ( ( ::hx::EnumBase)(Result) )->_hx_getIndex();
HXDLIN( 145)		switch((int)(_hx_tmp)){
            			case (int)1: {
...
Bool FlxSave_obj::checkBinding(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 170)		Bool _hx_tmp = hx::IsNull( this->_sharedObject );
