...
HXDLIN(  41)		this->start =  ::flixel::util::helpers::FlxBounds_obj::__new(point,point1);
...
HXDLIN(  42)		this->end =  ::flixel::util::helpers::FlxBounds_obj::__new(point2,point3);
...
hx::ObjectPtr< FlxPointRangeBounds_obj > FlxPointRangeBounds_obj::__new(Float startMinX, ::Dynamic startMinY, ::Dynamic startMaxX, ::Dynamic startMaxY, ::Dynamic endMinX, ::Dynamic endMinY, ::Dynamic endMaxX, ::Dynamic endMaxY)
{
	...
	_hx_result->__construct(startMinX,startMinY,startMaxX,startMaxY,endMinX,endMinY,endMaxX,endMaxY);
	return _hx_result;
}
...
HXDLIN(  63)		Bool _hx_tmp1 = hx::IsNull( startMinY );
...
HXLINE(  64)		Float _hx_tmp2;
HXDLIN(  64)		Bool _hx_tmp3 = hx::IsNull( startMaxX );
HXDLIN(  64)		if (_hx_tmp3) {
HXLINE(  64)			_hx_tmp2 = ( ( ::flixel::math::FlxPoint)(this->start->min) )->x;
            		}
            		else {
HXLINE(  64)			_hx_tmp2 = startMaxX;
            		}
HXDLIN(  64)		( ( ::flixel::math::FlxPoint)(this->start->max) )->set_x(_hx_tmp2);
HXLINE(  65)		Float _hx_tmp4;
HXDLIN(  65)		Bool _hx_tmp5 = hx::IsNull( startMaxY );
HXDLIN(  65)		if (_hx_tmp5) {
HXLINE(  65)			_hx_tmp4 = ( ( ::flixel::math::FlxPoint)(this->start->min) )->y;
            		}
            		else {
HXLINE(  65)			_hx_tmp4 = startMaxY;
            		}
HXDLIN(  65)		( ( ::flixel::math::FlxPoint)(this->start->max) )->set_y(_hx_tmp4);
HXLINE(  66)		Float _hx_tmp6;
HXDLIN(  66)		Bool _hx_tmp7 = hx::IsNull( endMinX );
HXDLIN(  66)		if (_hx_tmp7) {
HXLINE(  66)			_hx_tmp6 = ( ( ::flixel::math::FlxPoint)(this->start->min) )->x;
            		}
            		else {
HXLINE(  66)			_hx_tmp6 = endMinX;
            		}
HXDLIN(  66)		( ( ::flixel::math::FlxPoint)(this->end->min) )->set_x(_hx_tmp6);
HXLINE(  67)		Float _hx_tmp8;
HXDLIN(  67)		Bool _hx_tmp9 = hx::IsNull( endMinY );
HXDLIN(  67)		if (_hx_tmp9) {
HXLINE(  67)			_hx_tmp8 = ( ( ::flixel::math::FlxPoint)(this->start->min) )->y;
            		}
            		else {
HXLINE(  67)			_hx_tmp8 = endMinY;
            		}
HXDLIN(  67)		( ( ::flixel::math::FlxPoint)(this->end->min) )->set_y(_hx_tmp8);
HXLINE(  68)		Float _hx_tmp10;
HXDLIN(  68)		Bool _hx_tmp11 = hx::IsNull( endMaxX );
HXDLIN(  68)		if (_hx_tmp11) {
HXLINE(  68)			Bool _hx_tmp12 = hx::IsNull( endMinX );
HXDLIN(  68)			if (_hx_tmp12) {
HXLINE(  68)				_hx_tmp10 = ( ( ::flixel::math::FlxPoint)(this->start->max) )->x;
            			}
            			else {
HXLINE(  68)				_hx_tmp10 = ( ( ::flixel::math::FlxPoint)(this->end->min) )->x;
            			}
            		}
            		else {
HXLINE(  68)			_hx_tmp10 = endMaxX;
            		}
HXDLIN(  68)		( ( ::flixel::math::FlxPoint)(this->end->max) )->set_x(_hx_tmp10);
HXLINE(  69)		Float _hx_tmp13;
HXDLIN(  69)		Bool _hx_tmp14 = hx::IsNull( endMaxY );
HXDLIN(  69)		if (_hx_tmp14) {
HXLINE(  69)			Bool _hx_tmp15 = hx::IsNull( endMinY );
HXDLIN(  69)			if (_hx_tmp15) {
HXLINE(  69)				_hx_tmp13 = ( ( ::flixel::math::FlxPoint)(this->start->max) )->y;
            			}
            			else {
HXLINE(  69)				_hx_tmp13 = ( ( ::flixel::math::FlxPoint)(this->end->min) )->y;
            			}
            		}
            		else {
HXLINE(  69)			_hx_tmp13 = endMaxY;
            		}
HXDLIN(  69)		( ( ::flixel::math::FlxPoint)(this->end->max) )->set_y(_hx_tmp13);
...
HXDLIN(  82)		Float aValueA = _this->x;
HXDLIN(  82)		Float aValueB = point->x;
HXDLIN(  82)		Float _hx_tmp2 = ::Math_obj::abs((aValueA - aValueB));
HXDLIN(  82)		if ((_hx_tmp2 <= ((Float)0.0000001))) {
HXLINE(  82)			Float aValueA1 = _this->y;
HXDLIN(  82)			Float aValueB1 = point->y;
HXDLIN(  82)			Float _hx_tmp3 = ::Math_obj::abs((aValueA1 - aValueB1));
HXDLIN(  82)			result = (_hx_tmp3 <= ((Float)0.0000001));
            		}
            		else {
HXLINE(  82)			result = false;
            		}
HXDLIN(  82)		Bool _hx_tmp4 = point->_weak;
...
HXDLIN(  83)			Float aValueA2 = _this1->x;
HXDLIN(  83)			Float aValueB2 = point1->x;
HXDLIN(  83)			Float _hx_tmp5 = ::Math_obj::abs((aValueA2 - aValueB2));
HXDLIN(  83)			if ((_hx_tmp5 <= ((Float)0.0000001))) {
HXLINE(  83)				Float aValueA3 = _this1->y;
HXDLIN(  83)				Float aValueB3 = point1->y;
HXDLIN(  83)				Float _hx_tmp6 = ::Math_obj::abs((aValueA3 - aValueB3));
HXDLIN(  83)				result1 = (_hx_tmp6 <= ((Float)0.0000001));
            			}
            			else {
HXLINE(  83)				result1 = false;
            			}
HXDLIN(  83)			Bool _hx_tmp7 = point1->_weak;
...
HXDLIN(  84)			Float aValueA4 = _this2->x;
HXDLIN(  84)			Float aValueB4 = point2->x;
HXDLIN(  84)			Float _hx_tmp8 = ::Math_obj::abs((aValueA4 - aValueB4));
HXDLIN(  84)			if ((_hx_tmp8 <= ((Float)0.0000001))) {
HXLINE(  84)				Float aValueA5 = _this2->y;
HXDLIN(  84)				Float aValueB5 = point2->y;
HXDLIN(  84)				Float _hx_tmp9 = ::Math_obj::abs((aValueA5 - aValueB5));
HXDLIN(  84)				result2 = (_hx_tmp9 <= ((Float)0.0000001));
            			}
            			else {
HXLINE(  84)				result2 = false;
            			}
HXDLIN(  84)			Bool _hx_tmp10 = point2->_weak;
...
HXDLIN(  85)			Float aValueA6 = _this3->x;
HXDLIN(  85)			Float aValueB6 = point3->x;
HXDLIN(  85)			Float _hx_tmp11 = ::Math_obj::abs((aValueA6 - aValueB6));
HXDLIN(  85)			if ((_hx_tmp11 <= ((Float)0.0000001))) {
HXLINE(  85)				Float aValueA7 = _this3->y;
HXDLIN(  85)				Float aValueB7 = point3->y;
HXDLIN(  85)				Float _hx_tmp12 = ::Math_obj::abs((aValueA7 - aValueB7));
HXDLIN(  85)				result3 = (_hx_tmp12 <= ((Float)0.0000001));
            			}
            			else {
HXLINE(  85)				result3 = false;
            			}
HXDLIN(  85)			Bool _hx_tmp13 = point3->_weak;
...
::String FlxPointRangeBounds_obj::toString(){
            	HX_STACK_FRAME("flixel.util.helpers.FlxPointRangeBounds","toString",0x58cf5269,"flixel.util.helpers.FlxPointRangeBounds.toString","flixel/util/helpers/FlxPointRangeBounds.hx",93,0x6e9a8e2e)
            	HX_STACK_THIS(this)
