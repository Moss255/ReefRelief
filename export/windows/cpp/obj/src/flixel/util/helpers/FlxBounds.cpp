...
HXDLIN(  32)		Bool _hx_tmp1 = hx::IsNull( max );
...
HXDLIN(  45)		Bool _hx_tmp1 = hx::IsNull( max );
...
Bool FlxBounds_obj::equals( ::flixel::util::helpers::FlxBounds otherBounds){
            	HX_STACK_FRAME("flixel.util.helpers.FlxBounds","equals",0x1d409b09,"flixel.util.helpers.FlxBounds.equals","flixel/util/helpers/FlxBounds.hx",57,0x3d29a4bb)
            	HX_STACK_THIS(this)
...
::String FlxBounds_obj::toString(){
            	...
            	HX_STACK_THIS(this)
HXLINE(  66)		HX_VARI(  ::flixel::util::LabelValuePair,_this) = ::flixel::util::LabelValuePair_obj::_pool->get();
HXDLIN(  66)		_this->label = HX_("min",92,11,53,00);
HXDLIN(  66)		_this->value = this->min;
HXLINE(  67)		HX_VARI_NAME(  ::flixel::util::LabelValuePair,_this1,"_this") = ::flixel::util::LabelValuePair_obj::_pool->get();
HXDLIN(  67)		_this1->label = HX_("max",a4,0a,53,00);
HXDLIN(  67)		_this1->value = this->max;
