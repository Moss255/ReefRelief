...
Int CollideIndex = __o_CollideIndex.Default(1);
            	...
            	HX_STACK_ARG(DrawIndex,"DrawIndex")
            	HX_STACK_ARG(CollideIndex,"CollideIndex")
HXLINE( 322)		HX_VARI(  ::openfl::_legacy::display::BitmapData,mapBitmap) = ::flixel::_hx_system::FlxAssets_obj::resolveBitmapData(MapGraphic);
HXLINE( 323)		HX_VARI( ::String,mapData) = ::flixel::util::FlxStringUtil_obj::bitmapToCSV(mapBitmap,Invert,Scale,ColorMap);
...
HXLINE( 331)		::hx::EnumBase _hx_tmp;
HXDLIN( 331)		Bool _hx_tmp1 = hx::IsNull( AutoTile );
...
HXLINE( 332)		Int _hx_tmp2;
HXDLIN( 332)		if ((StartingIndex <= (int)0)) {
HXLINE( 332)			_hx_tmp2 = (int)0;
            		}
            		else {
HXLINE( 332)			_hx_tmp2 = StartingIndex;
            		}
HXDLIN( 332)		this->_startingIndex = _hx_tmp2;
...
void FlxBaseTilemap_obj::applyAutoTile(){
            	HX_STACK_FRAME("flixel.tile.FlxBaseTilemap","applyAutoTile",0xcc60c5b6,"flixel.tile.FlxBaseTilemap.applyAutoTile","flixel/tile/FlxBaseTilemap.hx",361,0x0139d8e5)
            	HX_STACK_THIS(this)
...
HXLINE( 366)				Int _hx_tmp = i++;
HXDLIN( 366)				this->autoTile(_hx_tmp);
            			}
            		}
            	}
...
HXLINE( 375)		Bool _hx_tmp = hx::IsNotNull( this->customTileRemap );
...
HXLINE( 395)		Bool _hx_tmp = hx::IsNotNull( this->_randomIndices );
HXDLIN( 395)		if (_hx_tmp) {
HXLINE( 397)			HX_VAR(  ::Dynamic,randLambda);
HXDLIN( 397)			Bool _hx_tmp1 = hx::IsNotNull( this->_randomLambda );
...
HXLINE( 397)				randLambda = this->_randomLambda;
            				...
            				Float _hx_run(){
            					HX_STACK_FRAME("flixel.tile.FlxBaseTilemap","randomizeIndices",0x9015e6eb,"flixel.tile.FlxBaseTilemap.randomizeIndices","flixel/tile/FlxBaseTilemap.hx",399,0x0139d8e5)
...
HXLINE( 411)							Float _hx_tmp2 = ( (Float)(randLambda()) );
HXDLIN( 411)							Float _hx_tmp3 = (_hx_tmp2 * this->_randomChoices->__get(j).StaticCast< ::Array< Int > >()->length);
HXDLIN( 411)							HX_VARI( Int,k) = ::Std_obj::_hx_int(_hx_tmp3);
HXLINE( 412)							newIndex = this->_randomChoices->__get(j).StaticCast< ::Array< Int > >()->__get(k);
            						}
HXLINE( 414)						++j;
            					}
            				}
...
HXLINE( 439)			hx::AddEq(this->_data[Index],(int)1);
            		}
HXLINE( 442)		Bool _hx_tmp1;
HXDLIN( 442)		if ((hx::Mod(Index,this->widthInTiles) < (this->widthInTiles - (int)1))) {
HXLINE( 442)			_hx_tmp1 = (this->_data->__get((Index + (int)1)) > (int)0);
            		}
            		else {
HXLINE( 442)			_hx_tmp1 = true;
            		}
HXDLIN( 442)		if (_hx_tmp1) {
HXLINE( 444)			hx::AddEq(this->_data[Index],(int)2);
            		}
HXLINE( 447)		Bool _hx_tmp2;
HXDLIN( 447)		Int _hx_tmp3 = (Index + this->widthInTiles);
HXDLIN( 447)		Int _hx_tmp4 = ::Std_obj::_hx_int(_hx_tmp3);
HXDLIN( 447)		if ((_hx_tmp4 < this->totalTiles)) {
HXLINE( 447)			_hx_tmp2 = (this->_data->__get((Index + this->widthInTiles)) > (int)0);
            		}
            		else {
HXLINE( 447)			_hx_tmp2 = true;
            		}
HXDLIN( 447)		if (_hx_tmp2) {
HXLINE( 449)			hx::AddEq(this->_data[Index],(int)4);
            		}
HXLINE( 452)		Bool _hx_tmp5;
HXDLIN( 452)		if ((hx::Mod(Index,this->widthInTiles) > (int)0)) {
HXLINE( 452)			_hx_tmp5 = (this->_data->__get((Index - (int)1)) > (int)0);
            		}
            		else {
HXLINE( 452)			_hx_tmp5 = true;
            		}
HXDLIN( 452)		if (_hx_tmp5) {
HXLINE( 454)			hx::AddEq(this->_data[Index],(int)8);
            		}
HXLINE( 458)		Bool _hx_tmp6;
HXDLIN( 458)		if (hx::IsEq( this->_hx_auto,::flixel::tile::FlxTilemapAutoTiling_obj::ALT_dyn() )) {
HXLINE( 458)			_hx_tmp6 = (this->_data->__get(Index) == (int)15);
            		}
            		else {
HXLINE( 458)			_hx_tmp6 = false;
            		}
HXDLIN( 458)		if (_hx_tmp6) {
HXLINE( 461)			Bool _hx_tmp7;
HXDLIN( 461)			Bool _hx_tmp8;
HXDLIN( 461)			Bool _hx_tmp9 = (hx::Mod(Index,this->widthInTiles) > (int)0);
HXDLIN( 461)			if (_hx_tmp9) {
HXLINE( 461)				Int _hx_tmp10 = (Index + this->widthInTiles);
HXDLIN( 461)				Int _hx_tmp11 = ::Std_obj::_hx_int(_hx_tmp10);
HXDLIN( 461)				_hx_tmp8 = (_hx_tmp11 < this->totalTiles);
            			}
            			else {
HXLINE( 461)				_hx_tmp8 = false;
            			}
HXDLIN( 461)			if (_hx_tmp8) {
HXLINE( 461)				_hx_tmp7 = (this->_data->__get(((Index + this->widthInTiles) - (int)1)) <= (int)0);
            			}
            			else {
...
HXLINE( 466)			Bool _hx_tmp12;
HXDLIN( 466)			Bool _hx_tmp13;
HXDLIN( 466)			if ((hx::Mod(Index,this->widthInTiles) > (int)0)) {
HXLINE( 466)				_hx_tmp13 = ((Index - this->widthInTiles) >= (int)0);
            			}
            			else {
HXLINE( 466)				_hx_tmp13 = false;
            			}
HXDLIN( 466)			if (_hx_tmp13) {
HXLINE( 466)				_hx_tmp12 = (this->_data->__get(((Index - this->widthInTiles) - (int)1)) <= (int)0);
            			}
            			else {
HXLINE( 466)				_hx_tmp12 = false;
            			}
HXDLIN( 466)			if (_hx_tmp12) {
HXLINE( 468)				this->_data[Index] = (int)2;
            			}
HXLINE( 471)			Bool _hx_tmp14;
HXDLIN( 471)			Bool _hx_tmp15;
HXDLIN( 471)			if ((hx::Mod(Index,this->widthInTiles) < (this->widthInTiles - (int)1))) {
HXLINE( 471)				_hx_tmp15 = ((Index - this->widthInTiles) >= (int)0);
            			}
            			else {
HXLINE( 471)				_hx_tmp15 = false;
            			}
HXDLIN( 471)			if (_hx_tmp15) {
HXLINE( 471)				_hx_tmp14 = (this->_data->__get(((Index - this->widthInTiles) + (int)1)) <= (int)0);
            			}
            			else {
HXLINE( 471)				_hx_tmp14 = false;
            			}
HXDLIN( 471)			if (_hx_tmp14) {
HXLINE( 473)				this->_data[Index] = (int)4;
            			}
HXLINE( 476)			Bool _hx_tmp16;
HXDLIN( 476)			Bool _hx_tmp17;
HXDLIN( 476)			Bool _hx_tmp18 = (hx::Mod(Index,this->widthInTiles) < (this->widthInTiles - (int)1));
HXDLIN( 476)			if (_hx_tmp18) {
HXLINE( 476)				Int _hx_tmp19 = (Index + this->widthInTiles);
HXDLIN( 476)				Int _hx_tmp20 = ::Std_obj::_hx_int(_hx_tmp19);
HXDLIN( 476)				_hx_tmp17 = (_hx_tmp20 < this->totalTiles);
            			}
            			else {
HXLINE( 476)				_hx_tmp17 = false;
            			}
HXDLIN( 476)			if (_hx_tmp17) {
HXLINE( 476)				_hx_tmp16 = (this->_data->__get(((Index + this->widthInTiles) + (int)1)) <= (int)0);
            			}
            			else {
HXLINE( 476)				_hx_tmp16 = false;
            			}
HXDLIN( 476)			if (_hx_tmp16) {
HXLINE( 478)				this->_data[Index] = (int)8;
            			}
            		}
HXLINE( 482)		hx::AddEq(this->_data[Index],(int)1);
            	}
...
HXDLIN( 502)		Bool _hx_tmp1 = hx::IsNotNull( this->_randomIndices );
HXDLIN( 502)		if (_hx_tmp1) {
HXLINE( 502)			Bool _hx_tmp2 = hx::IsNotNull( this->_randomChoices );
...
Int FlxBaseTilemap_obj::getTile(Int X,Int Y){
            	HX_STACK_FRAME("flixel.tile.FlxBaseTilemap","getTile",0x3ff9148f,"flixel.tile.FlxBaseTilemap.getTile","flixel/tile/FlxBaseTilemap.hx",517,0x0139d8e5)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(X,"X")
            	HX_STACK_ARG(Y,"Y")
...
Int FlxBaseTilemap_obj::getTileByIndex(Int Index){
            	HX_STACK_FRAME("flixel.tile.FlxBaseTilemap","getTileByIndex",0xf0387cec,"flixel.tile.FlxBaseTilemap.getTileByIndex","flixel/tile/FlxBaseTilemap.hx",528,0x0139d8e5)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(Index,"Index")
...
Int FlxBaseTilemap_obj::getTileCollisions(Int Index){
            	HX_STACK_FRAME("flixel.tile.FlxBaseTilemap","getTileCollisions",0x9ca1bd30,"flixel.tile.FlxBaseTilemap.getTileCollisions","flixel/tile/FlxBaseTilemap.hx",539,0x0139d8e5)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(Index,"Index")
...
HXLINE( 556)			Bool _hx_tmp = (this->_data->__get(i) == Index);
HXDLIN( 556)			if (_hx_tmp) {
HXLINE( 558)				Bool _hx_tmp1 = hx::IsNull( array );
...
HXLINE( 586)		Int _hx_tmp1 = ((Y * this->widthInTiles) + X);
HXDLIN( 586)		return this->setTileByIndex(_hx_tmp1,Tile,UpdateGraphics);
            	}
...
HXLINE( 616)			Int _hx_tmp = this->_data->__get(Index);
HXDLIN( 616)			this->updateTile(_hx_tmp);
HXLINE( 617)			return true;
            		}
HXLINE( 621)		HX_VAR( Int,i);
HXLINE( 622)		Float _hx_tmp1 = ((Float)Index / (Float)this->widthInTiles);
HXDLIN( 622)		Int _hx_tmp2 = ::Std_obj::_hx_int(_hx_tmp1);
HXDLIN( 622)		HX_VARI( Int,row) = (_hx_tmp2 - (int)1);
...
HXLINE( 633)					_hx_tmp5 = (row < this->heightInTiles);
            				}
            				else {
HXLINE( 633)					_hx_tmp5 = false;
            				}
HXDLIN( 633)				if (_hx_tmp5) {
HXLINE( 633)					_hx_tmp4 = (column >= (int)0);
            				}
            				else {
HXLINE( 633)					_hx_tmp4 = false;
            				}
HXDLIN( 633)				if (_hx_tmp4) {
HXLINE( 633)					_hx_tmp3 = (column < this->widthInTiles);
            				}
            				else {
...
HXLINE( 637)					Int _hx_tmp6 = this->_data->__get(i);
HXDLIN( 637)					this->updateTile(_hx_tmp6);
            				}
HXLINE( 639)				++column;
            			}
HXLINE( 641)			++row;
...
HXLINE( 659)		Bool _hx_tmp = (Range <= (int)0);
...
HXLINE( 676)			Int _hx_tmp1 = i++;
HXDLIN( 676)			tile = this->_tileObjects->__get(_hx_tmp1);
...
HXLINE( 737)		Bool _hx_tmp1 = hx::IsNull( distances );
...
HXDLIN( 749)			Bool _hx_tmp2 = Start->_weak;
...
HXDLIN( 751)			Bool _hx_tmp3 = End->_weak;
...
HXLINE( 769)			Int _hx_tmp4 = i--;
HXDLIN( 769)			node = points->__get(_hx_tmp4).StaticCast<  ::flixel::math::FlxPoint >();
HXLINE( 771)			Bool _hx_tmp5 = hx::IsNotNull( node );
...
HXLINE( 801)			Bool _hx_tmp = (( ( ::flixel::FlxObject)(this->_tileObjects->__get(this->_data->__get(i))) )->allowCollisions != (int)0);
...
HXLINE( 833)				Int _hx_tmp1 = i++;
HXDLIN( 833)				currentIndex = current->__get(_hx_tmp1);
HXLINE( 835)				Int _hx_tmp2 = ::Std_obj::_hx_int(EndIndex);
HXDLIN( 835)				if ((currentIndex == _hx_tmp2)) {
HXLINE( 837)					foundEnd = true;
HXLINE( 838)					if (StopOnEnd) {
HXLINE( 840)						neighbors = ::Array_obj< Int >::__new(0);
HXLINE( 841)						goto _hx_goto_14;
            					}
            				}
...
HXLINE( 857)					Bool _hx_tmp3 = (distances->__get(index) == (int)-1);
...
HXLINE( 867)					Bool _hx_tmp4 = (distances->__get(index) == (int)-1);
HXDLIN( 867)					if (_hx_tmp4) {
...
HXLINE( 877)					Bool _hx_tmp5 = (distances->__get(index) == (int)-1);
...
HXLINE( 887)					Bool _hx_tmp6 = (distances->__get(index) == (int)-1);
HXDLIN( 887)					if (_hx_tmp6) {
...
HXLINE( 897)					Bool _hx_tmp7;
HXDLIN( 897)					if (up) {
HXLINE( 897)						_hx_tmp7 = right;
            					}
            					else {
HXLINE( 897)						_hx_tmp7 = false;
            					}
HXDLIN( 897)					if (_hx_tmp7) {
HXLINE( 899)						index = ((currentIndex - this->widthInTiles) + (int)1);
HXLINE( 901)						Bool _hx_tmp8;
HXDLIN( 901)						Bool _hx_tmp9;
HXDLIN( 901)						Bool _hx_tmp10;
HXDLIN( 901)						if (wideDiagonal) {
HXLINE( 901)							_hx_tmp10 = (distances->__get(index) == (int)-1);
            						}
            						else {
HXLINE( 901)							_hx_tmp10 = false;
            						}
HXDLIN( 901)						if (_hx_tmp10) {
HXLINE( 901)							_hx_tmp9 = (distances->__get((currentIndex - this->widthInTiles)) >= (int)-1);
            						}
            						else {
HXLINE( 901)							_hx_tmp9 = false;
            						}
HXDLIN( 901)						if (_hx_tmp9) {
HXLINE( 901)							_hx_tmp8 = (distances->__get((currentIndex + (int)1)) >= (int)-1);
            						}
            						else {
...
HXLINE( 908)							Bool _hx_tmp11;
HXDLIN( 908)							if (!(wideDiagonal)) {
HXLINE( 908)								_hx_tmp11 = (distances->__get(index) == (int)-1);
            							}
            							else {
HXLINE( 908)								_hx_tmp11 = false;
            							}
HXDLIN( 908)							if (_hx_tmp11) {
HXLINE( 910)								distances[index] = distance;
HXLINE( 911)								neighbors->push(index);
            							}
            						}
            					}
HXLINE( 914)					Bool _hx_tmp12;
HXDLIN( 914)					if (right) {
HXLINE( 914)						_hx_tmp12 = down;
            					}
            					else {
HXLINE( 914)						_hx_tmp12 = false;
            					}
HXDLIN( 914)					if (_hx_tmp12) {
HXLINE( 916)						index = ((currentIndex + this->widthInTiles) + (int)1);
HXLINE( 918)						Bool _hx_tmp13;
HXDLIN( 918)						Bool _hx_tmp14;
HXDLIN( 918)						Bool _hx_tmp15;
HXDLIN( 918)						if (wideDiagonal) {
HXLINE( 918)							_hx_tmp15 = (distances->__get(index) == (int)-1);
            						}
            						else {
HXLINE( 918)							_hx_tmp15 = false;
            						}
HXDLIN( 918)						if (_hx_tmp15) {
HXLINE( 918)							_hx_tmp14 = (distances->__get((currentIndex + this->widthInTiles)) >= (int)-1);
            						}
            						else {
HXLINE( 918)							_hx_tmp14 = false;
            						}
HXDLIN( 918)						if (_hx_tmp14) {
HXLINE( 918)							_hx_tmp13 = (distances->__get((currentIndex + (int)1)) >= (int)-1);
            						}
            						else {
HXLINE( 918)							_hx_tmp13 = false;
            						}
HXDLIN( 918)						if (_hx_tmp13) {
HXLINE( 922)							distances[index] = distance;
HXLINE( 923)							neighbors->push(index);
            						}
            						else {
HXLINE( 925)							Bool _hx_tmp16;
HXDLIN( 925)							if (!(wideDiagonal)) {
HXLINE( 925)								_hx_tmp16 = (distances->__get(index) == (int)-1);
            							}
            							else {
HXLINE( 925)								_hx_tmp16 = false;
            							}
...
HXLINE( 931)					Bool _hx_tmp17;
HXDLIN( 931)					if (left) {
HXLINE( 931)						_hx_tmp17 = down;
            					}
            					else {
HXLINE( 931)						_hx_tmp17 = false;
            					}
HXDLIN( 931)					if (_hx_tmp17) {
HXLINE( 933)						index = ((currentIndex + this->widthInTiles) - (int)1);
HXLINE( 935)						Bool _hx_tmp18;
HXDLIN( 935)						Bool _hx_tmp19;
HXDLIN( 935)						Bool _hx_tmp20;
HXDLIN( 935)						if (wideDiagonal) {
HXLINE( 935)							_hx_tmp20 = (distances->__get(index) == (int)-1);
            						}
            						else {
HXLINE( 935)							_hx_tmp20 = false;
            						}
HXDLIN( 935)						if (_hx_tmp20) {
HXLINE( 935)							_hx_tmp19 = (distances->__get((currentIndex + this->widthInTiles)) >= (int)-1);
            						}
            						else {
HXLINE( 935)							_hx_tmp19 = false;
            						}
HXDLIN( 935)						if (_hx_tmp19) {
HXLINE( 935)							_hx_tmp18 = (distances->__get((currentIndex - (int)1)) >= (int)-1);
            						}
            						else {
HXLINE( 935)							_hx_tmp18 = false;
            						}
HXDLIN( 935)						if (_hx_tmp18) {
HXLINE( 939)							distances[index] = distance;
HXLINE( 940)							neighbors->push(index);
            						}
            						else {
HXLINE( 942)							Bool _hx_tmp21;
HXDLIN( 942)							if (!(wideDiagonal)) {
HXLINE( 942)								_hx_tmp21 = (distances->__get(index) == (int)-1);
            							}
            							else {
HXLINE( 942)								_hx_tmp21 = false;
            							}
HXDLIN( 942)							if (_hx_tmp21) {
HXLINE( 944)								distances[index] = distance;
HXLINE( 945)								neighbors->push(index);
            							}
            						}
            					}
HXLINE( 948)					Bool _hx_tmp22;
HXDLIN( 948)					if (up) {
HXLINE( 948)						_hx_tmp22 = left;
            					}
            					else {
HXLINE( 948)						_hx_tmp22 = false;
            					}
HXDLIN( 948)					if (_hx_tmp22) {
HXLINE( 950)						index = ((currentIndex - this->widthInTiles) - (int)1);
HXLINE( 952)						Bool _hx_tmp23;
HXDLIN( 952)						Bool _hx_tmp24;
HXDLIN( 952)						Bool _hx_tmp25;
HXDLIN( 952)						if (wideDiagonal) {
HXLINE( 952)							_hx_tmp25 = (distances->__get(index) == (int)-1);
            						}
            						else {
HXLINE( 952)							_hx_tmp25 = false;
            						}
HXDLIN( 952)						if (_hx_tmp25) {
HXLINE( 952)							_hx_tmp24 = (distances->__get((currentIndex - this->widthInTiles)) >= (int)-1);
            						}
            						else {
HXLINE( 952)							_hx_tmp24 = false;
            						}
HXDLIN( 952)						if (_hx_tmp24) {
HXLINE( 952)							_hx_tmp23 = (distances->__get((currentIndex - (int)1)) >= (int)-1);
            						}
            						else {
HXLINE( 952)							_hx_tmp23 = false;
            						}
HXDLIN( 952)						if (_hx_tmp23) {
HXLINE( 956)							distances[index] = distance;
HXLINE( 957)							neighbors->push(index);
            						}
            						else {
HXLINE( 959)							Bool _hx_tmp26;
HXDLIN( 959)							if (!(wideDiagonal)) {
HXLINE( 959)								_hx_tmp26 = (distances->__get(index) == (int)-1);
            							}
            							else {
HXLINE( 959)								_hx_tmp26 = false;
            							}
HXDLIN( 959)							if (_hx_tmp26) {
...
HXLINE( 987)		 ::flixel::math::FlxPoint _hx_tmp = this->getTileCoordsByIndex(Start,null());
HXDLIN( 987)		Points->push(_hx_tmp);
...
HXLINE(1007)			Bool _hx_tmp1;
HXDLIN(1007)			Bool _hx_tmp2;
HXDLIN(1007)			if ((i >= (int)0)) {
HXLINE(1007)				_hx_tmp2 = (Data->__get(i) >= (int)0);
            			}
            			else {
HXLINE(1007)				_hx_tmp2 = false;
            			}
HXDLIN(1007)			if (_hx_tmp2) {
HXLINE(1007)				_hx_tmp1 = (Data->__get(i) < current);
            			}
            			else {
...
HXLINE(1016)			Bool _hx_tmp3;
HXDLIN(1016)			Bool _hx_tmp4;
HXDLIN(1016)			if ((i >= (int)0)) {
HXLINE(1016)				_hx_tmp4 = (Data->__get(i) >= (int)0);
            			}
            			else {
HXLINE(1016)				_hx_tmp4 = false;
            			}
HXDLIN(1016)			if (_hx_tmp4) {
HXLINE(1016)				_hx_tmp3 = (Data->__get(i) < current);
            			}
            			else {
...
HXDLIN(1025)			Bool _hx_tmp6;
HXDLIN(1025)			if ((i >= (int)0)) {
HXLINE(1025)				_hx_tmp6 = (Data->__get(i) >= (int)0);
            			}
            			else {
HXLINE(1025)				_hx_tmp6 = false;
            			}
HXDLIN(1025)			if (_hx_tmp6) {
HXLINE(1025)				_hx_tmp5 = (Data->__get(i) < current);
            			}
            			else {
...
HXLINE(1034)			Bool _hx_tmp7;
HXDLIN(1034)			Bool _hx_tmp8;
HXDLIN(1034)			if ((i >= (int)0)) {
HXLINE(1034)				_hx_tmp8 = (Data->__get(i) >= (int)0);
            			}
            			else {
HXLINE(1034)				_hx_tmp8 = false;
            			}
HXDLIN(1034)			if (_hx_tmp8) {
HXLINE(1034)				_hx_tmp7 = (Data->__get(i) < current);
            			}
            			else {
...
HXLINE(1043)			Bool _hx_tmp10;
HXDLIN(1043)			Bool _hx_tmp11;
HXDLIN(1043)			if ((i >= (int)0)) {
HXLINE(1043)				_hx_tmp11 = (Data->__get(i) >= (int)0);
            			}
            			else {
HXLINE(1043)				_hx_tmp11 = false;
            			}
HXDLIN(1043)			if (_hx_tmp11) {
HXLINE(1043)				_hx_tmp10 = (Data->__get(i) < current);
            			}
            			else {
...
HXLINE(1048)		Bool _hx_tmp12;
HXDLIN(1048)		if (right) {
HXLINE(1048)			_hx_tmp12 = down;
            		}
            		else {
HXLINE(1048)			_hx_tmp12 = false;
            		}
HXDLIN(1048)		if (_hx_tmp12) {
HXLINE(1050)			i = ((Start + this->widthInTiles) + (int)1);
HXLINE(1052)			Bool _hx_tmp13;
HXDLIN(1052)			Bool _hx_tmp14;
HXDLIN(1052)			if ((i >= (int)0)) {
HXLINE(1052)				_hx_tmp14 = (Data->__get(i) >= (int)0);
            			}
            			else {
HXLINE(1052)				_hx_tmp14 = false;
            			}
HXDLIN(1052)			if (_hx_tmp14) {
HXLINE(1052)				_hx_tmp13 = (Data->__get(i) < current);
            			}
            			else {
...
HXLINE(1057)		Bool _hx_tmp15;
HXDLIN(1057)		if (left) {
HXLINE(1057)			_hx_tmp15 = down;
            		}
            		else {
...
HXLINE(1061)			Bool _hx_tmp16;
HXDLIN(1061)			Bool _hx_tmp17;
HXDLIN(1061)			if ((i >= (int)0)) {
HXLINE(1061)				_hx_tmp17 = (Data->__get(i) >= (int)0);
            			}
            			else {
HXLINE(1061)				_hx_tmp17 = false;
            			}
HXDLIN(1061)			if (_hx_tmp17) {
HXLINE(1061)				_hx_tmp16 = (Data->__get(i) < current);
            			}
            			else {
...
HXLINE(1066)		Bool _hx_tmp18;
HXDLIN(1066)		if (up) {
HXLINE(1066)			_hx_tmp18 = left;
            		}
            		else {
HXLINE(1066)			_hx_tmp18 = false;
            		}
HXDLIN(1066)		if (_hx_tmp18) {
HXLINE(1068)			i = ((Start - this->widthInTiles) - (int)1);
HXLINE(1070)			Bool _hx_tmp19;
HXDLIN(1070)			Bool _hx_tmp20;
HXDLIN(1070)			if ((i >= (int)0)) {
HXLINE(1070)				_hx_tmp20 = (Data->__get(i) >= (int)0);
            			}
            			else {
HXLINE(1070)				_hx_tmp20 = false;
            			}
HXDLIN(1070)			if (_hx_tmp20) {
HXLINE(1070)				_hx_tmp19 = (Data->__get(i) < current);
            			}
            			else {
...
HXLINE(1127)			Int _hx_tmp = i++;
HXDLIN(1127)			node = Points->__get(_hx_tmp).StaticCast<  ::flixel::math::FlxPoint >();
HXLINE(1129)			Bool _hx_tmp1 = hx::IsNull( node );
HXDLIN(1129)			if (_hx_tmp1) {
HXLINE(1131)				continue;
            			}
HXLINE(1134)			Bool _hx_tmp2 = this->ray(source,node,this->_point,null());
HXDLIN(1134)			if (_hx_tmp2) {
...
HXLINE(1164)		Bool _hx_tmp = hx::IsNotNull( group );
...
HXLINE(1168)				_hx_tmp2 = (ObjectOrGroup->flixelType == (int)3);
            			}
            			else {
HXLINE(1168)				_hx_tmp2 = true;
            			}
HXDLIN(1168)			if (_hx_tmp2) {
HXLINE(1168)				_hx_tmp1 = this->overlapsWithCallback(( ( ::flixel::FlxObject)(ObjectOrGroup) ),null(),null(),null());
            			}
            			else {
HXLINE(1168)				_hx_tmp1 = this->overlaps(ObjectOrGroup,false,null());
            			}
...
Bool InScreenSpace = __o_InScreenSpace.Default(false);
            	HX_STACK_FRAME("flixel.tile.FlxBaseTilemap","tilemapOverlapsCallback",0x40d17cea,"flixel.tile.FlxBaseTilemap.tilemapOverlapsCallback","flixel/tile/FlxBaseTilemap.hx",1177,0x0139d8e5)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(ObjectOrGroup,"ObjectOrGroup")
            	HX_STACK_ARG(X,"X")
            	HX_STACK_ARG(Y,"Y")
...
HXLINE(1203)		Bool _hx_tmp = hx::IsNotNull( group );
...
HXLINE(1207)				_hx_tmp2 = (ObjectOrGroup->flixelType == (int)3);
            			}
            			else {
HXLINE(1207)				_hx_tmp2 = true;
            			}
HXDLIN(1207)			if (_hx_tmp2) {
HXLINE(1207)				 ::flixel::math::FlxPoint _hx_tmp3 = this->_point->set(X,Y);
HXDLIN(1207)				_hx_tmp1 = this->overlapsWithCallback(( ( ::flixel::FlxObject)(ObjectOrGroup) ),null(),false,_hx_tmp3);
            			}
            			else {
HXLINE(1207)				_hx_tmp1 = this->overlapsAt(X,Y,ObjectOrGroup,InScreenSpace,Camera);
            			}
...
Bool FlxBaseTilemap_obj::tilemapOverlapsAtCallback( ::flixel::FlxBasic ObjectOrGroup,Float X,Float Y,Bool InScreenSpace, ::flixel::FlxCamera Camera){
            	HX_STACK_FRAME("flixel.tile.FlxBaseTilemap","tilemapOverlapsAtCallback",0xbef90c3d,"flixel.tile.FlxBaseTilemap.tilemapOverlapsAtCallback","flixel/tile/FlxBaseTilemap.hx",1217,0x0139d8e5)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(ObjectOrGroup,"ObjectOrGroup")
            	HX_STACK_ARG(X,"X")
            	HX_STACK_ARG(Y,"Y")
...
HXLINE(1219)			 ::flixel::math::FlxPoint _hx_tmp1 = this->_point->set(X,Y);
HXDLIN(1219)			return this->overlapsWithCallback(( ( ::flixel::FlxObject)(ObjectOrGroup) ),null(),false,_hx_tmp1);
            		}
            		else {
...
HXLINE(1264)		Bool _hx_tmp = hx::IsNull( Bounds );
HXDLIN(1264)		if (_hx_tmp) {
HXLINE(1265)			Float X = (int)0;
HXDLIN(1265)			Float Y = (int)0;
HXDLIN(1265)			Float Width = (int)0;
HXDLIN(1265)			Float Height = (int)0;
HXDLIN(1265)			HX_VARI(  ::flixel::math::FlxRect,_this) = ::flixel::math::FlxRect_obj::_pool->get();
HXDLIN(1265)			_this->x = X;
HXDLIN(1265)			_this->y = Y;
HXDLIN(1265)			_this->width = Width;
HXDLIN(1265)			_this->height = Height;
HXDLIN(1265)			_this->_inPool = false;
HXDLIN(1265)			Bounds = _this;
            		}
HXLINE(1267)		Float X1 = this->x;
HXDLIN(1267)		Float Y1 = this->y;
HXDLIN(1267)		Float Width1 = this->get_width();
HXDLIN(1267)		Float Height1 = this->get_height();
HXDLIN(1267)		Bounds->x = X1;
HXDLIN(1267)		Bounds->y = Y1;
HXDLIN(1267)		Bounds->width = Width1;
HXDLIN(1267)		Bounds->height = Height1;
