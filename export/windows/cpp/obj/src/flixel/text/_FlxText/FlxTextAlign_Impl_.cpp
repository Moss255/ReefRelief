...
::String FlxTextAlign_Impl__obj::fromOpenFL(::String align){
            	HX_STACK_FRAME("flixel.text._FlxText.FlxTextAlign_Impl_","fromOpenFL",0xc584ea03,"flixel.text._FlxText.FlxTextAlign_Impl_.fromOpenFL","flixel/text/FlxText.hx",1124,0xdf165a6e)
...
::String FlxTextAlign_Impl__obj::toOpenFL(::String align){
            	HX_STACK_FRAME("flixel.text._FlxText.FlxTextAlign_Impl_","toOpenFL",0xa34e3094,"flixel.text._FlxText.FlxTextAlign_Impl_.toOpenFL","flixel/text/FlxText.hx",1136,0xdf165a6e)
            	HX_STACK_ARG(align,"align")
HXLINE(1136)		::String _hx_switch_0 = align;
            		if (  (_hx_switch_0==HX_("center",d5,25,db,05)) ){
HXLINE(1136)			return HX_("center",d5,25,db,05);
HXDLIN(1136)			goto _hx_goto_1;
            		}
            		if (  (_hx_switch_0==HX_("justify",50,df,b5,83)) ){
...
{
{
            	HX_STACK_FRAME("flixel.text._FlxText.FlxTextAlign_Impl_","boot",0xece2bcdb,"flixel.text._FlxText.FlxTextAlign_Impl_.boot","flixel/text/FlxText.hx",1109,0xdf165a6e)
HXLINE(1109)		LEFT = HX_("left",07,08,b0,47);
            	}
{
            	HX_STACK_FRAME("flixel.text._FlxText.FlxTextAlign_Impl_","boot",0xece2bcdb,"flixel.text._FlxText.FlxTextAlign_Impl_.boot","flixel/text/FlxText.hx",1116,0xdf165a6e)
HXLINE(1116)		CENTER = HX_("center",d5,25,db,05);
            	}
{
            	HX_STACK_FRAME("flixel.text._FlxText.FlxTextAlign_Impl_","boot",0xece2bcdb,"flixel.text._FlxText.FlxTextAlign_Impl_.boot","flixel/text/FlxText.hx",1118,0xdf165a6e)
HXLINE(1118)		RIGHT = HX_("right",dc,0b,64,e9);
            	}
{
            	HX_STACK_FRAME("flixel.text._FlxText.FlxTextAlign_Impl_","boot",0xece2bcdb,"flixel.text._FlxText.FlxTextAlign_Impl_.boot","flixel/text/FlxText.hx",1120,0xdf165a6e)
