...
void FlxTextFormatRange_obj::__construct( ::flixel::text::FlxTextFormat format,Int start,Int end){
            	HX_STACK_FRAME("flixel.text._FlxText.FlxTextFormatRange","new",0x02a8ae38,"flixel.text._FlxText.FlxTextFormatRange.new","flixel/text/FlxText.hx",1071,0xdf165a6e)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(format,"format")
            	HX_STACK_ARG(start,"start")
            	HX_STACK_ARG(end,"end")
HXLINE(1072)		this->range =  ::flixel::util::helpers::FlxRange_obj::__new(start,end);
HXLINE(1073)		this->format = format;
            	}
