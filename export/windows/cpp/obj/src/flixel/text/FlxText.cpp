...
HXLINE( 189)		this->textField =  ::openfl::_legacy::text::TextField_obj::__new();
...
HXLINE( 193)		this->_defaultFormat =  ::openfl::_legacy::text::TextFormat_obj::__new(null(),Size,(int)16777215,null(),null(),null(),null(),null(),null(),null(),null(),null(),null());
HXLINE( 194)		this->set_font(::flixel::_hx_system::FlxAssets_obj::FONT_DEFAULT);
HXLINE( 195)		this->_formatAdjusted =  ::openfl::_legacy::text::TextFormat_obj::__new(null(),null(),null(),null(),null(),null(),null(),null(),null(),null(),null(),null(),null());
...
HXLINE( 521)			::hx::EnumBase _hx_tmp1;
HXDLIN( 521)			if (value) {
HXLINE( 521)				_hx_tmp1 = ::openfl::_legacy::text::TextFieldAutoSize_obj::LEFT_dyn();
            			}
            			else {
HXLINE( 521)				_hx_tmp1 = ::openfl::_legacy::text::TextFieldAutoSize_obj::NONE_dyn();
            			}
...
HXLINE( 530)			::hx::EnumBase _hx_tmp1 = this->textField->get_autoSize();
HXDLIN( 530)			return hx::IsNotEq( _hx_tmp1,::openfl::_legacy::text::TextFieldAutoSize_obj::NONE_dyn() );
            		}
            		else {
...
HXLINE( 581)			Bool _hx_tmp1 = ::openfl::_legacy::Assets_obj::exists(Font,::openfl::_legacy::AssetType_obj::FONT_dyn());
...
HXLINE( 728)			this->colorTransform =  ::openfl::_legacy::geom::ColorTransform_obj::__new(null(),null(),null(),null(),null(),null(),null(),null());
            		}
...
HXLINE( 790)					this->_borderPixels =  ::openfl::_legacy::display::BitmapData_obj::__new(this->frameWidth,this->frameHeight,true,null(),null());
            				}
            				else {
...
HXLINE( 804)					this->_borderColorTransform =  ::openfl::_legacy::geom::ColorTransform_obj::__new(null(),null(),null(),null(),null(),null(),null(),null());
            				}
...
HXDLIN( 804)				 ::openfl::_legacy::geom::Rectangle _hx_tmp20 = this->_borderPixels->get_rect();
HXDLIN( 804)				this->_borderPixels->colorTransform(_hx_tmp20,this->_borderColorTransform);
...
HXLINE( 962)			this->_borderColorTransform =  ::openfl::_legacy::geom::ColorTransform_obj::__new(null(),null(),null(),null(),null(),null(),null(),null());
            		}
...
HXLINE( 965)		 ::openfl::_legacy::geom::Rectangle _hx_tmp2 = this->_borderPixels->get_rect();
HXDLIN( 965)		this->_borderPixels->colorTransform(_hx_tmp2,this->_borderColorTransform);
...
HXLINE(1002)				Int _hx_tmp5 = ( (Int)(formatRange->range->end) );
HXDLIN(1002)				Float _hx_tmp6 = ::Math_obj::min(_hx_tmp5,this->textField->get_text().length);
HXDLIN(1002)				Int _hx_tmp7 = ::Std_obj::_hx_int(_hx_tmp6);
HXLINE(1001)				this->textField->setTextFormat(FormatAdjusted,_hx_tmp4,_hx_tmp7);
            			}
            			_hx_goto_11:;
            		}
            	}
...
HXLINE(1025)		return  ::openfl::_legacy::text::TextFormat_obj::__new(dtf->font,dtf->size,dtf->color,dtf->bold,dtf->italic,dtf->underline,dtf->url,dtf->target,dtf->align,null(),null(),null(),null());
            	}
