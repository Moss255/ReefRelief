...
::String FlxBasic_obj::toString(){
            	HX_STACK_FRAME("flixel.FlxBasic","toString",0x03b3efcc,"flixel.FlxBasic.toString","flixel/FlxBasic.hx",120,0xd8d6cfcf)
            	HX_STACK_THIS(this)
...
Bool FlxBasic_obj::set_visible(Bool Value){
            	HX_STACK_FRAME("flixel.FlxBasic","set_visible",0x942af475,"flixel.FlxBasic.set_visible","flixel/FlxBasic.hx",130,0xd8d6cfcf)
            	HX_STACK_THIS(this)
...
Bool FlxBasic_obj::set_active(Bool Value){
            	HX_STACK_FRAME("flixel.FlxBasic","set_active",0x086e7723,"flixel.FlxBasic.set_active","flixel/FlxBasic.hx",136,0xd8d6cfcf)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(Value,"Value")
...
Bool FlxBasic_obj::set_exists(Bool Value){
            	HX_STACK_FRAME("flixel.FlxBasic","set_exists",0xb2085339,"flixel.FlxBasic.set_exists","flixel/FlxBasic.hx",142,0xd8d6cfcf)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(Value,"Value")
...
Bool FlxBasic_obj::set_alive(Bool Value){
            	HX_STACK_FRAME("flixel.FlxBasic","set_alive",0x59c1c910,"flixel.FlxBasic.set_alive","flixel/FlxBasic.hx",148,0xd8d6cfcf)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(Value,"Value")
...
HX_DEFINE_DYNAMIC_FUNC1(FlxBasic_obj,set_alive,return )
 ...
 ::flixel::FlxCamera FlxBasic_obj::get_camera(){
            	HX_STACK_FRAME("flixel.FlxBasic","get_camera",0xa636dd8e,"flixel.FlxBasic.get_camera","flixel/FlxBasic.hx",154,0xd8d6cfcf)
            	HX_STACK_THIS(this)
HXLINE( 154)		Bool _hx_tmp;
HXDLIN( 154)		Bool _hx_tmp1 = hx::IsNotNull( this->_cameras );
...
HX_DEFINE_DYNAMIC_FUNC0(FlxBasic_obj,get_camera,return )
 ...
 ::flixel::FlxCamera FlxBasic_obj::set_camera( ::flixel::FlxCamera Value){
            	...
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(Value,"Value")
HXLINE( 160)		Bool _hx_tmp = hx::IsNull( this->_cameras );
...
::Array< ::Dynamic> FlxBasic_obj::get_cameras(){
            	HX_STACK_FRAME("flixel.FlxBasic","get_cameras",0xc9caff25,"flixel.FlxBasic.get_cameras","flixel/FlxBasic.hx",170,0xd8d6cfcf)
            	HX_STACK_THIS(this)
HXLINE( 170)		Bool _hx_tmp = hx::IsNull( this->_cameras );
...
{
{
            	HX_STACK_FRAME("flixel.FlxBasic","boot",0x115a9352,"flixel.FlxBasic.boot","flixel/FlxBasic.hx",17,0xd8d6cfcf)
HXLINE(  17)		activeCount = (int)0;
            	}
{
            	HX_STACK_FRAME("flixel.FlxBasic","boot",0x115a9352,"flixel.FlxBasic.boot","flixel/FlxBasic.hx",19,0xd8d6cfcf)
