...
HXLINE( 230)		this->_facingFlip =  ::haxe::ds::IntMap_obj::__new();
...
HXLINE( 245)		Bool _hx_tmp = hx::IsNotNull( SimpleGraphic );
...
HXLINE( 254)		this->animation =  ::flixel::animation::FlxAnimationController_obj::__new(hx::ObjectPtr<OBJ_>(this));
HXLINE( 256)		this->_flashPoint =  ::openfl::_legacy::geom::Point_obj::__new(null(),null());
HXLINE( 257)		this->_flashRect =  ::openfl::_legacy::geom::Rectangle_obj::__new(null(),null(),null(),null());
HXLINE( 258)		this->_flashRect2 =  ::openfl::_legacy::geom::Rectangle_obj::__new(null(),null(),null(),null());
HXLINE( 259)		this->_flashPointZero =  ::openfl::_legacy::geom::Point_obj::__new(null(),null());
...
HXLINE( 264)		this->_matrix =  ::flixel::math::FlxMatrix_obj::__new(null(),null(),null(),null(),null(),null());
HXLINE( 265)		this->colorTransform =  ::openfl::_legacy::geom::ColorTransform_obj::__new(null(),null(),null(),null(),null(),null(),null(),null());
            	}
...
HXLINE( 298)		this->shader = null();
 ...
 ::flixel::FlxSprite FlxSprite_obj::clone(){
            	HX_STACK_FRAME("flixel.FlxSprite","clone",0x3c30f394,"flixel.FlxSprite.clone","flixel/FlxSprite.hx",303,0x0384bffa)
            	HX_STACK_THIS(this)
HXLINE( 303)		return  ::flixel::FlxSprite_obj::__new(null(),null(),null())->loadGraphicFromSprite(hx::ObjectPtr<OBJ_>(this));
            	}
...
HXLINE( 317)		Bool _hx_tmp = (this->bakedRotationAngle > (int)0);
HXDLIN( 317)		if (_hx_tmp) {
HXLINE( 319)			Float _hx_tmp1 = Sprite->get_width();
HXDLIN( 319)			this->set_width(_hx_tmp1);
HXLINE( 320)			Float _hx_tmp2 = Sprite->get_height();
HXDLIN( 320)			this->set_height(_hx_tmp2);
...
HXLINE( 350)		Bool _hx_tmp = hx::IsNull( graph );
HXDLIN( 350)		if (_hx_tmp) {
HXLINE( 351)			return hx::ObjectPtr<OBJ_>(this);
            		}
HXLINE( 353)		Bool _hx_tmp1 = (Width == (int)0);
...
HXLINE( 356)			Bool _hx_tmp2 = (Width > graph->width);
...
HXLINE( 359)		Bool _hx_tmp3 = (Height == (int)0);
...
HXLINE( 362)			Bool _hx_tmp4 = (Height > graph->height);
...
HXDLIN( 367)			 ::flixel::graphics::frames::FlxTileFrames _hx_tmp5 = ::flixel::graphics::frames::FlxTileFrames_obj::fromGraphic(graph,point,null(),null());
HXDLIN( 367)			this->set_frames(_hx_tmp5);
            		}
            		else {
HXLINE( 371)			 ::flixel::graphics::frames::FlxImageFrame _hx_tmp6 = graph->get_imageFrame();
HXDLIN( 371)			this->set_frames(_hx_tmp6);
            		}
...
HXLINE( 392)		Bool _hx_tmp = hx::IsNull( brushGraphic );
...
HXLINE( 402)			Int _hx_tmp1 = brush->get_width();
HXDLIN( 402)			HX_VARI( Int,framesNum) = ::Std_obj::_hx_int(((Float)_hx_tmp1 / (Float)brushSize));
HXLINE( 403)			Bool _hx_tmp2 = (framesNum > Frame);
HXDLIN( 403)			if (_hx_tmp2) {
HXLINE( 403)				Frame = Frame;
            			}
            			else {
HXLINE( 403)				hx::ModEq(Frame,framesNum);
            			}
HXLINE( 404)			hx::AddEq(key,(HX_(":",3a,00,00,00) + Frame));
HXLINE( 406)			HX_VARI(  ::openfl::_legacy::display::BitmapData,full) = brush;
HXLINE( 407)			brush =  ::openfl::_legacy::display::BitmapData_obj::__new(brushSize,brushSize,true,(int)0,null());
...
HXLINE( 412)		::String _hx_tmp3 = ((HX_(":",3a,00,00,00) + Rotations) + HX_(":",3a,00,00,00));
HXDLIN( 412)		::String _hx_tmp4 = ::Std_obj::string(AutoBuffer);
HXDLIN( 412)		hx::AddEq(key,(_hx_tmp3 + _hx_tmp4));
HXLINE( 415)		HX_VARI(  ::flixel::graphics::FlxGraphic,tempGraph) = ::flixel::FlxG_obj::bitmap->_cache->get(key).StaticCast<  ::flixel::graphics::FlxGraphic >();
HXLINE( 416)		Bool _hx_tmp5 = hx::IsNull( tempGraph );
HXDLIN( 416)		if (_hx_tmp5) {
HXLINE( 418)			HX_VARI(  ::openfl::_legacy::display::BitmapData,bitmap) = ::flixel::util::FlxBitmapDataUtil_obj::generateRotations(brush,Rotations,AntiAliasing,AutoBuffer);
HXLINE( 419)			tempGraph = ::flixel::graphics::FlxGraphic_obj::fromBitmapData(bitmap,false,key,null());
            		}
HXLINE( 422)		HX_VAR( Int,max);
HXDLIN( 422)		Int _hx_tmp6 = brush->get_height();
HXDLIN( 422)		Int _hx_tmp7 = brush->get_width();
HXDLIN( 422)		if ((_hx_tmp6 > _hx_tmp7)) {
...
HXDLIN( 425)		 ::flixel::graphics::frames::FlxTileFrames _hx_tmp8 = ::flixel::graphics::frames::FlxTileFrames_obj::fromGraphic(tempGraph,point,null(),null());
HXDLIN( 425)		this->set_frames(_hx_tmp8);
HXLINE( 427)		if (AutoBuffer) {
HXLINE( 429)			Int _hx_tmp9 = brush->get_width();
HXDLIN( 429)			this->set_width(_hx_tmp9);
HXLINE( 430)			Int _hx_tmp10 = brush->get_height();
HXDLIN( 430)			this->set_height(_hx_tmp10);
...
HXLINE( 452)		Bool _hx_tmp = hx::IsNotNull( Frame->name );
HXDLIN( 452)		if (_hx_tmp) {
HXLINE( 454)			hx::AddEq(key,(HX_(":",3a,00,00,00) + Frame->name));
            		}
            		else {
...
HXDLIN( 458)			::String _hx_tmp1 = ::flixel::util::FlxStringUtil_obj::getDebugString(::Array_obj< ::Dynamic>::__new(4)->init(0,_this1)->init(1,_this2)->init(2,_this3)->init(3,_this4));
HXDLIN( 458)			hx::AddEq(key,(HX_(":",3a,00,00,00) + _hx_tmp1));
            		}
HXLINE( 461)		HX_VARI(  ::flixel::graphics::FlxGraphic,graphic) = ::flixel::FlxG_obj::bitmap->_cache->get(key).StaticCast<  ::flixel::graphics::FlxGraphic >();
HXLINE( 462)		Bool _hx_tmp2 = hx::IsNull( graphic );
HXDLIN( 462)		if (_hx_tmp2) {
HXLINE( 464)			 ::openfl::_legacy::display::BitmapData _hx_tmp3 = Frame->paint(null(),null(),null(),null());
HXDLIN( 464)			graphic = ::flixel::graphics::FlxGraphic_obj::fromBitmapData(_hx_tmp3,false,key,null());
            		}
...
Bool Unique = __o_Unique.Default(false);
            	...
            	HX_STACK_ARG(Unique,"Unique")
            	HX_STACK_ARG(Key,"Key")
HXLINE( 492)		HX_VARI(  ::flixel::graphics::FlxGraphic,graph) = ::flixel::FlxG_obj::bitmap->create(Width,Height,Color,Unique,Key);
HXLINE( 493)		 ::flixel::graphics::frames::FlxImageFrame _hx_tmp = graph->get_imageFrame();
HXDLIN( 493)		this->set_frames(_hx_tmp);
...
void FlxSprite_obj::resetFrameSize(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 519)		Bool _hx_tmp = hx::IsNotNull( this->frame );
...
HXLINE( 524)		Float _hx_tmp1 = (((Float)0.5) * this->frameWidth);
HXDLIN( 524)		Float _hx_tmp2 = (((Float)0.5) * this->frameHeight);
HXDLIN( 524)		this->_halfSize->set(_hx_tmp1,_hx_tmp2);
HXLINE( 525)		{
...
void FlxSprite_obj::resetFrame(){
            	HX_STACK_FRAME("flixel.FlxSprite","resetFrame",0x02a6a847,"flixel.FlxSprite.resetFrame","flixel/FlxSprite.hx",545,0x0384bffa)
            	HX_STACK_THIS(this)
...
void FlxSprite_obj::updateHitbox(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 580)		Float _hx_tmp = ::Math_obj::abs(this->scale->x);
HXDLIN( 580)		Float _hx_tmp1 = (_hx_tmp * this->frameWidth);
HXDLIN( 580)		this->set_width(_hx_tmp1);
HXLINE( 581)		Float _hx_tmp2 = ::Math_obj::abs(this->scale->y);
HXDLIN( 581)		Float _hx_tmp3 = (_hx_tmp2 * this->frameHeight);
HXDLIN( 581)		this->set_height(_hx_tmp3);
HXLINE( 582)		Float _hx_tmp4 = this->get_width();
HXDLIN( 582)		Float _hx_tmp5 = (((Float)-0.5) * (_hx_tmp4 - this->frameWidth));
HXDLIN( 582)		Float _hx_tmp6 = this->get_height();
HXDLIN( 582)		Float _hx_tmp7 = (((Float)-0.5) * (_hx_tmp6 - this->frameHeight));
HXDLIN( 582)		this->offset->set(_hx_tmp5,_hx_tmp7);
HXLINE( 583)		Float _hx_tmp8 = (this->frameWidth * ((Float)0.5));
HXDLIN( 583)		Float _hx_tmp9 = (this->frameHeight * ((Float)0.5));
HXDLIN( 583)		this->origin->set(_hx_tmp8,_hx_tmp9);
            	}
...
void FlxSprite_obj::resetHelpers(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 592)		{
HXLINE( 592)			Bool _hx_tmp = hx::IsNotNull( this->frame );
...
HXDLIN( 592)			Float _hx_tmp1 = (((Float)0.5) * this->frameWidth);
HXDLIN( 592)			Float _hx_tmp2 = (((Float)0.5) * this->frameHeight);
HXDLIN( 592)			this->_halfSize->set(_hx_tmp1,_hx_tmp2);
HXDLIN( 592)			{
...
HXLINE( 597)		Bool _hx_tmp3 = hx::IsNotNull( this->graphic );
...
HXLINE( 603)		Float _hx_tmp4 = (this->frameWidth * ((Float)0.5));
HXDLIN( 603)		Float _hx_tmp5 = (this->frameHeight * ((Float)0.5));
HXDLIN( 603)		this->origin->set(_hx_tmp4,_hx_tmp5);
HXLINE( 605)		Bool _hx_tmp6 = ::flixel::FlxG_obj::renderBlit;
HXDLIN( 605)		if (_hx_tmp6) {
...
void FlxSprite_obj::updateAnimation(Float elapsed){
            	HX_STACK_FRAME("flixel.FlxSprite","updateAnimation",0x7e6eaab2,"flixel.FlxSprite.updateAnimation","flixel/FlxSprite.hx",623,0x0384bffa)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(elapsed,"elapsed")
...
void FlxSprite_obj::checkEmptyFrame(){
            	HX_STACK_FRAME("flixel.FlxSprite","checkEmptyFrame",0xe3dea03f,"flixel.FlxSprite.checkEmptyFrame","flixel/FlxSprite.hx",629,0x0384bffa)
            	HX_STACK_THIS(this)
HXLINE( 629)		Bool _hx_tmp = hx::IsNull( this->_frame );
...
HXLINE( 643)		Bool _hx_tmp1 = this->dirty;
...
HXLINE( 648)					_hx_tmp3 = !(camera->exists);
            				}
            				else {
HXLINE( 648)					_hx_tmp3 = true;
            				}
HXDLIN( 648)				if (!(_hx_tmp3)) {
HXLINE( 648)					_hx_tmp2 = !(this->isOnScreen(camera));
            				}
            				else {
...
HXLINE( 653)				Bool _hx_tmp4 = this->isSimpleRender(camera);
...
HXLINE( 664)		Bool _hx_tmp5 = ::flixel::FlxG_obj::debugger->drawDebug;
...
HXLINE( 672)		Bool _hx_tmp = this->isPixelPerfectRender(camera);
HXDLIN( 672)		if (_hx_tmp) {
HXLINE( 673)			HX_VARI(  ::flixel::math::FlxPoint,_this) = this->_point;
HXDLIN( 673)			Int _hx_tmp1 = ::Math_obj::floor(_this->x);
HXDLIN( 673)			_this->set_x(_hx_tmp1);
HXDLIN( 673)			Int _hx_tmp2 = ::Math_obj::floor(_this->y);
HXDLIN( 673)			_this->set_y(_hx_tmp2);
            		}
HXLINE( 675)		{
...
HXDLIN( 675)			Bool _hx_tmp3 = hx::IsNull( FlashPoint );
HXDLIN( 675)			if (_hx_tmp3) {
HXLINE( 675)				FlashPoint =  ::openfl::_legacy::geom::Point_obj::__new(null(),null());
            			}
...
HXDLIN( 683)		Bool _hx_tmp1 = hx::IsNotNull( this->animation->_curAnim );
...
HXDLIN( 683)		Bool _hx_tmp3 = hx::IsNotNull( this->animation->_curAnim );
HXDLIN( 683)		if (_hx_tmp3) {
HXLINE( 683)			_hx_tmp2 = (doFlipY != this->animation->_curAnim->flipY);
            		}
            		else {
HXLINE( 683)			_hx_tmp2 = doFlipY;
            		}
HXDLIN( 683)		this->_frame->prepareMatrix(this->_matrix,(int)0,_hx_tmp,_hx_tmp2);
HXLINE( 684)		this->_matrix->translate(-(this->origin->x),-(this->origin->y));
HXLINE( 685)		this->_matrix->scale(this->scale->x,this->scale->y);
HXLINE( 687)		Bool _hx_tmp4 = (this->bakedRotationAngle <= (int)0);
HXDLIN( 687)		if (_hx_tmp4) {
HXLINE( 689)			Bool _hx_tmp5 = this->_angleChanged;
...
HXLINE( 691)			Bool _hx_tmp6 = (this->angle != (int)0);
...
HXDLIN( 692)				Float _hx_tmp7 = (_this->a * sin);
HXDLIN( 692)				Float _hx_tmp8 = (_this->b * cos);
HXDLIN( 692)				_this->b = (_hx_tmp7 + _hx_tmp8);
HXDLIN( 692)				_this->a = a1;
HXDLIN( 692)				HX_VARI( Float,c1) = ((_this->c * cos) - (_this->d * sin));
HXDLIN( 692)				Float _hx_tmp9 = (_this->c * sin);
HXDLIN( 692)				Float _hx_tmp10 = (_this->d * cos);
HXDLIN( 692)				_this->d = (_hx_tmp9 + _hx_tmp10);
HXDLIN( 692)				_this->c = c1;
HXDLIN( 692)				HX_VARI( Float,tx1) = ((_this->tx * cos) - (_this->ty * sin));
HXDLIN( 692)				Float _hx_tmp11 = (_this->tx * sin);
HXDLIN( 692)				Float _hx_tmp12 = (_this->ty * cos);
HXDLIN( 692)				_this->ty = (_hx_tmp11 + _hx_tmp12);
HXDLIN( 692)				_this->tx = tx1;
            			}
            		}
HXLINE( 695)		{
HXLINE( 695)			HX_VARI_NAME(  ::flixel::math::FlxPoint,_this1,"_this") = this->_point;
HXDLIN( 695)			Float X = this->origin->x;
HXDLIN( 695)			Float Y = this->origin->y;
HXDLIN( 695)			{
HXLINE( 695)				Float _hx_tmp13 = (_this1->x + X);
HXDLIN( 695)				_this1->set_x(_hx_tmp13);
            			}
HXDLIN( 695)			{
HXLINE( 695)				Float _hx_tmp14 = (_this1->y + Y);
HXDLIN( 695)				_this1->set_y(_hx_tmp14);
            			}
            		}
HXLINE( 696)		this->_matrix->translate(this->_point->x,this->_point->y);
HXLINE( 698)		Bool _hx_tmp15 = this->isPixelPerfectRender(camera);
HXDLIN( 698)		if (_hx_tmp15) {
...
HXDLIN( 719)		Bool _hx_tmp1 = hx::IsNotNull( this->graphic );
...
HXLINE( 724)		Bool _hx_tmp2 = this->isSimpleRenderBlit(null());
...
HXLINE( 739)			Bool _hx_tmp3 = (Brush->angle != (int)0);
HXDLIN( 739)			if (_hx_tmp3) {
HXLINE( 741)				Float _hx_tmp4 = (Brush->angle * ((Float)::Math_obj::PI / (Float)(int)180));
HXDLIN( 741)				this->_matrix->rotate(_hx_tmp4);
            			}
HXLINE( 743)			Float _hx_tmp5 = ((X + this->frame->frame->x) + Brush->origin->x);
HXDLIN( 743)			Float _hx_tmp6 = ((Y + this->frame->frame->y) + Brush->origin->y);
HXDLIN( 743)			this->_matrix->translate(_hx_tmp5,_hx_tmp6);
HXLINE( 745)			this->graphic->bitmap->draw(bitmapData,this->_matrix,null(),Brush->blend,null(),Brush->antialiasing);
            		}
HXLINE( 748)		Bool _hx_tmp7 = ::flixel::FlxG_obj::renderBlit;
...
Bool Force = __o_Force.Default(false);
            	HX_STACK_FRAME("flixel.FlxSprite","drawFrame",0x99d67540,"flixel.FlxSprite.drawFrame","flixel/FlxSprite.hx",763,0x0384bffa)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(Force,"Force")
HXLINE( 763)		Bool _hx_tmp = ::flixel::FlxG_obj::renderBlit;
HXDLIN( 763)		if (_hx_tmp) {
HXLINE( 765)			Bool _hx_tmp1;
HXDLIN( 765)			if (!(Force)) {
HXLINE( 765)				_hx_tmp1 = this->dirty;
            			}
            			else {
...
HXLINE( 785)		Int _hx_tmp = this->frameWidth;
HXDLIN( 785)		Float _hx_tmp1 = this->get_width();
HXDLIN( 785)		this->offset->set_x(((_hx_tmp - _hx_tmp1) * ((Float)0.5)));
HXLINE( 786)		Int _hx_tmp2 = this->frameHeight;
HXDLIN( 786)		Float _hx_tmp3 = this->get_height();
HXDLIN( 786)		this->offset->set_y(((_hx_tmp2 - _hx_tmp3) * ((Float)0.5)));
HXLINE( 787)		if (AdjustPosition) {
HXLINE( 789)			{
HXLINE( 789)				HX_VARI(  ::flixel::FlxSprite,_g) = hx::ObjectPtr<OBJ_>(this);
HXDLIN( 789)				Float _hx_tmp4 = (_g->x + this->offset->x);
HXDLIN( 789)				_g->set_x(_hx_tmp4);
            			}
HXLINE( 790)			{
HXLINE( 790)				HX_VARI_NAME(  ::flixel::FlxSprite,_g1,"_g") = hx::ObjectPtr<OBJ_>(this);
HXDLIN( 790)				Float _hx_tmp5 = (_g1->y + this->offset->y);
HXDLIN( 790)				_g1->set_y(_hx_tmp5);
            			}
            		}
            	}
...
void FlxSprite_obj::centerOrigin(){
            	HX_STACK_FRAME("flixel.FlxSprite","centerOrigin",0x4cbae644,"flixel.FlxSprite.centerOrigin","flixel/FlxSprite.hx",800,0x0384bffa)
            	HX_STACK_THIS(this)
HXLINE( 800)		Float _hx_tmp = (this->frameWidth * ((Float)0.5));
HXDLIN( 800)		Float _hx_tmp1 = (this->frameHeight * ((Float)0.5));
HXDLIN( 800)		this->origin->set(_hx_tmp,_hx_tmp1);
            	}
...
HXLINE( 815)		Bool _hx_tmp = hx::IsNotNull( positions );
...
HXLINE( 836)		HX_VARI( Float,Alpha) = (int)1;
HXDLIN( 836)		HX_VARI( Int,color) = ::flixel::util::_FlxColor::FlxColor_Impl__obj::_new(null());
HXDLIN( 836)		{
HXLINE( 836)			HX_VARI( Int,Value) = ::Math_obj::round((redMultiplier * (int)255));
HXDLIN( 836)			hx::AndEq(color,(int)-16711681);
HXDLIN( 836)			Int _hx_tmp;
HXDLIN( 836)			if ((Value > (int)255)) {
HXLINE( 836)				_hx_tmp = (int)255;
            			}
            			else {
HXLINE( 836)				if ((Value < (int)0)) {
HXLINE( 836)					_hx_tmp = (int)0;
            				}
            				else {
HXLINE( 836)					_hx_tmp = Value;
            				}
            			}
HXDLIN( 836)			hx::OrEq(color,((int)_hx_tmp << (int)(int)16));
            		}
HXDLIN( 836)		{
HXLINE( 836)			HX_VARI_NAME( Int,Value1,"Value") = ::Math_obj::round((greenMultiplier * (int)255));
HXDLIN( 836)			hx::AndEq(color,(int)-65281);
HXDLIN( 836)			Int _hx_tmp1;
HXDLIN( 836)			if ((Value1 > (int)255)) {
HXLINE( 836)				_hx_tmp1 = (int)255;
            			}
            			else {
HXLINE( 836)				if ((Value1 < (int)0)) {
HXLINE( 836)					_hx_tmp1 = (int)0;
            				}
            				else {
HXLINE( 836)					_hx_tmp1 = Value1;
            				}
            			}
HXDLIN( 836)			hx::OrEq(color,((int)_hx_tmp1 << (int)(int)8));
            		}
HXDLIN( 836)		{
HXLINE( 836)			HX_VARI_NAME( Int,Value2,"Value") = ::Math_obj::round((blueMultiplier * (int)255));
HXDLIN( 836)			hx::AndEq(color,(int)-256);
HXDLIN( 836)			Int _hx_tmp2;
HXDLIN( 836)			if ((Value2 > (int)255)) {
HXLINE( 836)				_hx_tmp2 = (int)255;
            			}
            			else {
HXLINE( 836)				if ((Value2 < (int)0)) {
HXLINE( 836)					_hx_tmp2 = (int)0;
            				}
            				else {
HXLINE( 836)					_hx_tmp2 = Value2;
            				}
            			}
HXDLIN( 836)			hx::OrEq(color,_hx_tmp2);
            		}
HXDLIN( 836)		{
HXLINE( 836)			HX_VARI_NAME( Int,Value3,"Value") = ::Math_obj::round((Alpha * (int)255));
HXDLIN( 836)			hx::AndEq(color,(int)16777215);
HXDLIN( 836)			Int _hx_tmp3;
HXDLIN( 836)			if ((Value3 > (int)255)) {
HXLINE( 836)				_hx_tmp3 = (int)255;
            			}
            			else {
HXLINE( 836)				if ((Value3 < (int)0)) {
HXLINE( 836)					_hx_tmp3 = (int)0;
            				}
            				else {
HXLINE( 836)					_hx_tmp3 = Value3;
            				}
            			}
HXDLIN( 836)			hx::OrEq(color,((int)_hx_tmp3 << (int)(int)24));
            		}
...
HXDLIN( 842)		Bool _hx_tmp5;
HXDLIN( 842)		if ((this->alpha == (int)1)) {
HXLINE( 842)			_hx_tmp5 = (this->color != (int)16777215);
            		}
            		else {
HXLINE( 842)			_hx_tmp5 = true;
            		}
HXDLIN( 842)		if (!(_hx_tmp5)) {
HXLINE( 842)			_hx_tmp4 = ::flixel::util::FlxColorTransformUtil_obj::hasRGBOffsets(this->colorTransform);
            		}
            		else {
HXLINE( 842)			_hx_tmp4 = true;
            		}
HXDLIN( 842)		this->useColorTransform = _hx_tmp4;
...
void FlxSprite_obj::updateColorTransform(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 848)		Bool _hx_tmp = hx::IsNull( this->colorTransform );
HXDLIN( 848)		if (_hx_tmp) {
HXLINE( 849)			this->colorTransform =  ::openfl::_legacy::geom::ColorTransform_obj::__new(null(),null(),null(),null(),null(),null(),null(),null());
            		}
HXLINE( 851)		Bool _hx_tmp1;
HXDLIN( 851)		if ((this->alpha == (int)1)) {
HXLINE( 851)			_hx_tmp1 = (this->color != (int)16777215);
            		}
            		else {
HXLINE( 851)			_hx_tmp1 = true;
            		}
HXDLIN( 851)		this->useColorTransform = _hx_tmp1;
HXLINE( 852)		Bool _hx_tmp2 = this->useColorTransform;
HXDLIN( 852)		if (_hx_tmp2) {
HXLINE( 853)			Float _hx_tmp3 = ((Float)((int)((int)this->color >> (int)(int)16) & (int)(int)255) / (Float)(int)255);
HXDLIN( 853)			Float _hx_tmp4 = ((Float)((int)((int)this->color >> (int)(int)8) & (int)(int)255) / (Float)(int)255);
HXDLIN( 853)			Int _hx_tmp5 = ((int)this->color & (int)(int)255);
HXDLIN( 853)			::flixel::util::FlxColorTransformUtil_obj::setMultipliers(this->colorTransform,_hx_tmp3,_hx_tmp4,((Float)_hx_tmp5 / (Float)(int)255),this->alpha);
            		}
            		else {
...
Int Mask = __o_Mask.Default(255);
            	...
            	HX_STACK_ARG(Camera,"Camera")
HXLINE( 871)		Bool _hx_tmp = hx::IsNull( Camera );
...
HXLINE( 876)		Float _hx_tmp1 = (point->x - Camera->scroll->x);
HXDLIN( 876)		this->_flashPoint->x = (_hx_tmp1 - this->_point->x);
HXLINE( 877)		Float _hx_tmp2 = (point->y - Camera->scroll->y);
HXDLIN( 877)		this->_flashPoint->y = (_hx_tmp2 - this->_point->y);
HXLINE( 879)		Bool _hx_tmp3 = point->_weak;
...
HXLINE( 882)			_hx_tmp6 = (this->_flashPoint->x > this->frameWidth);
            		}
            		else {
HXLINE( 882)			_hx_tmp6 = true;
            		}
HXDLIN( 882)		if (!(_hx_tmp6)) {
HXLINE( 882)			_hx_tmp5 = (this->_flashPoint->y < (int)0);
            		}
            		else {
HXLINE( 882)			_hx_tmp5 = true;
            		}
HXDLIN( 882)		if (!(_hx_tmp5)) {
HXLINE( 882)			_hx_tmp4 = (this->_flashPoint->y > this->frameHeight);
            		}
            		else {
HXLINE( 882)			_hx_tmp4 = true;
            		}
...
HXLINE( 889)			Int _hx_tmp7 = ::Std_obj::_hx_int(this->_flashPoint->x);
HXDLIN( 889)			Int _hx_tmp8 = ::Std_obj::_hx_int(this->_flashPoint->y);
HXDLIN( 889)			HX_VARI( Int,pixelColor) = frameData->getPixel32(_hx_tmp7,_hx_tmp8);
HXLINE( 890)			return ((((int)((int)pixelColor >> (int)(int)24) & (int)(int)255) * this->alpha) >= Mask);
            		}
...
HXDLIN( 915)		Bool _hx_tmp1 = hx::IsNotNull( this->_frame );
...
HXLINE( 920)			_hx_tmp2 = hx::IsNotNull( this->_frameGraphic );
            		}
            		else {
...
HXDLIN( 926)		Bool _hx_tmp3 = hx::IsNotNull( this->animation->_curAnim );
HXDLIN( 926)		if (_hx_tmp3) {
...
HXDLIN( 927)		Bool _hx_tmp4 = hx::IsNotNull( this->animation->_curAnim );
HXDLIN( 927)		if (_hx_tmp4) {
HXLINE( 927)			doFlipY1 = (doFlipY != this->animation->_curAnim->flipY);
            		}
            		else {
HXLINE( 927)			doFlipY1 = doFlipY;
            		}
HXLINE( 929)		Bool _hx_tmp5;
HXDLIN( 929)		Bool _hx_tmp6;
HXDLIN( 929)		if (!(doFlipX1)) {
HXLINE( 929)			_hx_tmp6 = !(doFlipY1);
            		}
            		else {
HXLINE( 929)			_hx_tmp6 = false;
            		}
HXDLIN( 929)		if (_hx_tmp6) {
HXLINE( 929)			_hx_tmp5 = (this->_frame->type == (int)0);
            		}
            		else {
HXLINE( 929)			_hx_tmp5 = false;
            		}
HXDLIN( 929)		if (_hx_tmp5) {
...
HXLINE( 939)		Bool _hx_tmp7 = this->useColorTransform;
HXDLIN( 939)		if (_hx_tmp7) {
HXLINE( 941)			this->framePixels->colorTransform(this->_flashRect,this->colorTransform);
            		}
HXLINE( 944)		Bool _hx_tmp8;
HXDLIN( 944)		if (::flixel::FlxG_obj::renderTile) {
HXLINE( 944)			_hx_tmp8 = this->useFramePixels;
            		}
            		else {
HXLINE( 944)			_hx_tmp8 = false;
            		}
HXDLIN( 944)		if (_hx_tmp8) {
...
HX_DEFINE_DYNAMIC_FUNC0(FlxSprite_obj,updateFramePixels,return )
 ...
 ::flixel::math::FlxPoint FlxSprite_obj::getGraphicMidpoint( ::flixel::math::FlxPoint point){
            	...
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(point,"point")
HXLINE( 964)		Bool _hx_tmp = hx::IsNull( point );
...
HXLINE( 968)		Float _hx_tmp1 = (this->x + (this->frameWidth * ((Float)0.5)));
HXDLIN( 968)		Float _hx_tmp2 = (this->y + (this->frameHeight * ((Float)0.5)));
HXDLIN( 968)		return point->set(_hx_tmp1,_hx_tmp2);
            	}
...
Bool FlxSprite_obj::isOnScreen( ::flixel::FlxCamera Camera){
            	...
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(Camera,"Camera")
HXLINE( 980)		Bool _hx_tmp = hx::IsNull( Camera );
...
HXLINE( 986)			_hx_tmp3 = (this->bakedRotationAngle > (int)0);
            		}
            		else {
HXLINE( 986)			_hx_tmp3 = true;
            		}
HXDLIN( 986)		if (_hx_tmp3) {
HXLINE( 986)			_hx_tmp2 = (this->scale->x == (int)1);
            		}
            		else {
HXLINE( 986)			_hx_tmp2 = false;
            		}
HXDLIN( 986)		if (_hx_tmp2) {
HXLINE( 986)			_hx_tmp1 = (this->scale->y == (int)1);
            		}
            		else {
HXLINE( 986)			_hx_tmp1 = false;
            		}
HXDLIN( 986)		if (_hx_tmp1) {
HXLINE( 988)			Bool _hx_tmp4;
HXDLIN( 988)			if (!((minX > Camera->width))) {
HXLINE( 988)				_hx_tmp4 = ((minX + this->frameWidth) < (int)0);
            			}
            			else {
HXLINE( 988)				_hx_tmp4 = true;
            			}
HXDLIN( 988)			if (_hx_tmp4) {
HXLINE( 989)				return false;
            			}
HXLINE( 991)			Bool _hx_tmp5;
HXDLIN( 991)			if (!((minY > Camera->height))) {
HXLINE( 991)				_hx_tmp5 = ((minY + this->frameHeight) < (int)0);
            			}
            			else {
HXLINE( 991)				_hx_tmp5 = true;
            			}
HXDLIN( 991)			if (_hx_tmp5) {
...
HXLINE(1002)				HX_VARI( Float,x1) = ::Math_obj::abs(ox);
HXLINE(1003)				Float _hx_tmp6 = (this->frameWidth - ox);
HXDLIN(1003)				HX_VARI( Float,x2) = ::Math_obj::abs(_hx_tmp6);
HXLINE(1004)				radiusX = ::Math_obj::max(x2,x1);
            			}
HXLINE(1007)			HX_VARI( Float,oy) = this->origin->y;
HXLINE(1008)			if ((oy != radiusY)) {
HXLINE(1010)				HX_VARI( Float,y1) = ::Math_obj::abs(oy);
HXLINE(1011)				Float _hx_tmp7 = (this->frameHeight - oy);
HXDLIN(1011)				HX_VARI( Float,y2) = ::Math_obj::abs(_hx_tmp7);
HXLINE(1012)				radiusY = ::Math_obj::max(y2,y1);
            			}
HXLINE(1015)			Float _hx_tmp8 = ::Math_obj::abs(this->scale->x);
HXDLIN(1015)			hx::MultEq(radiusX,_hx_tmp8);
HXLINE(1016)			Float _hx_tmp9 = ::Math_obj::abs(this->scale->y);
HXDLIN(1016)			hx::MultEq(radiusY,_hx_tmp9);
HXLINE(1017)			HX_VARI( Float,radius) = ::Math_obj::max(radiusX,radiusY);
HXLINE(1018)			hx::MultEq(radius,((Float)1.41421356237));
HXLINE(1020)			hx::AddEq(minX,ox);
HXLINE(1021)			HX_VARI( Float,maxX) = (minX + radius);
HXLINE(1022)			hx::SubEq(minX,radius);
HXLINE(1024)			Bool _hx_tmp10;
HXDLIN(1024)			if (!((maxX < (int)0))) {
HXLINE(1024)				_hx_tmp10 = (minX > Camera->width);
            			}
            			else {
HXLINE(1024)				_hx_tmp10 = true;
            			}
HXDLIN(1024)			if (_hx_tmp10) {
HXLINE(1025)				return false;
            			}
HXLINE(1027)			hx::AddEq(minY,oy);
HXLINE(1028)			HX_VARI( Float,maxY) = (minY + radius);
HXLINE(1029)			hx::SubEq(minY,radius);
HXLINE(1031)			Bool _hx_tmp11;
HXDLIN(1031)			if (!((maxY < (int)0))) {
HXLINE(1031)				_hx_tmp11 = (minY > Camera->height);
            			}
            			else {
HXLINE(1031)				_hx_tmp11 = true;
            			}
HXDLIN(1031)			if (_hx_tmp11) {
...
HXDLIN(1058)		Bool _hx_tmp;
HXDLIN(1058)		Bool _hx_tmp1;
HXDLIN(1058)		Bool _hx_tmp2;
HXDLIN(1058)		if ((this->angle != (int)0)) {
HXLINE(1058)			_hx_tmp2 = (this->bakedRotationAngle > (int)0);
            		}
            		else {
HXLINE(1058)			_hx_tmp2 = true;
            		}
HXDLIN(1058)		if (_hx_tmp2) {
HXLINE(1058)			_hx_tmp1 = (this->scale->x == (int)1);
            		}
            		else {
HXLINE(1058)			_hx_tmp1 = false;
            		}
HXDLIN(1058)		if (_hx_tmp1) {
HXLINE(1058)			_hx_tmp = (this->scale->y == (int)1);
            		}
            		else {
...
HXLINE(1060)			Bool _hx_tmp3 = hx::IsNotNull( camera );
...
void FlxSprite_obj::setFacingFlip(Int Direction,Bool FlipX,Bool FlipY){
            	HX_STACK_FRAME("flixel.FlxSprite","setFacingFlip",0x6816c060,"flixel.FlxSprite.setFacingFlip","flixel/FlxSprite.hx",1076,0x0384bffa)
            	HX_STACK_THIS(this)
...
HXLINE(1097)			Bool _hx_tmp = hx::IsNotNull( this->animation->_curAnim );
...
HXLINE(1106)			 ::flixel::graphics::frames::FlxFrame _hx_tmp1 = this->frames->frames->__get(frameIndex).StaticCast<  ::flixel::graphics::frames::FlxFrame >();
HXDLIN(1106)			this->set_frame(_hx_tmp1);
HXLINE(1107)			this->animation->_animations = animations;
HXLINE(1109)			Bool _hx_tmp2 = hx::IsNotNull( currName );
...
HX_DEFINE_DYNAMIC_FUNC2(FlxSprite_obj,setFrames,return )
 ...
 ::openfl::_legacy::display::BitmapData FlxSprite_obj::get_pixels(){
            	HX_STACK_FRAME("flixel.FlxSprite","get_pixels",0x90b8575f,"flixel.FlxSprite.get_pixels","flixel/FlxSprite.hx",1125,0x0384bffa)
            	HX_STACK_THIS(this)
HXLINE(1125)		Bool _hx_tmp = hx::IsNull( this->graphic );
...
HXLINE(1133)		Bool _hx_tmp = hx::IsNull( key );
HXDLIN(1133)		if (_hx_tmp) {
HXLINE(1135)			key = ::flixel::FlxG_obj::bitmap->getUniqueKey(null());
HXLINE(1136)			 ::flixel::graphics::FlxGraphic _hx_tmp1 = ::flixel::FlxG_obj::bitmap->add(Pixels,false,key);
HXDLIN(1136)			this->set_graphic(_hx_tmp1);
            		}
            		else {
HXLINE(1140)			this->set_graphic(::flixel::FlxG_obj::bitmap->_cache->get(key).StaticCast<  ::flixel::graphics::FlxGraphic >());
            		}
HXLINE(1143)		 ::flixel::graphics::frames::FlxImageFrame _hx_tmp2 = this->graphic->get_imageFrame();
HXDLIN(1143)		this->set_frames(_hx_tmp2);
...
HXLINE(1151)		Bool _hx_tmp = hx::IsNotNull( this->frame );
HXDLIN(1151)		if (_hx_tmp) {
HXLINE(1153)			{
HXLINE(1153)				Bool _hx_tmp1 = hx::IsNotNull( this->frame );
...
HXDLIN(1153)				Float _hx_tmp2 = (((Float)0.5) * this->frameWidth);
HXDLIN(1153)				Float _hx_tmp3 = (((Float)0.5) * this->frameHeight);
HXDLIN(1153)				this->_halfSize->set(_hx_tmp2,_hx_tmp3);
HXDLIN(1153)				{
...
HXLINE(1156)			Bool _hx_tmp4;
HXDLIN(1156)			Bool _hx_tmp5;
HXDLIN(1156)			Bool _hx_tmp6 = hx::IsNotNull( this->frames );
HXDLIN(1156)			if (_hx_tmp6) {
HXLINE(1156)				_hx_tmp5 = hx::IsNotNull( this->frames->frames );
            			}
            			else {
HXLINE(1156)				_hx_tmp5 = false;
            			}
HXDLIN(1156)			if (_hx_tmp5) {
HXLINE(1156)				_hx_tmp4 = (this->numFrames > (int)0);
            			}
            			else {
HXLINE(1156)				_hx_tmp4 = false;
            			}
...
HXLINE(1166)		Bool _hx_tmp7 = ::flixel::FlxG_obj::renderTile;
HXDLIN(1166)		if (_hx_tmp7) {
HXLINE(1168)			this->_frameGraphic = ( ( ::flixel::graphics::FlxGraphic)(::flixel::util::FlxDestroyUtil_obj::destroy(this->_frameGraphic)) );
            		}
HXLINE(1171)		Bool _hx_tmp8 = hx::IsNotNull( this->clipRect );
...
HXLINE(1187)		Bool _hx_tmp = hx::IsNotNull( flip );
HXDLIN(1187)		if (_hx_tmp) {
HXLINE(1189)			this->set_flipX( ::Dynamic(flip->__Field(HX_("x",78,00,00,00),hx::paccDynamic)));
HXLINE(1190)			this->set_flipY( ::Dynamic(flip->__Field(HX_("y",79,00,00,00),hx::paccDynamic)));
            		}
...
void FlxSprite_obj::updateTrig(){
            	HX_STACK_FRAME("flixel.FlxSprite","updateTrig",0x193f7fee,"flixel.FlxSprite.updateTrig","flixel/FlxSprite.hx",1236,0x0384bffa)
            	HX_STACK_THIS(this)
HXLINE(1236)		Bool _hx_tmp = this->_angleChanged;
...
::hx::EnumBase FlxSprite_obj::set_blend(::hx::EnumBase Value){
            	HX_STACK_FRAME("flixel.FlxSprite","set_blend",0xa736f86b,"flixel.FlxSprite.set_blend","flixel/FlxSprite.hx",1248,0x0384bffa)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(Value,"Value")
...
HXLINE(1262)			HX_VARI( Int,_g1) = Value->get_useCount();
HXDLIN(1262)			Value->set_useCount((_g1 + (int)1));
            		}
HXLINE(1265)		Bool _hx_tmp1;
HXDLIN(1265)		Bool _hx_tmp2 = hx::IsNotNull( oldGraphic );
...
HXLINE(1267)			HX_VARI_NAME( Int,_g11,"_g1") = oldGraphic->get_useCount();
HXDLIN(1267)			oldGraphic->set_useCount((_g11 - (int)1));
            		}
...
HXLINE(1276)		Bool _hx_tmp = hx::IsNotNull( rect );
...
HXLINE(1285)		Bool _hx_tmp1 = hx::IsNotNull( this->frames );
HXDLIN(1285)		if (_hx_tmp1) {
HXLINE(1287)			 ::flixel::graphics::frames::FlxFrame _hx_tmp2 = this->frames->frames->__get(this->animation->frameIndex).StaticCast<  ::flixel::graphics::frames::FlxFrame >();
HXDLIN(1287)			this->set_frame(_hx_tmp2);
            		}
...
HX_DEFINE_DYNAMIC_FUNC1(FlxSprite_obj,set_clipRect,return )
 ...
 ::flixel::graphics::frames::FlxFramesCollection FlxSprite_obj::set_frames( ::flixel::graphics::frames::FlxFramesCollection Frames){
            	...
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(Frames,"Frames")
HXLINE(1303)		Bool _hx_tmp = hx::IsNotNull( this->animation );
HXDLIN(1303)		if (_hx_tmp) {
HXLINE(1305)			this->animation->destroyAnimations();
            		}
HXLINE(1308)		Bool _hx_tmp1 = hx::IsNotNull( Frames );
HXDLIN(1308)		if (_hx_tmp1) {
HXLINE(1310)			this->set_graphic(Frames->parent);
HXLINE(1311)			this->frames = Frames;
HXLINE(1312)			 ::flixel::graphics::frames::FlxFrame _hx_tmp2 = this->frames->frames->__get((int)0).StaticCast<  ::flixel::graphics::frames::FlxFrame >();
HXDLIN(1312)			this->set_frame(_hx_tmp2);
...
Bool FlxSprite_obj::set_flipX(Bool Value){
            	...
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(Value,"Value")
HXLINE(1333)		Bool _hx_tmp = ::flixel::FlxG_obj::renderTile;
HXDLIN(1333)		if (_hx_tmp) {
HXLINE(1335)			Int _hx_tmp1;
HXDLIN(1335)			if (Value) {
HXLINE(1335)				_hx_tmp1 = (int)-1;
            			}
            			else {
HXLINE(1335)				_hx_tmp1 = (int)1;
            			}
HXDLIN(1335)			this->_facingHorizontalMult = _hx_tmp1;
            		}
HXLINE(1337)		Bool _hx_tmp2;
HXDLIN(1337)		if ((this->flipX == Value)) {
HXLINE(1337)			_hx_tmp2 = this->dirty;
            		}
            		else {
HXLINE(1337)			_hx_tmp2 = true;
            		}
HXDLIN(1337)		this->dirty = _hx_tmp2;
...
Bool FlxSprite_obj::set_flipY(Bool Value){
            	...
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(Value,"Value")
HXLINE(1344)		Bool _hx_tmp = ::flixel::FlxG_obj::renderTile;
HXDLIN(1344)		if (_hx_tmp) {
HXLINE(1346)			Int _hx_tmp1;
HXDLIN(1346)			if (Value) {
HXLINE(1346)				_hx_tmp1 = (int)-1;
            			}
            			else {
HXLINE(1346)				_hx_tmp1 = (int)1;
            			}
HXDLIN(1346)			this->_facingVerticalMult = _hx_tmp1;
            		}
HXLINE(1348)		Bool _hx_tmp2;
HXDLIN(1348)		if ((this->flipY == Value)) {
HXLINE(1348)			_hx_tmp2 = this->dirty;
            		}
            		else {
HXLINE(1348)			_hx_tmp2 = true;
            		}
HXDLIN(1348)		this->dirty = _hx_tmp2;
...
Bool FlxSprite_obj::set_antialiasing(Bool value){
            	HX_STACK_FRAME("flixel.FlxSprite","set_antialiasing",0xf8f29e1a,"flixel.FlxSprite.set_antialiasing","flixel/FlxSprite.hx",1355,0x0384bffa)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(value,"value")
...
Bool FlxSprite_obj::set_useFramePixels(Bool value){
            	HX_STACK_FRAME("flixel.FlxSprite","set_useFramePixels",0x72e62ad9,"flixel.FlxSprite.set_useFramePixels","flixel/FlxSprite.hx",1361,0x0384bffa)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(value,"value")
HXLINE(1361)		Bool _hx_tmp = ::flixel::FlxG_obj::renderTile;
HXDLIN(1361)		if (_hx_tmp) {
HXLINE(1363)			Bool _hx_tmp1 = (value != this->useFramePixels);
...
HXLINE(1387)		Bool _hx_tmp = hx::IsNotNull( this->animation->_curAnim );
...
HXLINE(1398)		Bool _hx_tmp = hx::IsNotNull( this->animation->_curAnim );
