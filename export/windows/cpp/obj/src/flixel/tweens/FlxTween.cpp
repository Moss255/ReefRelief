...
HXLINE( 384)		this->set_type( ::Dynamic(Options->__Field(HX_("type",ba,f2,08,4d),hx::paccDynamic)));
...
HXLINE( 389)		this->setDelays( ::Dynamic(Options->__Field(HX_("startDelay",c1,af,3d,f3),hx::paccDynamic)), ::Dynamic(Options->__Field(HX_("loopDelay",7f,f6,d2,04),hx::paccDynamic)));
HXLINE( 390)		 ::flixel::tweens::FlxTweenManager _hx_tmp;
HXDLIN( 390)		Bool _hx_tmp1 = hx::IsNotNull( manager );
...
void *FlxTween_obj::_hx_getInterface(int inHash) {
 ...
 ::Dynamic FlxTween_obj::resolveTweenOptions( ::Dynamic Options){
            	...
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(Options,"Options")
HXLINE( 395)		Bool _hx_tmp = hx::IsNull( Options );
HXDLIN( 395)		if (_hx_tmp) {
HXLINE( 396)			Options =  ::Dynamic(hx::Anon_obj::Create(1)
            				->setFixed(0,HX_("type",ba,f2,08,4d),(int)8));
            		}
HXLINE( 398)		Bool _hx_tmp1 = hx::IsNull( Options->__Field(HX_("type",ba,f2,08,4d),hx::paccDynamic) );
...
HX_DEFINE_DYNAMIC_FUNC0(FlxTween_obj,destroy,(void))
 ...
 ::flixel::tweens::FlxTween FlxTween_obj::then( ::flixel::tweens::FlxTween tween){
            	HX_STACK_FRAME("flixel.tweens.FlxTween","then",0x19b266be,"flixel.tweens.FlxTween.then","flixel/tweens/FlxTween.hx",420,0x5d58d691)
            	HX_STACK_THIS(this)
...
HX_DEFINE_DYNAMIC_FUNC1(FlxTween_obj,then,return )
 ...
 ::flixel::tweens::FlxTween FlxTween_obj::wait(Float delay){
            	HX_STACK_FRAME("flixel.tweens.FlxTween","wait",0x1ba8be56,"flixel.tweens.FlxTween.wait","flixel/tweens/FlxTween.hx",428,0x5d58d691)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(delay,"delay")
HXLINE( 428)		 ::flixel::tweens::misc::NumTween _hx_tmp = ::flixel::tweens::FlxTween_obj::num((int)0,(int)0,delay,null(),null());
HXDLIN( 428)		return this->addChainedTween(_hx_tmp);
            	}
...
HXLINE( 436)		Bool _hx_tmp = hx::IsNull( this->_chainedTweens );
...
HXLINE( 445)		hx::AddEq(this->_secondsSinceStart,elapsed);
...
HXLINE( 451)		Float _hx_tmp = (this->_secondsSinceStart - delay);
HXDLIN( 451)		Float _hx_tmp1 = ::Math_obj::max(_hx_tmp,(int)0);
HXDLIN( 451)		this->scale = ((Float)_hx_tmp1 / (Float)this->duration);
HXLINE( 452)		Bool _hx_tmp2 = hx::IsNotNull( this->ease );
HXDLIN( 452)		if (_hx_tmp2) {
HXLINE( 454)			this->scale = ( (Float)(this->ease(this->scale)) );
            		}
HXLINE( 456)		Bool _hx_tmp3 = this->backward;
...
HXLINE( 460)			_hx_tmp4 = !(this->_running);
            		}
            		else {
...
HXLINE( 463)			Bool _hx_tmp5 = hx::IsNotNull( this->onStart );
HXDLIN( 463)			if (_hx_tmp5) {
HXLINE( 464)				this->onStart(hx::ObjectPtr<OBJ_>(this));
            			}
            		}
HXLINE( 466)		Bool _hx_tmp6 = (this->_secondsSinceStart >= (this->duration + delay));
HXDLIN( 466)		if (_hx_tmp6) {
HXLINE( 468)			Float _hx_tmp7;
HXDLIN( 468)			if (this->backward) {
HXLINE( 468)				_hx_tmp7 = (int)0;
            			}
            			else {
HXLINE( 468)				_hx_tmp7 = (int)1;
            			}
HXDLIN( 468)			this->scale = _hx_tmp7;
HXLINE( 469)			this->finished = true;
            		}
            		else {
HXLINE( 473)			Bool _hx_tmp8 = hx::IsNotNull( this->onUpdate );
...
HXLINE( 486)		Bool _hx_tmp1 = (this->duration == (int)0);
...
HXLINE( 505)		Bool _hx_tmp = hx::IsNotNull( this->manager );
...
HXLINE( 513)		Bool _hx_tmp = hx::IsNotNull( this->onComplete );
...
HXLINE( 518)			_hx_tmp1 = (type == (int)8);
            		}
            		else {
...
HXLINE( 523)				_hx_tmp2 = hx::IsNotNull( this->manager );
            			}
            			else {
...
HXLINE( 529)			_hx_tmp3 = (type == (int)4);
            		}
            		else {
HXLINE( 529)			_hx_tmp3 = true;
            		}
HXDLIN( 529)		if (_hx_tmp3) {
HXLINE( 531)			Float _hx_tmp4 = hx::Mod((this->_secondsSinceStart - this->_delayToUse),this->duration);
HXDLIN( 531)			this->_secondsSinceStart = (_hx_tmp4 + this->_delayToUse);
HXLINE( 532)			Float _hx_tmp5 = (this->_secondsSinceStart - this->_delayToUse);
HXDLIN( 532)			Float _hx_tmp6 = ::Math_obj::max(_hx_tmp5,(int)0);
HXDLIN( 532)			this->scale = ((Float)_hx_tmp6 / (Float)this->duration);
HXLINE( 534)			Bool _hx_tmp7;
HXDLIN( 534)			Bool _hx_tmp8;
HXDLIN( 534)			Bool _hx_tmp9 = hx::IsNotNull( this->ease );
HXDLIN( 534)			if (_hx_tmp9) {
HXLINE( 534)				_hx_tmp8 = (this->scale > (int)0);
            			}
            			else {
HXLINE( 534)				_hx_tmp8 = false;
            			}
HXDLIN( 534)			if (_hx_tmp8) {
HXLINE( 534)				_hx_tmp7 = (this->scale < (int)1);
            			}
            			else {
HXLINE( 534)				_hx_tmp7 = false;
            			}
HXDLIN( 534)			if (_hx_tmp7) {
HXLINE( 536)				this->scale = ( (Float)(this->ease(this->scale)) );
            			}
HXLINE( 539)			if ((type == (int)4)) {
HXLINE( 541)				this->backward = !(this->backward);
HXLINE( 542)				Bool _hx_tmp10 = this->backward;
HXDLIN( 542)				if (_hx_tmp10) {
...
HXDLIN( 570)		Bool _hx_tmp1 = hx::IsNotNull( this->_chainedTweens );
...
HXLINE( 573)		 ::flixel::tweens::FlxTween _hx_tmp2 = this->_chainedTweens->shift().StaticCast<  ::flixel::tweens::FlxTween >();
HXDLIN( 573)		this->doNextTween(_hx_tmp2);
...
void FlxTween_obj::doNextTween( ::flixel::tweens::FlxTween tween){
            	...
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(tween,"tween")
HXLINE( 579)		Bool _hx_tmp = !(tween->active);
...
HXLINE( 590)		Bool _hx_tmp = hx::IsNull( previousChain );
HXDLIN( 590)		if (_hx_tmp) {
HXLINE( 591)			return;
            		}
HXLINE( 593)		Bool _hx_tmp1 = hx::IsNull( this->_chainedTweens );
...
void FlxTween_obj::restart(){
            	HX_STACK_FRAME("flixel.tweens.FlxTween","restart",0xf888468e,"flixel.tweens.FlxTween.restart","flixel/tweens/FlxTween.hx",605,0x5d58d691)
            	HX_STACK_THIS(this)
HXLINE( 605)		Bool _hx_tmp = this->active;
...
HXDLIN( 623)		Bool _hx_tmp1 = hx::IsNotNull( StartDelay );
...
HXLINE( 624)		Float _hx_tmp2;
HXDLIN( 624)		Bool _hx_tmp3 = hx::IsNotNull( LoopDelay );
HXDLIN( 624)		if (_hx_tmp3) {
HXLINE( 624)			_hx_tmp2 = LoopDelay;
            		}
            		else {
HXLINE( 624)			_hx_tmp2 = (int)0;
            		}
HXDLIN( 624)		this->set_loopDelay(_hx_tmp2);
...
HXLINE( 631)		Bool _hx_tmp = (this->executions == (int)0);
HXDLIN( 631)		if (_hx_tmp) {
HXLINE( 633)			Float _hx_tmp1 = this->duration;
HXDLIN( 633)			Float _hx_tmp2 = (this->_secondsSinceStart - this->_delayToUse);
HXDLIN( 633)			Float _hx_tmp3 = ::Math_obj::max(_hx_tmp2,(int)0);
HXDLIN( 633)			Float _hx_tmp4 = (_hx_tmp1 * ((Float)_hx_tmp3 / (Float)this->duration));
HXDLIN( 633)			Float _hx_tmp5 = (dly - this->startDelay);
HXDLIN( 633)			Float _hx_tmp6 = ::Math_obj::max(_hx_tmp5,(int)0);
HXDLIN( 633)			this->_secondsSinceStart = (_hx_tmp4 + _hx_tmp6);
...
HXLINE( 642)		Bool _hx_tmp = (this->executions > (int)0);
HXDLIN( 642)		if (_hx_tmp) {
HXLINE( 644)			Float _hx_tmp1 = this->duration;
HXDLIN( 644)			Float _hx_tmp2 = (this->_secondsSinceStart - this->_delayToUse);
HXDLIN( 644)			Float _hx_tmp3 = ::Math_obj::max(_hx_tmp2,(int)0);
HXDLIN( 644)			Float _hx_tmp4 = (_hx_tmp1 * ((Float)_hx_tmp3 / (Float)this->duration));
HXDLIN( 644)			Float _hx_tmp5 = (dly - this->loopDelay);
HXDLIN( 644)			Float _hx_tmp6 = ::Math_obj::max(_hx_tmp5,(int)0);
HXDLIN( 644)			this->_secondsSinceStart = (_hx_tmp4 + _hx_tmp6);
...
Float FlxTween_obj::get_percent(){
            	HX_STACK_FRAME("flixel.tweens.FlxTween","get_percent",0x9c57551b,"flixel.tweens.FlxTween.get_percent","flixel/tweens/FlxTween.hx",652,0x5d58d691)
            	HX_STACK_THIS(this)
HXLINE( 652)		Float _hx_tmp = (this->_secondsSinceStart - this->_delayToUse);
HXDLIN( 652)		Float _hx_tmp1 = ::Math_obj::max(_hx_tmp,(int)0);
HXDLIN( 652)		return ((Float)_hx_tmp1 / (Float)this->duration);
            	}
...
Float FlxTween_obj::set_percent(Float value){
            	HX_STACK_FRAME("flixel.tweens.FlxTween","set_percent",0xa6c45c27,"flixel.tweens.FlxTween.set_percent","flixel/tweens/FlxTween.hx",657,0x5d58d691)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(value,"value")
HXLINE( 657)		Float _hx_tmp = (this->duration * value);
HXDLIN( 657)		return (this->_secondsSinceStart = (_hx_tmp + this->_delayToUse));
            	}
...
Int FlxTween_obj::set_type(Int value){
            	...
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(value,"value")
HXLINE( 662)		Bool _hx_tmp = (value == (int)0);
HXDLIN( 662)		if (_hx_tmp) {
HXLINE( 664)			value = (int)8;
            		}
            		else {
HXLINE( 666)			Bool _hx_tmp1 = (value == (int)16);
...
HXLINE( 679)		Bool _hx_tmp = this->_waitingForRestart;
...
Float Duration = __o_Duration.Default(1);
            	HX_STACK_FRAME("flixel.tweens.FlxTween","num",0xa4425185,"flixel.tweens.FlxTween.num","flixel/tweens/FlxTween.hx",105,0x5d58d691)
...
Float Duration = __o_Duration.Default(1);
            	HX_STACK_FRAME("flixel.tweens.FlxTween","angle",0x75c344d2,"flixel.tweens.FlxTween.angle","flixel/tweens/FlxTween.hx",131,0x5d58d691)
...
Bool UseDuration = __o_UseDuration.Default(true);
            	HX_STACK_FRAME("flixel.tweens.FlxTween","linearMotion",0xd656f2dc,"flixel.tweens.FlxTween.linearMotion","flixel/tweens/FlxTween.hx",186,0x5d58d691)
            	HX_STACK_ARG(Object,"Object")
...
Float DurationOrSpeed = __o_DurationOrSpeed.Default(1);
Bool UseDuration = __o_UseDuration.Default(true);
            	HX_STACK_FRAME("flixel.tweens.FlxTween","quadMotion",0xc62584fe,"flixel.tweens.FlxTween.quadMotion","flixel/tweens/FlxTween.hx",217,0x5d58d691)
            	HX_STACK_ARG(Object,"Object")
            	HX_STACK_ARG(FromX,"FromX")
            	HX_STACK_ARG(FromY,"FromY")
...
Float Duration = __o_Duration.Default(1);
            	HX_STACK_FRAME("flixel.tweens.FlxTween","cubicMotion",0xa068755f,"flixel.tweens.FlxTween.cubicMotion","flixel/tweens/FlxTween.hx",249,0x5d58d691)
            	HX_STACK_ARG(Object,"Object")
            	HX_STACK_ARG(FromX,"FromX")
            	HX_STACK_ARG(FromY,"FromY")
            	HX_STACK_ARG(aX,"aX")
...
Float DurationOrSpeed = __o_DurationOrSpeed.Default(1);
Bool UseDuration = __o_UseDuration.Default(true);
            	HX_STACK_FRAME("flixel.tweens.FlxTween","circularMotion",0x65e89916,"flixel.tweens.FlxTween.circularMotion","flixel/tweens/FlxTween.hx",279,0x5d58d691)
            	HX_STACK_ARG(Object,"Object")
...
Float DurationOrSpeed = __o_DurationOrSpeed.Default(1);
Bool UseDuration = __o_UseDuration.Default(true);
            	HX_STACK_FRAME("flixel.tweens.FlxTween","linearPath",0xd40abccb,"flixel.tweens.FlxTween.linearPath","flixel/tweens/FlxTween.hx",304,0x5d58d691)
            	HX_STACK_ARG(Object,"Object")
...
Float DurationOrSpeed = __o_DurationOrSpeed.Default(1);
Bool UseDuration = __o_UseDuration.Default(true);
            	HX_STACK_FRAME("flixel.tweens.FlxTween","quadPath",0x6abb226d,"flixel.tweens.FlxTween.quadPath","flixel/tweens/FlxTween.hx",329,0x5d58d691)
            	HX_STACK_ARG(Object,"Object")
            	HX_STACK_ARG(Points,"Points")
            	HX_STACK_ARG(DurationOrSpeed,"DurationOrSpeed")
            	HX_STACK_ARG(UseDuration,"UseDuration")
...
{
{
            	HX_STACK_FRAME("flixel.tweens.FlxTween","boot",0x0dd1e813,"flixel.tweens.FlxTween.boot","flixel/tweens/FlxTween.hx",28,0x5d58d691)
HXLINE(  28)		PERSIST = (int)1;
            	}
{
            	HX_STACK_FRAME("flixel.tweens.FlxTween","boot",0x0dd1e813,"flixel.tweens.FlxTween.boot","flixel/tweens/FlxTween.hx",32,0x5d58d691)
HXLINE(  32)		LOOPING = (int)2;
            	}
{
            	HX_STACK_FRAME("flixel.tweens.FlxTween","boot",0x0dd1e813,"flixel.tweens.FlxTween.boot","flixel/tweens/FlxTween.hx",36,0x5d58d691)
HXLINE(  36)		PINGPONG = (int)4;
            	}
{
            	HX_STACK_FRAME("flixel.tweens.FlxTween","boot",0x0dd1e813,"flixel.tweens.FlxTween.boot","flixel/tweens/FlxTween.hx",40,0x5d58d691)
HXLINE(  40)		ONESHOT = (int)8;
            	}
{
            	HX_STACK_FRAME("flixel.tweens.FlxTween","boot",0x0dd1e813,"flixel.tweens.FlxTween.boot","flixel/tweens/FlxTween.hx",44,0x5d58d691)
