...
HXLINE(  36)		this->_pointD = ::Array_obj< Float >::fromData( _hx_array_data_0,1);
HXLINE(  37)		this->_pointT = ::Array_obj< Float >::fromData( _hx_array_data_1,1);
            	}
...
Float y = __o_y.Default(0);
            	...
            	HX_STACK_ARG(x,"x")
            	HX_STACK_ARG(y,"y")
HXLINE(  80)		Bool _hx_tmp = hx::IsNotNull( this->_last );
HXDLIN(  80)		if (_hx_tmp) {
HXLINE(  82)			Float _hx_tmp1 = ((x - this->_last->x) * (x - this->_last->x));
HXDLIN(  82)			Float _hx_tmp2 = ((y - this->_last->y) * (y - this->_last->y));
HXDLIN(  82)			hx::AddEq(this->distance,::Math_obj::sqrt((_hx_tmp1 + _hx_tmp2)));
HXLINE(  83)			this->_pointD[this->points->length] = this->distance;
            		}
HXLINE(  85)		Int _hx_tmp3 = this->points->length;
HXDLIN(  85)		HX_VARI(  ::flixel::math::FlxPoint,point) = ::flixel::math::FlxPoint_obj::_pool->get()->set(x,y);
HXDLIN(  85)		point->_inPool = false;
HXDLIN(  85)		 ::flixel::math::FlxPoint _hx_tmp4 = (this->_last = point);
HXDLIN(  85)		this->points[_hx_tmp3] = _hx_tmp4;
...
HXLINE( 111)		Bool _hx_tmp = hx::IsNull( this->points );
HXDLIN( 111)		if (_hx_tmp) {
HXLINE( 112)			return;
            		}
HXLINE( 114)		Bool _hx_tmp1 = !(this->backward);
HXDLIN( 114)		if (_hx_tmp1) {
HXLINE( 116)			Bool _hx_tmp2 = (this->_index < (this->points->length - (int)1));
HXDLIN( 116)			if (_hx_tmp2) {
HXLINE( 118)				while((this->scale > this->_pointT->__get((this->_index + (int)1)))){
HXLINE( 120)					this->_index++;
HXLINE( 121)					Bool _hx_tmp3 = (this->_index == (this->points->length - (int)1));
HXDLIN( 121)					if (_hx_tmp3) {
HXLINE( 123)						hx::SubEq(this->_index,(int)1);
...
HXLINE( 131)			Float _hx_tmp4 = (this->scale - td);
HXDLIN( 131)			td = ((Float)_hx_tmp4 / (Float)tt);
HXLINE( 132)			this->_prevPoint = this->points->__get(this->_index).StaticCast<  ::flixel::math::FlxPoint >();
HXLINE( 133)			Int _hx_tmp5 = (this->_index + (int)1);
HXDLIN( 133)			this->_nextPoint = this->points->__get(_hx_tmp5).StaticCast<  ::flixel::math::FlxPoint >();
HXLINE( 134)			Float _hx_tmp6 = this->_prevPoint->x;
HXDLIN( 134)			Float _hx_tmp7 = ((this->_nextPoint->x - this->_prevPoint->x) * td);
HXDLIN( 134)			this->x = (_hx_tmp6 + _hx_tmp7);
HXLINE( 135)			Float _hx_tmp8 = this->_prevPoint->y;
HXDLIN( 135)			Float _hx_tmp9 = ((this->_nextPoint->y - this->_prevPoint->y) * td);
HXDLIN( 135)			this->y = (_hx_tmp8 + _hx_tmp9);
            		}
            		else {
HXLINE( 139)			Bool _hx_tmp10 = (this->_index > (int)0);
HXDLIN( 139)			if (_hx_tmp10) {
HXLINE( 141)				while((this->scale < this->_pointT->__get((this->_index - (int)1)))){
HXLINE( 143)					hx::SubEq(this->_index,(int)1);
HXLINE( 144)					Bool _hx_tmp11 = (this->_index == (int)0);
HXDLIN( 144)					if (_hx_tmp11) {
HXLINE( 146)						hx::AddEq(this->_index,(int)1);
...
HXLINE( 154)			Float _hx_tmp12 = (this->scale - td);
HXDLIN( 154)			td = ((Float)_hx_tmp12 / (Float)tt);
HXLINE( 155)			this->_prevPoint = this->points->__get(this->_index).StaticCast<  ::flixel::math::FlxPoint >();
HXLINE( 156)			Int _hx_tmp13 = (this->_index - (int)1);
HXDLIN( 156)			this->_nextPoint = this->points->__get(_hx_tmp13).StaticCast<  ::flixel::math::FlxPoint >();
HXLINE( 157)			Float _hx_tmp14 = this->_prevPoint->x;
HXDLIN( 157)			Float _hx_tmp15 = ((this->_nextPoint->x - this->_prevPoint->x) * td);
HXDLIN( 157)			this->x = (_hx_tmp14 + _hx_tmp15);
HXLINE( 158)			Float _hx_tmp16 = this->_prevPoint->y;
HXDLIN( 158)			Float _hx_tmp17 = ((this->_nextPoint->y - this->_prevPoint->y) * td);
HXDLIN( 158)			this->y = (_hx_tmp16 + _hx_tmp17);
            		}
...
HXLINE( 175)			Int _hx_tmp = i;
HXDLIN( 175)			Int _hx_tmp1 = i++;
HXDLIN( 175)			Float _hx_tmp2 = ((Float)this->_pointD->__get(_hx_tmp1) / (Float)this->distance);
HXDLIN( 175)			this->_pointT[_hx_tmp] = _hx_tmp2;
            		}
            	}
