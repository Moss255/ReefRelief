...
class AssetData {
	...
	public static function initialize():Void {
		...
		if (!initialized) {
			...
			type.set ("assets/images/map_bk.png", Reflect.field (AssetType, "image".toUpperCase ()));
			path.set ("assets/images/SmallCrate.png", "assets/images/SmallCrate.png");
			type.set ("assets/images/SmallCrate.png", Reflect.field (AssetType, "image".toUpperCase ()));
			...
			type.set ("assets/images/sub_bk.png", Reflect.field (AssetType, "image".toUpperCase ()));
			...
			type.set ("assets/images/Urchin.psd", Reflect.field (AssetType, "binary".toUpperCase ()));
