...
class ApplicationMain {
	...
	public static function create ():Void {
		...
		urls.push ("assets/fonts/Oswald-Regular.eot");
		types.push (lime.Assets.AssetType.BINARY);
		
		
		urls.push ("assets/fonts/Oswald-Regular.svg");
		types.push (lime.Assets.AssetType.TEXT);
		
		
		urls.push ("Oswald Regular");
		types.push (lime.Assets.AssetType.FONT);
		
		
		urls.push ("assets/fonts/Oswald-Regular.woff");
		types.push (lime.Assets.AssetType.BINARY);
		
		
		urls.push ("assets/images/barrell.png");
		...
		urls.push ("assets/images/sub.png");
		types.push (lime.Assets.AssetType.IMAGE);
		...
		urls.push ("assets/images/Urchin.png");
		types.push (lime.Assets.AssetType.IMAGE);
		
		
		urls.push ("assets/map.csv");
		types.push (lime.Assets.AssetType.TEXT);
